...
<a name="3060-1621846615933"></a><a name="n2mq-1708678164426"></a>[一.数据库设计](#jeyl-1677787446995)

<a name="bvmo-1708678164428"></a>[1. 关系型数据库](#5hya-1677787446996)

<a name="apdr-1708678164430"></a>[.E-R图，由台湾工程师提出的设计概念](#ohc5-1621692571287)

<a name="50jo-1708678164432"></a>[.流程图-业务逻辑相关，系统用户动作。抽象出E-R图](#5ocb-1645598528868)

<a name="n4jg-1708678164434"></a>[1.1 E-R图 ](#gzqe-1677787446997)

<a name="fjhc-1708678164436"></a>[1.根据名词抽象出实体](#r1ac-1621692724628)

<a name="htvw-1708678164438"></a>[2.名词找属性](#d2fl-1621692745600)

<a name="fdsn-1708678164440"></a>[3.实体间联系](#dwkp-1621692752824)

<a name="l2lx-1708678164442"></a>[.状态图](#53bo-1621692829033)

<a name="coua-1708678164444"></a>[1.2 转化成数据库设计（公式）](#c2cy-1677787446998)

<a name="yhij-1708678164446"></a>[.1 对1 关系 往记录少的乙方加主键](#xmox-1621692858500)

<a name="kmx0-1708678164449"></a>[.1对n 关系 ，往 n 实体加关联主键 ](#mdr8-1621692924289)

<a name="4cet-1708678164451"></a>[. n对 m 关系，需要一个关联表作映射关联](#hd3i-1621692960576)

<a name="ifdl-1708678164453"></a>[二.系统优化](#cdso-1677787447000)

<a name="zlvb-1708678164455"></a>[应用整体的优化](#3qep-1642647362896)

<a name="m7ee-1708678164457"></a>[-cpu -> 纳秒级别](#knge-1642647371136)

<a name="xj4s-1708678164459"></a>[1.多线程和并发编程](#ovup-1704437622969)

<a name="nf5m-1708678164461"></a>[2.JNI ](#ufpl-1704437634986)

<a name="usjg-1708678164463"></a>[3.JIT/AOT编译](#ixb5-1704437634987)

<a name="ltzd-1708678164465"></a>[4.算法优化](#kr1f-1704437634988)

<a name="t23g-1708678164467"></a>[-内存RAM（GB）/高速缓存(KB) -> 微秒级别(分级缓存)](#1xur-1642647384168)

<a name="kwqr-1708678164469"></a>[1.JVM内存管理](#7hi9-1704437851514)

<a name="j66a-1708678164471"></a>[2.缓存](#te7c-1704437851799)

<a name="vyjg-1708678164473"></a>[3.消息中间件](#bqty-1704437851800)

<a name="ea7g-1708678164475"></a>[-磁盘（TB）-> 毫秒级别(减少io次数,减少随机io-redolog)](#ziti-1642647439005)

<a name="z88g-1708678164477"></a>[1.减少磁盘io](#zups-1704437900079)

<a name="qdsr-1708678164479"></a>[2.数据压缩   ](#u3ok-1704438035018)

<a name="kwaf-1708678164481"></a>[-网络传输/系统交互 -> 秒级 (减少io，连接池化) ](#irbp-1642647458856)

<a name="9nhe-1708678164483"></a>[1.减少网络请求   ](#6qil-1704438276193)

<a name="9cqi-1708678164485"></a>[2.使用CDN](#p5dt-1704438283633)

<a name="yy9x-1708678164487"></a>[3.Sockets异步通信                                      ](#zhp8-1704438283634)

<a name="gjv5-1708678164489"></a>[项目架构层面的优化](#3l0l-1704424353262)

<a name="kk2p-1708678164491"></a>[-多级缓存](#8o8s-1704424396933)

<a name="pp0r-1708678164493"></a>[-应用层](#trcg-1704438366333)

<a name="nj6m-1708678164495"></a>[代码优化](#68oa-1704438530062)

<a name="uaki-1708678164497"></a>[数据库优化](#clmf-1704438530257)

<a name="vsov-1708678164499"></a>[日志优化](#md03-1704438530259)

<a name="vsoj-1708678164501"></a>[-监控与调优](#ocux-1704438477879)

<a name="5wmd-1708678164503"></a>[性能监控：](#vdq2-1704438556836)

<a name="v7bb-1708678164505"></a>[分析和调优](#t29d-1704438557094)

<a name="624h-1708678164507"></a>[-分布式系统架构](#ukjf-1704424419442)

<a name="cjkb-1708678164509"></a>[  .负载均衡](#a0bx-1704438677201)

<a name="9ksa-1708678164511"></a>[分布式缓存](#xn9x-1704438687994)

<a name="51it-1708678164513"></a>[服务降级和容错](#zcdp-1704438687996)

<a name="deyf-1708678164515"></a>[读写层面](#six7-1642647372926)

<a name="rqkz-1708678164517"></a>[.读优化](#g4uv-1704732583614)

<a name="6o1r-1708678164519"></a>[1.缓存](#uuzh-1704732602620)

<a name="vbaa-1708678164521"></a>[2.索引](#qobc-1704732605892)

<a name="lnsv-1708678164523"></a>[3.减少io/批量读/非阻塞io](#zlg9-1704732609048)

<a name="e2z7-1708678164525"></a>[4.减少多余数据加载/列式存储读](#fpjd-1704732631316)

<a name="hknp-1708678164527"></a>[.写优化](#oyob-1704732598377)

<a name="3bqw-1708678164529"></a>[1.异步写](#6jmb-1704732509150)

<a name="8pl1-1708678164531"></a>[2.并发写](#tkwp-1704732723564)

<a name="gdod-1708678164533"></a>[3.批量写](#hewz-1704732862030)

<a name="5fxu-1708678164536"></a>[4.优化算法和数据结构](#ccd8-1704732727854)

<a name="ui2w-1708678164538"></a>[5.缓存写](#eqd9-1704732736281)

<a name="n6cw-1708678164540"></a>[6.非阻塞io](#hyq8-1704732768916)

<a name="yo91-1708678164542"></a>[1.分控系统优化复盘](#tncv-1677787447001)

<a name="yp5v-1708678164544"></a>[1.1 数据库系统](#ydq7-1677787447002)

<a name="dj4f-1708678164546"></a>[1.2 sql慢](#wxdd-1677787447003)

<a name="fm43-1708678164548"></a>[1.3 接口慢](#olpb-1677787447004)

<a name="9ews-1708678164550"></a>[高并发系统设计](#wrwk-1642647280506)

<a name="p4di-1708678164552"></a>[1.满足大规模用户同时访问，提供良好响应时间和性能](#8ien-1704757782146)

<a name="zolj-1708678164554"></a>[2.设计之初就要考虑伸缩性和容错性是非常重要的](#xy0g-1704757785190)

<a name="j8td-1708678164556"></a>[.垂直伸缩 ](#wr12-1704947861599)

<a name="zhe4-1708678164558"></a>[.水平伸缩](#bizh-1704947959744)

<a name="hvxf-1708678164560"></a>[1.分布式架构](#fvzi-1704756770858)

<a name="pnvt-1708678164562"></a>[.微服务架构](#ywzr-1704756872033)

<a name="4e4c-1708678164564"></a>[.分布式计算](#xgna-1704756877646)

<a name="p5me-1708678164566"></a>[2.负载均衡](#wnfy-1704756775272)

<a name="9gpz-1708678164568"></a>[.负载均衡](#h6nf-1704756891918)

<a name="1vdv-1708678164570"></a>[.水平扩展](#c8zr-1704756894402)

<a name="yokg-1708678164572"></a>[3.数据库设计](#wxjk-1704756782840)

<a name="hqlf-1708678164574"></a>[.读写分离](#lxca-1704756910837)

<a name="8hdf-1708678164576"></a>[.数据库分片](#p7d2-1704756922362)

<a name="ccjv-1708678164578"></a>[.缓存](#hxjt-1704756963988)

<a name="n537-1708678164580"></a>[4.缓存优化](#iivs-1704756788012)

<a name="8juh-1708678164582"></a>[.分布式缓存](#cvui-1704756971791)

<a name="zgwu-1708678164584"></a>[.本地缓存](#ysly-1704756979122)

<a name="wxk5-1708678164586"></a>[.缓存预热](#rqwj-1704756986363)

<a name="nzod-1708678164588"></a>[5.消息队列](#so9h-1704756800253)

<a name="3bbm-1708678164590"></a>[.异步处理](#sxlo-1704756996000)

<a name="4hnb-1708678164592"></a>[.削峰填谷](#llm2-1704757002994)

<a name="n5a1-1708678164594"></a>[6.分布式事务](#n39o-1704756805232)

<a name="du6h-1708678164596"></a>[.两阶段提交](#5bhj-1704757017700)

<a name="h1kr-1708678164598"></a>[.补偿事务](#becc-1704757028036)

<a name="s9iu-1708678164600"></a>[7.高可用和容错](#wgkk-1704756813448)

<a name="j80x-1708678164602"></a>[.多地域部署](#akwz-1704757035393)

<a name="0ek8-1708678164604"></a>[.设计容错](#3nxv-1704757055271)

<a name="w6xz-1708678164606"></a>[1. 熔断限流](#g3xx-1704757371028)

<a name="w2gs-1708678164608"></a>[2. 多节点服务](#jafy-1704757374368)

<a name="ip5t-1708678164610"></a>[8.监控和性能调优](#ilyo-1704756820772)

<a name="cevm-1708678164612"></a>[.实时监控](#kpwq-1704757064566)

<a name="3rd6-1708678164614"></a>[.性能测试](#shf4-1704757066453)

<a name="rfrx-1708678164616"></a>[9.安全性设计](#2pry-1704756830245)

<a name="w6nu-1708678164618"></a>[.防御性编程](#pkiw-1704757078583)

<a name="hv64-1708678164620"></a>[.访问控制](#g4l1-1704757084924)

<a name="qvbf-1708678164622"></a>[10.水平扩展](#1tsd-1704756838192)

<a name="qlbu-1708678164625"></a>[.自动化部署](#r1dd-1704757092061)

<a name="cn0i-1708678164627"></a>[.云服务](#7mhk-1704757104117)

<a name="a3h0-1708678164629"></a>[高并发性能指标](#rpxb-1677787447005)

<a name="akpv-1708678164631"></a>[QPS(每秒请求)](#klnv-1704761369323)

<a name="wpky-1708678164633"></a>[TPS(每秒事务)](#zvlz-1704761369324)

<a name="2yuz-1708678164635"></a>[RT(响应时间)](#gvrn-1704761369325)

<a name="vxpr-1708678164637"></a>[===系统架构设计师===](#ozkt-1704761368259)

<a name="zjg0-1708678164639"></a>[系统工程与信息系统基础](#mpwu-1704949756608)

<a name="3y3i-1708678164641"></a>[.系统工程方法](#2gzz-1704980837071)

<a name="ksb0-1708678164643"></a>[.系统工程生命周期阶段](#mk93-1704952875199)

<a name="yesx-1708678164645"></a>[.系统工程生命周期方法](#ny2c-1704952893636)

<a name="wez1-1708678164647"></a>[.信息系统建设原则](#shmt-1704952904062)

<a name="rzek-1708678164649"></a>[.信息系统开发方法](#itje-1704951812273)

<a name="qko8-1708678164651"></a>[原型法](#bnzq-1705819374009)

<a name="qwqk-1708678164653"></a>[结构化法-瀑布型](#ujj3-1705819377863)

<a name="jef5-1708678164655"></a>[形式化法-数模](#8wek-1705819398251)

<a name="bak0-1708678164657"></a>[敏捷方法](#jeuk-1705819392097)

<a name="w7wr-1708678164659"></a>[.信息系统分类](#w8yd-1704980881013)

<a name="pfqw-1708678164661"></a>[业务处理系统TPS](#hlhq-1705819204285)

<a name="4qp7-1708678164663"></a>[管理信息系统MIS](#oksn-1705819204735)

<a name="4ph1-1708678164665"></a>[决策支持系统DSS](#lwm7-1705819204736)

<a name="g2db-1708678164667"></a>[专家系统ES](#bmeu-1705819204737)

<a name="ogsy-1708678164669"></a>[办公自动化系统OAS](#kffq-1705819204738)

<a name="vm4w-1708678164671"></a>[企业资源系统ERP](#k2px-1705819204739)

<a name="b8km-1708678164673"></a>[过程模型](#f98t-1704981918920)

<a name="de8n-1708678164675"></a>[瀑布模型](#yk4j-1705841608124)

<a name="djpx-1708678164677"></a>[V模型【瀑布变种-测试贯穿】](#oryp-1705841608705)

<a name="xlpu-1708678164679"></a>[原型模型](#b0cp-1705841621350)

<a name="0zcl-1708678164681"></a>[螺旋模型【原型+瀑布 风险】](#sfqi-1705841608707)

<a name="3u8j-1708678164683"></a>[构件组装模型/基于构件的开发方法](#kbjw-1705841608709)

<a name="ymzk-1708678164685"></a>[快速应用开发RAD【瀑布+构件组装】](#mvze-1705841627436)

<a name="0azf-1708678164687"></a>[统一过程/统一开发方法](#xici-1705841629815)

<a name="kihb-1708678164689"></a>[敏捷开发方法](#9jca-1705841608711)

<a name="c13g-1708678164691"></a>[XP](#28va-1705841590197)

<a name="04ox-1708678164693"></a>[Scrum](#fyfq-1705938223773)

<a name="mxjq-1708678164695"></a>[逆向工程](#d5ko-1705938215067)

<a name="sduh-1708678164697"></a>[实现级](#os3c-1706090901666)

<a name="ffnx-1708678164699"></a>[结构级](#irxb-1706090905276)

<a name="9dn8-1708678164701"></a>[功能级](#rk8d-1706090908958)

<a name="v53k-1708678164703"></a>[领域级](#k3pt-1706090912460)

<a name="hux7-1708678164705"></a>[净室软件工程](#tybd-1705938215235)

<a name="cl0j-1708678164707"></a>[需求工程](#ochn-1705940085547)

<a name="5pw5-1708678164709"></a>[.需求获取](#xdlf-1705940054108)

<a name="f1zv-1708678164711"></a>[用户面谈 ](#s1uq-1706090846730)

<a name="jynl-1708678164713"></a>[联合需求计划(JRP) ](#vuil-1706090851858)

<a name="n9sm-1708678164716"></a>[问卷调查 ](#gpxg-1706090851859)

<a name="hpc9-1708678164718"></a>[现场观察   ](#mg9n-1706090851860)

<a name="vxhs-1708678164720"></a>[原型化方法        ](#3ww6-1706090851861)

<a name="jwt5-1708678164722"></a>[头脑风暴法](#0awr-1706090851863)

<a name="bpxi-1708678164724"></a>[.需求分析](#axny-1705940052332)

<a name="ltfq-1708678164726"></a>[1.功能模型(数据流图DFD)](#v8wz-1706090812929)

<a name="9cyz-1708678164728"></a>[2.行为模型(状态转换图)](#3uls-1706090814821)

<a name="jbj8-1708678164730"></a>[3.实体模型(E-R图)](#69df-1706090816407)

<a name="otar-1708678164732"></a>[UML](#loq2-1705940640473)

<a name="bjce-1708678164734"></a>[需求定义](#4aeg-1706091062964)

<a name="sxpp-1708678164736"></a>[需求验证](#ud2s-1706090947930)

<a name="bwmf-1708678164738"></a>[需求跟踪](#l03x-1705940634470)

<a name="3qnt-1708678164740"></a>[需求变更管理](#muqf-1706093218719)

<a name="dd56-1708678164742"></a>[软件系统建模](#ilpb-1706093190683)

<a name="zreq-1708678164744"></a>[软件界面设计](#j396-1706094675778)

<a name="rhgs-1708678164746"></a>[结构化设计](#vqsk-1706094478028)

<a name="5tav-1708678164748"></a>[内聚](#jczo-1706095018132)

<a name="gfzu-1708678164750"></a>[耦合](#qa8z-1706095402118)

<a name="rlol-1708678164752"></a>[模块四要素](#g1dc-1706095391028)

<a name="i5zp-1708678164754"></a>[面相对象设计](#ydwa-1706095870710)

<a name="0hpv-1708678164756"></a>[类的分类](#fouz-1706095958643)

<a name="kimc-1708678164758"></a>[基本过程](#9pd1-1706095996137)

<a name="44xm-1708678164760"></a>[设计原则(同设计模式)](#k8lc-1706096001163)

<a name="hvgk-1708678164762"></a>[计算机](#qvol-1706095952165)

<a name="na1k-1708678164764"></a>[计算机结构(★)](#ef1b-1706108352037)

<a name="j2sc-1708678164766"></a>[存储系统(★★★★)](#4kj7-1706108373776)

<a name="3qn5-1708678164768"></a>[层次化存储结构](#ucta-1706109825295)

<a name="utrq-1708678164770"></a>[Cache](#j9hn-1706109828962)

<a name="2jeg-1708678164772"></a>[主存编址计算](#pv51-1706109847372)

<a name="e9c8-1708678164774"></a>[磁盘基本结构与存储过程](#jcqv-1706108377026)

<a name="ffju-1708678164776"></a>[磁盘优化分布存储](#puux-1706111215530)

<a name="8cai-1708678164778"></a>[磁盘单缓冲区与双缓冲区读取](#dvin-1706111222861)

<a name="flht-1708678164780"></a>[磁盘移臂调度算法](#jr2r-1706111239137)

<a name="aak0-1708678164782"></a>[数据传输控制方式（★)](#sz2k-1706111188014)

<a name="bv9b-1708678164784"></a>[总线（★★)](#cbul-1706108378755)

<a name="zhbp-1708678164786"></a>[CISC与RISC(★)](#0hb5-1706108373778)

<a name="1uuj-1708678164788"></a>[流水线(★★)](#ernn-1706108380109)

<a name="krgm-1708678164790"></a>[校验码(★)](#grix-1706108381278)

<a name="3nxf-1708678164792"></a>[嵌入式（★)](#1p2v-1706108382511)

<a name="ymyd-1708678164794"></a>[计算机网络](#8vmt-1706198382356)

<a name="sath-1708678164796"></a>[TCP/IP协议族(7层/4层网络模型)](#a4es-1706106975412)

<a name="c0tt-1708678164798"></a>[.TCP与UDP (★★★)](#vwim-1706198561289)

<a name="zvet-1708678164800"></a>[.DHCP与DNS (★★★)](#imsh-1706198537828)

<a name="je5m-1708678164802"></a>[网络规划与设计](#u7sd-1706198559304)

<a name="ndp0-1708678164804"></a>[1.逻辑设计与物理设计(★★★★）](#nov8-1706198591905)

<a name="xvux-1708678164806"></a>[2.层次化网络设计](#sy2g-1706198599196)

<a name="j5dl-1708678164809"></a>[3.网络冗余设计](#igl7-1706257923205)

<a name="7grk-1708678164811"></a>[网络存储（★★)](#zkxb-1706257899477)

<a name="d5kd-1708678164813"></a>[磁盘阵列Raid](#fxma-1706198636789)

<a name="3wgj-1708678164815"></a>[lPv6 (★)](#vlem-1706259832461)

<a name="r0jw-1708678164817"></a>[网络接入(有线/无线)](#g438-1706198637653)

<a name="az0h-1708678164819"></a>[综合布线(★)](#lxli-1706198497856)

<a name="fbik-1708678164821"></a>[网络技术扩展](#5dlt-1706198650540)

<a name="avo1-1708678164823"></a>[物联网(IOT)](#jgll-1706198586849)

<a name="120z-1708678164825"></a>[云计算(Saas/Paas/Iaas)](#pr8x-1706198586851)

<a name="rsof-1708678164827"></a>[===系统架构设计case===](#1rnn-1706941312871)

<a name="wzto-1708678164829"></a>[google L5设计一个分布式数据库架构](#nm5q-1706969255961)

<a name="olfa-1708678164831"></a>[.what is total ordering(ordering first 100 custormer)](#g7yu-1707229908505)

<a name="jhr5-1708678164833"></a>[.why single leader()](#ebxf-1707230056989)

<a name="dudr-1708678164835"></a>[.request router](#ttmg-1707230034624)

<a name="tebn-1708678164837"></a>[.variations](#aftd-1707229925082)

<a name="irrg-1708678164839"></a>[1.Failover handing](#uk2k-1707457488655)

<a name="0v5j-1708678164841"></a>[2.Reblancing after new node added](#btbd-1707457496651)

<a name="ehmb-1708678164843"></a>[3.Leaderless for heavy write-shard](#moaq-1707457524278)

<a name="tptm-1708678164845"></a>[4.TicketMasler (and total ordering is necessary](#wyvq-1707458882987)

<a name="jh5h-1708678164847"></a>[===数据密集型应用===](#sswx-1706094478181)

<a name="ojgf-1708678164849"></a>[第一部分 数据系统的基石](#unbe-1677787447006)

<a name="103h-1708678164851"></a>[1.可靠性、可拓展性、可维护性能](#kwfx-1677787447007)

<a name="lw9b-1708678164853"></a>[-功能性需求：CRUD](#lykw-1644227240038)

<a name="vqqt-1708678164855"></a>[-非功能性需求：安全性，可靠性，合规性，可扩展性，兼容性和可维护性](#b2tu-1644227249556)

<a name="j0fs-1708678164857"></a>[.可靠性：](#qqm5-1644227303238)

<a name="claa-1708678164859"></a>[硬件故障](#7xms-1644228225080)

<a name="0cbi-1708678164861"></a>[软件错误](#dfpv-1708357497902)

<a name="qn45-1708678164863"></a>[人为错误(如何让系统变得可靠)](#drpl-1708357507365)

<a name="u4bu-1708678164865"></a>[如何让系统变得可靠：](#pqmh-1708523552230)

<a name="soo6-1708678164867"></a>[。最小化犯错机会的方式设计系统,  但如果限制太多，人们可能会忽略它们的好处而绕开，很难把握其中微妙的平衡](#i4we-1708358144376)

<a name="gzqt-1708678164869"></a>[。在易错地方和可能导致失效的地方解耦decouple,提供非生产环境沙箱sandbox-虚拟化环境，隔离真实系统进行安全测试](#xzfa-1708358243121)

<a name="eomq-1708678164871"></a>[。彻底的测试，单元测试，集成测试，手动测试，自动化测试覆盖边缘场景corner case.](#9jaa-1708358634289)

<a name="xbzr-1708678164873"></a>[。滚动发布，快速回滚](#zlp4-1708358698137)

<a name="hghc-1708678164875"></a>[。配置详细和明确的监控](#40us-1708358954660)

<a name="lenm-1708678164877"></a>[。良好的管理和充分的培训。一个复杂而重要的方面，但超出本书的范围](#o66x-1708358967000)

<a name="zms7-1708678164879"></a>[可靠性有多重要](#x7co-1708357515795)

<a name="krbh-1708678164882"></a>[造成客户巨大损失-阿里云宕机造成的用户损失](#nc0w-1708358745350)

<a name="xnbg-1708678164884"></a>[家长将孩子照片存储在你的应用李，数据库损坏，客户有何体验，他们可能会知道如何从备份恢复吗？](#qopp-1708358856827)

<a name="gyfk-1708678164886"></a>[.可扩展性： ](#dsae-1708357483848)

<a name="y6gd-1708678164888"></a>[描述负载(tps-推特主页时间线扇出-查询性能优化)](#vja4-1708356470840)

<a name="agod-1708678164890"></a>[描述性能](#s6un-1708356581594)

<a name="px4l-1708678164892"></a>[吞吐量throughput](#fcez-1708523606684)

<a name="kfu1-1708678164894"></a>[响应时间 response time.](#k30f-1708523620292)

<a name="hsj8-1708678164896"></a>[响应时间的高位百分点（也称为尾部延迟tail latencies](#bogk-1708523658968)

<a name="fia6-1708678164898"></a>[.可维护性：](#k1dg-1708355783343)

<a name="fy9j-1708678164900"></a>[2.数据模型与查询语言](#jufm-1677787447008)

<a name="1uy5-1708678164902"></a>[-关系模型](#pgu6-1699844351041)

<a name="ddbb-1708678164904"></a>[-NoSql (es,redis)](#kfpd-1644410618294)

<a name="7zaq-1708678164906"></a>[1.文档数据库:MongoDB](#0p23-1644410807294)

<a name="p4tv-1708678164908"></a>[  2.图形数据库 ：](#09bl-1644410666587)

<a name="pjsh-1708678164910"></a>[-其它模型(基因序列)](#6fxw-1644410924417)

<a name="peq7-1708678164912"></a>[3.存储与检索](#sm0u-1677787447009)

<a name="bglf-1708678164914"></a>[-优化事务处理（OLTP）transaction ](#bhcv-1644935436804)

<a name="fhku-1708678164916"></a>[1.OLTP系统通常面向用户，大量的请求。](#tbhw-1699844517372)

<a name="ulos-1708678164918"></a>[2.磁盘寻道时间往往是这里的瓶颈。](#fnev-1644935714127)

<a name="22za-1708678164920"></a>[3.应用程序使用某种键来请求记录，存储引擎使用索引来查找所请求额键的数据。](#cjwp-1644935609899)

<a name="31nr-1708678164922"></a>[-优化分析（OLAP）analys](#jg7s-1699844443567)

<a name="vb9g-1708678164924"></a>[1.列式储存(投影操作，压缩技术，聚合过滤)](#pjd1-1703887811615)

<a name="s6lq-1708678164926"></a>[-OLTP两大主流学派的存储引擎：](#8sgm-1644935924013)

<a name="wf9d-1708678164928"></a>[1.日志结构学派](#i55y-1644935943748)

<a name="ialv-1708678164930"></a>[2.就地更新学派](#h3il-1644935977285)

<a name="0pev-1708678164932"></a>[4.编码（序列化）与演化(XML,JSON,CSV)](#lbs1-1677787447010)

<a name="zdv3-1708678164934"></a>[第二部分 分布式数据](#4p9n-1677787447012)

<a name="og2b-1708678164936"></a>[1.高可用性/容错](#o4ag-1646310813851)

<a name="bhd7-1708678164938"></a>[2.断开连接的操作](#snwm-1646310894841)

<a name="urqm-1708678164941"></a>[3.减少延迟(节点近)](#evly-1646310918322)

<a name="zlr7-1708678164943"></a>[4.可拓展性](#itsh-1646310968967)

<a name="zd05-1708678164945"></a>[.拓展至更高的载荷](#gjis-1708362947856)

<a name="grfr-1708678164947"></a>[垂直扩展scale up ：购买更强大的机器 cpu](#mgia-1708362999715)

<a name="qkmz-1708678164949"></a>[共享内存架构shared-memory architecture：许多处理器、内存和磁盘再同一操作系统下相互连接，共享内存和磁盘](#pdo8-1708363038596)

<a name="u4pa-1708678164951"></a>[共享磁盘share-disk architecture：独立处理器和内存，数据存储在机器之间共享的磁盘阵列上，磁盘通过快速网络连接。数仓](#wgwl-1708363065800)

<a name="yoog-1708678164953"></a>[无共享架构](#klw2-1708363340866)

<a name="vsaf-1708678164955"></a>[.复制VS分区](#gbgq-1646311175182)

<a name="u7dh-1708678164957"></a>[5.复制](#gd4q-1708363438406)

<a name="mw4f-1708678164959"></a>[.领导者与追随者-单主复制](#9hbs-1708441077626)

<a name="o5ld-1708678164961"></a>[客户端将所有写入操作发送到单个节点（领导者），该结点将数据更改事件流发送到其它副本（追随者）。](#aucb-1708528116000)

<a name="nygc-1708678164963"></a>[读取可以再任何副本中执行，但从追随者读取可能是陈旧的 （最终一致性问题）](#wgge-1646311567456)

<a name="s9hh-1708678164965"></a>[.同步复制与异步复制](#cbey-1646310922523)

<a name="8hpv-1708678164967"></a>[.设置新从库(快照复制+caught up binlog)](#j5o0-1704983008475)

<a name="idwq-1708678164969"></a>[.处理宕机节点](#bcod-1708442233018)

<a name="eioo-1708678164971"></a>[从库失效：追赶恢复](#5ufz-1708443850274)

<a name="2hjp-1708678164973"></a>[主库失效：故障切换failover](#udix-1708443860752)

<a name="47bg-1708678164975"></a>[自动切换步骤：1.确认主库失效](#w3sj-1708523445192)

<a name="hqxw-1708678164977"></a>[2.选举新主库：共识](#y3qn-1708523480847)

<a name="rvrv-1708678164979"></a>[3.配置系统启用新主库](#wua6-1708523497956)

<a name="ermm-1708678164981"></a>[failover的麻烦：1.异步复制数据丢失](#z7mn-1708523814309)

<a name="crbp-1708678164983"></a>[2.自增主键冲突](#mnjx-1708523836932)

<a name="va1i-1708678164985"></a>[3.脑裂split brain](#dbhg-1708523873194)

<a name="quka-1708678164987"></a>[4.如何设置超时](#561v-1708523878338)

<a name="lxzq-1708678164989"></a>[.复制日志的实现](#8mem-1708442228760)

<a name="elom-1708678164991"></a>[基于语句的复制(每个写入请求语句statment)](#k8yo-1708524004340)

<a name="jkdt-1708678164993"></a>[记录每个写入请求语句statment，语句日志传输给从库](#hcqe-1708524155632)

<a name="crqy-1708678164995"></a>[问题：非确定函数nondeterministic, NOW()  RAND()](#9xml-1708524182083)

<a name="u7eh-1708678164997"></a>[    自增列- 造成差异](#il4a-1708524271564)

<a name="o6ec-1708678164999"></a>[副作用的语句：用户自定义函数，触发器，存储过程](#azmh-1708524331636)

<a name="tdbg-1708678165001"></a>[解决: 用固定值替换](#rcfb-1708524371120)

<a name="lx8g-1708678165003"></a>[  如语句存在任何不确定性，切换到基于行的数据](#6uy2-1708524426849)

<a name="yuh7-1708678165005"></a>[传输预写式日志(WAL)](#rnmz-1708524013585)

<a name="ehcc-1708678165007"></a>[日志存储引擎SSTables LSM树](#hze4-1708524498278)

<a name="lana-1708678165009"></a>[磁盘块的B树  WAL, 崩溃恢复](#qzop-1708524541132)

<a name="2blx-1708678165011"></a>[逻辑日志复制(基于行)](#a3ng-1708524040960)

<a name="zuej-1708678165013"></a>[binlog](#jiiu-1708524648209)

<a name="viws-1708678165015"></a>[基于触发器的复制](#ezoi-1708524083973)

<a name="racw-1708678165020"></a>[.复制延迟问题(解决方法都是反分布式，或者趋于单机一致性。数据一致性模型：https://jepsen.io/consistency)](#https://jepsen.io/consistency)

<a name="e5vc-1708678165022"></a>[读己之写(读主库或带写时间戳查询)](#w5nz-1708525244967)

<a name="uza2-1708678165024"></a>[写后从旧副本读取数据-未同步  ](#25nj-1708526407050)

<a name="fyn6-1708678165027"></a>[解决：写后读read after write 一致性 或叫做 read your write consistency 防止这种异常](#4st1-1708525569674)

<a name="cll4-1708678165029"></a>[1.都从主库读。适用仅由用户本人编辑的数据，如个人信息。大部分内容从主库读不适用，扩容读无效果](#v4r0-1708525736897)

<a name="i4au-1708678165031"></a>[2. 扩容读需要保证更新时间，监控复制延迟，防止滞后超过一分钟从从库发出查询](#vqjs-1708525818133)

<a name="0ffn-1708678165033"></a>[3. 客户端记录写入时间戳，系统确保从库提供查询时，版本时间已覆盖，否则从另一个从库读，或者等待caught up-不可用状态，且时钟不可靠](#nmrh-1708525971734)

<a name="lbtg-1708678165035"></a>[4. 副本在多个数据中心，复杂度高，都需经过主库IDC](#wmu9-1708526095856)

<a name="schr-1708678165037"></a>[单调读(基于id散列路由同一副本)](#kwrd-1708525264596)

<a name="h3dg-1708678165039"></a>[先读到最新副本，后读到旧副本感觉数据消失](#npwe-1708527802311)

<a name="pzfo-1708678165041"></a>[A看到B评论后消失，时光倒流moving backward in time ](#4cn0-1708526272081)

<a name="kygn-1708678165043"></a>[解决：单调读monotonic reads总是从同一个副本进行读取(基于用户散列id，如果副本失效则重新路由)](#drqk-1708526396300)

<a name="bbl5-1708678165045"></a>[  比强一致性(同步复制/类比单机)弱，比最终一致性更强](#s6u3-1708526566643)

<a name="fecu-1708678165047"></a>[一致前缀读(因果关系写到相同分区)](#bfps-1708525268614)

<a name="mydf-1708678165049"></a>[不同分片副本同步先后问题导致读顺序错误](#rqcm-1708527879976)

<a name="luku-1708678165051"></a>[分区partition/分片sharded数据库中的一个特殊问题，全局写入顺序](#bwov-1708526677620)

<a name="qkt1-1708678165053"></a>[分区主库1写入 A:你吃饭了吗？ 分区主库2写入B:没有。 分区1副本同步主库1落后分区2副本同步主库2    C读取1副本: 没有，后读取2副本。你吃饭了吗？](#7e9o-1708526727984)

<a name="aolr-1708678165055"></a>[解决：确保因果关系都写入到相同分区](#turn-1708527108521)

<a name="c7e7-1708678165057"></a>[复制延迟解决方案](#a2la-1708525420248)

<a name="heki-1708678165059"></a>[趋于反分布式，局部或者部分看做一个单机，做到强一致性](#x8ng-1708527233293)

<a name="sukq-1708678165061"></a>[写后读。](#gecf-1708527304184)

<a name="x3je-1708678165063"></a>[数据库通过事务提供强大保证。](#zsq6-1708527307246)

<a name="ngfr-1708678165065"></a>[多主复制](#pbfd-1708528009698)

<a name="bvow-1708678165067"></a>[7.事务](#7qvp-1708523954496)

<a name="k82e-1708678165069"></a>[.简化故障失败的机制](#du4g-1704983767151)

<a name="he8u-1708678165071"></a>[.事务的棘手问题](#k9de-1704984009883)

<a name="yfqw-1708678165073"></a>[原⼦性（Atomicity）](#65nh-1704984028565)

<a name="xtlp-1708678165075"></a>[⼀致性（Consistency）](#qeub-1646310871673)

<a name="sxu8-1708678165077"></a>[隔离性（Isolation）](#rpju-1646310871817)

<a name="fvrg-1708678165079"></a>[持久性（Durability）](#aq1q-1646310872064)

<a name="q8zj-1708678165081"></a>[8.分布式系统的麻烦](#enui-1704985776096)

<a name="e714-1708678165083"></a>[9.一致性共识](#rp9s-1705080859004)

<a name="ugbr-1708678165085"></a>[分布式事务](#cys8-1705080619829)

<a name="s9g3-1708678165087"></a>[2PC提交](#bjec-1705081008345)

<a name="j7is-1708678165089"></a>[3PC提交](#dyd0-1705118358884)

<a name="2ibn-1708678165091"></a>[实践中的分布式事务](#pudp-1705080909535)

<a name="wqff-1708678165093"></a>[XA事务(扩展架构（eXtended Architecture)](#ozc0-1705080997483)
...
<a name="x47a-1708527710206"></a><a name="w5nz-1708525244967"></a>**读己之写(读主库或带写时间戳查询)**
...
<a name="nmrh-1708525971734"></a>**3. 客户端记录写入时间戳，系统确保从库提供查询时，版本时间已覆盖，否则从另一个从库读，或者等待caught up-不可用状态，且时钟不可靠**

<a name="wmu9-1708526095856"></a>**4. 副本在多个数据中心，复杂度高，都需经过主库IDC**

<a name="8ols-1708527699481"></a><a name="kwrd-1708525264596"></a>**单调读(基于id散列路由同一副本)**
...
<a name="a2la-1708525420248"></a>**复制延迟解决方案**
...
<a name="m7de-1708525314549"></a><a name="pbfd-1708528009698"></a>**多主复制**

<a name="kxkx-1708441627686"></a><a name="7qvp-1708523954496"></a>**7.事务**

...
<a name="3060-1621846615933"></a><a name="xdks-1709924116548"></a>[一.数据库设计](#jeyl-1677787446995)

<a name="a9k9-1709924116550"></a>[1. 关系型数据库](#5hya-1677787446996)

<a name="alvz-1709924116552"></a>[.E-R图，由台湾工程师提出的设计概念](#ohc5-1621692571287)

<a name="a1wq-1709924116554"></a>[.流程图-业务逻辑相关，系统用户动作。抽象出E-R图](#5ocb-1645598528868)

<a name="l103-1709924116556"></a>[1.1 E-R图 ](#gzqe-1677787446997)

<a name="qxib-1709924116558"></a>[1.根据名词抽象出实体](#r1ac-1621692724628)

<a name="9naf-1709924116560"></a>[2.名词找属性](#d2fl-1621692745600)

<a name="zy8b-1709924116562"></a>[3.实体间联系](#dwkp-1621692752824)

<a name="lkwc-1709924116564"></a>[.状态图](#53bo-1621692829033)

<a name="bqx1-1709924116566"></a>[1.2 转化成数据库设计（公式）](#c2cy-1677787446998)

<a name="dach-1709924116568"></a>[.1 对1 关系 往记录少的乙方加主键](#xmox-1621692858500)

<a name="jfaj-1709924116570"></a>[.1对n 关系 ，往 n 实体加关联主键 ](#mdr8-1621692924289)

<a name="9rdq-1709924116572"></a>[. n对 m 关系，需要一个关联表作映射关联](#hd3i-1621692960576)

<a name="s0ho-1709924116574"></a>[二.系统优化](#cdso-1677787447000)

<a name="lmuz-1709924116576"></a>[应用整体的优化](#3qep-1642647362896)

<a name="ddxw-1709924116578"></a>[-cpu -> 纳秒级别](#knge-1642647371136)

<a name="bdon-1709924116580"></a>[1.多线程和并发编程](#ovup-1704437622969)

<a name="ee45-1709924116582"></a>[2.JNI ](#ufpl-1704437634986)

<a name="isnl-1709924116584"></a>[3.JIT/AOT编译](#ixb5-1704437634987)

<a name="rzsr-1709924116586"></a>[4.算法优化](#kr1f-1704437634988)

<a name="oxvb-1709924116588"></a>[-内存RAM（GB）/高速缓存(KB) -> 微秒级别(分级缓存)](#1xur-1642647384168)

<a name="hj3g-1709924116590"></a>[1.JVM内存管理](#7hi9-1704437851514)

<a name="zxox-1709924116592"></a>[2.缓存](#te7c-1704437851799)

<a name="6jkv-1709924116594"></a>[3.消息中间件](#bqty-1704437851800)

<a name="ewji-1709924116596"></a>[-磁盘（TB）-> 毫秒级别(减少io次数,减少随机io-redolog)](#ziti-1642647439005)

<a name="y5zx-1709924116598"></a>[1.减少磁盘io](#zups-1704437900079)

<a name="akkt-1709924116600"></a>[2.数据压缩   ](#u3ok-1704438035018)

<a name="nsz3-1709924116602"></a>[-网络传输/系统交互 -> 秒级 (减少io，连接池化) ](#irbp-1642647458856)

<a name="6guv-1709924116604"></a>[1.减少网络请求   ](#6qil-1704438276193)

<a name="4ive-1709924116606"></a>[2.使用CDN](#p5dt-1704438283633)

<a name="0120-1709924116608"></a>[3.Sockets异步通信                                      ](#zhp8-1704438283634)

<a name="f57b-1709924116610"></a>[项目架构层面的优化](#3l0l-1704424353262)

<a name="kxp5-1709924116612"></a>[-多级缓存](#8o8s-1704424396933)

<a name="bqag-1709924116614"></a>[-应用层](#trcg-1704438366333)

<a name="xbds-1709924116616"></a>[代码优化](#68oa-1704438530062)

<a name="6ge4-1709924116619"></a>[数据库优化](#clmf-1704438530257)

<a name="qzxu-1709924116621"></a>[日志优化](#md03-1704438530259)

<a name="ctxl-1709924116623"></a>[-监控与调优](#ocux-1704438477879)

<a name="iwgh-1709924116625"></a>[性能监控：](#vdq2-1704438556836)

<a name="xwpj-1709924116627"></a>[分析和调优](#t29d-1704438557094)

<a name="qjmp-1709924116629"></a>[-分布式系统架构](#ukjf-1704424419442)

<a name="tovv-1709924116631"></a>[  .负载均衡](#a0bx-1704438677201)

<a name="vyxz-1709924116633"></a>[分布式缓存](#xn9x-1704438687994)

<a name="dnjr-1709924116635"></a>[服务降级和容错](#zcdp-1704438687996)

<a name="tmv4-1709924116637"></a>[读写层面](#six7-1642647372926)

<a name="gkq3-1709924116639"></a>[.读优化](#g4uv-1704732583614)

<a name="docx-1709924116641"></a>[1.缓存](#uuzh-1704732602620)

<a name="6alc-1709924116643"></a>[2.索引](#qobc-1704732605892)

<a name="4c3e-1709924116645"></a>[3.减少io/批量读/非阻塞io](#zlg9-1704732609048)

<a name="yggd-1709924116647"></a>[4.减少多余数据加载/列式存储读](#fpjd-1704732631316)

<a name="5ka1-1709924116649"></a>[.写优化](#oyob-1704732598377)

<a name="tijq-1709924116651"></a>[1.异步写](#6jmb-1704732509150)

<a name="znkv-1709924116653"></a>[2.并发写](#tkwp-1704732723564)

<a name="jnwn-1709924116655"></a>[3.批量写](#hewz-1704732862030)

<a name="qqvy-1709924116657"></a>[4.优化算法和数据结构](#ccd8-1704732727854)

<a name="mshm-1709924116659"></a>[5.缓存写](#eqd9-1704732736281)

<a name="9fdn-1709924116661"></a>[6.非阻塞io](#hyq8-1704732768916)

<a name="h5kc-1709924116663"></a>[1.分控系统优化复盘](#tncv-1677787447001)

<a name="0uf2-1709924116665"></a>[1.1 数据库系统](#ydq7-1677787447002)

<a name="szgg-1709924116667"></a>[1.2 sql慢](#wxdd-1677787447003)

<a name="gmds-1709924116669"></a>[1.3 接口慢](#olpb-1677787447004)

<a name="h87i-1709924116671"></a>[高并发系统设计](#wrwk-1642647280506)

<a name="rfog-1709924116673"></a>[1.满足大规模用户同时访问，提供良好响应时间和性能](#8ien-1704757782146)

<a name="d3bt-1709924116675"></a>[2.设计之初就要考虑伸缩性和容错性是非常重要的](#xy0g-1704757785190)

<a name="f1bv-1709924116677"></a>[.垂直伸缩 ](#wr12-1704947861599)

<a name="clfo-1709924116679"></a>[.水平伸缩](#bizh-1704947959744)

<a name="1gci-1709924116681"></a>[1.分布式架构](#fvzi-1704756770858)

<a name="ijkn-1709924116683"></a>[.微服务架构](#ywzr-1704756872033)

<a name="aqfs-1709924116685"></a>[.分布式计算](#xgna-1704756877646)

<a name="9kda-1709924116687"></a>[2.负载均衡](#wnfy-1704756775272)

<a name="kogh-1709924116689"></a>[.负载均衡](#h6nf-1704756891918)

<a name="ictl-1709924116691"></a>[.水平扩展](#c8zr-1704756894402)

<a name="wj7d-1709924116693"></a>[3.数据库设计](#wxjk-1704756782840)

<a name="xac0-1709924116695"></a>[.读写分离](#lxca-1704756910837)

<a name="lpwi-1709924116697"></a>[.数据库分片](#p7d2-1704756922362)

<a name="rq1m-1709924116700"></a>[.缓存](#hxjt-1704756963988)

<a name="ds7z-1709924116702"></a>[4.缓存优化](#iivs-1704756788012)

<a name="jh7r-1709924116704"></a>[.分布式缓存](#cvui-1704756971791)

<a name="ojvg-1709924116706"></a>[.本地缓存](#ysly-1704756979122)

<a name="tkxa-1709924116708"></a>[.缓存预热](#rqwj-1704756986363)

<a name="fqdm-1709924116710"></a>[5.消息队列](#so9h-1704756800253)

<a name="tg0h-1709924116712"></a>[.异步处理](#sxlo-1704756996000)

<a name="ipho-1709924116714"></a>[.削峰填谷](#llm2-1704757002994)

<a name="gryp-1709924116716"></a>[6.分布式事务](#n39o-1704756805232)

<a name="5502-1709924116718"></a>[.两阶段提交](#5bhj-1704757017700)

<a name="ctvn-1709924116720"></a>[.补偿事务](#becc-1704757028036)

<a name="iehj-1709924116722"></a>[7.高可用和容错](#wgkk-1704756813448)

<a name="sh8x-1709924116724"></a>[.多地域部署](#akwz-1704757035393)

<a name="i5d6-1709924116726"></a>[.设计容错](#3nxv-1704757055271)

<a name="ettk-1709924116728"></a>[1. 熔断限流](#g3xx-1704757371028)

<a name="lnrh-1709924116730"></a>[2. 多节点服务](#jafy-1704757374368)

<a name="wr3i-1709924116732"></a>[8.监控和性能调优](#ilyo-1704756820772)

<a name="brod-1709924116734"></a>[.实时监控](#kpwq-1704757064566)

<a name="xmsy-1709924116736"></a>[.性能测试](#shf4-1704757066453)

<a name="trmx-1709924116738"></a>[9.安全性设计](#2pry-1704756830245)

<a name="hsfk-1709924116740"></a>[.防御性编程](#pkiw-1704757078583)

<a name="9mqj-1709924116742"></a>[.访问控制](#g4l1-1704757084924)

<a name="uwub-1709924116744"></a>[10.水平扩展](#1tsd-1704756838192)

<a name="f0a5-1709924116746"></a>[.自动化部署](#r1dd-1704757092061)

<a name="32mq-1709924116748"></a>[.云服务](#7mhk-1704757104117)

<a name="emac-1709924116750"></a>[高并发性能指标](#rpxb-1677787447005)

<a name="fdqv-1709924116752"></a>[QPS(每秒请求)](#klnv-1704761369323)

<a name="lwui-1709924116754"></a>[TPS(每秒事务)](#zvlz-1704761369324)

<a name="vxzj-1709924116756"></a>[RT(响应时间)](#gvrn-1704761369325)

<a name="pw8t-1709924116758"></a>[(原子操作)并发编程中保证数据一致性/安全的方法](#ysmj-1709309531982)

<a name="hxlt-1709924116760"></a>[原子性+悲观锁：各种锁机制](#fdxy-1709308630108)

<a name="64q3-1709924116762"></a>[.（锁+事务/ 分布式锁+分布式事务）](#v06l-1709312268021)

<a name="hykk-1709924116764"></a>[.  CASmysql版本号实现 (数据库update锁+update原子性）](#k0op-1709312304164)

<a name="q1u8-1709924116766"></a>[原子性+乐观锁/不加锁: CAS原子操作(java原子类)，](#qth5-1709308703202)

<a name="vrbz-1709924116768"></a>[CAS底层实现原理](#g3uo-1709309147469)

<a name="osbt-1709924116770"></a>[总线锁定（Bus Locking）：](#qpbw-1709308842021)

<a name="zddr-1709924116772"></a>[缓存一致性协议（Cache Coherence Protocol）：](#ikm2-1709308842025)

<a name="4dot-1709924116774"></a>[指令序列化（Instruction Serialization）：](#wpeu-1709308842029)

<a name="isxc-1709924116776"></a>[不同的场景适用哪种锁](#olfu-1709309769107)

<a name="6ozo-1709924116778"></a>[.共享数据的读写操作：](#y60t-1709309615585)

<a name="zpsj-1709924116780"></a>[适用措施：读写锁（ReadWrite Lock）、互斥锁（Mutex）、原子操作、无锁算法。Copy on Write优化读写锁](#lqad-1709309615587)

<a name="vcrw-1709924116782"></a>[.并发容器的操作：](#fsfa-1709309615591)

<a name="zcfa-1709924116785"></a>[适用措施：线程安全的容器类（如ConcurrentHashMap、ConcurrentLinkedQueue）、原子操作。](#rs2n-1709309615593)

<a name="lwvp-1709924116787"></a>[.多个线程协作的场景：](#xdpv-1709309615597)

<a name="i8xz-1709924116789"></a>[适用措施：信号量（Semaphore）、条件变量（Condition Variable）。](#uzlr-1709309615599)

<a name="onaj-1709924116791"></a>[.分布式系统的并发操作：](#0aah-1709309615603)

<a name="799g-1709924116793"></a>[适用措施：分布式锁、分布式事务。](#wlhe-1709309615605)

<a name="aafa-1709924116795"></a>[.不可变数据的并发访问：](#angi-1709309615609)

<a name="mgde-1709924116797"></a>[适用措施：不可变数据结构、原子操作。](#pga0-1709309615611)

<a name="zf16-1709924116799"></a>[.高性能要求的并发操作：](#pw5v-1709309615615)

<a name="cfsi-1709924116801"></a>[适用措施：无锁算法、并发数据结构。 -CAS乐观锁](#plv6-1709309615617)

<a name="q3ln-1709924116803"></a>[互斥访问：](#62mg-1709309976431)

<a name="jvi1-1709924116805"></a>[.互斥锁（Mutex）：](#0qt3-1709307350160)

<a name="jbys-1709924116807"></a>[.原子操作：](#7xva-1709307350164)

<a name="moec-1709924116809"></a>[.临界区（Critical Section）：](#r8cl-1709307350168)

<a name="ehxm-1709924116811"></a>[.读写锁（ReadWrite Lock）：](#occj-1709307350172)

<a name="bnre-1709924116813"></a>[.信号量（Semaphore）：](#vej9-1709307350176)

<a name="raiy-1709924116815"></a>[.条件变量（Condition Variable）：](#ssge-1709307350180)

<a name="at9j-1709924116817"></a>[.无锁算法（Lock-Free Algorithms）：](#zk0j-1709307350184)

<a name="7mpn-1709924116819"></a>[.数据拷贝-写时复制（Copy-on-Write）：优化读写锁，写时复制且串行执行(锁)，读不加锁](#tiqo-1709307350188)

<a name="npv7-1709924116821"></a>[.线程安全的数据结构：](#b8ca-1709307350192)

<a name="khxa-1709924116823"></a>[===系统架构设计师===](#nyrv-1709307688718)

<a name="aa2g-1709924116825"></a>[系统工程与信息系统基础](#mpwu-1704949756608)

<a name="jnjp-1709924116827"></a>[.系统工程方法](#2gzz-1704980837071)

<a name="cyjg-1709924116829"></a>[.系统工程生命周期阶段](#mk93-1704952875199)

<a name="aksr-1709924116831"></a>[.系统工程生命周期方法](#ny2c-1704952893636)

<a name="oodn-1709924116833"></a>[.信息系统建设原则](#shmt-1704952904062)

<a name="dvfs-1709924116835"></a>[.信息系统开发方法](#itje-1704951812273)

<a name="3guf-1709924116837"></a>[原型法](#bnzq-1705819374009)

<a name="cglz-1709924116839"></a>[结构化法-瀑布型](#ujj3-1705819377863)

<a name="2aty-1709924116841"></a>[形式化法-数模](#8wek-1705819398251)

<a name="jenc-1709924116843"></a>[敏捷方法](#jeuk-1705819392097)

<a name="4nrc-1709924116845"></a>[.信息系统分类](#w8yd-1704980881013)

<a name="pbzp-1709924116847"></a>[业务处理系统TPS](#hlhq-1705819204285)

<a name="pfq0-1709924116849"></a>[管理信息系统MIS](#oksn-1705819204735)

<a name="xgmj-1709924116851"></a>[决策支持系统DSS](#lwm7-1705819204736)

<a name="tqmi-1709924116853"></a>[专家系统ES](#bmeu-1705819204737)

<a name="nvnd-1709924116855"></a>[办公自动化系统OAS](#kffq-1705819204738)

<a name="b4e2-1709924116857"></a>[企业资源系统ERP](#k2px-1705819204739)

<a name="5ln9-1709924116859"></a>[过程模型](#f98t-1704981918920)

<a name="rme9-1709924116861"></a>[瀑布模型](#yk4j-1705841608124)

<a name="vhg7-1709924116863"></a>[V模型【瀑布变种-测试贯穿】](#oryp-1705841608705)

<a name="55mf-1709924116866"></a>[原型模型](#b0cp-1705841621350)

<a name="b6kh-1709924116868"></a>[螺旋模型【原型+瀑布 风险】](#sfqi-1705841608707)

<a name="bwm9-1709924116870"></a>[构件组装模型/基于构件的开发方法](#kbjw-1705841608709)

<a name="6az8-1709924116872"></a>[快速应用开发RAD【瀑布+构件组装】](#mvze-1705841627436)

<a name="tdpv-1709924116874"></a>[统一过程/统一开发方法](#xici-1705841629815)

<a name="ikuv-1709924116876"></a>[敏捷开发方法](#9jca-1705841608711)

<a name="6fok-1709924116878"></a>[XP](#28va-1705841590197)

<a name="1nfj-1709924116880"></a>[Scrum](#fyfq-1705938223773)

<a name="4mtc-1709924116882"></a>[逆向工程](#d5ko-1705938215067)

<a name="ftea-1709924116884"></a>[实现级](#os3c-1706090901666)

<a name="imkc-1709924116886"></a>[结构级](#irxb-1706090905276)

<a name="ifba-1709924116888"></a>[功能级](#rk8d-1706090908958)

<a name="bzsm-1709924116890"></a>[领域级](#k3pt-1706090912460)

<a name="kcns-1709924116892"></a>[净室软件工程](#tybd-1705938215235)

<a name="1pkz-1709924116894"></a>[需求工程](#ochn-1705940085547)

<a name="nxga-1709924116896"></a>[.需求获取](#xdlf-1705940054108)

<a name="egfn-1709924116898"></a>[用户面谈 ](#s1uq-1706090846730)

<a name="fcrr-1709924116900"></a>[联合需求计划(JRP) ](#vuil-1706090851858)

<a name="n5fu-1709924116902"></a>[问卷调查 ](#gpxg-1706090851859)

<a name="3hrs-1709924116904"></a>[现场观察   ](#mg9n-1706090851860)

<a name="tkrf-1709924116906"></a>[原型化方法        ](#3ww6-1706090851861)

<a name="z772-1709924116908"></a>[头脑风暴法](#0awr-1706090851863)

<a name="znbg-1709924116910"></a>[.需求分析](#axny-1705940052332)

<a name="b7jd-1709924116912"></a>[1.功能模型(数据流图DFD)](#v8wz-1706090812929)

<a name="xpw0-1709924116914"></a>[2.行为模型(状态转换图)](#3uls-1706090814821)

<a name="atod-1709924116916"></a>[3.实体模型(E-R图)](#69df-1706090816407)

<a name="3hpk-1709924116918"></a>[UML](#loq2-1705940640473)

<a name="4x2q-1709924116920"></a>[需求定义](#4aeg-1706091062964)

<a name="4xnn-1709924116922"></a>[需求验证](#ud2s-1706090947930)

<a name="o35m-1709924116924"></a>[需求跟踪](#l03x-1705940634470)

<a name="alw4-1709924116926"></a>[需求变更管理](#muqf-1706093218719)

<a name="olmm-1709924116928"></a>[软件系统建模](#ilpb-1706093190683)

<a name="r4mg-1709924116931"></a>[软件界面设计](#j396-1706094675778)

<a name="8f2g-1709924116933"></a>[结构化设计](#vqsk-1706094478028)

<a name="gape-1709924116935"></a>[内聚](#jczo-1706095018132)

<a name="gjj5-1709924116937"></a>[耦合](#qa8z-1706095402118)

<a name="rj4g-1709924116939"></a>[模块四要素](#g1dc-1706095391028)

<a name="foxe-1709924116941"></a>[面相对象设计](#ydwa-1706095870710)

<a name="k2cj-1709924116943"></a>[类的分类](#fouz-1706095958643)

<a name="6qay-1709924116945"></a>[基本过程](#9pd1-1706095996137)

<a name="cdyp-1709924116947"></a>[设计原则(同设计模式)](#k8lc-1706096001163)

<a name="i7oh-1709924116949"></a>[计算机](#qvol-1706095952165)

<a name="bxde-1709924116951"></a>[计算机结构(★)](#ef1b-1706108352037)

<a name="soyh-1709924116953"></a>[存储系统(★★★★)](#4kj7-1706108373776)

<a name="rwny-1709924116955"></a>[层次化存储结构](#ucta-1706109825295)

<a name="osra-1709924116957"></a>[Cache](#j9hn-1706109828962)

<a name="cluf-1709924116959"></a>[主存编址计算](#pv51-1706109847372)

<a name="oenr-1709924116961"></a>[磁盘基本结构与存储过程](#jcqv-1706108377026)

<a name="mndi-1709924116963"></a>[磁盘优化分布存储](#puux-1706111215530)

<a name="gnp5-1709924116965"></a>[磁盘单缓冲区与双缓冲区读取](#dvin-1706111222861)

<a name="xdrg-1709924116967"></a>[磁盘移臂调度算法](#jr2r-1706111239137)

<a name="iwy4-1709924116969"></a>[数据传输控制方式（★)](#sz2k-1706111188014)

<a name="j7m1-1709924116971"></a>[总线（★★)](#cbul-1706108378755)

<a name="hdsa-1709924116973"></a>[CISC与RISC(★)](#0hb5-1706108373778)

<a name="juww-1709924116975"></a>[流水线(★★)](#ernn-1706108380109)

<a name="6dn4-1709924116977"></a>[校验码(★)](#grix-1706108381278)

<a name="ddgn-1709924116979"></a>[嵌入式（★)](#1p2v-1706108382511)

<a name="zini-1709924116981"></a>[计算机网络](#8vmt-1706198382356)

<a name="ynmr-1709924116983"></a>[TCP/IP协议族(7层/4层网络模型)](#a4es-1706106975412)

<a name="inw3-1709924116985"></a>[.TCP与UDP (★★★)](#vwim-1706198561289)

<a name="pip0-1709924116987"></a>[.DHCP与DNS (★★★)](#imsh-1706198537828)

<a name="5zsf-1709924116989"></a>[网络规划与设计](#u7sd-1706198559304)

<a name="7kc3-1709924116991"></a>[1.逻辑设计与物理设计(★★★★）](#nov8-1706198591905)

<a name="yley-1709924116994"></a>[2.层次化网络设计](#sy2g-1706198599196)

<a name="qbc4-1709924116996"></a>[3.网络冗余设计](#igl7-1706257923205)

<a name="wftj-1709924116998"></a>[网络存储（★★)](#zkxb-1706257899477)

<a name="nml9-1709924117000"></a>[磁盘阵列Raid](#fxma-1706198636789)

<a name="vkl5-1709924117002"></a>[lPv6 (★)](#vlem-1706259832461)

<a name="0vf8-1709924117004"></a>[网络接入(有线/无线)](#g438-1706198637653)

<a name="ubow-1709924117006"></a>[综合布线(★)](#lxli-1706198497856)

<a name="vz5c-1709924117008"></a>[网络技术扩展](#5dlt-1706198650540)

<a name="vr0c-1709924117010"></a>[物联网(IOT)](#jgll-1706198586849)

<a name="uh4i-1709924117012"></a>[云计算(Saas/Paas/Iaas)](#pr8x-1706198586851)

<a name="sfim-1709924117014"></a>[===系统架构设计case===](#1rnn-1706941312871)

<a name="oa5o-1709924117016"></a>[google L5设计一个分布式数据库架构](#nm5q-1706969255961)

<a name="krhv-1709924117018"></a>[.what is total ordering(ordering first 100 custormer)](#g7yu-1707229908505)

<a name="take-1709924117020"></a>[.why single leader()](#ebxf-1707230056989)

<a name="s5dd-1709924117022"></a>[.request router](#ttmg-1707230034624)

<a name="wwi9-1709924117024"></a>[.variations](#aftd-1707229925082)

<a name="yjnd-1709924117026"></a>[1.Failover handing](#uk2k-1707457488655)

<a name="w46i-1709924117028"></a>[2.Reblancing after new node added](#btbd-1707457496651)

<a name="snwz-1709924117030"></a>[3.Leaderless for heavy write-shard](#moaq-1707457524278)

<a name="tu4x-1709924117032"></a>[4.TicketMasler (and total ordering is necessary](#wyvq-1707458882987)

<a name="5iwx-1709924117034"></a>[===数据密集型应用===](#sswx-1706094478181)

<a name="coci-1709924117036"></a>[第一部分 数据系统的基石](#unbe-1677787447006)

<a name="vp1c-1709924117038"></a>[1.可靠性、可拓展性、可维护性能](#kwfx-1677787447007)

<a name="5nsa-1709924117040"></a>[-功能性需求：CRUD](#lykw-1644227240038)

<a name="ycnq-1709924117042"></a>[-非功能性需求：安全性，可靠性，合规性，可扩展性，兼容性和可维护性](#b2tu-1644227249556)

<a name="pbfk-1709924117044"></a>[.可靠性：](#qqm5-1644227303238)

<a name="fsad-1709924117046"></a>[硬件故障](#7xms-1644228225080)

<a name="zkph-1709924117048"></a>[软件错误](#dfpv-1708357497902)

<a name="ar6w-1709924117050"></a>[人为错误(如何让系统变得可靠)](#drpl-1708357507365)

<a name="umya-1709924117052"></a>[如何让系统变得可靠：](#pqmh-1708523552230)

<a name="z4lw-1709924117054"></a>[。最小化犯错机会的方式设计系统,  但如果限制太多，人们可能会忽略它们的好处而绕开，很难把握其中微妙的平衡](#i4we-1708358144376)

<a name="qhin-1709924117056"></a>[。在易错地方和可能导致失效的地方解耦decouple,提供非生产环境沙箱sandbox-虚拟化环境，隔离真实系统进行安全测试](#xzfa-1708358243121)

<a name="k2wi-1709924117058"></a>[。彻底的测试，单元测试，集成测试，手动测试，自动化测试覆盖边缘场景corner case.](#9jaa-1708358634289)

<a name="uyp3-1709924117061"></a>[。滚动发布，快速回滚](#zlp4-1708358698137)

<a name="1ury-1709924117063"></a>[。配置详细和明确的监控](#40us-1708358954660)

<a name="gmk6-1709924117065"></a>[。良好的管理和充分的培训。一个复杂而重要的方面，但超出本书的范围](#o66x-1708358967000)

<a name="sdhp-1709924117067"></a>[可靠性有多重要](#x7co-1708357515795)

<a name="s8ei-1709924117069"></a>[造成客户巨大损失-阿里云宕机造成的用户损失](#nc0w-1708358745350)

<a name="dosa-1709924117071"></a>[家长将孩子照片存储在你的应用李，数据库损坏，客户有何体验，他们可能会知道如何从备份恢复吗？](#qopp-1708358856827)

<a name="86cq-1709924117073"></a>[.可扩展性： ](#dsae-1708357483848)

<a name="nnsa-1709924117075"></a>[描述负载(tps-推特主页时间线扇出-查询性能优化)](#vja4-1708356470840)

<a name="ns2r-1709924117077"></a>[描述性能](#s6un-1708356581594)

<a name="ofbx-1709924117079"></a>[吞吐量throughput](#fcez-1708523606684)

<a name="zzcc-1709924117081"></a>[响应时间 response time.](#k30f-1708523620292)

<a name="xkte-1709924117083"></a>[响应时间的高位百分点（也称为尾部延迟tail latencies](#bogk-1708523658968)

<a name="peor-1709924117085"></a>[.可维护性：](#k1dg-1708355783343)

<a name="5tad-1709924117087"></a>[2.数据模型与查询语言](#jufm-1677787447008)

<a name="xrj0-1709924117089"></a>[-关系模型](#pgu6-1699844351041)

<a name="rmax-1709924117091"></a>[-NoSql (es,redis)](#kfpd-1644410618294)

<a name="bz1t-1709924117093"></a>[1.文档数据库:MongoDB](#0p23-1644410807294)

<a name="5tvn-1709924117095"></a>[  2.图形数据库 ：](#09bl-1644410666587)

<a name="vlrc-1709924117097"></a>[-其它模型(基因序列)](#6fxw-1644410924417)

<a name="mthu-1709924117099"></a>[3.存储与检索](#sm0u-1677787447009)

<a name="7xse-1709924117101"></a>[-优化事务处理（OLTP）transaction ](#bhcv-1644935436804)

<a name="pazc-1709924117103"></a>[1.OLTP系统通常面向用户，大量的请求。](#tbhw-1699844517372)

<a name="upiy-1709924117105"></a>[2.磁盘寻道时间往往是这里的瓶颈。](#fnev-1644935714127)

<a name="rwhl-1709924117107"></a>[3.应用程序使用某种键来请求记录，存储引擎使用索引来查找所请求额键的数据。](#cjwp-1644935609899)

<a name="wfxr-1709924117109"></a>[-优化分析（OLAP）analys](#jg7s-1699844443567)

<a name="a3kl-1709924117111"></a>[1.列式储存(投影操作，压缩技术，聚合过滤)](#pjd1-1703887811615)

<a name="mxoc-1709924117113"></a>[-OLTP两大主流学派的存储引擎：](#8sgm-1644935924013)

<a name="jtcn-1709924117115"></a>[1.日志结构学派](#i55y-1644935943748)

<a name="3hdw-1709924117117"></a>[2.就地更新学派](#h3il-1644935977285)

<a name="lul2-1709924117119"></a>[4.编码（序列化）与演化(XML,JSON,CSV)](#lbs1-1677787447010)

<a name="cgza-1709924117121"></a>[第二部分 分布式数据](#4p9n-1677787447012)

<a name="go6r-1709924117123"></a>[1.高可用性/容错](#o4ag-1646310813851)

<a name="wbcz-1709924117125"></a>[2.断开连接的操作](#snwm-1646310894841)

<a name="fgea-1709924117127"></a>[3.减少延迟(节点近)](#evly-1646310918322)

<a name="ofpq-1709924117129"></a>[4.可拓展性](#itsh-1646310968967)

<a name="cjx2-1709924117131"></a>[.拓展至更高的载荷](#gjis-1708362947856)

<a name="wob7-1709924117133"></a>[垂直扩展scale up ：购买更强大的机器 cpu](#mgia-1708362999715)

<a name="nepm-1709924117135"></a>[共享内存架构shared-memory architecture：许多处理器、内存和磁盘再同一操作系统下相互连接，共享内存和磁盘](#pdo8-1708363038596)

<a name="qb0a-1709924117137"></a>[共享磁盘share-disk architecture：独立处理器和内存，数据存储在机器之间共享的磁盘阵列上，磁盘通过快速网络连接。数仓](#wgwl-1708363065800)

<a name="odqe-1709924117139"></a>[无共享架构](#klw2-1708363340866)

<a name="qndf-1709924117142"></a>[.复制VS分区](#gbgq-1646311175182)

<a name="hwe3-1709924117144"></a>[5.复制](#gd4q-1708363438406)

<a name="ww01-1709924117146"></a>[.领导者与追随者-单主复制](#9hbs-1708441077626)

<a name="oyur-1709924117148"></a>[客户端将所有写入操作发送到单个节点（领导者），该结点将数据更改事件流发送到其它副本（追随者）。](#aucb-1708528116000)

<a name="daif-1709924117150"></a>[读取可以再任何副本中执行，但从追随者读取可能是陈旧的 （最终一致性问题）](#wgge-1646311567456)

<a name="4zug-1709924117152"></a>[.同步复制与异步复制](#cbey-1646310922523)

<a name="fvcq-1709924117154"></a>[.设置新从库(快照复制+caught up binlog)](#j5o0-1704983008475)

<a name="sqgk-1709924117156"></a>[.处理宕机节点](#bcod-1708442233018)

<a name="5ayg-1709924117158"></a>[从库失效：追赶恢复](#5ufz-1708443850274)

<a name="r3at-1709924117160"></a>[主库失效：故障切换failover](#udix-1708443860752)

<a name="b82b-1709924117162"></a>[自动切换步骤：1.确认主库失效](#w3sj-1708523445192)

<a name="jhzm-1709924117164"></a>[2.选举新主库：共识](#y3qn-1708523480847)

<a name="cswb-1709924117166"></a>[3.配置系统启用新主库](#wua6-1708523497956)

<a name="zedb-1709924117168"></a>[failover的麻烦：1.异步复制数据丢失](#z7mn-1708523814309)

<a name="fpw9-1709924117170"></a>[2.自增主键冲突](#mnjx-1708523836932)

<a name="65sl-1709924117172"></a>[3.脑裂split brain](#dbhg-1708523873194)

<a name="wlsh-1709924117174"></a>[4.如何设置超时](#561v-1708523878338)

<a name="nsvu-1709924117176"></a>[.复制日志的实现](#8mem-1708442228760)

<a name="gkvy-1709924117178"></a>[基于语句的复制(每个写入请求语句statment)](#k8yo-1708524004340)

<a name="j5lc-1709924117180"></a>[记录每个写入请求语句statment，语句日志传输给从库](#hcqe-1708524155632)

<a name="n2t7-1709924117182"></a>[问题：非确定函数nondeterministic, NOW()  RAND()](#9xml-1708524182083)

<a name="9lyo-1709924117184"></a>[    自增列- 造成差异](#il4a-1708524271564)

<a name="nkgu-1709924117186"></a>[副作用的语句：用户自定义函数，触发器，存储过程](#azmh-1708524331636)

<a name="wflx-1709924117188"></a>[解决: 用固定值替换](#rcfb-1708524371120)

<a name="kfjx-1709924117190"></a>[  如语句存在任何不确定性，切换到基于行的数据](#6uy2-1708524426849)

<a name="rl3c-1709924117192"></a>[传输预写式日志(WAL)](#rnmz-1708524013585)

<a name="xyqq-1709924117194"></a>[日志存储引擎SSTables LSM树](#hze4-1708524498278)

<a name="25hw-1709924117196"></a>[磁盘块的B树  WAL, 崩溃恢复](#qzop-1708524541132)

<a name="j9gl-1709924117198"></a>[逻辑日志复制(基于行)](#a3ng-1708524040960)

<a name="khbx-1709924117200"></a>[binlog](#jiiu-1708524648209)

<a name="yiql-1709924117202"></a>[基于触发器的复制](#ezoi-1708524083973)

<a name="syjk-1709924117207"></a>[.复制延迟问题(解决方法都是反分布式，或者趋于单机一致性。数据一致性模型：https://jepsen.io/consistency)](#https://jepsen.io/consistency)

<a name="hljl-1709924117209"></a>[读己之写(读主库或带写时间戳查询)](#w5nz-1708525244967)

<a name="1zdj-1709924117211"></a>[写后从旧副本读取数据-未同步  ](#25nj-1708526407050)

<a name="t28i-1709924117213"></a>[解决：写后读read after write 一致性 或叫做 read your write consistency 防止这种异常](#4st1-1708525569674)

<a name="qqrx-1709924117215"></a>[1.都从主库读。适用仅由用户本人编辑的数据，如个人信息。大部分内容从主库读不适用，扩容读无效果](#v4r0-1708525736897)

<a name="zwnp-1709924117217"></a>[2. 扩容读需要保证更新时间，监控复制延迟，防止滞后超过一分钟从从库发出查询](#vqjs-1708525818133)

<a name="vq9h-1709924117219"></a>[3. 客户端记录写入时间戳，系统确保从库提供查询时，版本时间已覆盖，否则从另一个从库读，或者等待caught up-  等待不就相当弱可用状态，且时钟不可靠](#nmrh-1708525971734)

<a name="b67m-1709924117221"></a>[4. 副本在多个数据中心，复杂度高，都需经过主库IDC](#wmu9-1708526095856)

<a name="fqro-1709924117223"></a>[单调读(基于id散列路由同一副本)](#kwrd-1708525264596)

<a name="iahn-1709924117226"></a>[先读到最新副本，后读到旧副本感觉数据消失](#npwe-1708527802311)

<a name="inmf-1709924117228"></a>[A看到B评论后消失，时光倒流moving backward in time ](#4cn0-1708526272081)

<a name="jpju-1709924117230"></a>[解决：单调读monotonic reads总是从同一个副本进行读取(基于用户散列id，如果副本失效则重新路由)](#drqk-1708526396300)

<a name="paok-1709924117232"></a>[  比强一致性(同步复制/类比单机)弱，比最终一致性更强](#s6u3-1708526566643)

<a name="3jvc-1709924117234"></a>[一致前缀读(因果关系写到相同分区)](#bfps-1708525268614)

<a name="s6su-1709924117236"></a>[不同分片副本同步先后问题导致读顺序错误](#rqcm-1708527879976)

<a name="iira-1709924117238"></a>[分区partition/分片sharded数据库中的一个特殊问题，全局写入顺序](#bwov-1708526677620)

<a name="29oo-1709924117240"></a>[分区主库1写入 A:你吃饭了吗？ 分区主库2写入B:没有。 分区1副本同步主库1落后分区2副本同步主库2    C读取1副本: 没有，后读取2副本。你吃饭了吗？](#7e9o-1708526727984)

<a name="hqkt-1709924117242"></a>[解决：确保因果关系都写入到相同分区](#turn-1708527108521)

<a name="tdt3-1709924117244"></a>[复制延迟解决方案](#a2la-1708525420248)

<a name="rvsc-1709924117246"></a>[趋于反分布式，局部或者部分看做一个单机，做到强一致性](#x8ng-1708527233293)

<a name="2q3e-1709924117248"></a>[写后读。](#gecf-1708527304184)

<a name="yumz-1709924117250"></a>[数据库通过事务提供强大保证。](#zsq6-1708527307246)

<a name="8b9i-1709924117252"></a>[.多主复制(主主复制，互为副本-写冲突。多主复制被认为是危险的领域)](#pbfd-1708528009698)

<a name="24gx-1709924117254"></a>[多主复制的应用场景](#kxkx-1708441627686)

<a name="edw6-1709924117256"></a>[运维多个数据中心(IDC-主主间复制需要处理写冲突）](#xrso-1708700002291)

<a name="ouew-1709924117258"></a>[性能(多活配置，写操作在本地IDC处理，其他IDC异步复制，性能更好)](#06t6-1708700132681)

<a name="gnea-1709924117260"></a>[容忍IDC停机](#9sww-1708700267631)

<a name="xvpq-1709924117262"></a>[容忍网络问题(临时的网络中断不会妨碍正在写入的处理)](#dtkl-1708700295371)

<a name="dy3b-1709924117264"></a>[需要离线操作的客户端(支持多个终端离线操作couchDB)](#knxa-1708700020273)

<a name="lmgt-1709924117266"></a>[协同编辑](#hvwb-1708700115895)

<a name="tvhb-1709924117268"></a>[处理写冲突(A将标题从1改2,B将1改3)](#fdot-1708700612321)

<a name="1vjv-1709924117270"></a>[同步于异步冲突检测](#u8bc-1708700824251)

<a name="dhhc-1709924117272"></a>[同步：单主程序复制 - 不允许每个副本独立接受写入](#wfgd-1708700957597)

<a name="ejgu-1709924117274"></a>[异步：独立接受写入- 异步检测，但为时已晚](#x6is-1708701017804)

<a name="33hf-1709924117276"></a>[避免冲突(特定记录写入都通过同一个领导者，主库切换或者用户迁移至更近的主库时会有同时写入的可能性)](#xg2a-1708700840681)

<a name="4ddg-1709924117278"></a>[收敛convergent至一致的状态(副本主库和其副本在复制完成时收敛至一个相同的最终值)](#ucfn-1708700844474)

<a name="bao4-1709924117280"></a>[最后写入胜利LWW,last write wins- 给每个写入一个唯一id, 挑选最高ID的写入作为胜利者，并丢弃其他写入-数据丢失](#cbla-1708701376316)

<a name="sv4k-1709924117282"></a>[为每个副本分配一个唯一ID,ID编号更高的具有高优先级。数据丢失](#40po-1708701481447)

<a name="pqvo-1709924117284"></a>[将值合并在一起](#p4m4-1708701593939)

<a name="fiuf-1709924117286"></a>[记录冲突，并编写解决逻辑代码。如通过提醒用户方式](#8fcs-1708701611999)

<a name="oxaz-1709924117288"></a>[自定义冲突解决逻辑](#yrdi-1708700860148)

<a name="qi9z-1709924117290"></a>[自定义冲突解决逻辑(complex)](#t4i7-1708702160004)

<a name="t4rn-1709924117292"></a>[写时执行-后台处理](#pdql-1708702370625)

<a name="wvqz-1709924117294"></a>[读时执行-提供多版本用户选择，回写数据库](#sksk-1708702376293)

<a name="ijtg-1709924117296"></a>[亚马逊购物车移除的商品重新出现](#4bqp-1708702425059)

<a name="z2it-1709924117298"></a>[什么是冲突(两个领导者预订同一个会议室，7章看冲突实例12章看检测解决)](#6x4i-1708700867996)

<a name="ndnk-1709924117300"></a>[多主复制拓扑](#o41a-1708702111509)

<a name="4rez-1709924117302"></a>[环形，星型，all to all -mysql仅支持环形](#5feh-1708702903239)

<a name="lyli-1709924117304"></a>[问题：多主复制时，可能在某些副本中写入错误的顺序。like A写主库1，B写主库2，主库3先同步2，再同步1。类似一致前缀读。](#ddyu-1708702949257)

<a name="uvul-1709924117306"></a>[解决：时间戳是不够的-不可靠时钟，使用一种称为版本向量(version vectors)的技术-检测并发写入](#ghp3-1708703247102)

<a name="yz3q-1709924117308"></a>[无主复制leaderless](#bfz8-1708759285067)

<a name="ixj3-1709924117311"></a>[Amazon的Dynomo系统。](#cvru-1708759359537)

<a name="3hpy-1709924117313"></a>[Riak, Cassandra，Voldmort 也称为Dynamo风格。](#wf6o-1708759707666)

<a name="sxsq-1709924117315"></a>[类型1：客户端直接将写入发送到几个副本中](#xpqf-1708760120711)

<a name="gxug-1709924117317"></a>[类型2：coordinator协调者节点代表客户端写入。](#pl2z-1708760121090)

<a name="ym2i-1709924117319"></a>[当节点故障时写入数据库(仲裁写⼊，法定读取，并在节点中断后读修复。)](#qgpe-1708760989905)

<a name="5z5m-1709924117321"></a>[如果主从复制，主故障/重启系统更新 则需进行故障切换](#zfuz-1708760396929)

<a name="dr7j-1709924117323"></a>[无主复制： userA set piture_url   -> replica1 ok    Then version=7](#3soj-1708760452090)

<a name="a106-1709924117325"></a>[           user set piture_url   -> replica2 ok  Then version=7](#4f05-1708760543198)

<a name="pxky-1709924117327"></a>[user set piture_url   -> replica3 offline  fail   version= 6](#ynls-1708759898772)

<a name="zkt8-1709924117329"></a>[    userB get piture  :  rp3(version6) rp1(version7)  rp2(version7)  Than fix rp3 value to version7](#e1ur-1708760618873)

<a name="etoq-1709924117331"></a>[ 读修复和反熵(失效节点重新连机后如何caught up)](#tyv3-1708760780373)

<a name="bboh-1709924117333"></a>[读修复like userB get piture fixed rp3](#wjho-1708761214792)

<a name="wcky-1709924117335"></a>[反熵 后台进程不断查找副本之间的数据差异。Voldmort无反熵过程，副本可能丢失数据](#xblj-1708761286988)

<a name="dhjk-1709924117337"></a>[ 读写的法定人数（仲裁）](#w3ia-1708761120623)

<a name="9wwp-1709924117339"></a>[仲裁一致性的局限性-最终一致，更强的保证需要事务或共识](#oj1i-1708759830121)

<a name="8shn-1709924117341"></a>[松散法定人数与带提示的接力](#cu5q-1708759841416)

<a name="qt8u-1709924117343"></a>[运维多个数据中心-将写入发送到所有副本，仅需本地IDC内法定节点确认](#kzki-1708761744887)

<a name="8qq4-1709924117345"></a>[检测并发写入](#pt1k-1708759856530)

<a name="hm9n-1709924117347"></a>[Dynamo风格的数据存储，没有明确定义的顺序。](#mu89-1708761978075)

<a name="egkp-1709924117349"></a>[userA set x=A   get x](#dbni-1708763823783)

<a name="mms5-1709924117351"></a>[rp 1 A ok    B unresponsive   A](#auce-1708763993783)

<a name="uuwg-1709924117353"></a>[rp2 A ok   B OK  B](#kteo-1708764011894)

<a name="q3bk-1709924117355"></a>[rp3 B ok A ok A](#9xyy-1708764019308)

<a name="hrmm-1709924117357"></a>[userB set x=B ](#esiv-1708702764305)

<a name="cubm-1709924117359"></a>[最后写入胜利(丢弃并发写入)](#wd1i-1708764197180)

<a name="vosd-1709924117361"></a>[LLW 无法确定真实排序，强制排序，选择最新的最大时间戳，并丢弃较早的任何写入.Cassandra唯一支持的方式，Riak可选](#uzhw-1708874432788)

<a name="gtaf-1709924117363"></a>[缺点：数据丢失 ](#henp-1708874594301)

<a name="9uaq-1709924117365"></a>[此前发生的关系和并发](#hzwp-1708764215825)

<a name="lfju-1709924117367"></a>[因果依赖(causally dependent)  如果B后发与A, 则B因果依赖A, ](#3wp0-1708874672763)

<a name="j1w5-1709924117369"></a>[如果是并发，则存在需要解决的冲突](#1wzv-1708875051673)

<a name="wc9c-1709924117372"></a>[捕获此前发生的关系](#j2r6-1708764228505)

<a name="onyt-1709924117374"></a>[捕获两个客户端间的因果关系，同时编辑购物车(示例为单副本)](#vv7q-1708875756229)

<a name="knwu-1709924117376"></a>[合并同时写入的值](#zp0i-1708874374616)

<a name="sxtz-1709924117378"></a>[客户端需额外工作，合并并发写入的值来擦屁股。Riak称这些并发值兄弟(sibings)](#wawo-1708876272614)

<a name="gczv-1709924117380"></a>[版本向量](#arlv-1708874381589)

<a name="gk2a-1709924117382"></a>[所有副本的版本号集合称为版本向量(version vector)](#b1ov-1708700703636)

<a name="s3gv-1709924117384"></a>[6.分区](#dyz5-1709800112532)

<a name="aprq-1709924117386"></a>[.分区与复制(分区与复制方案是独立的)](#twd1-1709800204792)

<a name="ub1d-1709924117388"></a>[.键值数据的分区](#fbqg-1709800263679)

<a name="p7ii-1709924117390"></a>[偏斜skew：分区过多数据或过多查询](#s7ju-1709801062977)

<a name="qpkw-1709924117392"></a>[热点hot spot:高负载的分区](#u0d3-1709801107270)

<a name="p5nn-1709924117394"></a>[根据键的范围分区](#lqbu-1709800332210)

<a name="6l6t-1709924117396"></a>[Bigtable, HBase, RethinkDB 和 MongoDB2.4](#i2ju-1709801151406)

<a name="fhdl-1709924117398"></a>[按照一定的顺序保存键（SSTbale和LSM-树）](#np00-1709801582805)

<a name="g9mj-1709924117400"></a>[按时间分区当日写过载（需加传感器保证日期+传感主键均匀分布）](#evhb-1709801683166)

<a name="whog-1709924117402"></a>[根据键的散列分区(可将偏斜数据均匀分布)](#a1yy-1709800347130)

<a name="kzd1-1709924117404"></a>[不适合分区的简单哈希函数：java .hashCode-同键不同进程不同哈希值](#mdg4-1709801628016)

<a name="gcff-1709924117406"></a>[一致性哈希consistent hashing:哈希键分区边界均匀间隔，也可伪随机选择（CDN均匀分配负载）。](#7rkg-1709802019859)

<a name="g1tw-1709924117408"></a>[缺点：无序，低效范围查询(需发送到所有分区)](#iktb-1709802309508)

<a name="gzzk-1709924117410"></a>[折中方案：复合主键/组合索引。(uid,time).不同用户在不同分区，每个用户按时间搓顺序存储在单个分区上。](#zznq-1709802490074)

<a name="ssih-1709924117412"></a>[负载倾斜与消除热点](#ed70-1709800357523)

<a name="qjkb-1709924117414"></a>[数百万追随者做某事-大量写入同一个键](#403a-1709802593546)

<a name="amdh-1709924117416"></a>[解决：火爆主键+随机数即可将主键分散为100个分区](#wx5s-1709802730512)

<a name="m7nb-1709924117418"></a>[缺点：数据合并，跟踪火爆主键。需权衡利弊。](#h0b7-1709802773377)

<a name="0ill-1709924117420"></a>[.分片与次级索引](#ekdv-1709800287975)

<a name="dwxx-1709924117422"></a>[次级索引通常并不能唯一标识记录。](#n3vk-1709803239471)

<a name="k30d-1709924117424"></a>[HBase Volde-mort为了减少实现复杂度放弃了次级索引。](#q1u5-1709803293988)

<a name="jzby-1709924117427"></a>[Riak开始添加， 次索是Solr Elasticesearch 搜索的基石](#fhpr-1709803333585)

<a name="dtzv-1709924117429"></a>[按文档的二级索引](#mwm0-1709800370635)

<a name="lpbg-1709924117431"></a>[文档分区索引/本地索引](#ud7o-1709803718409)

<a name="wkff-1709924117433"></a>[每个分区独立维护自己的二级索引。](#zlhf-1709803740582)

<a name="3gfo-1709924117435"></a>[查询发送所有分区，并合并所有返回结果，分散/聚集scatter/gather-容易导致尾部延迟放大。](#bkj3-1709803789802)

<a name="ft0l-1709924117437"></a>[缺点：可能使二级索引读取查询相当昂贵。](#ghpm-1709803878421)

<a name="j1bd-1709924117439"></a>[根据关键词(Term)的二级索引](#itl0-1709800380617)

<a name="4fis-1709924117441"></a>[全局索引：覆盖所有分区数据的索引，也须分区。](#8bw4-1709804016790)

<a name="fmaq-1709924117443"></a>[关键词分区：关键词本身或它的散列进行分区。](#qc2d-1709913637902)

<a name="uxxe-1709924117445"></a>[优点：只需请求包含关键词的分区，读取更有效率](#jmj8-1709913775261)

<a name="elss-1709924117447"></a>[缺点：写入慢且复杂。需支持分布式事务。](#i7kp-1709913825503)

<a name="emkx-1709924117449"></a>[理想下总是最新，实践中更新通常为异步。Amazon DynamoDB声称全局次级索引不到1s内更新。](#mv7j-1709913923874)

<a name="iyvj-1709924117451"></a>[.分区再平衡(reblancing)](#hpnd-1709800294747)

<a name="4hkp-1709924117453"></a>[吞吐量增加：加cpu](#1f0n-1709914101899)

<a name="pean-1709924117455"></a>[数据集大小增加：加磁盘和RAM](#vjb0-1709914129763)

<a name="zgvq-1709924117457"></a>[机器故障：其他机器接管](#smcd-1709914153882)

<a name="kvoz-1709924117459"></a>[----------再平衡应满足--------------](#2efu-1709916803909)

<a name="1zon-1709924117461"></a>[发生时：数据库应该继续接受读取和写入](#20wj-1709916807951)

<a name="xmad-1709924117463"></a>[节点之间只移动必须数据(分区)，以便快速再平衡，减少网络和磁盘io负载。](#cxoi-1709916893371)

<a name="qpkc-1709924117465"></a>[平衡后：存储，读取和写入公平共享](#cj8j-1709916938075)

<a name="zaag-1709924117467"></a>[平衡策略](#cavd-1709800402611)

<a name="jmeg-1709924117469"></a>[反面教材：hash mod N](#6f6z-1709800409866)

<a name="t0v2-1709924117471"></a>[$hash(key)=22  22mod10..2  22mod 11...0  22 mod 9 ...4 ](#anib-1709916997775)

<a name="ubne-1709924117473"></a>[节点需要转移秘钥及次数过多，过于昂贵。](#anz7-1709917243580)

<a name="aqcu-1709924117475"></a>[解决：更换为只移动必须数据的方法。](#7ytl-1709917334275)

<a name="92mc-1709924117477"></a>[固定数量的分区(加节点时分配分区)](#8l9j-1709800420954)

<a name="u9jg-1709924117479"></a>[新增/减少节点时，将现存部分数据转移到节点新增/现存节点(Riak,es,couchbase Voldemort使用这种再平衡）](#vmsm-1709917322722)

<a name="k5zw-1709924117481"></a>[适用：分区数量第一次建立时确定。](#ktrd-1709917648400)

<a name="jcii-1709924117483"></a>[缺点：数据集总量大小难以预估时；分区大再平衡代价昂贵，分区小产生额外开销。](#vw7j-1709917692466)

<a name="6vpl-1709924117485"></a>[分区大小与集群数据总量成比例增长](#eszc-1709921747523)

<a name="sy0e-1709924117487"></a>[动态分区(适用键范围的分区)？切分节点/分区数量 还是 切分分区/分区数据量](#tkjw-1709800428033)

<a name="k221-1709924117489"></a>[解决：使用键范围分区，固定边界的固定数量的分区不便。出现边界错误，手动重新陪去分区边界将非常繁琐。](#itsg-1709917825657)

<a name="cozo-1709924117491"></a>[动态分区：与B树类似，分区数据增长超过配置时将分成两区，大量数据删除分区缩小低于阈值则合并(HBase RethinkDB)](#05rm-1709917996703)

<a name="kfz5-1709924117493"></a>[优点：分区数量适应总数据量-动态划分分区数量。](#v8uv-1709918235496)

<a name="4ngk-1709924117495"></a>[注意：空库分区开始，未绘制边界先验信息。所有写操作都必须由单个节点处理。其它节点空闲](#cdjv-1709918375629)

<a name="tugx-1709924117497"></a>[解决：配置一组初始分区-预分割 Hbase MongoDb。配需提前知道键分配方式。](#3uee-1709918458100)

<a name="hc9a-1709924117499"></a>[MongoDB同时支持范围和哈希分区且动态分割分区。](#tlmq-1709918504615)

<a name="pbx0-1709924117502"></a>[分区数量与数据集大小成正比](#xqee-1709921516740)

<a name="hcwg-1709924117504"></a>[按节点比列分区](#kcsr-1709800432396)

<a name="sutq-1709924117506"></a>[新增节点，分区将变小。随机选择固定数量的现有分区进行拆分,最终获得公平的负载份额。cassandre ketama.](#xscz-1709920011051)

<a name="u7qz-1709924117508"></a>[随机选择分区边界要求使用基于散列的分区-一致性哈希。](#pmpc-1709920187661)

<a name="ywnb-1709924117510"></a>[分区数量与节点数量无关](#a0l0-1709923420226)

<a name="p4n6-1709924117512"></a>[ 运维：手动还是自动平衡](#w6ob-1709800443454)

<a name="l3xe-1709924117514"></a>[自动：与故障检测结合将十分危险，高负载节点响应慢被视为死亡被踢掉，重新平衡集群时其他超负荷节点可能级联失败](#qobk-1709920292898)

<a name="ki8v-1709924117516"></a>[手动人为监控+自动](#a05n-1709920414620)

<a name="x6mm-1709924117518"></a>[.请求路由](#qxk3-1709800301840)

<a name="nnp2-1709924117520"></a>[分区再平衡后的服务发现(IP 端口)](#sd2e-1709921854453)

<a name="mceu-1709924117522"></a>[-------方案-------](#gliq-1709921964410)

<a name="rrv1-1709924117524"></a>[1.循环策略：Round-Robin load balancer，轮询节点看是否有请求的分区。](#ibln-1709921978507)

<a name="lnoc-1709924117526"></a>[2.路由层：有中间层的路由决定请求的节点，由路由层负载均衡](#gjxa-1709922094115)

<a name="kfke-1709924117528"></a>[3.要求客户端知道分区和节点的分配。客户端可直连节点。](#ukz9-1709922149547)

<a name="rss0-1709924117530"></a>[具有挑战性的问题。重要的是所有参与者都同意-否则将被发送到错误的节点，而不是正确处理。分布式中的共识协议-但很难正确实现。](#1c54-1709922244119)

<a name="dtjd-1709924117532"></a>[Zookeper分区分配改变时通知路由层保持最新信息。](#c7dc-1709922373821)

<a name="8dam-1709924117534"></a>[LinkedIn的Espressor使用Heix进行集群管理(依靠Zookeeper）](#ne7u-1709922442881)

<a name="5lax-1709924117536"></a>[Hbase,SolrCloud 和kafka也是用Zookeeper来跟踪分区分配。](#41cr-1709922584212)

<a name="mbae-1709924117538"></a>[Cassandra  Riaks节点间使用留言协议gossip protocol来传播群集状态变化。请求发送任意节点，该节点转发到含有请求分区的节点。模型增加数据库节点的复杂性。但避免对Zookeeper这类外部协调服务的依赖](#kg5k-1709922347652)

<a name="xjcz-1709924117540"></a>[Couchbash不会自动再平衡，简化了设计。moxi路由层。](#uohs-1709922928889)

<a name="cjbb-1709924117542"></a>[执行并行查询](#h26t-1709800460759)

<a name="tkgq-1709924117544"></a>[大规模并行处理(MPP,massively parallel processing)-数仓](#oj8k-1709923010027)

<a name="cojj-1709924117546"></a>[7.事务](#7qvp-1708523954496)

<a name="7x25-1709924117548"></a>[.简化故障失败的机制-强大的事务！！！！！！！](#du4g-1704983767151)

<a name="3bjg-1709924117550"></a>[.事务的棘手问题](#k9de-1704984009883)

<a name="3pdh-1709924117552"></a>[原⼦性（Atomicity）](#65nh-1704984028565)

<a name="rn3w-1709924117554"></a>[⼀致性（Consistency）](#qeub-1646310871673)

<a name="aear-1709924117556"></a>[—致性这个词重载的很厉害:](#yyl1-1708878763788)

<a name="ekfm-1709924117558"></a>[隔离性（Isolation）](#rpju-1646310871817)

<a name="l240-1709924117560"></a>[持久性（Durability）](#aq1q-1646310872064)

<a name="my10-1709924117562"></a>[8.分布式系统的麻烦](#enui-1704985776096)

<a name="6dgw-1709924117564"></a>[9.一致性共识](#rp9s-1705080859004)

<a name="ijpq-1709924117566"></a>[分布式事务与共识](#cys8-1705080619829)

<a name="adqp-1709924117568"></a>[2PC提交](#bjec-1705081008345)

<a name="8qrq-1709924117570"></a>[3PC提交](#dyd0-1705118358884)

<a name="c9f6-1709924117572"></a>[实践中的分布式事务](#pudp-1705080909535)

<a name="jvv3-1709924117574"></a>[XA事务(扩展架构（eXtended Architecture)](#ozc0-1705080997483)

<a name="tn0p-1709924117576"></a>[怀疑时持有锁](#ssso-1705081563263)
...
<a name="iuyh-1710770211133"></a><a name="qi7j-1710172616303"></a>**两阶段锁定的功能**

<a name="ccq8-1710172621528"></a>**谓词锁**

<a name="zv5c-1710172626404"></a>**索引范围锁**

<a name="slwa-1710172573367"></a>**序列化快照隔离SSI**

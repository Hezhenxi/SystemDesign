...
<a name="3060-1621846615933"></a><a name="k7m4-1709312409084"></a>[一.数据库设计](#jeyl-1677787446995)

<a name="ogis-1709312409086"></a>[1. 关系型数据库](#5hya-1677787446996)

<a name="ivwm-1709312409089"></a>[.E-R图，由台湾工程师提出的设计概念](#ohc5-1621692571287)

<a name="ltju-1709312409091"></a>[.流程图-业务逻辑相关，系统用户动作。抽象出E-R图](#5ocb-1645598528868)

<a name="4pae-1709312409093"></a>[1.1 E-R图 ](#gzqe-1677787446997)

<a name="r0if-1709312409095"></a>[1.根据名词抽象出实体](#r1ac-1621692724628)

<a name="4ois-1709312409097"></a>[2.名词找属性](#d2fl-1621692745600)

<a name="aev5-1709312409099"></a>[3.实体间联系](#dwkp-1621692752824)

<a name="pkkb-1709312409101"></a>[.状态图](#53bo-1621692829033)

<a name="yvsk-1709312409103"></a>[1.2 转化成数据库设计（公式）](#c2cy-1677787446998)

<a name="sfis-1709312409105"></a>[.1 对1 关系 往记录少的乙方加主键](#xmox-1621692858500)

<a name="w75c-1709312409107"></a>[.1对n 关系 ，往 n 实体加关联主键 ](#mdr8-1621692924289)

<a name="yzce-1709312409109"></a>[. n对 m 关系，需要一个关联表作映射关联](#hd3i-1621692960576)

<a name="q7rb-1709312409111"></a>[二.系统优化](#cdso-1677787447000)

<a name="c1vh-1709312409113"></a>[应用整体的优化](#3qep-1642647362896)

<a name="ewkv-1709312409115"></a>[-cpu -> 纳秒级别](#knge-1642647371136)

<a name="mk6s-1709312409117"></a>[1.多线程和并发编程](#ovup-1704437622969)

<a name="9g0g-1709312409119"></a>[2.JNI ](#ufpl-1704437634986)

<a name="mfl6-1709312409121"></a>[3.JIT/AOT编译](#ixb5-1704437634987)

<a name="arfb-1709312409123"></a>[4.算法优化](#kr1f-1704437634988)

<a name="lszj-1709312409125"></a>[-内存RAM（GB）/高速缓存(KB) -> 微秒级别(分级缓存)](#1xur-1642647384168)

<a name="gmv6-1709312409127"></a>[1.JVM内存管理](#7hi9-1704437851514)

<a name="dumv-1709312409129"></a>[2.缓存](#te7c-1704437851799)

<a name="mnyh-1709312409131"></a>[3.消息中间件](#bqty-1704437851800)

<a name="7nkc-1709312409133"></a>[-磁盘（TB）-> 毫秒级别(减少io次数,减少随机io-redolog)](#ziti-1642647439005)

<a name="z1ny-1709312409135"></a>[1.减少磁盘io](#zups-1704437900079)

<a name="kkoc-1709312409137"></a>[2.数据压缩   ](#u3ok-1704438035018)

<a name="igoe-1709312409139"></a>[-网络传输/系统交互 -> 秒级 (减少io，连接池化) ](#irbp-1642647458856)

<a name="dnll-1709312409141"></a>[1.减少网络请求   ](#6qil-1704438276193)

<a name="f1e9-1709312409143"></a>[2.使用CDN](#p5dt-1704438283633)

<a name="0tcu-1709312409145"></a>[3.Sockets异步通信                                      ](#zhp8-1704438283634)

<a name="nnhn-1709312409147"></a>[项目架构层面的优化](#3l0l-1704424353262)

<a name="2ebt-1709312409149"></a>[-多级缓存](#8o8s-1704424396933)

<a name="kbb0-1709312409151"></a>[-应用层](#trcg-1704438366333)

<a name="g3as-1709312409153"></a>[代码优化](#68oa-1704438530062)

<a name="ql2b-1709312409155"></a>[数据库优化](#clmf-1704438530257)

<a name="drfm-1709312409157"></a>[日志优化](#md03-1704438530259)

<a name="tp28-1709312409159"></a>[-监控与调优](#ocux-1704438477879)

<a name="5ykk-1709312409161"></a>[性能监控：](#vdq2-1704438556836)

<a name="fzo9-1709312409163"></a>[分析和调优](#t29d-1704438557094)

<a name="gxvs-1709312409165"></a>[-分布式系统架构](#ukjf-1704424419442)

<a name="pyf6-1709312409167"></a>[  .负载均衡](#a0bx-1704438677201)

<a name="ffwm-1709312409169"></a>[分布式缓存](#xn9x-1704438687994)

<a name="zz80-1709312409171"></a>[服务降级和容错](#zcdp-1704438687996)

<a name="z6sp-1709312409173"></a>[读写层面](#six7-1642647372926)

<a name="lrdm-1709312409176"></a>[.读优化](#g4uv-1704732583614)

<a name="oqsq-1709312409178"></a>[1.缓存](#uuzh-1704732602620)

<a name="pmgw-1709312409180"></a>[2.索引](#qobc-1704732605892)

<a name="jqy7-1709312409182"></a>[3.减少io/批量读/非阻塞io](#zlg9-1704732609048)

<a name="pet5-1709312409184"></a>[4.减少多余数据加载/列式存储读](#fpjd-1704732631316)

<a name="b18j-1709312409186"></a>[.写优化](#oyob-1704732598377)

<a name="7sdz-1709312409188"></a>[1.异步写](#6jmb-1704732509150)

<a name="r1ga-1709312409190"></a>[2.并发写](#tkwp-1704732723564)

<a name="pnr8-1709312409192"></a>[3.批量写](#hewz-1704732862030)

<a name="xbri-1709312409194"></a>[4.优化算法和数据结构](#ccd8-1704732727854)

<a name="x8rb-1709312409196"></a>[5.缓存写](#eqd9-1704732736281)

<a name="bved-1709312409198"></a>[6.非阻塞io](#hyq8-1704732768916)

<a name="2o4r-1709312409200"></a>[1.分控系统优化复盘](#tncv-1677787447001)

<a name="24cz-1709312409202"></a>[1.1 数据库系统](#ydq7-1677787447002)

<a name="x8gy-1709312409204"></a>[1.2 sql慢](#wxdd-1677787447003)

<a name="rzso-1709312409206"></a>[1.3 接口慢](#olpb-1677787447004)

<a name="kj4v-1709312409208"></a>[高并发系统设计](#wrwk-1642647280506)

<a name="4uql-1709312409210"></a>[1.满足大规模用户同时访问，提供良好响应时间和性能](#8ien-1704757782146)

<a name="sdxr-1709312409212"></a>[2.设计之初就要考虑伸缩性和容错性是非常重要的](#xy0g-1704757785190)

<a name="70mh-1709312409214"></a>[.垂直伸缩 ](#wr12-1704947861599)

<a name="lcg5-1709312409216"></a>[.水平伸缩](#bizh-1704947959744)

<a name="kbzq-1709312409218"></a>[1.分布式架构](#fvzi-1704756770858)

<a name="y42n-1709312409220"></a>[.微服务架构](#ywzr-1704756872033)

<a name="qb4a-1709312409222"></a>[.分布式计算](#xgna-1704756877646)

<a name="fhig-1709312409224"></a>[2.负载均衡](#wnfy-1704756775272)

<a name="ea3v-1709312409226"></a>[.负载均衡](#h6nf-1704756891918)

<a name="c4co-1709312409228"></a>[.水平扩展](#c8zr-1704756894402)

<a name="iznn-1709312409230"></a>[3.数据库设计](#wxjk-1704756782840)

<a name="5eo8-1709312409232"></a>[.读写分离](#lxca-1704756910837)

<a name="nvx7-1709312409234"></a>[.数据库分片](#p7d2-1704756922362)

<a name="zj5h-1709312409236"></a>[.缓存](#hxjt-1704756963988)

<a name="xrxj-1709312409238"></a>[4.缓存优化](#iivs-1704756788012)

<a name="2rkl-1709312409240"></a>[.分布式缓存](#cvui-1704756971791)

<a name="svkd-1709312409242"></a>[.本地缓存](#ysly-1704756979122)

<a name="l517-1709312409244"></a>[.缓存预热](#rqwj-1704756986363)

<a name="5cmx-1709312409246"></a>[5.消息队列](#so9h-1704756800253)

<a name="8ner-1709312409248"></a>[.异步处理](#sxlo-1704756996000)

<a name="thfd-1709312409250"></a>[.削峰填谷](#llm2-1704757002994)

<a name="d0ai-1709312409252"></a>[6.分布式事务](#n39o-1704756805232)

<a name="40ue-1709312409254"></a>[.两阶段提交](#5bhj-1704757017700)

<a name="u1ot-1709312409256"></a>[.补偿事务](#becc-1704757028036)

<a name="nskg-1709312409258"></a>[7.高可用和容错](#wgkk-1704756813448)

<a name="k5vw-1709312409260"></a>[.多地域部署](#akwz-1704757035393)

<a name="5l5q-1709312409263"></a>[.设计容错](#3nxv-1704757055271)

<a name="pe3f-1709312409265"></a>[1. 熔断限流](#g3xx-1704757371028)

<a name="xv87-1709312409267"></a>[2. 多节点服务](#jafy-1704757374368)

<a name="hnwk-1709312409269"></a>[8.监控和性能调优](#ilyo-1704756820772)

<a name="v5i8-1709312409271"></a>[.实时监控](#kpwq-1704757064566)

<a name="vma6-1709312409273"></a>[.性能测试](#shf4-1704757066453)

<a name="ezpx-1709312409275"></a>[9.安全性设计](#2pry-1704756830245)

<a name="svgr-1709312409277"></a>[.防御性编程](#pkiw-1704757078583)

<a name="nhg5-1709312409279"></a>[.访问控制](#g4l1-1704757084924)

<a name="a2cq-1709312409281"></a>[10.水平扩展](#1tsd-1704756838192)

<a name="8m2j-1709312409283"></a>[.自动化部署](#r1dd-1704757092061)

<a name="35ie-1709312409285"></a>[.云服务](#7mhk-1704757104117)

<a name="fpoq-1709312409287"></a>[高并发性能指标](#rpxb-1677787447005)

<a name="y1zr-1709312409289"></a>[QPS(每秒请求)](#klnv-1704761369323)

<a name="wmgg-1709312409291"></a>[TPS(每秒事务)](#zvlz-1704761369324)

<a name="57mc-1709312409293"></a>[RT(响应时间)](#gvrn-1704761369325)

<a name="fsyr-1709312409295"></a>[(原子操作)并发编程中保证数据一致性/安全的方法](#ysmj-1709309531982)

<a name="loev-1709312409297"></a>[原子性+悲观锁：各种锁机制](#fdxy-1709308630108)

<a name="6hfo-1709312409299"></a>[.（锁+事务/ 分布式锁+分布式事务）](#v06l-1709312268021)

<a name="6zsa-1709312409301"></a>[.  CASmysql版本号实现 (数据库update锁+update原子性）](#k0op-1709312304164)

<a name="unfa-1709312409303"></a>[原子性+乐观锁/不加锁: CAS原子操作(java原子类)，](#qth5-1709308703202)

<a name="xcwa-1709312409305"></a>[CAS底层实现原理](#g3uo-1709309147469)

<a name="5m7r-1709312409307"></a>[总线锁定（Bus Locking）：](#qpbw-1709308842021)

<a name="vxeu-1709312409309"></a>[缓存一致性协议（Cache Coherence Protocol）：](#ikm2-1709308842025)

<a name="krh0-1709312409311"></a>[指令序列化（Instruction Serialization）：](#wpeu-1709308842029)

<a name="name-1709312409313"></a>[不同的场景适用哪种锁](#olfu-1709309769107)

<a name="uuva-1709312409315"></a>[.共享数据的读写操作：](#y60t-1709309615585)

<a name="kvic-1709312409317"></a>[适用措施：读写锁（ReadWrite Lock）、互斥锁（Mutex）、原子操作、无锁算法。Copy on Write优化读写锁](#lqad-1709309615587)

<a name="nmkh-1709312409319"></a>[.并发容器的操作：](#fsfa-1709309615591)

<a name="t5is-1709312409321"></a>[适用措施：线程安全的容器类（如ConcurrentHashMap、ConcurrentLinkedQueue）、原子操作。](#rs2n-1709309615593)

<a name="aocb-1709312409323"></a>[.多个线程协作的场景：](#xdpv-1709309615597)

<a name="m7t2-1709312409325"></a>[适用措施：信号量（Semaphore）、条件变量（Condition Variable）。](#uzlr-1709309615599)

<a name="402c-1709312409327"></a>[.分布式系统的并发操作：](#0aah-1709309615603)

<a name="i8d3-1709312409329"></a>[适用措施：分布式锁、分布式事务。](#wlhe-1709309615605)

<a name="ao9f-1709312409331"></a>[.不可变数据的并发访问：](#angi-1709309615609)

<a name="g8jl-1709312409333"></a>[适用措施：不可变数据结构、原子操作。](#pga0-1709309615611)

<a name="gttc-1709312409335"></a>[.高性能要求的并发操作：](#pw5v-1709309615615)

<a name="hbzr-1709312409337"></a>[适用措施：无锁算法、并发数据结构。 -CAS乐观锁](#plv6-1709309615617)

<a name="xzve-1709312409339"></a>[互斥访问：](#62mg-1709309976431)

<a name="zlpw-1709312409341"></a>[.互斥锁（Mutex）：](#0qt3-1709307350160)

<a name="ove3-1709312409343"></a>[.原子操作：](#7xva-1709307350164)

<a name="0w2a-1709312409345"></a>[.临界区（Critical Section）：](#r8cl-1709307350168)

<a name="f4ip-1709312409348"></a>[.读写锁（ReadWrite Lock）：](#occj-1709307350172)

<a name="07ja-1709312409350"></a>[.信号量（Semaphore）：](#vej9-1709307350176)

<a name="6eer-1709312409352"></a>[.条件变量（Condition Variable）：](#ssge-1709307350180)

<a name="du3s-1709312409354"></a>[.无锁算法（Lock-Free Algorithms）：](#zk0j-1709307350184)

<a name="5llh-1709312409356"></a>[.数据拷贝-写时复制（Copy-on-Write）：优化读写锁，写时复制且串行执行(锁)，读不加锁](#tiqo-1709307350188)

<a name="qpu8-1709312409358"></a>[.线程安全的数据结构：](#b8ca-1709307350192)

<a name="nada-1709312409360"></a>[===系统架构设计师===](#nyrv-1709307688718)

<a name="pijn-1709312409362"></a>[系统工程与信息系统基础](#mpwu-1704949756608)

<a name="wuxu-1709312409364"></a>[.系统工程方法](#2gzz-1704980837071)

<a name="yvwr-1709312409366"></a>[.系统工程生命周期阶段](#mk93-1704952875199)

<a name="wzxo-1709312409368"></a>[.系统工程生命周期方法](#ny2c-1704952893636)

<a name="pi2g-1709312409370"></a>[.信息系统建设原则](#shmt-1704952904062)

<a name="bfke-1709312409372"></a>[.信息系统开发方法](#itje-1704951812273)

<a name="uke6-1709312409374"></a>[原型法](#bnzq-1705819374009)

<a name="qef6-1709312409376"></a>[结构化法-瀑布型](#ujj3-1705819377863)

<a name="5bgy-1709312409378"></a>[形式化法-数模](#8wek-1705819398251)

<a name="zleb-1709312409380"></a>[敏捷方法](#jeuk-1705819392097)

<a name="o80b-1709312409382"></a>[.信息系统分类](#w8yd-1704980881013)

<a name="z3zx-1709312409384"></a>[业务处理系统TPS](#hlhq-1705819204285)

<a name="owuc-1709312409386"></a>[管理信息系统MIS](#oksn-1705819204735)

<a name="5xnu-1709312409388"></a>[决策支持系统DSS](#lwm7-1705819204736)

<a name="tstb-1709312409390"></a>[专家系统ES](#bmeu-1705819204737)

<a name="lh5j-1709312409392"></a>[办公自动化系统OAS](#kffq-1705819204738)

<a name="9wsq-1709312409394"></a>[企业资源系统ERP](#k2px-1705819204739)

<a name="ujdd-1709312409396"></a>[过程模型](#f98t-1704981918920)

<a name="ieaw-1709312409398"></a>[瀑布模型](#yk4j-1705841608124)

<a name="jvwx-1709312409400"></a>[V模型【瀑布变种-测试贯穿】](#oryp-1705841608705)

<a name="spj8-1709312409402"></a>[原型模型](#b0cp-1705841621350)

<a name="h1jx-1709312409404"></a>[螺旋模型【原型+瀑布 风险】](#sfqi-1705841608707)

<a name="sq1g-1709312409406"></a>[构件组装模型/基于构件的开发方法](#kbjw-1705841608709)

<a name="yrsa-1709312409408"></a>[快速应用开发RAD【瀑布+构件组装】](#mvze-1705841627436)

<a name="cxgp-1709312409410"></a>[统一过程/统一开发方法](#xici-1705841629815)

<a name="4hki-1709312409412"></a>[敏捷开发方法](#9jca-1705841608711)

<a name="53xb-1709312409414"></a>[XP](#28va-1705841590197)

<a name="eorm-1709312409416"></a>[Scrum](#fyfq-1705938223773)

<a name="e95a-1709312409418"></a>[逆向工程](#d5ko-1705938215067)

<a name="34da-1709312409420"></a>[实现级](#os3c-1706090901666)

<a name="0yts-1709312409422"></a>[结构级](#irxb-1706090905276)

<a name="4knl-1709312409424"></a>[功能级](#rk8d-1706090908958)

<a name="dnow-1709312409426"></a>[领域级](#k3pt-1706090912460)

<a name="rasr-1709312409428"></a>[净室软件工程](#tybd-1705938215235)

<a name="crkc-1709312409430"></a>[需求工程](#ochn-1705940085547)

<a name="rsmg-1709312409432"></a>[.需求获取](#xdlf-1705940054108)

<a name="x0lh-1709312409434"></a>[用户面谈 ](#s1uq-1706090846730)

<a name="lmla-1709312409437"></a>[联合需求计划(JRP) ](#vuil-1706090851858)

<a name="hrec-1709312409439"></a>[问卷调查 ](#gpxg-1706090851859)

<a name="ndll-1709312409441"></a>[现场观察   ](#mg9n-1706090851860)

<a name="k5pg-1709312409443"></a>[原型化方法        ](#3ww6-1706090851861)

<a name="xk9j-1709312409445"></a>[头脑风暴法](#0awr-1706090851863)

<a name="kw3k-1709312409447"></a>[.需求分析](#axny-1705940052332)

<a name="l4xi-1709312409449"></a>[1.功能模型(数据流图DFD)](#v8wz-1706090812929)

<a name="80ot-1709312409451"></a>[2.行为模型(状态转换图)](#3uls-1706090814821)

<a name="mnfw-1709312409453"></a>[3.实体模型(E-R图)](#69df-1706090816407)

<a name="ln2e-1709312409455"></a>[UML](#loq2-1705940640473)

<a name="gnci-1709312409457"></a>[需求定义](#4aeg-1706091062964)

<a name="txr4-1709312409459"></a>[需求验证](#ud2s-1706090947930)

<a name="qpy8-1709312409461"></a>[需求跟踪](#l03x-1705940634470)

<a name="iccw-1709312409463"></a>[需求变更管理](#muqf-1706093218719)

<a name="9eqx-1709312409465"></a>[软件系统建模](#ilpb-1706093190683)

<a name="ba9c-1709312409467"></a>[软件界面设计](#j396-1706094675778)

<a name="wn2z-1709312409469"></a>[结构化设计](#vqsk-1706094478028)

<a name="i5vn-1709312409471"></a>[内聚](#jczo-1706095018132)

<a name="4vp1-1709312409473"></a>[耦合](#qa8z-1706095402118)

<a name="wg8q-1709312409475"></a>[模块四要素](#g1dc-1706095391028)

<a name="in5c-1709312409477"></a>[面相对象设计](#ydwa-1706095870710)

<a name="wi3y-1709312409479"></a>[类的分类](#fouz-1706095958643)

<a name="lpep-1709312409481"></a>[基本过程](#9pd1-1706095996137)

<a name="llda-1709312409483"></a>[设计原则(同设计模式)](#k8lc-1706096001163)

<a name="2dzw-1709312409485"></a>[计算机](#qvol-1706095952165)

<a name="gref-1709312409487"></a>[计算机结构(★)](#ef1b-1706108352037)

<a name="v1ec-1709312409489"></a>[存储系统(★★★★)](#4kj7-1706108373776)

<a name="5ukl-1709312409491"></a>[层次化存储结构](#ucta-1706109825295)

<a name="udoi-1709312409493"></a>[Cache](#j9hn-1706109828962)

<a name="e0uq-1709312409495"></a>[主存编址计算](#pv51-1706109847372)

<a name="mz2j-1709312409497"></a>[磁盘基本结构与存储过程](#jcqv-1706108377026)

<a name="wmhh-1709312409499"></a>[磁盘优化分布存储](#puux-1706111215530)

<a name="fikr-1709312409501"></a>[磁盘单缓冲区与双缓冲区读取](#dvin-1706111222861)

<a name="uooh-1709312409503"></a>[磁盘移臂调度算法](#jr2r-1706111239137)

<a name="qcxn-1709312409505"></a>[数据传输控制方式（★)](#sz2k-1706111188014)

<a name="mbyo-1709312409507"></a>[总线（★★)](#cbul-1706108378755)

<a name="goz7-1709312409509"></a>[CISC与RISC(★)](#0hb5-1706108373778)

<a name="k8a3-1709312409511"></a>[流水线(★★)](#ernn-1706108380109)

<a name="dthc-1709312409513"></a>[校验码(★)](#grix-1706108381278)

<a name="97be-1709312409515"></a>[嵌入式（★)](#1p2v-1706108382511)

<a name="7nt6-1709312409518"></a>[计算机网络](#8vmt-1706198382356)

<a name="vxjh-1709312409520"></a>[TCP/IP协议族(7层/4层网络模型)](#a4es-1706106975412)

<a name="4u42-1709312409522"></a>[.TCP与UDP (★★★)](#vwim-1706198561289)

<a name="auyg-1709312409524"></a>[.DHCP与DNS (★★★)](#imsh-1706198537828)

<a name="qodo-1709312409526"></a>[网络规划与设计](#u7sd-1706198559304)

<a name="1exh-1709312409528"></a>[1.逻辑设计与物理设计(★★★★）](#nov8-1706198591905)

<a name="y4w5-1709312409530"></a>[2.层次化网络设计](#sy2g-1706198599196)

<a name="eewd-1709312409532"></a>[3.网络冗余设计](#igl7-1706257923205)

<a name="611a-1709312409534"></a>[网络存储（★★)](#zkxb-1706257899477)

<a name="prh2-1709312409536"></a>[磁盘阵列Raid](#fxma-1706198636789)

<a name="jn0c-1709312409538"></a>[lPv6 (★)](#vlem-1706259832461)

<a name="r1k9-1709312409540"></a>[网络接入(有线/无线)](#g438-1706198637653)

<a name="dhpv-1709312409542"></a>[综合布线(★)](#lxli-1706198497856)

<a name="1trz-1709312409544"></a>[网络技术扩展](#5dlt-1706198650540)

<a name="txuf-1709312409546"></a>[物联网(IOT)](#jgll-1706198586849)

<a name="ysgp-1709312409548"></a>[云计算(Saas/Paas/Iaas)](#pr8x-1706198586851)

<a name="p4aj-1709312409550"></a>[===系统架构设计case===](#1rnn-1706941312871)

<a name="eo2i-1709312409552"></a>[google L5设计一个分布式数据库架构](#nm5q-1706969255961)

<a name="zqxc-1709312409554"></a>[.what is total ordering(ordering first 100 custormer)](#g7yu-1707229908505)

<a name="rwxo-1709312409556"></a>[.why single leader()](#ebxf-1707230056989)

<a name="6pho-1709312409558"></a>[.request router](#ttmg-1707230034624)

<a name="vvzk-1709312409560"></a>[.variations](#aftd-1707229925082)

<a name="jsh9-1709312409562"></a>[1.Failover handing](#uk2k-1707457488655)

<a name="6trd-1709312409564"></a>[2.Reblancing after new node added](#btbd-1707457496651)

<a name="nzm7-1709312409566"></a>[3.Leaderless for heavy write-shard](#moaq-1707457524278)

<a name="xh0f-1709312409568"></a>[4.TicketMasler (and total ordering is necessary](#wyvq-1707458882987)

<a name="8l2u-1709312409570"></a>[===数据密集型应用===](#sswx-1706094478181)

<a name="el2e-1709312409572"></a>[第一部分 数据系统的基石](#unbe-1677787447006)

<a name="pe82-1709312409574"></a>[1.可靠性、可拓展性、可维护性能](#kwfx-1677787447007)

<a name="l7f6-1709312409576"></a>[-功能性需求：CRUD](#lykw-1644227240038)

<a name="tqe0-1709312409578"></a>[-非功能性需求：安全性，可靠性，合规性，可扩展性，兼容性和可维护性](#b2tu-1644227249556)

<a name="pbai-1709312409580"></a>[.可靠性：](#qqm5-1644227303238)

<a name="xmza-1709312409582"></a>[硬件故障](#7xms-1644228225080)

<a name="b9n6-1709312409584"></a>[软件错误](#dfpv-1708357497902)

<a name="nwrj-1709312409586"></a>[人为错误(如何让系统变得可靠)](#drpl-1708357507365)

<a name="xate-1709312409588"></a>[如何让系统变得可靠：](#pqmh-1708523552230)

<a name="m1nn-1709312409590"></a>[。最小化犯错机会的方式设计系统,  但如果限制太多，人们可能会忽略它们的好处而绕开，很难把握其中微妙的平衡](#i4we-1708358144376)

<a name="yxoi-1709312409592"></a>[。在易错地方和可能导致失效的地方解耦decouple,提供非生产环境沙箱sandbox-虚拟化环境，隔离真实系统进行安全测试](#xzfa-1708358243121)

<a name="d6mu-1709312409594"></a>[。彻底的测试，单元测试，集成测试，手动测试，自动化测试覆盖边缘场景corner case.](#9jaa-1708358634289)

<a name="bpiu-1709312409597"></a>[。滚动发布，快速回滚](#zlp4-1708358698137)

<a name="bqvu-1709312409599"></a>[。配置详细和明确的监控](#40us-1708358954660)

<a name="mzqh-1709312409601"></a>[。良好的管理和充分的培训。一个复杂而重要的方面，但超出本书的范围](#o66x-1708358967000)

<a name="ltdx-1709312409603"></a>[可靠性有多重要](#x7co-1708357515795)

<a name="q2us-1709312409605"></a>[造成客户巨大损失-阿里云宕机造成的用户损失](#nc0w-1708358745350)

<a name="qsnl-1709312409607"></a>[家长将孩子照片存储在你的应用李，数据库损坏，客户有何体验，他们可能会知道如何从备份恢复吗？](#qopp-1708358856827)

<a name="nuqh-1709312409609"></a>[.可扩展性： ](#dsae-1708357483848)

<a name="kc8x-1709312409611"></a>[描述负载(tps-推特主页时间线扇出-查询性能优化)](#vja4-1708356470840)

<a name="lc2x-1709312409613"></a>[描述性能](#s6un-1708356581594)

<a name="s7yu-1709312409615"></a>[吞吐量throughput](#fcez-1708523606684)

<a name="inaq-1709312409617"></a>[响应时间 response time.](#k30f-1708523620292)

<a name="ypjy-1709312409619"></a>[响应时间的高位百分点（也称为尾部延迟tail latencies](#bogk-1708523658968)

<a name="gqqr-1709312409621"></a>[.可维护性：](#k1dg-1708355783343)

<a name="qmea-1709312409623"></a>[2.数据模型与查询语言](#jufm-1677787447008)

<a name="aoyt-1709312409625"></a>[-关系模型](#pgu6-1699844351041)

<a name="5bhj-1709312409627"></a>[-NoSql (es,redis)](#kfpd-1644410618294)

<a name="k9og-1709312409629"></a>[1.文档数据库:MongoDB](#0p23-1644410807294)

<a name="mxwp-1709312409631"></a>[  2.图形数据库 ：](#09bl-1644410666587)

<a name="uj8m-1709312409633"></a>[-其它模型(基因序列)](#6fxw-1644410924417)

<a name="o0bj-1709312409635"></a>[3.存储与检索](#sm0u-1677787447009)

<a name="bmbi-1709312409637"></a>[-优化事务处理（OLTP）transaction ](#bhcv-1644935436804)

<a name="ak75-1709312409639"></a>[1.OLTP系统通常面向用户，大量的请求。](#tbhw-1699844517372)

<a name="kocn-1709312409641"></a>[2.磁盘寻道时间往往是这里的瓶颈。](#fnev-1644935714127)

<a name="831d-1709312409643"></a>[3.应用程序使用某种键来请求记录，存储引擎使用索引来查找所请求额键的数据。](#cjwp-1644935609899)

<a name="uacs-1709312409645"></a>[-优化分析（OLAP）analys](#jg7s-1699844443567)

<a name="pzcf-1709312409647"></a>[1.列式储存(投影操作，压缩技术，聚合过滤)](#pjd1-1703887811615)

<a name="lwwp-1709312409649"></a>[-OLTP两大主流学派的存储引擎：](#8sgm-1644935924013)

<a name="3utj-1709312409651"></a>[1.日志结构学派](#i55y-1644935943748)

<a name="gq7m-1709312409653"></a>[2.就地更新学派](#h3il-1644935977285)

<a name="tll4-1709312409655"></a>[4.编码（序列化）与演化(XML,JSON,CSV)](#lbs1-1677787447010)

<a name="nkhb-1709312409657"></a>[第二部分 分布式数据](#4p9n-1677787447012)

<a name="qdt0-1709312409659"></a>[1.高可用性/容错](#o4ag-1646310813851)

<a name="9ijc-1709312409661"></a>[2.断开连接的操作](#snwm-1646310894841)

<a name="wuvt-1709312409663"></a>[3.减少延迟(节点近)](#evly-1646310918322)

<a name="z1lc-1709312409665"></a>[4.可拓展性](#itsh-1646310968967)

<a name="m1wv-1709312409667"></a>[.拓展至更高的载荷](#gjis-1708362947856)

<a name="35bq-1709312409669"></a>[垂直扩展scale up ：购买更强大的机器 cpu](#mgia-1708362999715)

<a name="ci2i-1709312409671"></a>[共享内存架构shared-memory architecture：许多处理器、内存和磁盘再同一操作系统下相互连接，共享内存和磁盘](#pdo8-1708363038596)

<a name="r6i0-1709312409673"></a>[共享磁盘share-disk architecture：独立处理器和内存，数据存储在机器之间共享的磁盘阵列上，磁盘通过快速网络连接。数仓](#wgwl-1708363065800)

<a name="cfxe-1709312409675"></a>[无共享架构](#klw2-1708363340866)

<a name="zoxf-1709312409678"></a>[.复制VS分区](#gbgq-1646311175182)

<a name="xd8f-1709312409680"></a>[5.复制](#gd4q-1708363438406)

<a name="mw4u-1709312409682"></a>[.领导者与追随者-单主复制](#9hbs-1708441077626)

<a name="1kok-1709312409684"></a>[客户端将所有写入操作发送到单个节点（领导者），该结点将数据更改事件流发送到其它副本（追随者）。](#aucb-1708528116000)

<a name="jfq0-1709312409686"></a>[读取可以再任何副本中执行，但从追随者读取可能是陈旧的 （最终一致性问题）](#wgge-1646311567456)

<a name="umlo-1709312409688"></a>[.同步复制与异步复制](#cbey-1646310922523)

<a name="sbzy-1709312409690"></a>[.设置新从库(快照复制+caught up binlog)](#j5o0-1704983008475)

<a name="kvc3-1709312409692"></a>[.处理宕机节点](#bcod-1708442233018)

<a name="p1ax-1709312409694"></a>[从库失效：追赶恢复](#5ufz-1708443850274)

<a name="ho4v-1709312409696"></a>[主库失效：故障切换failover](#udix-1708443860752)

<a name="cwer-1709312409698"></a>[自动切换步骤：1.确认主库失效](#w3sj-1708523445192)

<a name="waoh-1709312409700"></a>[2.选举新主库：共识](#y3qn-1708523480847)

<a name="isq0-1709312409702"></a>[3.配置系统启用新主库](#wua6-1708523497956)

<a name="lko7-1709312409704"></a>[failover的麻烦：1.异步复制数据丢失](#z7mn-1708523814309)

<a name="yqv6-1709312409706"></a>[2.自增主键冲突](#mnjx-1708523836932)

<a name="fvaq-1709312409708"></a>[3.脑裂split brain](#dbhg-1708523873194)

<a name="kcd5-1709312409710"></a>[4.如何设置超时](#561v-1708523878338)

<a name="er5p-1709312409712"></a>[.复制日志的实现](#8mem-1708442228760)

<a name="sveq-1709312409714"></a>[基于语句的复制(每个写入请求语句statment)](#k8yo-1708524004340)

<a name="skof-1709312409716"></a>[记录每个写入请求语句statment，语句日志传输给从库](#hcqe-1708524155632)

<a name="re0p-1709312409718"></a>[问题：非确定函数nondeterministic, NOW()  RAND()](#9xml-1708524182083)

<a name="udpb-1709312409720"></a>[    自增列- 造成差异](#il4a-1708524271564)

<a name="uumz-1709312409722"></a>[副作用的语句：用户自定义函数，触发器，存储过程](#azmh-1708524331636)

<a name="z1p2-1709312409724"></a>[解决: 用固定值替换](#rcfb-1708524371120)

<a name="drpf-1709312409726"></a>[  如语句存在任何不确定性，切换到基于行的数据](#6uy2-1708524426849)

<a name="1xb1-1709312409728"></a>[传输预写式日志(WAL)](#rnmz-1708524013585)

<a name="r74d-1709312409730"></a>[日志存储引擎SSTables LSM树](#hze4-1708524498278)

<a name="bzm8-1709312409732"></a>[磁盘块的B树  WAL, 崩溃恢复](#qzop-1708524541132)

<a name="9wop-1709312409734"></a>[逻辑日志复制(基于行)](#a3ng-1708524040960)

<a name="c6hc-1709312409736"></a>[binlog](#jiiu-1708524648209)

<a name="mcug-1709312409738"></a>[基于触发器的复制](#ezoi-1708524083973)

<a name="qoct-1709312409743"></a>[.复制延迟问题(解决方法都是反分布式，或者趋于单机一致性。数据一致性模型：https://jepsen.io/consistency)](#https://jepsen.io/consistency)

<a name="o1b5-1709312409745"></a>[读己之写(读主库或带写时间戳查询)](#w5nz-1708525244967)

<a name="dyzh-1709312409747"></a>[写后从旧副本读取数据-未同步  ](#25nj-1708526407050)

<a name="datt-1709312409749"></a>[解决：写后读read after write 一致性 或叫做 read your write consistency 防止这种异常](#4st1-1708525569674)

<a name="woay-1709312409751"></a>[1.都从主库读。适用仅由用户本人编辑的数据，如个人信息。大部分内容从主库读不适用，扩容读无效果](#v4r0-1708525736897)

<a name="eldy-1709312409753"></a>[2. 扩容读需要保证更新时间，监控复制延迟，防止滞后超过一分钟从从库发出查询](#vqjs-1708525818133)

<a name="hs5u-1709312409755"></a>[3. 客户端记录写入时间戳，系统确保从库提供查询时，版本时间已覆盖，否则从另一个从库读，或者等待caught up-  等待不就相当弱可用状态，且时钟不可靠](#nmrh-1708525971734)

<a name="mjfa-1709312409757"></a>[4. 副本在多个数据中心，复杂度高，都需经过主库IDC](#wmu9-1708526095856)

<a name="vdda-1709312409759"></a>[单调读(基于id散列路由同一副本)](#kwrd-1708525264596)

<a name="lexe-1709312409761"></a>[先读到最新副本，后读到旧副本感觉数据消失](#npwe-1708527802311)

<a name="f0ta-1709312409763"></a>[A看到B评论后消失，时光倒流moving backward in time ](#4cn0-1708526272081)

<a name="qcpi-1709312409766"></a>[解决：单调读monotonic reads总是从同一个副本进行读取(基于用户散列id，如果副本失效则重新路由)](#drqk-1708526396300)

<a name="jbvr-1709312409768"></a>[  比强一致性(同步复制/类比单机)弱，比最终一致性更强](#s6u3-1708526566643)

<a name="ekaz-1709312409770"></a>[一致前缀读(因果关系写到相同分区)](#bfps-1708525268614)

<a name="ekow-1709312409772"></a>[不同分片副本同步先后问题导致读顺序错误](#rqcm-1708527879976)

<a name="pgqj-1709312409774"></a>[分区partition/分片sharded数据库中的一个特殊问题，全局写入顺序](#bwov-1708526677620)

<a name="ntqo-1709312409776"></a>[分区主库1写入 A:你吃饭了吗？ 分区主库2写入B:没有。 分区1副本同步主库1落后分区2副本同步主库2    C读取1副本: 没有，后读取2副本。你吃饭了吗？](#7e9o-1708526727984)

<a name="irqy-1709312409778"></a>[解决：确保因果关系都写入到相同分区](#turn-1708527108521)

<a name="1niq-1709312409780"></a>[复制延迟解决方案](#a2la-1708525420248)

<a name="l0vr-1709312409782"></a>[趋于反分布式，局部或者部分看做一个单机，做到强一致性](#x8ng-1708527233293)

<a name="j4ca-1709312409784"></a>[写后读。](#gecf-1708527304184)

<a name="qkfg-1709312409786"></a>[数据库通过事务提供强大保证。](#zsq6-1708527307246)

<a name="lxl5-1709312409788"></a>[.多主复制(主主复制，互为副本-写冲突。多主复制被认为是危险的领域)](#pbfd-1708528009698)

<a name="srgu-1709312409790"></a>[多主复制的应用场景](#kxkx-1708441627686)

<a name="yzn1-1709312409792"></a>[运维多个数据中心(IDC-主主间复制需要处理写冲突）](#xrso-1708700002291)

<a name="rvvl-1709312409794"></a>[性能(多活配置，写操作在本地IDC处理，其他IDC异步复制，性能更好)](#06t6-1708700132681)

<a name="csnd-1709312409796"></a>[容忍IDC停机](#9sww-1708700267631)

<a name="udfv-1709312409798"></a>[容忍网络问题(临时的网络中断不会妨碍正在写入的处理)](#dtkl-1708700295371)

<a name="htel-1709312409800"></a>[需要离线操作的客户端(支持多个终端离线操作couchDB)](#knxa-1708700020273)

<a name="h1w7-1709312409802"></a>[协同编辑](#hvwb-1708700115895)

<a name="1mf8-1709312409804"></a>[处理写冲突(A将标题从1改2,B将1改3)](#fdot-1708700612321)

<a name="95tr-1709312409806"></a>[同步于异步冲突检测](#u8bc-1708700824251)

<a name="gys3-1709312409808"></a>[同步：单主程序复制 - 不允许每个副本独立接受写入](#wfgd-1708700957597)

<a name="9yq8-1709312409810"></a>[异步：独立接受写入- 异步检测，但为时已晚](#x6is-1708701017804)

<a name="cn62-1709312409812"></a>[避免冲突(特定记录写入都通过同一个领导者，主库切换或者用户迁移至更近的主库时会有同时写入的可能性)](#xg2a-1708700840681)

<a name="pgwg-1709312409814"></a>[收敛convergent至一致的状态(副本主库和其副本在复制完成时收敛至一个相同的最终值)](#ucfn-1708700844474)

<a name="fq98-1709312409816"></a>[最后写入胜利LWW,last write wins- 给每个写入一个唯一id, 挑选最高ID的写入作为胜利者，并丢弃其他写入-数据丢失](#cbla-1708701376316)

<a name="novy-1709312409818"></a>[为每个副本分配一个唯一ID,ID编号更高的具有高优先级。数据丢失](#40po-1708701481447)

<a name="8pd6-1709312409820"></a>[将值合并在一起](#p4m4-1708701593939)

<a name="sbze-1709312409822"></a>[记录冲突，并编写解决逻辑代码。如通过提醒用户方式](#8fcs-1708701611999)

<a name="pgz7-1709312409824"></a>[自定义冲突解决逻辑](#yrdi-1708700860148)

<a name="6b1w-1709312409826"></a>[自定义冲突解决逻辑(complex)](#t4i7-1708702160004)

<a name="o0nl-1709312409828"></a>[写时执行-后台处理](#pdql-1708702370625)

<a name="juwy-1709312409830"></a>[读时执行-提供多版本用户选择，回写数据库](#sksk-1708702376293)

<a name="k2ju-1709312409832"></a>[亚马逊购物车移除的商品重新出现](#4bqp-1708702425059)

<a name="husu-1709312409834"></a>[什么是冲突(两个领导者预订同一个会议室，7章看冲突实例12章看检测解决)](#6x4i-1708700867996)

<a name="m2tg-1709312409836"></a>[多主复制拓扑](#o41a-1708702111509)

<a name="ayyv-1709312409838"></a>[环形，星型，all to all -mysql仅支持环形](#5feh-1708702903239)

<a name="w32b-1709312409840"></a>[问题：多主复制时，可能在某些副本中写入错误的顺序。like A写主库1，B写主库2，主库3先同步2，再同步1。类似一致前缀读。](#ddyu-1708702949257)

<a name="adi1-1709312409842"></a>[解决：时间戳是不够的-不可靠时钟，使用一种称为版本向量(version vectors)的技术-检测并发写入](#ghp3-1708703247102)

<a name="ytpx-1709312409844"></a>[无主复制leaderless](#bfz8-1708759285067)

<a name="ni2q-1709312409846"></a>[Amazon的Dynomo系统。](#cvru-1708759359537)

<a name="blan-1709312409848"></a>[Riak, Cassandra，Voldmort 也称为Dynamo风格。](#wf6o-1708759707666)

<a name="spnr-1709312409850"></a>[类型1：客户端直接将写入发送到几个副本中](#xpqf-1708760120711)

<a name="snik-1709312409853"></a>[类型2：coordinator协调者节点代表客户端写入。](#pl2z-1708760121090)

<a name="phm2-1709312409855"></a>[当节点故障时写入数据库(仲裁写⼊，法定读取，并在节点中断后读修复。)](#qgpe-1708760989905)

<a name="0oz8-1709312409857"></a>[如果主从复制，主故障/重启系统更新 则需进行故障切换](#zfuz-1708760396929)

<a name="qijo-1709312409859"></a>[无主复制： userA set piture_url   -> replica1 ok    Then version=7](#3soj-1708760452090)

<a name="b9oq-1709312409861"></a>[           user set piture_url   -> replica2 ok  Then version=7](#4f05-1708760543198)

<a name="qaok-1709312409863"></a>[user set piture_url   -> replica3 offline  fail   version= 6](#ynls-1708759898772)

<a name="spvx-1709312409865"></a>[    userB get piture  :  rp3(version6) rp1(version7)  rp2(version7)  Than fix rp3 value to version7](#e1ur-1708760618873)

<a name="mg5o-1709312409867"></a>[ 读修复和反熵(失效节点重新连机后如何caught up)](#tyv3-1708760780373)

<a name="26cq-1709312409869"></a>[读修复like userB get piture fixed rp3](#wjho-1708761214792)

<a name="5ndy-1709312409871"></a>[反熵 后台进程不断查找副本之间的数据差异。Voldmort无反熵过程，副本可能丢失数据](#xblj-1708761286988)

<a name="xxqb-1709312409873"></a>[ 读写的法定人数（仲裁）](#w3ia-1708761120623)

<a name="gepo-1709312409875"></a>[仲裁一致性的局限性-最终一致，更强的保证需要事务或共识](#oj1i-1708759830121)

<a name="j506-1709312409877"></a>[松散法定人数与带提示的接力](#cu5q-1708759841416)

<a name="zdvh-1709312409879"></a>[运维多个数据中心-将写入发送到所有副本，仅需本地IDC内法定节点确认](#kzki-1708761744887)

<a name="rj3k-1709312409881"></a>[检测并发写入](#pt1k-1708759856530)

<a name="hish-1709312409883"></a>[Dynamo风格的数据存储，没有明确定义的顺序。](#mu89-1708761978075)

<a name="depr-1709312409885"></a>[userA set x=A   get x](#dbni-1708763823783)

<a name="fvww-1709312409887"></a>[rp 1 A ok    B unresponsive   A](#auce-1708763993783)

<a name="zayk-1709312409889"></a>[rp2 A ok   B OK  B](#kteo-1708764011894)

<a name="sjjp-1709312409891"></a>[rp3 B ok A ok A](#9xyy-1708764019308)

<a name="qyaq-1709312409893"></a>[userB set x=B ](#esiv-1708702764305)

<a name="hyzf-1709312409895"></a>[最后写入胜利(丢弃并发写入)](#wd1i-1708764197180)

<a name="p54f-1709312409897"></a>[LLW 无法确定真实排序，强制排序，选择最新的最大时间戳，并丢弃较早的任何写入.Cassandra唯一支持的方式，Riak可选](#uzhw-1708874432788)

<a name="2poo-1709312409899"></a>[缺点：数据丢失 ](#henp-1708874594301)

<a name="kmjo-1709312409901"></a>[此前发生的关系和并发](#hzwp-1708764215825)

<a name="6q4l-1709312409903"></a>[因果依赖(causally dependent)  如果B后发与A, 则B因果依赖A, ](#3wp0-1708874672763)

<a name="9woh-1709312409905"></a>[如果是并发，则存在需要解决的冲突](#1wzv-1708875051673)

<a name="hvil-1709312409907"></a>[捕获此前发生的关系](#j2r6-1708764228505)

<a name="dnqu-1709312409909"></a>[捕获两个客户端间的因果关系，同时编辑购物车(示例为单副本)](#vv7q-1708875756229)

<a name="q7i1-1709312409911"></a>[合并同时写入的值](#zp0i-1708874374616)

<a name="nupb-1709312409913"></a>[客户端需额外工作，合并并发写入的值来擦屁股。Riak称这些并发值兄弟(sibings)](#wawo-1708876272614)

<a name="qjtt-1709312409915"></a>[版本向量](#arlv-1708874381589)

<a name="r2cp-1709312409917"></a>[所有副本的版本号集合称为版本向量(version vector)](#b1ov-1708700703636)

<a name="v4ad-1709312409919"></a>[7.事务](#7qvp-1708523954496)

<a name="bilq-1709312409921"></a>[.简化故障失败的机制-强大的事务！！！！！！！](#du4g-1704983767151)

<a name="a8hy-1709312409923"></a>[.事务的棘手问题](#k9de-1704984009883)

<a name="2fdl-1709312409925"></a>[原⼦性（Atomicity）](#65nh-1704984028565)

<a name="5wok-1709312409927"></a>[⼀致性（Consistency）](#qeub-1646310871673)

<a name="53s2-1709312409929"></a>[—致性这个词重载的很厉害:](#yyl1-1708878763788)

<a name="1m1j-1709312409931"></a>[隔离性（Isolation）](#rpju-1646310871817)

<a name="hqrs-1709312409933"></a>[持久性（Durability）](#aq1q-1646310872064)

<a name="16fc-1709312409936"></a>[8.分布式系统的麻烦](#enui-1704985776096)

<a name="ujn5-1709312409938"></a>[9.一致性共识](#rp9s-1705080859004)

<a name="krpm-1709312409940"></a>[分布式事务与共识](#cys8-1705080619829)

<a name="ogol-1709312409942"></a>[2PC提交](#bjec-1705081008345)

<a name="tthw-1709312409944"></a>[3PC提交](#dyd0-1705118358884)

<a name="4wnm-1709312409946"></a>[实践中的分布式事务](#pudp-1705080909535)

<a name="rfki-1709312409948"></a>[XA事务(扩展架构（eXtended Architecture)](#ozc0-1705080997483)

<a name="g3ls-1709312409950"></a>[怀疑时持有锁](#ssso-1705081563263)
...
<a name="k0op-1709312304164"></a>**.  CASmysql版本号实现 (数据库update锁+update原子性）**
...
<a name="t4at-1709312672885"></a>-读写锁与copy on write适用于写不依赖于读，令写是原子操作(单写原子性+锁隔离性)。写时复制则令读无需加锁，读性能更高。
...
<a name="occj-1709307350172"></a>**.读写锁（ReadWrite Lock）：**
...
<a name="hdj8-1708940956650"></a><a name="7qvp-1708523954496"></a>**7.事务**

<a name="du4g-1704983767151"></a>**.简化故障失败的机制-强大的事务！！！！！！！**

<a name="rfev-1704983016027"></a>数据库软件、硬件可能在任意时刻发⽣故障（包括写操作进⾏到⼀半时）。 -回滚，原子性  undolog， 
...
<a name="rpud-1708940366352"></a><a name="offx-1708940363646"></a><a name="5xk9-1646310922755"></a><a name="vo8p-1704983742288"></a>**事务（transaction）** ⼀直是简化这些问题的⾸选机制。整个事务要么成功（**提交（commit）**）要么失败（**中⽌（abort）**，**回滚（rollback）**）
...
<a name="yyl1-1708878763788"></a>**—致性这个词重载的很厉害:**
...
<a name="8sbn-1709306957869"></a><a name="rpju-1646310871817"></a>**隔离性（Isolation）**

<a name="wbo9-1704984301328"></a>**同时执⾏的事务是相互隔离的，快照隔离（snapshot isolation）** 的功能-MVCC，**这是⼀种⽐可序列化更弱的保证**【8,11】

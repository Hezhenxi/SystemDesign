...
<a name="3060-1621846615933"></a><a name="miup-1713164057206"></a>[一.数据库设计](#jeyl-1677787446995)

<a name="hgts-1713164057208"></a>[1. 关系型数据库](#5hya-1677787446996)

<a name="qc0l-1713164057211"></a>[.E-R图，由台湾工程师提出的设计概念](#ohc5-1621692571287)

<a name="076l-1713164057213"></a>[.流程图-业务逻辑相关，系统用户动作。抽象出E-R图](#5ocb-1645598528868)

<a name="ri2d-1713164057215"></a>[1.1 E-R图 ](#gzqe-1677787446997)

<a name="ksgf-1713164057217"></a>[1.根据名词抽象出实体](#r1ac-1621692724628)

<a name="8ceo-1713164057219"></a>[2.名词找属性](#d2fl-1621692745600)

<a name="71fi-1713164057221"></a>[3.实体间联系](#dwkp-1621692752824)

<a name="jxiv-1713164057223"></a>[.状态图](#53bo-1621692829033)

<a name="vhhb-1713164057225"></a>[1.2 转化成数据库设计（公式）](#c2cy-1677787446998)

<a name="vxkm-1713164057227"></a>[.1 对1 关系 往记录少的乙方加主键](#xmox-1621692858500)

<a name="bz7l-1713164057229"></a>[.1对n 关系 ，往 n 实体加关联主键 ](#mdr8-1621692924289)

<a name="vvxi-1713164057231"></a>[. n对 m 关系，需要一个关联表作映射关联](#hd3i-1621692960576)

<a name="nhh2-1713164057233"></a>[二.系统优化](#cdso-1677787447000)

<a name="xnkb-1713164057235"></a>[应用整体的优化](#3qep-1642647362896)

<a name="juzc-1713164057237"></a>[-cpu -> 纳秒级别](#knge-1642647371136)

<a name="unrs-1713164057239"></a>[1.多线程和并发编程](#ovup-1704437622969)

<a name="tqfx-1713164057241"></a>[2.JNI ](#ufpl-1704437634986)

<a name="urrn-1713164057243"></a>[3.JIT/AOT编译](#ixb5-1704437634987)

<a name="kfx6-1713164057245"></a>[4.算法优化](#kr1f-1704437634988)

<a name="1dau-1713164057247"></a>[-内存RAM（GB）/高速缓存(KB) -> 微秒级别(分级缓存)](#1xur-1642647384168)

<a name="ztbb-1713164057249"></a>[1.JVM内存管理](#7hi9-1704437851514)

<a name="enas-1713164057251"></a>[2.缓存](#te7c-1704437851799)

<a name="xfz4-1713164057253"></a>[3.消息中间件](#bqty-1704437851800)

<a name="izcd-1713164057255"></a>[-磁盘（TB）-> 毫秒级别(减少io次数,减少随机io-redolog)](#ziti-1642647439005)

<a name="80nn-1713164057257"></a>[1.减少磁盘io](#zups-1704437900079)

<a name="eado-1713164057259"></a>[2.数据压缩   ](#u3ok-1704438035018)

<a name="less-1713164057261"></a>[-网络传输/系统交互 -> 秒级 (减少io，连接池化) ](#irbp-1642647458856)

<a name="rvwo-1713164057263"></a>[1.减少网络请求   ](#6qil-1704438276193)

<a name="c0wp-1713164057265"></a>[2.使用CDN](#p5dt-1704438283633)

<a name="2gwq-1713164057267"></a>[3.Sockets异步通信                                      ](#zhp8-1704438283634)

<a name="goed-1713164057269"></a>[项目架构层面的优化](#3l0l-1704424353262)

<a name="ag24-1713164057271"></a>[-多级缓存](#8o8s-1704424396933)

<a name="d2dq-1713164057273"></a>[-应用层](#trcg-1704438366333)

<a name="dcyd-1713164057275"></a>[.代码优化](#68oa-1704438530062)

<a name="baxu-1713164057277"></a>[.数据库优化](#clmf-1704438530257)

<a name="zvbw-1713164057279"></a>[.日志优化](#md03-1704438530259)

<a name="j04b-1713164057281"></a>[-监控与调优](#ocux-1704438477879)

<a name="i11m-1713164057283"></a>[.性能监控：](#vdq2-1704438556836)

<a name="huwv-1713164057285"></a>[.分析和调优](#t29d-1704438557094)

<a name="kyk5-1713164057287"></a>[-分布式系统架构](#ukjf-1704424419442)

<a name="7lva-1713164057289"></a>[ .负载均衡](#a0bx-1704438677201)

<a name="ufea-1713164057292"></a>[.分布式缓存](#xn9x-1704438687994)

<a name="sgb4-1713164057294"></a>[.服务降级和容错](#zcdp-1704438687996)

<a name="mpra-1713164057296"></a>[读写层面](#six7-1642647372926)

<a name="7mul-1713164057298"></a>[.读优化](#g4uv-1704732583614)

<a name="vyh8-1713164057300"></a>[1.缓存](#uuzh-1704732602620)

<a name="lnpt-1713164057302"></a>[2.索引](#qobc-1704732605892)

<a name="e8ur-1713164057304"></a>[3.减少io/批量读/非阻塞io](#zlg9-1704732609048)

<a name="stbx-1713164057306"></a>[4.减少多余数据加载/列式存储读](#fpjd-1704732631316)

<a name="jk21-1713164057308"></a>[.写优化](#oyob-1704732598377)

<a name="9uuj-1713164057310"></a>[1.异步写](#6jmb-1704732509150)

<a name="ctdf-1713164057312"></a>[2.并发写](#tkwp-1704732723564)

<a name="gqg8-1713164057314"></a>[3.批量写](#hewz-1704732862030)

<a name="nx2r-1713164057316"></a>[4.优化算法和数据结构](#ccd8-1704732727854)

<a name="dx7c-1713164057318"></a>[5.缓存写](#eqd9-1704732736281)

<a name="mbbt-1713164057320"></a>[6.非阻塞io](#hyq8-1704732768916)

<a name="bfeq-1713164057322"></a>[1.分控系统优化复盘](#tncv-1677787447001)

<a name="6ha1-1713164057324"></a>[1.1 数据库系统](#ydq7-1677787447002)

<a name="lhtn-1713164057326"></a>[1.2 sql慢](#wxdd-1677787447003)

<a name="oqgr-1713164057328"></a>[1.3 接口慢](#olpb-1677787447004)

<a name="pqo5-1713164057330"></a>[高并发系统设计](#wrwk-1642647280506)

<a name="eent-1713164057332"></a>[1.满足大规模用户同时访问，提供良好响应时间和性能](#8ien-1704757782146)

<a name="etto-1713164057334"></a>[2.设计之初就要考虑伸缩性和容错性是非常重要的](#xy0g-1704757785190)

<a name="dsg5-1713164057336"></a>[.垂直伸缩 ](#wr12-1704947861599)

<a name="my07-1713164057338"></a>[.水平伸缩](#bizh-1704947959744)

<a name="e9zj-1713164057340"></a>[1.分布式架构](#fvzi-1704756770858)

<a name="8owm-1713164057342"></a>[.微服务架构](#ywzr-1704756872033)

<a name="vhic-1713164057344"></a>[.分布式计算](#xgna-1704756877646)

<a name="oows-1713164057346"></a>[2.负载均衡](#wnfy-1704756775272)

<a name="fzur-1713164057348"></a>[.负载均衡](#h6nf-1704756891918)

<a name="7n8n-1713164057350"></a>[.水平扩展](#c8zr-1704756894402)

<a name="bxir-1713164057352"></a>[3.数据库设计](#wxjk-1704756782840)

<a name="5sl9-1713164057354"></a>[.读写分离](#lxca-1704756910837)

<a name="z3fk-1713164057356"></a>[.数据库分片](#p7d2-1704756922362)

<a name="ogul-1713164057358"></a>[.缓存](#hxjt-1704756963988)

<a name="4yri-1713164057360"></a>[4.缓存优化](#iivs-1704756788012)

<a name="qfbw-1713164057362"></a>[.分布式缓存](#cvui-1704756971791)

<a name="u6ys-1713164057364"></a>[.本地缓存](#ysly-1704756979122)

<a name="3d2a-1713164057366"></a>[.缓存预热](#rqwj-1704756986363)

<a name="jljw-1713164057369"></a>[5.消息队列](#so9h-1704756800253)

<a name="twx0-1713164057371"></a>[.异步处理](#sxlo-1704756996000)

<a name="4irg-1713164057373"></a>[.削峰填谷](#llm2-1704757002994)

<a name="ndlq-1713164057375"></a>[6.分布式事务](#n39o-1704756805232)

<a name="odhi-1713164057377"></a>[.两阶段提交](#5bhj-1704757017700)

<a name="dxlv-1713164057379"></a>[.补偿事务](#becc-1704757028036)

<a name="irqg-1713164057381"></a>[7.高可用和容错](#wgkk-1704756813448)

<a name="cboz-1713164057383"></a>[.多地域部署](#akwz-1704757035393)

<a name="nppa-1713164057385"></a>[.设计容错](#3nxv-1704757055271)

<a name="wrao-1713164057387"></a>[1. 熔断限流](#g3xx-1704757371028)

<a name="igj9-1713164057389"></a>[2. 多节点服务](#jafy-1704757374368)

<a name="0ffb-1713164057391"></a>[8.监控和性能调优](#ilyo-1704756820772)

<a name="19xi-1713164057393"></a>[.实时监控](#kpwq-1704757064566)

<a name="eonj-1713164057395"></a>[.性能测试](#shf4-1704757066453)

<a name="h5ob-1713164057397"></a>[9.安全性设计](#2pry-1704756830245)

<a name="tkld-1713164057399"></a>[.防御性编程](#pkiw-1704757078583)

<a name="k5ln-1713164057401"></a>[.访问控制](#g4l1-1704757084924)

<a name="xwcy-1713164057403"></a>[10.水平扩展](#1tsd-1704756838192)

<a name="ynuz-1713164057405"></a>[.自动化部署](#r1dd-1704757092061)

<a name="gjor-1713164057407"></a>[.云服务](#7mhk-1704757104117)

<a name="ehba-1713164057409"></a>[高并发性能指标](#rpxb-1677787447005)

<a name="y4no-1713164057411"></a>[QPS(每秒请求)](#klnv-1704761369323)

<a name="4fra-1713164057413"></a>[TPS(每秒事务)](#zvlz-1704761369324)

<a name="ya35-1713164057415"></a>[RT(响应时间)](#gvrn-1704761369325)

<a name="zw3w-1713164057417"></a>[(原子操作)并发编程中保证数据一致性/安全的方法](#ysmj-1709309531982)

<a name="82rw-1713164057419"></a>[原子性+悲观锁：各种锁机制](#fdxy-1709308630108)

<a name="hleo-1713164057421"></a>[.（锁+事务/ 分布式锁+分布式事务）](#v06l-1709312268021)

<a name="op8r-1713164057423"></a>[.  CASmysql版本号实现 (前提是数据库的update已经是原子写：mysql update排它锁）](#k0op-1709312304164)

<a name="fk8r-1713164057425"></a>[原子性+乐观锁/不加锁: CAS原子操作(java原子类)，](#qth5-1709308703202)

<a name="uv8n-1713164057427"></a>[CAS底层实现原理](#g3uo-1709309147469)

<a name="x7qo-1713164057429"></a>[总线锁定（Bus Locking）：](#qpbw-1709308842021)

<a name="0doe-1713164057431"></a>[缓存一致性协议（Cache Coherence Protocol）：](#ikm2-1709308842025)

<a name="uoiq-1713164057433"></a>[指令序列化（Instruction Serialization）：](#wpeu-1709308842029)

<a name="cdpy-1713164057435"></a>[不同的场景适用哪种锁](#olfu-1709309769107)

<a name="imud-1713164057438"></a>[.共享数据的读写操作：](#y60t-1709309615585)

<a name="owh5-1713164057440"></a>[适用措施：读写锁（ReadWrite Lock）、互斥锁（Mutex）、原子操作、无锁算法。Copy on Write优化读写锁](#lqad-1709309615587)

<a name="9rxh-1713164057442"></a>[.并发容器的操作：](#fsfa-1709309615591)

<a name="s2e1-1713164057444"></a>[适用措施：线程安全的容器类（如ConcurrentHashMap、ConcurrentLinkedQueue）、原子操作。](#rs2n-1709309615593)

<a name="ffrd-1713164057446"></a>[.多个线程协作的场景：](#xdpv-1709309615597)

<a name="2oty-1713164057448"></a>[适用措施：信号量（Semaphore）、条件变量（Condition Variable）。](#uzlr-1709309615599)

<a name="gf6u-1713164057450"></a>[.分布式系统的并发操作：](#0aah-1709309615603)

<a name="ceym-1713164057452"></a>[适用措施：分布式锁、分布式事务。](#wlhe-1709309615605)

<a name="5wuu-1713164057454"></a>[.不可变数据的并发访问：](#angi-1709309615609)

<a name="bgnf-1713164057456"></a>[适用措施：不可变数据结构、原子操作。](#pga0-1709309615611)

<a name="ekks-1713164057458"></a>[.高性能要求的并发操作：](#pw5v-1709309615615)

<a name="m8pd-1713164057460"></a>[适用措施：无锁算法、并发数据结构。 -CAS乐观锁](#plv6-1709309615617)

<a name="e12h-1713164057462"></a>[互斥访问：](#62mg-1709309976431)

<a name="ah2x-1713164057464"></a>[.互斥锁（Mutex）：](#0qt3-1709307350160)

<a name="wwhm-1713164057466"></a>[.原子操作：](#7xva-1709307350164)

<a name="fe6z-1713164057468"></a>[.临界区（Critical Section）：](#r8cl-1709307350168)

<a name="yqdv-1713164057470"></a>[.读写锁（ReadWrite Lock）：主要用于避免脏读](#occj-1709307350172)

<a name="3jn4-1713164057472"></a>[.信号量（Semaphore）：](#vej9-1709307350176)

<a name="gcsu-1713164057474"></a>[.条件变量（Condition Variable）：](#ssge-1709307350180)

<a name="wov1-1713164057476"></a>[.无锁算法（Lock-Free Algorithms）：](#zk0j-1709307350184)

<a name="addm-1713164057478"></a>[.数据拷贝-写时复制（Copy-on-Write）：优化读写锁，写时复制且串行执行(锁)，读不加锁](#tiqo-1709307350188)

<a name="q609-1713164057480"></a>[.线程安全的数据结构：](#b8ca-1709307350192)

<a name="nshb-1713164057482"></a>[===系统架构设计师===](#nyrv-1709307688718)

<a name="db3b-1713164057484"></a>[系统工程与信息系统基础](#mpwu-1704949756608)

<a name="3tjc-1713164057486"></a>[.系统工程方法](#2gzz-1704980837071)

<a name="vbtr-1713164057488"></a>[.系统工程生命周期阶段](#mk93-1704952875199)

<a name="l2qo-1713164057490"></a>[.系统工程生命周期方法](#ny2c-1704952893636)

<a name="1tmi-1713164057492"></a>[.信息系统建设原则](#shmt-1704952904062)

<a name="crir-1713164057494"></a>[.信息系统开发方法](#itje-1704951812273)

<a name="kauc-1713164057496"></a>[原型法](#bnzq-1705819374009)

<a name="xq3l-1713164057498"></a>[结构化法-瀑布型](#ujj3-1705819377863)

<a name="8yev-1713164057500"></a>[形式化法-数模](#8wek-1705819398251)

<a name="7aqt-1713164057502"></a>[敏捷方法](#jeuk-1705819392097)

<a name="tvjj-1713164057504"></a>[.信息系统分类](#w8yd-1704980881013)

<a name="lxnv-1713164057506"></a>[业务处理系统TPS](#hlhq-1705819204285)

<a name="amno-1713164057508"></a>[管理信息系统MIS](#oksn-1705819204735)

<a name="gqyu-1713164057510"></a>[决策支持系统DSS](#lwm7-1705819204736)

<a name="3hwq-1713164057512"></a>[专家系统ES](#bmeu-1705819204737)

<a name="cfdb-1713164057514"></a>[办公自动化系统OAS](#kffq-1705819204738)

<a name="ldff-1713164057516"></a>[企业资源系统ERP](#k2px-1705819204739)

<a name="cygw-1713164057519"></a>[过程模型](#f98t-1704981918920)

<a name="rrty-1713164057521"></a>[瀑布模型](#yk4j-1705841608124)

<a name="wl61-1713164057523"></a>[V模型【瀑布变种-测试贯穿】](#oryp-1705841608705)

<a name="lkoq-1713164057525"></a>[原型模型](#b0cp-1705841621350)

<a name="ybnu-1713164057527"></a>[螺旋模型【原型+瀑布 风险】](#sfqi-1705841608707)

<a name="3brh-1713164057529"></a>[构件组装模型/基于构件的开发方法](#kbjw-1705841608709)

<a name="kimu-1713164057531"></a>[快速应用开发RAD【瀑布+构件组装】](#mvze-1705841627436)

<a name="mws5-1713164057533"></a>[统一过程/统一开发方法](#xici-1705841629815)

<a name="atkn-1713164057535"></a>[敏捷开发方法](#9jca-1705841608711)

<a name="amh9-1713164057537"></a>[XP](#28va-1705841590197)

<a name="teck-1713164057539"></a>[Scrum](#fyfq-1705938223773)

<a name="4vgk-1713164057541"></a>[逆向工程](#d5ko-1705938215067)

<a name="nk2l-1713164057543"></a>[实现级](#os3c-1706090901666)

<a name="ouyu-1713164057545"></a>[结构级](#irxb-1706090905276)

<a name="wk1r-1713164057547"></a>[功能级](#rk8d-1706090908958)

<a name="hywg-1713164057549"></a>[领域级](#k3pt-1706090912460)

<a name="5e20-1713164057551"></a>[净室软件工程](#tybd-1705938215235)

<a name="2hul-1713164057553"></a>[需求工程](#ochn-1705940085547)

<a name="ac16-1713164057555"></a>[.需求获取](#xdlf-1705940054108)

<a name="f7v0-1713164057557"></a>[用户面谈 ](#s1uq-1706090846730)

<a name="5s2l-1713164057559"></a>[联合需求计划(JRP) ](#vuil-1706090851858)

<a name="34pe-1713164057561"></a>[问卷调查 ](#gpxg-1706090851859)

<a name="qyli-1713164057563"></a>[现场观察   ](#mg9n-1706090851860)

<a name="4ita-1713164057565"></a>[原型化方法        ](#3ww6-1706090851861)

<a name="i0bd-1713164057567"></a>[头脑风暴法](#0awr-1706090851863)

<a name="scgx-1713164057569"></a>[.需求分析](#axny-1705940052332)

<a name="sbyp-1713164057571"></a>[1.功能模型(数据流图DFD)](#v8wz-1706090812929)

<a name="olrh-1713164057573"></a>[2.行为模型(状态转换图)](#3uls-1706090814821)

<a name="1z8t-1713164057575"></a>[3.实体模型(E-R图)](#69df-1706090816407)

<a name="ignz-1713164057577"></a>[UML](#loq2-1705940640473)

<a name="ji33-1713164057579"></a>[需求定义](#4aeg-1706091062964)

<a name="s4yc-1713164057581"></a>[需求验证](#ud2s-1706090947930)

<a name="so9u-1713164057583"></a>[需求跟踪](#l03x-1705940634470)

<a name="uu6u-1713164057586"></a>[需求变更管理](#muqf-1706093218719)

<a name="wqrs-1713164057588"></a>[软件系统建模](#ilpb-1706093190683)

<a name="q03n-1713164057590"></a>[软件界面设计](#j396-1706094675778)

<a name="fcps-1713164057592"></a>[结构化设计](#vqsk-1706094478028)

<a name="ulu9-1713164057594"></a>[内聚](#jczo-1706095018132)

<a name="rge1-1713164057596"></a>[耦合](#qa8z-1706095402118)

<a name="dw81-1713164057598"></a>[模块四要素](#g1dc-1706095391028)

<a name="8txj-1713164057600"></a>[面相对象设计](#ydwa-1706095870710)

<a name="iq8e-1713164057602"></a>[类的分类](#fouz-1706095958643)

<a name="klys-1713164057604"></a>[基本过程](#9pd1-1706095996137)

<a name="jlf9-1713164057606"></a>[设计原则(同设计模式)](#k8lc-1706096001163)

<a name="pfjr-1713164057608"></a>[计算机](#qvol-1706095952165)

<a name="t0aa-1713164057610"></a>[计算机结构(★)](#ef1b-1706108352037)

<a name="qeee-1713164057612"></a>[存储系统(★★★★)](#4kj7-1706108373776)

<a name="ve7f-1713164057614"></a>[层次化存储结构](#ucta-1706109825295)

<a name="lr2s-1713164057616"></a>[Cache](#j9hn-1706109828962)

<a name="xiwu-1713164057618"></a>[主存编址计算](#pv51-1706109847372)

<a name="eetn-1713164057620"></a>[磁盘基本结构与存储过程](#jcqv-1706108377026)

<a name="qgtb-1713164057622"></a>[磁盘优化分布存储](#puux-1706111215530)

<a name="qzgd-1713164057624"></a>[磁盘单缓冲区与双缓冲区读取](#dvin-1706111222861)

<a name="kkkz-1713164057626"></a>[磁盘移臂调度算法](#jr2r-1706111239137)

<a name="artv-1713164057628"></a>[数据传输控制方式（★)](#sz2k-1706111188014)

<a name="7qvg-1713164057630"></a>[总线（★★)](#cbul-1706108378755)

<a name="9zu7-1713164057632"></a>[CISC与RISC(★)](#0hb5-1706108373778)

<a name="dcqs-1713164057635"></a>[流水线(★★)](#ernn-1706108380109)

<a name="hjfm-1713164057637"></a>[校验码(★)](#grix-1706108381278)

<a name="lcbq-1713164057639"></a>[嵌入式（★)](#1p2v-1706108382511)

<a name="5hg7-1713164057641"></a>[计算机网络](#8vmt-1706198382356)

<a name="tt9a-1713164057643"></a>[TCP/IP协议族(7层/4层网络模型)](#a4es-1706106975412)

<a name="uqcu-1713164057645"></a>[.TCP与UDP (★★★)](#vwim-1706198561289)

<a name="fihs-1713164057647"></a>[.DHCP与DNS (★★★)](#imsh-1706198537828)

<a name="uxq5-1713164057649"></a>[网络规划与设计](#u7sd-1706198559304)

<a name="vsl0-1713164057651"></a>[1.逻辑设计与物理设计(★★★★）](#nov8-1706198591905)

<a name="67m1-1713164057653"></a>[2.层次化网络设计](#sy2g-1706198599196)

<a name="erym-1713164057655"></a>[3.网络冗余设计](#igl7-1706257923205)

<a name="yc66-1713164057657"></a>[网络存储（★★)](#zkxb-1706257899477)

<a name="ycwp-1713164057659"></a>[磁盘阵列Raid](#fxma-1706198636789)

<a name="c8dh-1713164057661"></a>[lPv6 (★)](#vlem-1706259832461)

<a name="6uhz-1713164057663"></a>[网络接入(有线/无线)](#g438-1706198637653)

<a name="kpkz-1713164057665"></a>[综合布线(★)](#lxli-1706198497856)

<a name="7c2r-1713164057667"></a>[网络技术扩展](#5dlt-1706198650540)

<a name="nshh-1713164057669"></a>[物联网(IOT)](#jgll-1706198586849)

<a name="bebd-1713164057671"></a>[云计算(Saas/Paas/Iaas)](#pr8x-1706198586851)

<a name="tp1m-1713164057673"></a>[===系统架构设计case===](#1rnn-1706941312871)

<a name="zdf2-1713164057675"></a>[google L5设计一个分布式数据库架构](#nm5q-1706969255961)

<a name="erjw-1713164057677"></a>[.what is total ordering(ordering first 100 custormer)](#g7yu-1707229908505)

<a name="nlx6-1713164057679"></a>[.why single leader()](#ebxf-1707230056989)

<a name="wpmx-1713164057682"></a>[.request router](#ttmg-1707230034624)

<a name="ksdh-1713164057684"></a>[.variations](#aftd-1707229925082)

<a name="tdut-1713164057686"></a>[1.Failover handing](#uk2k-1707457488655)

<a name="hh0y-1713164057688"></a>[2.Reblancing after new node added](#btbd-1707457496651)

<a name="qjts-1713164057690"></a>[3.Leaderless for heavy write-shard](#moaq-1707457524278)

<a name="v7zi-1713164057692"></a>[4.TicketMasler (and total ordering is necessary](#wyvq-1707458882987)

<a name="ch25-1713164057694"></a>[===数据密集型应用===](#sswx-1706094478181)

<a name="4ow1-1713164057696"></a>[第一部分 数据系统的基石](#unbe-1677787447006)

<a name="ny09-1713164057698"></a>[1.可靠性、可拓展性、可维护性能](#kwfx-1677787447007)

<a name="lx5s-1713164057700"></a>[-功能性需求：CRUD](#lykw-1644227240038)

<a name="vsbk-1713164057702"></a>[-非功能性需求：安全性，可靠性，合规性，可扩展性，兼容性和可维护性](#b2tu-1644227249556)

<a name="ejvg-1713164057704"></a>[.可靠性：](#qqm5-1644227303238)

<a name="lfmx-1713164057706"></a>[硬件故障](#7xms-1644228225080)

<a name="crtc-1713164057708"></a>[软件错误](#dfpv-1708357497902)

<a name="jbtr-1713164057710"></a>[人为错误(如何让系统变得可靠)](#drpl-1708357507365)

<a name="olv7-1713164057712"></a>[如何让系统变得可靠：](#pqmh-1708523552230)

<a name="dt4j-1713164057714"></a>[。最小化犯错机会的方式设计系统,  但如果限制太多，人们可能会忽略它们的好处而绕开，很难把握其中微妙的平衡](#i4we-1708358144376)

<a name="x8uh-1713164057716"></a>[。在易错地方和可能导致失效的地方解耦decouple,提供非生产环境沙箱sandbox-虚拟化环境，隔离真实系统进行安全测试](#xzfa-1708358243121)

<a name="fzl0-1713164057718"></a>[。彻底的测试，单元测试，集成测试，手动测试，自动化测试覆盖边缘场景corner case.](#9jaa-1708358634289)

<a name="gvay-1713164057721"></a>[。滚动发布，快速回滚](#zlp4-1708358698137)

<a name="feqp-1713164057723"></a>[。配置详细和明确的监控](#40us-1708358954660)

<a name="ydv3-1713164057725"></a>[。良好的管理和充分的培训。一个复杂而重要的方面，但超出本书的范围](#o66x-1708358967000)

<a name="xtyb-1713164057727"></a>[可靠性有多重要](#x7co-1708357515795)

<a name="zcz6-1713164057729"></a>[造成客户巨大损失-阿里云宕机造成的用户损失](#nc0w-1708358745350)

<a name="p3bi-1713164057731"></a>[家长将孩子照片存储在你的应用李，数据库损坏，客户有何体验，他们可能会知道如何从备份恢复吗？](#qopp-1708358856827)

<a name="cgtk-1713164057733"></a>[.可扩展性： ](#dsae-1708357483848)

<a name="gqxy-1713164057735"></a>[描述负载(tps-推特主页时间线扇出-查询性能优化)](#vja4-1708356470840)

<a name="uee1-1713164057737"></a>[描述性能](#s6un-1708356581594)

<a name="owrf-1713164057739"></a>[吞吐量throughput](#fcez-1708523606684)

<a name="by3p-1713164057741"></a>[响应时间 response time.](#k30f-1708523620292)

<a name="r68u-1713164057745"></a>[响应时间的高位百分点（也称为尾部延迟tail latencies](#bogk-1708523658968)

<a name="mjhj-1713164057747"></a>[.可维护性：](#k1dg-1708355783343)

<a name="ex68-1713164057750"></a>[2.数据模型与查询语言](#jufm-1677787447008)

<a name="jqzy-1713164057752"></a>[-关系模型](#pgu6-1699844351041)

<a name="ujsa-1713164057754"></a>[-NoSql (es,redis)](#kfpd-1644410618294)

<a name="oajb-1713164057756"></a>[1.文档数据库:MongoDB](#0p23-1644410807294)

<a name="nnhc-1713164057758"></a>[  2.图形数据库 ：](#09bl-1644410666587)

<a name="9wwn-1713164057760"></a>[-其它模型(基因序列)](#6fxw-1644410924417)

<a name="54rg-1713164057762"></a>[3.存储与检索](#sm0u-1677787447009)

<a name="11xs-1713164057764"></a>[-优化事务处理（OLTP）transaction ](#bhcv-1644935436804)

<a name="dup1-1713164057766"></a>[1.OLTP系统通常面向用户，大量的请求。](#tbhw-1699844517372)

<a name="zvzk-1713164057768"></a>[2.磁盘寻道时间往往是这里的瓶颈。](#fnev-1644935714127)

<a name="wbbe-1713164057770"></a>[3.应用程序使用某种键来请求记录，存储引擎使用索引来查找所请求额键的数据。](#cjwp-1644935609899)

<a name="gsma-1713164057772"></a>[-优化分析（OLAP）analys](#jg7s-1699844443567)

<a name="frzn-1713164057774"></a>[1.列式储存(投影操作，压缩技术，聚合过滤)](#pjd1-1703887811615)

<a name="zsrm-1713164057776"></a>[-OLTP两大主流学派的存储引擎：](#8sgm-1644935924013)

<a name="f7dk-1713164057778"></a>[1.日志结构学派](#i55y-1644935943748)

<a name="z4uo-1713164057780"></a>[2.就地更新学派](#h3il-1644935977285)

<a name="yzev-1713164057782"></a>[4.编码（序列化）与演化(XML,JSON,CSV)](#lbs1-1677787447010)

<a name="imhp-1713164057784"></a>[第二部分 分布式数据](#4p9n-1677787447012)

<a name="dkob-1713164057786"></a>[1.高可用性/容错](#o4ag-1646310813851)

<a name="6apv-1713164057788"></a>[2.断开连接的操作](#snwm-1646310894841)

<a name="j2rr-1713164057790"></a>[3.减少延迟(节点近)](#evly-1646310918322)

<a name="uibs-1713164057792"></a>[4.可拓展性](#itsh-1646310968967)

<a name="k4dv-1713164057794"></a>[.拓展至更高的载荷](#gjis-1708362947856)

<a name="wwvr-1713164057796"></a>[垂直扩展scale up ：购买更强大的机器 cpu](#mgia-1708362999715)

<a name="qig5-1713164057798"></a>[共享内存架构shared-memory architecture：许多处理器、内存和磁盘再同一操作系统下相互连接，共享内存和磁盘](#pdo8-1708363038596)

<a name="uyfa-1713164057800"></a>[共享磁盘share-disk architecture：独立处理器和内存，数据存储在机器之间共享的磁盘阵列上，磁盘通过快速网络连接。数仓](#wgwl-1708363065800)

<a name="t9o6-1713164057802"></a>[无共享架构](#klw2-1708363340866)

<a name="n2ww-1713164057804"></a>[.复制VS分区](#gbgq-1646311175182)

<a name="mink-1713164057806"></a>[5.复制](#gd4q-1708363438406)

<a name="nwdb-1713164057808"></a>[.领导者与追随者-单主复制](#9hbs-1708441077626)

<a name="jbsw-1713164057810"></a>[客户端将所有写入操作发送到单个节点（领导者），该结点将数据更改事件流发送到其它副本（追随者）。](#aucb-1708528116000)

<a name="ytmw-1713164057812"></a>[读取可以再任何副本中执行，但从追随者读取可能是陈旧的 （最终一致性问题）](#wgge-1646311567456)

<a name="okkt-1713164057814"></a>[.同步复制与异步复制](#cbey-1646310922523)

<a name="nb2t-1713164057816"></a>[.设置新从库(快照复制+caught up binlog)](#j5o0-1704983008475)

<a name="a1tt-1713164057818"></a>[.处理宕机节点](#bcod-1708442233018)

<a name="1vvt-1713164057820"></a>[从库失效：追赶恢复](#5ufz-1708443850274)

<a name="xopb-1713164057822"></a>[主库失效：故障切换failover](#udix-1708443860752)

<a name="p0cs-1713164057824"></a>[自动切换步骤：1.确认主库失效](#w3sj-1708523445192)

<a name="z74m-1713164057826"></a>[2.选举新主库：共识](#y3qn-1708523480847)

<a name="jack-1713164057828"></a>[3.配置系统启用新主库](#wua6-1708523497956)

<a name="whop-1713164057830"></a>[failover的麻烦：1.异步复制数据丢失](#z7mn-1708523814309)

<a name="i3sy-1713164057832"></a>[2.自增主键冲突](#mnjx-1708523836932)

<a name="8ri1-1713164057834"></a>[3.脑裂split brain](#dbhg-1708523873194)

<a name="zvyd-1713164057836"></a>[4.如何设置超时](#561v-1708523878338)

<a name="4lqr-1713164057839"></a>[.复制日志的实现](#8mem-1708442228760)

<a name="azdd-1713164057841"></a>[基于语句的复制(每个写入请求语句statment)](#k8yo-1708524004340)

<a name="easu-1713164057843"></a>[记录每个写入请求语句statment，语句日志传输给从库](#hcqe-1708524155632)

<a name="bxnm-1713164057845"></a>[问题：非确定函数nondeterministic, NOW()  RAND()](#9xml-1708524182083)

<a name="2mxp-1713164057847"></a>[    自增列- 造成差异](#il4a-1708524271564)

<a name="xv37-1713164057849"></a>[副作用的语句：用户自定义函数，触发器，存储过程](#azmh-1708524331636)

<a name="6n3v-1713164057851"></a>[解决: 用固定值替换](#rcfb-1708524371120)

<a name="cagx-1713164057853"></a>[  如语句存在任何不确定性，切换到基于行的数据](#6uy2-1708524426849)

<a name="z6t3-1713164057855"></a>[传输预写式日志(WAL)](#rnmz-1708524013585)

<a name="c24h-1713164057857"></a>[日志存储引擎SSTables LSM树](#hze4-1708524498278)

<a name="07dv-1713164057859"></a>[磁盘块的B树  WAL, 崩溃恢复](#qzop-1708524541132)

<a name="9ubw-1713164057861"></a>[逻辑日志复制(基于行)](#a3ng-1708524040960)

<a name="8vdj-1713164057863"></a>[binlog](#jiiu-1708524648209)

<a name="ibuu-1713164057865"></a>[基于触发器的复制](#ezoi-1708524083973)

<a name="uqok-1713164057870"></a>[.复制延迟问题(解决方法都是反分布式，或者趋于单机一致性。数据一致性模型：https://jepsen.io/consistency)](#https://jepsen.io/consistency)

<a name="6lds-1713164057872"></a>[读己之写(读主库或带写时间戳查询)](#w5nz-1708525244967)

<a name="kqg6-1713164057874"></a>[写后从旧副本读取数据-未同步  ](#25nj-1708526407050)

<a name="73f1-1713164057876"></a>[解决：写后读read after write 一致性 或叫做 read your write consistency 防止这种异常](#4st1-1708525569674)

<a name="h7iy-1713164057878"></a>[1.都从主库读。适用仅由用户本人编辑的数据，如个人信息。大部分内容从主库读不适用，扩容读无效果](#v4r0-1708525736897)

<a name="wfyd-1713164057880"></a>[2. 扩容读需要保证更新时间，监控复制延迟，防止滞后超过一分钟从从库发出查询](#vqjs-1708525818133)

<a name="yggn-1713164057882"></a>[3. 客户端记录写入时间戳，系统确保从库提供查询时，版本时间已覆盖，否则从另一个从库读，或者等待caught up-  等待不就相当弱可用状态，且时钟不可靠](#nmrh-1708525971734)

<a name="gjqw-1713164057884"></a>[4. 副本在多个数据中心，复杂度高，都需经过主库IDC](#wmu9-1708526095856)

<a name="y3ij-1713164057886"></a>[单调读(基于id散列路由同一副本)](#kwrd-1708525264596)

<a name="htex-1713164057888"></a>[先读到最新副本，后读到旧副本感觉数据消失](#npwe-1708527802311)

<a name="t9uu-1713164057890"></a>[A看到B评论后消失，时光倒流moving backward in time ](#4cn0-1708526272081)

<a name="1jai-1713164057892"></a>[解决：单调读monotonic reads总是从同一个副本进行读取(基于用户散列id，如果副本失效则重新路由)](#drqk-1708526396300)

<a name="tp3b-1713164057894"></a>[  比强一致性(同步复制/类比单机)弱，比最终一致性更强](#s6u3-1708526566643)

<a name="aqt0-1713164057896"></a>[一致前缀读(因果关系写到相同分区)](#bfps-1708525268614)

<a name="xfoc-1713164057898"></a>[consistent prefix reads](#q7p0-1711363121071)

<a name="o8hv-1713164057900"></a>[不同分片副本同步先后问题导致读顺序错误](#rqcm-1708527879976)

<a name="0pbf-1713164057902"></a>[分区partition/分片sharded数据库中的一个特殊问题，全局写入顺序](#bwov-1708526677620)

<a name="mnom-1713164057904"></a>[分区主库1写入 A:你吃饭了吗？ 分区主库2写入B:没有。 分区1副本同步主库1落后分区2副本同步主库2    C读取1副本: 没有，后读取2副本。你吃饭了吗？](#7e9o-1708526727984)

<a name="enjb-1713164057906"></a>[解决：确保因果关系都写入到相同分区](#turn-1708527108521)

<a name="qej6-1713164057908"></a>[复制延迟解决方案](#a2la-1708525420248)

<a name="evnt-1713164057910"></a>[趋于反分布式，局部或者部分看做一个单机，做到强一致性](#x8ng-1708527233293)

<a name="ylru-1713164057912"></a>[写后读。](#gecf-1708527304184)

<a name="qqjt-1713164057914"></a>[数据库通过事务提供强大保证。](#zsq6-1708527307246)

<a name="b969-1713164057916"></a>[.多主复制(主主复制，互为副本-写冲突。多主复制被认为是危险的领域)](#pbfd-1708528009698)

<a name="0sym-1713164057918"></a>[多主复制的应用场景](#kxkx-1708441627686)

<a name="zii3-1713164057920"></a>[运维多个数据中心(IDC-主主间复制需要处理写冲突）](#xrso-1708700002291)

<a name="2vhu-1713164057922"></a>[性能(多活配置，写操作在本地IDC处理，其他IDC异步复制，性能更好)](#06t6-1708700132681)

<a name="8m18-1713164057925"></a>[容忍IDC停机](#9sww-1708700267631)

<a name="ym9r-1713164057927"></a>[容忍网络问题(临时的网络中断不会妨碍正在写入的处理)](#dtkl-1708700295371)

<a name="jja2-1713164057929"></a>[需要离线操作的客户端(支持多个终端离线操作couchDB)](#knxa-1708700020273)

<a name="b9gv-1713164057931"></a>[协同编辑](#hvwb-1708700115895)

<a name="i5y4-1713164057933"></a>[处理写冲突(A将标题从1改2,B将1改3)](#fdot-1708700612321)

<a name="vor2-1713164057935"></a>[同步于异步冲突检测](#u8bc-1708700824251)

<a name="qsu6-1713164057937"></a>[同步：单主程序复制 - 不允许每个副本独立接受写入](#wfgd-1708700957597)

<a name="svr0-1713164057939"></a>[异步：独立接受写入- 异步检测，但为时已晚](#x6is-1708701017804)

<a name="ki4w-1713164057941"></a>[避免冲突(特定记录写入都通过同一个领导者，主库切换或者用户迁移至更近的主库时会有同时写入的可能性)](#xg2a-1708700840681)

<a name="qxcw-1713164057943"></a>[收敛convergent至一致的状态(副本主库和其副本在复制完成时收敛至一个相同的最终值)](#ucfn-1708700844474)

<a name="bgf4-1713164057945"></a>[最后写入胜利LWW,last write wins- 给每个写入一个唯一id, 挑选最高ID的写入作为胜利者，并丢弃其他写入-数据丢失](#cbla-1708701376316)

<a name="szke-1713164057947"></a>[为每个副本分配一个唯一ID,ID编号更高的具有高优先级。数据丢失](#40po-1708701481447)

<a name="f6kd-1713164057949"></a>[将值合并在一起](#p4m4-1708701593939)

<a name="cfxk-1713164057951"></a>[记录冲突，并编写解决逻辑代码。如通过提醒用户方式](#8fcs-1708701611999)

<a name="nx9s-1713164057953"></a>[自定义冲突解决逻辑](#yrdi-1708700860148)

<a name="rojc-1713164057955"></a>[自定义冲突解决逻辑(complex)](#t4i7-1708702160004)

<a name="l7i3-1713164057957"></a>[写时执行-后台处理](#pdql-1708702370625)

<a name="tli2-1713164057959"></a>[读时执行-提供多版本用户选择，回写数据库](#sksk-1708702376293)

<a name="o8dq-1713164057961"></a>[亚马逊购物车移除的商品重新出现](#4bqp-1708702425059)

<a name="tezn-1713164057963"></a>[什么是冲突(两个领导者预订同一个会议室，7章看冲突实例12章看检测解决)](#6x4i-1708700867996)

<a name="txyz-1713164057965"></a>[多主复制拓扑](#o41a-1708702111509)

<a name="lubz-1713164057967"></a>[环形，星型，all to all -mysql仅支持环形](#5feh-1708702903239)

<a name="ook0-1713164057969"></a>[问题：多主复制时，可能在某些副本中写入错误的顺序。like A写主库1，B写主库2，主库3先同步2，再同步1。类似一致前缀读。](#ddyu-1708702949257)

<a name="hzlz-1713164057971"></a>[解决：时间戳是不够的-不可靠时钟，使用一种称为版本向量(version vectors)的技术-检测并发写入](#ghp3-1708703247102)

<a name="wwew-1713164057973"></a>[无主复制leaderless](#bfz8-1708759285067)

<a name="4amq-1713164057975"></a>[Amazon的Dynomo系统。](#cvru-1708759359537)

<a name="mqka-1713164057977"></a>[Riak, Cassandra，Voldmort 也称为Dynamo风格。](#wf6o-1708759707666)

<a name="rtoj-1713164057979"></a>[类型1：客户端直接将写入发送到几个副本中](#xpqf-1708760120711)

<a name="s3fb-1713164057981"></a>[类型2：coordinator协调者节点代表客户端写入。](#pl2z-1708760121090)

<a name="pj7j-1713164057983"></a>[当节点故障时写入数据库(仲裁写⼊，法定读取，并在节点中断后读修复。)](#qgpe-1708760989905)

<a name="plnd-1713164057985"></a>[如果主从复制，主故障/重启系统更新 则需进行故障切换](#zfuz-1708760396929)

<a name="8lsu-1713164057987"></a>[无主复制： userA set piture_url   -> replica1 ok    Then version=7](#3soj-1708760452090)

<a name="qkay-1713164057989"></a>[           user set piture_url   -> replica2 ok  Then version=7](#4f05-1708760543198)

<a name="lyen-1713164057991"></a>[user set piture_url   -> replica3 offline  fail   version= 6](#ynls-1708759898772)

<a name="yf5b-1713164057993"></a>[    userB get piture  :  rp3(version6) rp1(version7)  rp2(version7)  Than fix rp3 value to version7](#e1ur-1708760618873)

<a name="ot0p-1713164057995"></a>[ 读修复和反熵(失效节点重新连机后如何caught up)](#tyv3-1708760780373)

<a name="azih-1713164057997"></a>[读修复like userB get piture fixed rp3](#wjho-1708761214792)

<a name="qbna-1713164057999"></a>[反熵 后台进程不断查找副本之间的数据差异。Voldmort无反熵过程，副本可能丢失数据](#xblj-1708761286988)

<a name="bqoj-1713164058001"></a>[ 读写的法定人数（仲裁）](#w3ia-1708761120623)

<a name="bzez-1713164058003"></a>[仲裁一致性的局限性-最终一致，更强的保证需要事务或共识](#oj1i-1708759830121)

<a name="lrmo-1713164058005"></a>[松散法定人数与带提示的接力](#cu5q-1708759841416)

<a name="atrn-1713164058007"></a>[运维多个数据中心-将写入发送到所有副本，仅需本地IDC内法定节点确认](#kzki-1708761744887)

<a name="7cbt-1713164058009"></a>[检测并发写入](#pt1k-1708759856530)

<a name="cvio-1713164058011"></a>[Dynamo风格的数据存储，没有明确定义的顺序。](#mu89-1708761978075)

<a name="jbwx-1713164058013"></a>[userA set x=A   get x](#dbni-1708763823783)

<a name="asee-1713164058016"></a>[rp 1 A ok    B unresponsive   A](#auce-1708763993783)

<a name="1ubw-1713164058018"></a>[rp2 A ok   B OK  B](#kteo-1708764011894)

<a name="d2pa-1713164058020"></a>[rp3 B ok A ok A](#9xyy-1708764019308)

<a name="hjsz-1713164058022"></a>[userB set x=B ](#esiv-1708702764305)

<a name="grgm-1713164058024"></a>[最后写入胜利(丢弃并发写入)](#wd1i-1708764197180)

<a name="vama-1713164058026"></a>[LLW 无法确定真实排序，强制排序，选择最新的最大时间戳，并丢弃较早的任何写入.Cassandra唯一支持的方式，Riak可选](#uzhw-1708874432788)

<a name="xhzx-1713164058028"></a>[缺点：数据丢失 ](#henp-1708874594301)

<a name="lte2-1713164058030"></a>[此前发生的关系和并发](#hzwp-1708764215825)

<a name="abcl-1713164058032"></a>[因果依赖(causally dependent)  如果B后发与A, 则B因果依赖A, ](#3wp0-1708874672763)

<a name="3n9l-1713164058034"></a>[如果是并发，则存在需要解决的冲突](#1wzv-1708875051673)

<a name="f4wm-1713164058036"></a>[捕获此前发生的关系](#j2r6-1708764228505)

<a name="dgzx-1713164058038"></a>[捕获两个客户端间的因果关系，同时编辑购物车(示例为单副本)](#vv7q-1708875756229)

<a name="yv6k-1713164058040"></a>[合并同时写入的值](#zp0i-1708874374616)

<a name="vooe-1713164058042"></a>[客户端需额外工作，合并并发写入的值来擦屁股。Riak称这些并发值兄弟(sibings)](#wawo-1708876272614)

<a name="mbqi-1713164058044"></a>[版本向量](#arlv-1708874381589)

<a name="e7f6-1713164058046"></a>[所有副本的版本号集合称为版本向量(version vector)](#b1ov-1708700703636)

<a name="xlrs-1713164058048"></a>[6.分区](#dyz5-1709800112532)

<a name="j8pk-1713164058050"></a>[.分区与复制(分区与复制方案是独立的)](#twd1-1709800204792)

<a name="yirz-1713164058052"></a>[.键值数据的分区](#fbqg-1709800263679)

<a name="kvqr-1713164058054"></a>[偏斜skew：分区过多数据或过多查询](#s7ju-1709801062977)

<a name="mwhh-1713164058056"></a>[热点hot spot:高负载的分区](#u0d3-1709801107270)

<a name="ocot-1713164058058"></a>[根据键的范围分区](#lqbu-1709800332210)

<a name="x72j-1713164058060"></a>[Bigtable, HBase, RethinkDB 和 MongoDB2.4](#i2ju-1709801151406)

<a name="fgxg-1713164058062"></a>[按照一定的顺序保存键（SSTbale和LSM-树）](#np00-1709801582805)

<a name="qjpr-1713164058064"></a>[按时间分区当日写过载（需加传感器保证日期+传感主键均匀分布）](#evhb-1709801683166)

<a name="qgun-1713164058066"></a>[根据键的散列分区(可将偏斜数据均匀分布)](#a1yy-1709800347130)

<a name="hu4g-1713164058068"></a>[不适合分区的简单哈希函数：java .hashCode-同键不同进程不同哈希值](#mdg4-1709801628016)

<a name="z3ga-1713164058070"></a>[一致性哈希consistent hashing:哈希键分区边界均匀间隔，也可伪随机选择（CDN均匀分配负载）。](#7rkg-1709802019859)

<a name="3amt-1713164058072"></a>[缺点：无序，低效范围查询(需发送到所有分区)](#iktb-1709802309508)

<a name="n7di-1713164058074"></a>[折中方案：复合主键/组合索引。(uid,time).不同用户在不同分区，每个用户按时间搓顺序存储在单个分区上。](#zznq-1709802490074)

<a name="fzyh-1713164058076"></a>[负载倾斜与消除热点](#ed70-1709800357523)

<a name="jfwu-1713164058078"></a>[数百万追随者做某事-大量写入同一个键](#403a-1709802593546)

<a name="bz1p-1713164058080"></a>[解决：火爆主键+随机数即可将主键分散为100个分区](#wx5s-1709802730512)

<a name="eikc-1713164058082"></a>[缺点：数据合并，跟踪火爆主键。需权衡利弊。](#h0b7-1709802773377)

<a name="htlz-1713164058084"></a>[.分片与次级索引](#ekdv-1709800287975)

<a name="whuu-1713164058086"></a>[次级索引通常并不能唯一标识记录。](#n3vk-1709803239471)

<a name="guv2-1713164058088"></a>[HBase Volde-mort为了减少实现复杂度放弃了次级索引。](#q1u5-1709803293988)

<a name="x9kv-1713164058090"></a>[Riak开始添加， 次索是Solr Elasticesearch 搜索的基石](#fhpr-1709803333585)

<a name="udhs-1713164058092"></a>[按文档的二级索引](#mwm0-1709800370635)

<a name="2hvx-1713164058094"></a>[文档分区索引/本地索引](#ud7o-1709803718409)

<a name="eckg-1713164058096"></a>[每个分区独立维护自己的二级索引。](#zlhf-1709803740582)

<a name="6w4b-1713164058098"></a>[查询发送所有分区，并合并所有返回结果，分散/聚集scatter/gather-容易导致尾部延迟放大。](#bkj3-1709803789802)

<a name="pmpe-1713164058100"></a>[缺点：可能使二级索引读取查询相当昂贵。](#ghpm-1709803878421)

<a name="c5n9-1713164058102"></a>[根据关键词(Term)的二级索引](#itl0-1709800380617)

<a name="bveg-1713164058104"></a>[全局索引：覆盖所有分区数据的索引，也须分区。](#8bw4-1709804016790)

<a name="dt49-1713164058106"></a>[关键词分区：关键词本身或它的散列进行分区。](#qc2d-1709913637902)

<a name="qbp7-1713164058108"></a>[优点：只需请求包含关键词的分区，读取更有效率](#jmj8-1709913775261)

<a name="tpyd-1713164058111"></a>[缺点：写入慢且复杂。需支持分布式事务。](#i7kp-1709913825503)

<a name="rzld-1713164058113"></a>[理想下总是最新，实践中更新通常为异步。Amazon DynamoDB声称全局次级索引不到1s内更新。](#mv7j-1709913923874)

<a name="lztc-1713164058115"></a>[.分区再平衡(reblancing)](#hpnd-1709800294747)

<a name="s8cw-1713164058117"></a>[吞吐量增加：加cpu](#1f0n-1709914101899)

<a name="ux6f-1713164058119"></a>[数据集大小增加：加磁盘和RAM](#vjb0-1709914129763)

<a name="lzqw-1713164058121"></a>[机器故障：其他机器接管](#smcd-1709914153882)

<a name="odol-1713164058123"></a>[----------再平衡应满足--------------](#2efu-1709916803909)

<a name="cmo2-1713164058125"></a>[发生时：数据库应该继续接受读取和写入](#20wj-1709916807951)

<a name="hpiw-1713164058127"></a>[节点之间只移动必须数据(分区)，以便快速再平衡，减少网络和磁盘io负载。](#cxoi-1709916893371)

<a name="urup-1713164058129"></a>[平衡后：存储，读取和写入公平共享](#cj8j-1709916938075)

<a name="qoky-1713164058131"></a>[平衡策略](#cavd-1709800402611)

<a name="mgqh-1713164058133"></a>[反面教材：hash mod N](#6f6z-1709800409866)

<a name="t2ro-1713164058135"></a>[$hash(key)=22  22mod10..2  22mod 11...0  22 mod 9 ...4 ](#anib-1709916997775)

<a name="k4to-1713164058137"></a>[节点需要转移秘钥及次数过多，过于昂贵。](#anz7-1709917243580)

<a name="p3y1-1713164058139"></a>[解决：更换为只移动必须数据的方法。](#7ytl-1709917334275)

<a name="ic1y-1713164058141"></a>[固定数量的分区(加节点时分配分区)](#8l9j-1709800420954)

<a name="rvja-1713164058143"></a>[新增/减少节点时，将现存部分数据转移到节点新增/现存节点(Riak,es,couchbase Voldemort使用这种再平衡）](#vmsm-1709917322722)

<a name="llq7-1713164058145"></a>[适用：分区数量第一次建立时确定。](#ktrd-1709917648400)

<a name="x6bd-1713164058147"></a>[缺点：数据集总量大小难以预估时；分区大再平衡代价昂贵，分区小产生额外开销。](#vw7j-1709917692466)

<a name="kwct-1713164058149"></a>[分区大小与集群数据总量成比例增长](#eszc-1709921747523)

<a name="jkmh-1713164058151"></a>[动态分区(适用键范围的分区)](#tkjw-1709800428033)

<a name="vtix-1713164058153"></a>[解决：使用键范围分区，固定边界的固定数量的分区不便。出现边界错误，手动重新去配分区边界将非常繁琐。](#itsg-1709917825657)

<a name="4okh-1713164058155"></a>[动态分区：与B树类似，分区数据增长超过配置时将分成两区，大量数据删除分区缩小低于阈值则合并(HBase RethinkDB)](#05rm-1709917996703)

<a name="ukgd-1713164058157"></a>[优点：分区数量适应总数据量-动态划分分区数量。](#v8uv-1709918235496)

<a name="ojmy-1713164058159"></a>[注意：空库分区开始，未绘制边界先验信息。所有写操作都必须由单个节点处理。其它节点空闲](#cdjv-1709918375629)

<a name="jmt1-1713164058161"></a>[解决：配置一组初始分区-预分割 Hbase MongoDb。配需提前知道键分配方式。](#3uee-1709918458100)

<a name="tzcu-1713164058163"></a>[MongoDB同时支持范围和哈希分区且动态分割分区。](#tlmq-1709918504615)

<a name="uvde-1713164058165"></a>[分区数量与数据集大小成正比](#xqee-1709921516740)

<a name="gz1z-1713164058167"></a>[按节点比列分区](#kcsr-1709800432396)

<a name="fv1j-1713164058169"></a>[新增节点，分区将变小。随机选择固定数量的现有分区进行拆分,最终获得公平的负载份额。cassandre ketama.](#xscz-1709920011051)

<a name="hrwd-1713164058171"></a>[随机选择分区边界要求使用基于散列的分区-一致性哈希。](#pmpc-1709920187661)

<a name="cpx9-1713164058173"></a>[分区数量与节点数量无关](#a0l0-1709923420226)

<a name="jboc-1713164058175"></a>[ 运维：手动还是自动平衡](#w6ob-1709800443454)

<a name="2uat-1713164058177"></a>[自动：与故障检测结合将十分危险，高负载节点响应慢被视为死亡被踢掉，重新平衡集群时其他超负荷节点可能级联失败](#qobk-1709920292898)

<a name="u0ut-1713164058179"></a>[手动人为监控+自动](#a05n-1709920414620)

<a name="tamt-1713164058181"></a>[.请求路由](#qxk3-1709800301840)

<a name="tbnq-1713164058183"></a>[分区再平衡后的服务发现(IP 端口)](#sd2e-1709921854453)

<a name="4qu4-1713164058185"></a>[-------方案-------](#gliq-1709921964410)

<a name="zifk-1713164058187"></a>[1.循环策略：Round-Robin load balancer，轮询节点看是否有请求的分区。](#ibln-1709921978507)

<a name="em16-1713164058189"></a>[2.路由层：有中间层的路由决定请求的节点，由路由层负载均衡](#gjxa-1709922094115)

<a name="23bx-1713164058191"></a>[3.要求客户端知道分区和节点的分配。客户端可直连节点。](#ukz9-1709922149547)

<a name="oaay-1713164058193"></a>[具有挑战性的问题。重要的是所有参与者都同意-否则将被发送到错误的节点，而不是正确处理。分布式中的共识协议-但很难正确实现。](#1c54-1709922244119)

<a name="ixeu-1713164058195"></a>[Zookeper分区分配改变时通知路由层保持最新信息。](#c7dc-1709922373821)

<a name="8zzw-1713164058198"></a>[LinkedIn的Espressor使用Heix进行集群管理(依靠Zookeeper）](#ne7u-1709922442881)

<a name="3k2k-1713164058200"></a>[Hbase,SolrCloud 和kafka也是用Zookeeper来跟踪分区分配。](#41cr-1709922584212)

<a name="5ebj-1713164058202"></a>[Cassandra  Riaks节点间使用留言协议gossip protocol来传播群集状态变化。请求发送任意节点，该节点转发到含有请求分区的节点。模型增加数据库节点的复杂性。但避免对Zookeeper这类外部协调服务的依赖](#kg5k-1709922347652)

<a name="rtxt-1713164058204"></a>[Couchbash不会自动再平衡，简化了设计。moxi路由层。](#uohs-1709922928889)

<a name="ep7z-1713164058206"></a>[执行并行查询](#h26t-1709800460759)

<a name="u5sl-1713164058208"></a>[大规模并行处理(MPP,massively parallel processing)-数仓](#oj8k-1709923010027)

<a name="ndn0-1713164058210"></a>[7.事务](#7qvp-1708523954496)

<a name="cp1i-1713164058212"></a>[简化故障失败的机制-强大的事务！！](#wk3n-1710172857428)

<a name="bmge-1713164058214"></a>[故障](#pzui-1710172844274)

<a name="zznl-1713164058216"></a>[崩溃](#znoj-1710172848152)

<a name="wan4-1713164058218"></a>[网络中断](#vovu-1710172885568)

<a name="xlvp-1713164058220"></a>[多线程/客户端写入覆盖](#sxty-1710172894683)

<a name="xn8c-1713164058222"></a>[读取无意义中间态数据](#hbqy-1710172933218)

<a name="hssg-1713164058224"></a>[多线程/客户端竞争](#jlng-1710172974900)

<a name="dcro-1713164058226"></a>[.事务的棘手概念](#58hv-1710167822460)

<a name="myti-1713164058228"></a>[ACID的含义](#yxrp-1710167867782)

<a name="3ady-1713164058230"></a>[原子性atomicity](#hryj-1710167943276)

<a name="t2oe-1713164058232"></a>[一致性consistency](#9aal-1710167983379)

<a name="r668-1713164058234"></a>[—致性这个词重载的很厉害:](#jkse-1710173130714)

<a name="6czq-1713164058236"></a>[隔离性isolation](#gfkv-1710171645686)

<a name="3ndv-1713164058238"></a>[持久性durability](#7kja-1710171663168)

<a name="kzkj-1713164058240"></a>[单对象与多对象操作](#pblh-1710167919896)

<a name="ogq5-1713164058242"></a>[违反隔离性：一个事务读取另一个事务未被执行的写入（脏读）](#42qx-1710250188446)

<a name="7sm6-1713164058244"></a>[ 原⼦性确保发⽣错误时，事务先前的任何写⼊都会被撤消，以避免状态不⼀致（all or nothing）](#daxd-1710250201202)

<a name="loiu-1713164058246"></a>[单对象写入](#7ymn-1710171710772)

<a name="ybtj-1713164058248"></a>[单对象写入崩溃，原子性通过日志实现恢复](#h5aa-1710250215106)

<a name="qtbm-1713164058250"></a>[原子操作：CAS也是流行的操作](#ihdr-1710250368749)

<a name="xcrb-1713164058252"></a>[事务通常被理解为：将多个对象上的多个操作合并为一个执行单元的机制](#a1qj-1710250481310)

<a name="fohm-1713164058254"></a>[多对象事务的需求](#afyc-1710171718578)

<a name="pkb2-1713164058256"></a>[是否需要多对象事务？ ](#t9gh-1710251706186)

<a name="wdok-1713164058258"></a>[是否有可能只用键值模型和单对象来实现应用程序？](#9b6e-1710251739137)

<a name="cp8r-1713164058260"></a>[ 关系型数据库：多表关联插入操作](#ormg-1710250533532)

<a name="pmn6-1713164058262"></a>[ 文档数据模型：多个字段常在同一个文档(被视为单个对象），缺乏连接功能的文档DB会鼓励非规范化(操作非规范化信息需要更新多个文档)。事务可防止非规范化数据不同步。](#opfe-1710250566216)

<a name="wogr-1713164058264"></a>[ 二级索引的数据库中：一二级索引的同步更新](#syt6-1710251863622)

<a name="7qst-1713164058266"></a>[无原子性:复杂的错误处理](#ymgi-1710251891615)

<a name="2kgk-1713164058268"></a>[无隔离性：并发问题](#ovhl-1710251918119)

<a name="suyn-1713164058270"></a>[处理错误和中止](#g5o1-1710171723084)

<a name="v1zh-1713164058272"></a>[···   ACID哲学：违反规则宁可放弃，不留半成品。](#ygfp-1710251941752)

<a name="b5ky-1713164058274"></a>[无主复制则是尽力而为：数据库将做尽可能多的事。错误时不会撤销已经完成的事。-错误恢复是应用程序的责任。](#0hze-1710252188073)

<a name="gfhb-1713164058276"></a>[Rails的ActiveRecord、Django这样的orm框架不会重试中断的事务。丢弃用户输入。](#7mbo-1710252298563)

<a name="ewzq-1713164058278"></a>[中止的重点应该是允许安全的重试。但它并不完美：](#p2mf-1710253466041)

<a name="le6g-1713164058280"></a>[事务成功，网络故障可能导致执行两次。除非有额外应用级除重机制。](#lmfw-1710253530673)

<a name="q7gf-1713164058283"></a>[负载过大，重试将更槽糕。限制重试次数，指数退避算法。并单独处理和过载相关的错误](#nxyx-1710253675080)

<a name="oa05-1713164058285"></a>[仅在临时性错误才值得重试（死锁，异常，网络中断和切换）。发生永久性错误的重试是无意义的](#njy9-1710253740189)

<a name="9w6v-1713164058287"></a>[数据库外的副作用：重试每次重发电子邮件。不同系统事务。两阶段提交2PC.](#auy9-1710253799114)

<a name="w3tn-1713164058289"></a>[ 客户端重试失效则丢失数据。](#mtpo-1710253936214)

<a name="7m38-1713164058291"></a>[.弱隔离级别](#jngf-1710167840980)

<a name="upnj-1713164058293"></a>[安全并行parallel：事务不触及相同数据](#wdhp-1710263089880)

<a name="g264-1713164058295"></a>[竞争条件：](#ykgs-1710263216103)

<a name="qiq8-1713164058297"></a>[读：事务读取另一个事务同时修改的数据](#er05-1710263177909)

<a name="ejgv-1713164058299"></a>[写：事务同时修改相同的数据](#pypw-1710263203957)

<a name="3cmv-1713164058301"></a>[事务隔离：](#xps5-1710263234506)

<a name="oqi2-1713164058303"></a>[可序列化(一次一个执行，没有任何并发)](#ghkk-1710263260640)

<a name="ks2a-1713164058305"></a>[性能损失](#a876-1710263299289)

<a name="jilu-1713164058307"></a>[弱隔离级别(非串行化nonserializable)](#nqm3-1710263313752)

<a name="crgz-1713164058309"></a>[较弱的隔离级别防止一部分，而非全部的并发问题](#e7nl-1710263334073)

<a name="5pju-1713164058311"></a>[资金损失，耗费财务调查，财务数据请使用ACID数据库(注意：流行的数据库也使用弱隔离级别，不一定能防止并发错误)](#2xxd-1710331395046)

<a name="dtbh-1713164058313"></a>[读已提交](#pjqb-1710171742279)

<a name="0nlc-1713164058315"></a>[没有脏读](#7h42-1710171796899)

<a name="axhk-1713164058317"></a>[dirty reads：事务看到另一个事务未提交的值](#lyju-1710332135761)

<a name="tkqx-1713164058319"></a>[为什么要防止dirty reads：](#x8ch-1710333899846)

<a name="eszi-1713164058321"></a>[更新多对象：脏读以为只看到部分数据](#pwpa-1710333902582)

<a name="slbr-1713164058323"></a>[事务中止：回滚后，看到的是未提交的数据](#jcj0-1710333902583)

<a name="k0tg-1713164058325"></a>[解决：只能读取提交后的数据，且不会阻塞，并行时保存已提交的旧值 -mvcc](#3mi1-1710332238978)

<a name="sjs2-1713164058327"></a>[没有脏写](#vmfl-1710171803833)

<a name="t2ph-1713164058329"></a>[dirty write: 事务同时更新相同对象。后面的写入覆盖尚未提交的值。](#hvah-1710332040048)

<a name="tfug-1713164058331"></a>[避免的问题：](#chr0-1710333916523)

<a name="eu4u-1713164058333"></a>[混乱写入，导致bob后买车先更新发票commit而alic先买车后更新发票commit(buyer=bob but recipient=alice)](#14wx-1710333919188)

<a name="vxjp-1713164058335"></a>[解决：延迟/阻塞第二次的写入，直到第一次写入事务提交或终止。](#g1sw-1710332222649)

<a name="mm0g-1713164058337"></a>[但不能防止计数器增量的竞争状态。(读写非原子性，写依赖读的副本)](#ujzx-1710333397576)

<a name="zfik-1713164058339"></a>[计数器增量安全：防止更新丢失 -版本号](#ugiq-1710333641028)

<a name="2j6s-1713164058341"></a>[实现读已提交](#z96g-1710171821987)

<a name="mz6g-1713164058343"></a>[默认的隔离级别：oracle,postgreSQL,sql server ,memSql](#tays-1710333754461)

<a name="19nq-1713164058345"></a>[行锁row-level lock](#svaf-1710333809593)

<a name="oglo-1713164058347"></a>[读写锁防止脏读：读写锁互斥，只有读锁拥有者可持有写锁。](#fsbu-1710334081090)

<a name="6fya-1713164058349"></a>[缺点：阻塞，性能损失。](#xj1j-1710334321006)

<a name="yifm-1713164058351"></a>[优化：所以一般用mvcc的模式。-或者copy on write](#7klj-1710334353854)

<a name="f8se-1713164058353"></a>[快照隔离和可重复读](#bww4-1710171760070)

<a name="7pc9-1713164058355"></a>[不可重复读nonrepeatable read/读取偏差read skew](#wjut-1710343195467)

<a name="bdgu-1713164058357"></a>[skew重载：在热点指的是不平衡，这里指异常时机  alice两个账号各500，alice先读acount1=500,转账员将acount1+100,acount2-100后commit，alice读acount2=400.commit.导致Alice看起来少了100。-暂时不一致。](#jmuu-1710343248537)

<a name="s03j-1713164058359"></a>[提交后，刷新网页即可。有些情况不能容忍暂时不一致：](#gwgf-1710343469620)

<a name="exsw-1713164058361"></a>[备份：数据库备份需要几小时，期间接收写入包含新老数据。如果备份用于恢复，不一致就变成永久的了。-解决：全局锁/快照备份](#m0km-1710345572560)

<a name="bwwu-1713164058363"></a>[分析查询和完整性检查：扫描大部分数据库，查询在不同时间点观察数据库产生不同，可能返回无意义的结果。](#i5pt-1710345666724)

<a name="xqal-1713164058366"></a>[ 快照隔离snapshot isolation 对长时间运行的只读查询非常有用（备份和分析）。](#p7tm-1710345899708)

<a name="7sq8-1713164058368"></a>[ 即 一致快照consistent snapshot,即使被另一个事务更改，每个事务只能看到该特定时间的旧数据（特定时间点冻结的一致快照）。](#q8oz-1710345935366)

<a name="tqfq-1713164058370"></a>[PostgerSQL, mysql innoDB, Oracle, sqlServer](#mo1i-1710346175801)

<a name="pc4l-1713164058372"></a>[实现快照隔离](#2hpt-1710171981487)

<a name="yfug-1713164058374"></a>[关键原则：读不阻塞写，写不阻塞读。两者没有任何锁定争用。](#49s0-1710346236063)

<a name="2as7-1713164058376"></a>[多版本并发控制mvcc,multi-version concurrentcy contorl](#w8v8-1710346319154)

<a name="l81b-1713164058378"></a>[读已提交不提供快照隔离，保留对象的一两个版本就足够。通常支持快照隔离也是用mvcc来实现读已提交隔离级别：](#fh82-1710346453757)

<a name="s1hp-1713164058380"></a>[读已提交为每个查询使用单独的快照-每个select单独生成。](#3xbw-1710346540026)

<a name="zigk-1713164058382"></a>[快照隔离对整个事务使用相同的快照-复用第一个select生成的快照](#xqhm-1710346554737)

<a name="if8j-1713164058384"></a>[update操作在内部翻译为Delete 和 insert](#pmk8-1710351883488)

<a name="h7f4-1713164058386"></a>[-innoDB实际上delete将旧数据版本移到undolog版本链中。垃圾收集会删除任何事务不可见的就对象版本。](#vnfd-1710351911457)

<a name="kngs-1713164058388"></a>[观察一致性快照的可见性规则](#box0-1710171988275)

<a name="qh8s-1713164058390"></a>[从来不更新值，而是每次值改变时创建一个新版本。使得数据库提供一致快照产生的开销很小。](#yapf-1710408915465)

<a name="nt5s-1713164058392"></a>[事务id决定它可以看到哪些对象，规则如下：](#ecrk-1710408160769)

<a name="xssy-1713164058394"></a>[事务开始时列出当时所有事务清单，即使之后提交，这些事务的写入也都会被忽略。](#ogtp-1710408539120)

<a name="3m0x-1713164058396"></a>[忽略被中止事务任何写入](#unjc-1710408595672)

<a name="eeeq-1713164058398"></a>[较晚(当前事务之后开始)的写入都被忽略，不管是否提交](#ofbz-1710408626209)

<a name="yeox-1713164058400"></a>[所有其他写入，对应用都是可见的。](#hgwi-1710408682423)

<a name="bwaj-1713164058402"></a>[对象可见的两条规则](#rg1c-1710408738736)

<a name="swx0-1713164058404"></a>[读事务开始时，创建该对象的事务已提交。](#weyp-1710408754844)

<a name="r6wt-1713164058406"></a>[请求删除的事务在读事务开始时未提交。](#xqky-1710408773006)

<a name="a07m-1713164058408"></a>[索引和快照隔离(索引如何在多版本数据库中工作)](#ai77-1710171999516)

<a name="p5vc-1713164058410"></a>[同一对象不同版本放在同一个页面中，PostgreSQL的优化可以避免更新索引](#kanl-1710410047690)

<a name="2sq9-1713164058412"></a>[仅追加/写时拷贝apeend-only/copy-on-wirte的变体B树：更新不覆盖树的页面，为每个修改页创建副本。](#yv2q-1710410120895)

<a name="dccx-1713164058414"></a>[每个写入事务/一批事务都会创建一个新的B树，当创建时，从该特定树根生长的树就是数据库的一个一致性快照。](#etza-1710410471666)

<a name="6gz0-1713164058416"></a>[需要负责压缩和垃圾收集的后台进程。](#79xv-1710410561061)

<a name="dzp8-1713164058418"></a>[可重复读与命名混淆](#xr4f-1710172004472)

<a name="gvov-1713164058420"></a>[原因：System R定义隔离级别时并未有快照隔离](#nohd-1710417835613)

<a name="jvmj-1713164058422"></a>[oracle DB2 称为序列化](#uwdp-1710417928621)

<a name="mlgx-1713164058424"></a>[postgreSql mySql称为可重复读](#f5te-1710417946615)

<a name="l4gr-1713164058426"></a>[防止丢失更新](#e9wg-1710171770800)

<a name="tnqz-1713164058428"></a>[脏写导致丢失更新lost update](#ajmt-1710418075399)

<a name="78ex-1713164058430"></a>[读取-修改-写入序列的狠揍clobber：第二个事务并没有包括第一个事务的修改: -写依赖读](#c7rv-1710418271703)

<a name="uooz-1713164058432"></a>[增加计数器或更新账户余额(需读取当前值，计算新值并写回更新后的值)](#uvoq-1710418375497)

<a name="1fhm-1713164058434"></a>[进行本地修改： 解析文档，更改后回写修改的文档](#ro12-1710418458493)

<a name="u9lw-1713164058436"></a>[同时编辑wiki页面：整个页面覆盖当前内容。](#9n83-1710418515773)

<a name="okhu-1713164058438"></a>[原子写(x排它锁)](#lftw-1710172034957)

<a name="gg3o-1713164058440"></a>[数据库原子更新操作保证并发安全](#6jim-1710418574114)

<a name="gho7-1713164058442"></a>[mysql: 行级写锁](#dxgy-1710419672127)

<a name="zpps-1713164058444"></a>[MongoDB：对JSON文档一部分进行本地修改的原子操作](#bqxj-1710419591972)

<a name="1dfl-1713164058446"></a>[redis提供了优先队列等修改数据的原子操作。](#wxju-1710419646040)

<a name="ndau-1713164058448"></a>[原子操作/游标稳定性cursor stability：通常在读取对象时获取其上的排它锁，以便提交前没有事务可以读取它。另一个选择是将所有原子操作在单一线程上执行。-redis](#h0ip-1710421887552)

<a name="jhy2-1713164058450"></a>[unfortunately,ORM框架易执行读取-修改-写入序列，而不是使用数据库提供的原子操作。如果你知道自己在做什么那当然不是问题](#6hwo-1710422121598)

<a name="zzwr-1713164058452"></a>[显式锁定(for update：读-改-写序列)](#vysa-1710172041914)

<a name="9tv7-1713164058454"></a>[让应用程序显示锁定更新的对象，直到一个读取-修改-写入序列完成](#oknq-1710422501689)

<a name="qszc-1713164058457"></a>[select ..... for update;](#89ij-1710422624973)

<a name="naut-1713164058459"></a>[--更新先前select 返回棋子的位置。](#50q1-1710422845671)

<a name="jory-1713164058461"></a>[ update](#rmgw-1710422637550)

<a name="izhc-1713164058463"></a>[for update-对返回的所有行加锁，忘记加锁很容易引入竞争条件(同时修改)](#euv5-1710422671170)

<a name="da8f-1713164058465"></a>[自动检测丢失的更新(管理器检测处理并发问题)](#jpu5-1710172058032)

<a name="ju3u-1713164058467"></a>[允许并行执行，事务管理器检测到丢失更新，中止事务并强制重试读-改-写序列。](#8ytj-1710423161566)

<a name="9bhk-1713164058469"></a>[Oracle可串行化(快照隔离)和sqlServer的快照隔离级别会自动检测到丢失更新，中止惹麻烦的事务。一些作者认为能防止丢失更新才算提供快照隔离。这个定义下，mysql不算提供快照隔离](#w9el-1710423029153)

<a name="cjps-1713164058471"></a>[优点：是一个很好的功能，不需要应用代码使用任何特殊数据库功能。允许你忘记加锁或原子操作，由管理器检测丢失更新。](#qg6e-1710423330067)

<a name="wgmk-1713164058473"></a>[比较并设置(CAS)](#ftwe-1710172063360)

<a name="swnx-1713164058475"></a>[不提供事务的数据库中的原子操作：比较并设置（CAS compare and set）](#os3h-1710424617661)

<a name="j9ws-1713164058477"></a>[update table set content='new content' where id=123 and content = 'old content'  必要时重试](#hlfh-1710425612756)

<a name="7xzr-1713164058479"></a>[问题：数据库允许where子句从旧快照读取，此语句无法防止丢失更新。即另一个并发写入，where条件也为真。-非当前读或非原子写。](#rxcv-1710425806449)

<a name="kwmo-1713164058481"></a>[解决：检查数据库的CAS是否安全。保证比较交换为当前读且写是否加锁/原子写](#zss4-1710425865867)

<a name="tb9t-1713164058483"></a>[冲突解决与复制(多个数据库副本的并发)](#bvrp-1710172079412)

<a name="yum4-1713164058485"></a>[基于锁和cas操作不适用于多个数据库副本](#ewf7-1710434904534)

<a name="v7wv-1713164058487"></a>[如检测并发写入：允许并发吸入创建多个冲突版本(也称兄弟），应用代码或特殊数据结构在发生之后解决合并这些版本。](#8dx4-1710434970886)

<a name="uq6c-1713164058489"></a>[原子操作可在复制的上下文中很好工作，尤其具有可交换性时。Riak2.0不同客户端同时更新一个值是，Riak将自动更新合并在一起，以免丢失更新。防止复制副本丢失更新。](#gl8j-1710435048968)

<a name="ezgk-1713164058491"></a>[最后写入LWW解决冲突很容易丢失更新。unfortunately,许多复制数据库默认LWW。](#gdtn-1710435259414)

<a name="op1d-1713164058493"></a>[写入偏差与幻读（两个事务更新两个不同的对象）](#rkev-1710172453385)

<a name="yncb-1713164058495"></a>[select count(*) where oncall=true....alice 和 bob分别查在职医生人数](#itfd-1710436127298)

<a name="bba9-1713164058497"></a>[update...set oncall=false 然后将自己的记录更新为请假，违反至少一医生在职。](#leam-1710436160580)

<a name="gnku-1713164058499"></a>[写偏差的特征](#ovid-1710172462835)

<a name="zrhj-1713164058501"></a>[特征：涉及多个对象，单对象的原子操作不起作用](#iedp-1710437034438)

<a name="erwo-1713164058503"></a>[快照隔离实现中，自动检测丢失更新对此无帮助。postgred,innodb的可重复读，oracle序列化或sql server的快照隔离级别中，都不会自动检测写入偏差。写入偏差需要真正的可序列隔离-业务上的问题。](#wszw-1710437034814)

<a name="xdmd-1713164058505"></a>[数据库配置约束，指定至少一个值为true.大多数不支持这种配置，可以使用触发器或者物化视图实现。](#hn04-1710437034815)

<a name="pbpz-1713164058507"></a>[显示锁定。 select ...fro update -锁定返回的所有行，锁定两个医生](#crrt-1710437034816)

<a name="iauf-1713164058509"></a>[写偏差的更多例子](#4jr1-1710172470885)

<a name="a2b7-1713164058511"></a>[读数据为空，分别插入一条数据的会议室预定系统：select count(*) from bookings where roomid=123 and time...，insert into bookings....不能防止另一个用户插入冲突会议。解决：又需要串行化执行。](#0hyt-1710437389755)

<a name="ixdi-1713164058513"></a>[多人游戏：棋盘用锁防止丢失更新，但锁定不能妨碍将不同的棋子放在相同位置。产生写入偏差 。解决：使用唯一约束。](#pgcb-1710437636980)

<a name="oqvl-1713164058515"></a>[抢注用户名：和会议系统一样。不过唯一性约束可以解决该问题。](#bwel-1710437042998)

<a name="wcg5-1713164058517"></a>[防止双重开支；用户花钱和积分服务，检查支付数不超过余额，有了写入偏差，可能会发生两个支出项目同时插入，导致余额变为负值，两个事务都不会注意到另一个。](#ogt8-1710438166946)

<a name="09hw-1713164058519"></a>[导致写入偏差的幻读](#8gty-1710172478550)

<a name="9ph9-1713164058521"></a>[所有以上例子都遵循类似的模式](#tw0y-1710438423955)

<a name="gy6r-1713164058523"></a>[Select查询符合条件的行，至少两名医生值班；不存在该会议室同一时段的预定；棋盘位置未被占据；用户未被抢注；账户还有足够余额](#bngi-1710438445792)

<a name="iqtv-1713164058525"></a>[按照第一个查询的结果，应用代码决定是否继续](#l6p0-1710438590471)

<a name="trqz-1713164058527"></a>[应用决定继续操作，执行写入(插入更新删除），并提交事务](#qt10-1710438739456)

<a name="gwze-1713164058529"></a>[步骤3修改的行，是步骤1中返回的行之一，可以使用select for update来使事务安全避免写入偏差.](#cdmo-1710438899441)

<a name="d0vn-1713164058531"></a>[但检查是否不存在满足条件行，写入添加一个匹配相同条件的行。select for update 锁不了任何东西。](#caet-1710439501945)

<a name="apci-1713164058533"></a>[       这种效应：一个事务中的写入改变另一个事务的搜索查询结果，被称为幻读。快照隔离避免了只读查询中的幻读。以上的读写事务中，幻影会导致特别棘手的写歪斜情况。](#cwgh-1710440241091)

<a name="f9tw-1713164058535"></a>[物化冲突](#1cjy-1710172485201)

<a name="0dhg-1713164058537"></a>[物化冲突：将幻读变为数据库中一组具体行上的锁冲突。](#fv3x-1710440426895)

<a name="dkqo-1713164058539"></a>[通过创建时间槽和房间的表，提前出入房间和时间的所有可能组合。创建预定的事务可以select for update锁定房间和时间段对应的行，在获得锁定后，可以检查重叠的预定并插入新的预定。该表不是存储预定相关的信息，它完全就是一组锁，用于防止同时修改同一房间和时间范围内的预定。](#laff-1710440634993)

<a name="ljjp-1713164058541"></a>[缺点：弄清除如何物化冲突可能很难，也很容易出错，而让并发控制机制泄露到应用数据模型是很丑陋的做法。](#dngy-1710441936216)

<a name="6any-1713164058544"></a>[物化重入应为最后的手段。可序列化Serializeble级别是更可取的。](#i0he-1710441997817)

<a name="3aus-1713164058546"></a>[.可序列化](#di29-1710167844061)

<a name="qlhz-1713164058548"></a>[弱隔离级别读已提交和快照隔离不能解决写入偏差幻读：](#ztac-1710587737356)

<a name="nskj-1713164058550"></a>[隔离级别难以理解，且不同数据库中实现不一致，可重复读概念不一样](#ky3h-1710588699885)

<a name="stbq-1713164058552"></a>[光检查应用代码很难判定在特定隔离界别是否安全](#tpbs-1710588738858)

<a name="vloe-1713164058554"></a>[无检测竞争条件的好工具，往往倒霉时才会出现问题。](#jp98-1710588779920)

<a name="jd4w-1713164058556"></a>[20世纪70年代system R就已经是这样，研究人员的答案都很简单：可序列化（serializeble）级别（但非人见人爱），都使用三种技术之一。](#sqvc-1710588820273)

<a name="vf0e-1713164058558"></a>[字面意义上的串行顺序执行事务](#mqa4-1710589545518)

<a name="iump-1713164058560"></a>[两相锁定2PL two-phase locking,几十年来唯一的可行选择](#neot-1710589568078)

<a name="jzxn-1713164058562"></a>[乐观并发控制，可序列话的快照隔离serializable snapshot isolation](#pizj-1710589721553)

<a name="hdvy-1713164058564"></a>[真的串行执行(单线程执行事务)](#2oi3-1710172506817)

<a name="aqjo-1713164058566"></a>[数据库设计人员07年才确定，单线程循环执行事务时可行的。（多线程过去30年中被认为是获得良好性能的关键所在）](#o5af-1710589822067)

<a name="6ml8-1713164058568"></a>[两个进展引发了这个反思：](#phuh-1710609564138)

<a name="j4yd-1713164058570"></a>[RAM足够便宜，许多场景可以将完整的活跃数据保存在内存中。-redis](#owi7-1710609747624)

<a name="s0hu-1713164058572"></a>[数据库设计人员意识到OLTP事务很短，只进行少量的读写操作。长时间的分析查询通常是只读的，可以用一致快照（快照隔离）上运行。](#vhy4-1710609817752)

<a name="de8z-1713164058574"></a>[VoltDB/H-Store, Redis 和 Datomic中实现。避免锁的协调开销。吞吐量仅限单个cpu](#xcax-1710609934885)

<a name="f0rb-1713164058576"></a>[在存储过程中封装事务(优化交互式单线程事务)](#xh4n-1710172519134)

<a name="xbzw-1713164058578"></a>[数据库设计者认为，机票全流程是一个事务，可以被原子化执行。缺点：交互式会使流程性能直接下降。](#xthc-1710757083497)

<a name="oqfv-1713164058580"></a>[解决：单线程串行执行事务的系统不允许交互式的多语句事务。提前将整个事务作为存储过程提交数据库：](#oo8b-1710757291600)

<a name="8qvt-1713164058582"></a>[Interactive transaction :bob医生请假 1.select count  2.if count>=2 3.update false](#9fzd-1710757436562)

<a name="ny9k-1713164058584"></a>[stored procedure: execute stored take doctor of call](#gegl-1710763202697)

<a name="8pem-1713164058586"></a>[事务所需的数据都在内存中，快速执行，无需等待网络和磁盘IO](#t47s-1710763179337)

<a name="pdm4-1713164058588"></a>[存储过程的优点和缺点](#7ksv-1710172529258)

<a name="bdil-1713164058590"></a>[名声不好：](#jfoa-1710763413471)

<a name="ptyd-1713164058592"></a>[陈旧丑陋无库生态，数据库存储过程各自的语言没跟上通用编程语言的发展](#4qhf-1710763421594)

<a name="nyxb-1713164058594"></a>[管理困难，调试困难，版本控制测试部署困难，和监控指标的系统集成困难](#96la-1710763483936)

<a name="aps8-1713164058596"></a>[单个数据库通常由多个应用共享，写得不好的存储过程（占用大量内存和cpu）会比代码造成更大麻烦](#idii-1710763602399)

<a name="h5ix-1713164058598"></a>[ 这些问题都可以克服。现代存储过程放弃了PL/SQL,使用现有通用编程语言：VoltDB使用java或Groovy, Datomic使用Java或Clojure, Redis使用Lua.](#1w0a-1710763899035)

<a name="bgow-1713164058600"></a>[存储过程与内存存储，使得单线程执行事务可行，](#bp68-1710767504595)

<a name="9l3d-1713164058602"></a>[无需等待I/O,](#ahfz-1710767568244)

<a name="pcvi-1713164058604"></a>[避免并发控制机制的开销，可以在单线程实现相当好吞吐量](#mfvt-1710767570930)

<a name="1xxu-1713164058606"></a>[VoltDB还用存储过程进行复制，在每个节点上执行相同的存储过程，所以要求存储过程是确定性的。比如使用当前日期，需要通过特殊的确定性API实现。](#7m1p-1710767621202)

<a name="hkti-1713164058608"></a>[分区](#xxtp-1710172539181)

<a name="msxw-1713164058610"></a>[顺序执行事务使并发控制简单多，但吞吐限制为单机单核。吞吐量高的应用，单线程将可能成为严重瓶颈。](#rqu5-1710767939361)

<a name="t1ab-1713164058612"></a>[扩展多核多节点，可以对数据进行分区，每个事务只需在单个分区中读写数据，事务吞度量就可以与cpu保持现行扩展。](#puih-1710768082742)

<a name="bdgd-1713164058614"></a>[对于需要访问多个分区的任务事务，需要进行协调，存储过程跨所有分区锁定执行，保证串行。](#jpiw-1710768164695)

<a name="hqaa-1713164058616"></a>[缺点：协调开销性能比单区事务慢得多。VoltDB吞吐量每秒1000个跨分区写入，比单分区低几个数量级，且通过增加机器来提高](#fgu3-1710768218238)

<a name="ewpt-1713164058618"></a>[事务是否可划分-应用的数据结构，键值数据，多个二级索的数据引需要大量跨分区协调。](#8lf4-1710768407791)

<a name="vczy-1713164058620"></a>[串行执行小结](#zyih-1710172540516)

<a name="0owc-1713164058622"></a>[需每个事务小而快，一个缓慢的事务拖慢所有事务。](#dibg-1710768638498)

<a name="z3ho-1713164058624"></a>[可放入内存仅限活跃数据集，少量数据会移动到磁盘。但需要访问执行中的事务，系统会变慢。](#22nq-1710768681244)

<a name="qaxa-1713164058626"></a>[写入吞吐量必须低到能在单个cpu运行，否则事务能划分至但分区，且无需分区协调](#jmsk-1710768781527)

<a name="fclf-1713164058628"></a>[跨分区事务使用程度受限。](#wlnd-1710769060180)

<a name="3bfd-1713164058630"></a>[两阶段锁定（2PL）](#uhxa-1710172558745)

<a name="ponp-1713164058632"></a>[30年高使用的序列化算法：两阶段锁定2PL two phase locking ,独占访问exclusive access:](#nhdj-1710769248115)

<a name="2af7-1713164058634"></a>[事务A读取对象，阻塞B写入，直至A提交；](#khdp-1710769659952)

<a name="rmtu-1713164058636"></a>[事务A写入对象，阻塞B读取,直至A提交；](#elpw-1710769685611)

<a name="qhor-1713164058639"></a>[快照隔离使得不会阻塞读，2PL提高序列化性质，解决丢失更新和写入偏差。](#6ja2-1710769959539)

<a name="zme2-1713164058641"></a>[实现两阶段锁](#lfuv-1710172605096)

<a name="rgyg-1713164058643"></a>[2PL即innoDB可序列化级别及DB2可重复读隔离级别。](#8oif-1710770052594)

<a name="1peg-1713164058645"></a>[读写阻塞为每个对象添加锁。共享模式shared mode 与独占模式exclusive mode:](#6wad-1710770158675)

<a name="tytl-1713164058647"></a>[读取对象需以共享模式获取锁。读共享](#1dyc-1710770195788)

<a name="ddpy-1713164058649"></a>[写入需独占模式取锁。写互斥。](#bshw-1710770251530)

<a name="e00s-1713164058651"></a>[事务获得锁必须持有锁知道事务结束(提交或中止)。即一阶段获取锁，二阶段释放所有锁。](#r0b0-1711207524774)

<a name="tgf9-1713164058653"></a>[死锁deadlock, 数据库会自动检测死锁，并中止其中一个。被中止的事务充实需应用程序实现。](#iuyh-1710770211133)

<a name="aasc-1713164058655"></a>[两阶段锁定的性能](#qi7j-1710172616303)

<a name="vxwy-1713164058657"></a>[比弱隔离差得多](#vz0p-1711207837446)

<a name="da0d-1713164058659"></a>[锁开销、串行并发性降低](#ienx-1711207878742)

<a name="raey-1713164058661"></a>[交互式事务形成等待队列、高百分位响应慢](#z85f-1711207913718)

<a name="k7kw-1713164058663"></a>[死锁频繁时重试造成浪费](#kmkr-1711207799940)

<a name="vawa-1713164058665"></a>[谓词锁predicate lock](#ccq8-1710172621528)

<a name="khzm-1713164058667"></a>[谓词锁：属于符合搜索条件的对象，解决幻读phantoms](#kfpi-1711208306292)

<a name="hj1k-1713164058669"></a>[事务A获取共享谓词锁shared-mode predicate lock读取匹配对象，与排它互斥](#6dqd-1711208459688)

<a name="60hi-1713164058671"></a>[事务A写入需等待其他事务谓词锁释放。](#p3er-1711208588906)

<a name="jyal-1713164058673"></a>[适用于尚不存在，将可能添加的对象（幻象），如果两阶段包含谓词锁，可实现串行化。](#bdwj-1711208433268)

<a name="rk0i-1713164058675"></a>[索引范围锁next-key lock](#zv5c-1710172626404)

<a name="dgiq-1713164058677"></a>[谓词锁性能不佳：活跃事务持锁多，检查匹配非常耗时](#a3ce-1711208973949)

<a name="rm9w-1713164058679"></a>[2PL采用索引范围锁-简化版谓词锁：](#ayfb-1711209059199)

<a name="xbzj-1713164058681"></a>[索引位于roomid, 指示room123用于预定](#qmbu-1711212311152)

<a name="lurh-1713164058683"></a>[或者索引位于时间上，指示12:00~13:00用于预定。](#ajbo-1711212362665)

<a name="nrxo-1713164058685"></a>[以上任何一条件，当另一个事务想写入时，需要更新索引-叶子节点，会收到共享锁。解决幻读和写入偏差](#k1ie-1711212755816)

<a name="pry6-1713164058687"></a>[索引范围锁不如谓词锁精确，但开销低](#6lzs-1711212829915)

<a name="vv5p-1713164058689"></a>[无可挂载索引，将退化为表锁，性能不利，但这是回退到一个安全位置。](#bofb-1711212877091)

<a name="g7lg-1713164058691"></a>[序列化快照隔离SSI（高性能序列化算法）](#slwa-1710172573367)

<a name="rh5i-1713164058693"></a>[新算法：可序列化快照隔离SSI serializeble snapshot isolation 仅与快照隔离有很小性能损失. 08年 micheal cahill博士论文。](#lnci-1711213123166)

<a name="atmi-1713164058695"></a>[用于单节点PostgreSQL9.1后序列化和分布式数据库](#weo0-1711213307841)

<a name="ipy6-1713164058697"></a>[处于实践证明阶段](#ue1s-1711213377985)

<a name="glqf-1713164058699"></a>[悲观pessimistic与乐观optimistic的并发控制](#yq9i-1710172639651)

<a name="eoah-1713164058701"></a>[极致悲观：串行排它锁](#54jr-1711213690005)

<a name="joot-1713164058703"></a>[序列化快照隔离SSI是乐观技术： ](#bjxf-1711213769533)

<a name="olug-1713164058705"></a>[缺点：多事务争用contention时性能不佳，大部分事务中止，吞吐量极限下有重试机制将使性能变差。](#mefw-1711213819265)

<a name="lnui-1713164058707"></a>[优点：有备用容量，竞争不高场景比悲观好，可交换的原子操作可减少争用。](#nk1s-1711213915330)

<a name="vhqh-1713164058709"></a>[SSI在快照隔离基础上添加算法检测写入的序列化冲突，并决定中止哪些事务。](#snvf-1711214019984)

<a name="4f0o-1713164058711"></a>[基于过时前提的决策](#9lgw-1710172651041)

<a name="xpez-1713164058713"></a>[医生值班读取-修改-写入。数据库检测过时并终止：](#td4m-1711214184809)

<a name="qnqf-1713164058715"></a>[检测对旧MVCC对象版本的读取(读之前存在未提交的写入)](#t08a-1711215992016)

<a name="axhp-1713164058718"></a>[检测影响先前读取的写入（读之后发生写入）](#aego-1711216030637)

<a name="qpng-1713164058720"></a>[检测旧MVCC读取](#5smj-1710172660675)

<a name="uzyy-1713164058722"></a>[事务提交时，检测是否有被忽略的写入已被提交。](#z7u2-1711216050316)

<a name="9rti-1713164058724"></a>[SSI支持一致快照中长时间运行的读取-仅在提交时中止检测的陈旧读取。因为只读不产生幻读和写入偏差风险](#afqq-1711216243096)

<a name="duyw-1713164058726"></a>[检测影响之前读取的写入](#mvok-1710172671381)

<a name="eb22-1713164058728"></a>[事务写入提交时，在索引中查找最近读取受影响的其他事务，通知读取的事务非最新。并中止未提交写入的其他事务。](#mo5j-1711216452745)

<a name="fgu7-1713164058730"></a>[可序列化的快照隔离的性能](#0sq6-1710172685702)

<a name="sy06-1713164058732"></a>[粒度granularity，精准哪些事务需要中止，但簿记开销显著。](#g2eg-1711216636788)

<a name="hmhh-1713164058734"></a>[简略的跟踪速度快（粗粒度），但导致不必要的事务中止。](#ux2m-1711216812849)

<a name="quwb-1713164058736"></a>[相比2PL, 不需要锁定阻塞，读性能高](#jzqb-1711216700614)

<a name="ca2z-1713164058738"></a>[相比串行化，可扩展多台机器提高吞吐量，可跨分区读。](#qm51-1710756953994)

<a name="zevg-1713164058740"></a>[SSI要求事务尽量短，避免长事务发生冲突中止。慢事务SSI比2PL或串行执行更不敏感](#wvsk-1711216911828)

<a name="t99p-1713164058742"></a>[8.分布式系统的麻烦](#enui-1704985776096)

<a name="osb0-1713164058744"></a>[前几章failover故障切换, 复制延迟 与事务控制 处理各种可能发生的边缘情况，本章则是彻底的悲观总结。](#e2bp-1711387736669)

<a name="krti-1713164058746"></a>[故障与部分失效](#4yaw-1711386647072)

<a name="tmfy-1713164058748"></a>[部分失效partial failure  不确定性的nondeterministic: IDC配电单元故障](#9d0g-1711387883443)

<a name="0haj-1713164058750"></a>[云计算与超级计算机](#w7ln-1711386736921)

<a name="jy8t-1713164058752"></a>[不可靠的网络(Timeout)](#ynhs-1711386665148)

<a name="opqp-1713164058754"></a>[请求丢失： 拔网线](#fav6-1711388032544)

<a name="bltq-1713164058756"></a>[请求排队：](#znsf-1711388048086)

<a name="vla2-1713164058758"></a>[请求失效：](#gmdu-1711388084834)

<a name="wjou-1713164058760"></a>[.....](#dssu-1711388054944)

<a name="xarc-1713164058762"></a>[真实世界的网络故障](#y933-1711387087536)

<a name="8exe-1713164058764"></a>[检测故障](#aywv-1711387099045)

<a name="1uhf-1713164058766"></a>[超时与无穷的延迟](#z4hi-1711387103669)

<a name="mbdh-1713164058768"></a>[级联失效cascading failure](#qs2e-1711388153448)

<a name="tlpx-1713164058770"></a>[网络拥塞和排队](#gttn-1711387323883)

<a name="7fyl-1713164058772"></a>[TCP执行流量控制flow control](#v9f2-1711388199023)

<a name="jjos-1713164058774"></a>[视频、语音会议使用UDP，折中丢包与流畅](#up7k-1711389082773)

<a name="nnmv-1713164058776"></a>[同步网络vs异步网络](#t56p-1711387113980)

<a name="qynd-1713164058778"></a>[有限延迟bounded delay：同步网络，不收排队影响](#fmrl-1711389283437)

<a name="e2yv-1713164058780"></a>[我们不能简单地使用网络延迟可预测吗](#bwvp-1711387335617)

<a name="m5ob-1713164058782"></a>[不可靠的时钟](#l3p1-1711386676597)

<a name="3cdu-1713164058784"></a>[机器的时钟：硬件设备，石英振荡器，](#faqp-1711469591901)

<a name="kweb-1713164058786"></a>[不是完全准确的。](#xtjc-1711469629964)

<a name="mruh-1713164058788"></a>[同步时钟：网络时间协议NTP](#knwp-1711469656643)

<a name="lae6-1713164058790"></a>[服务器从精确时间源获取时间-GPS接收器](#pfpq-1711469689783)

<a name="wkaw-1713164058792"></a>[单调钟与时钟](#qoxv-1711387218692)

<a name="n7gn-1713164058794"></a>[时钟](#wu2k-1711387376627)

<a name="u8yh-1713164058796"></a>[Linux: clock_gettime(CLOCK_REALTIME)](#obwb-1711469781129)

<a name="c0ca-1713164058798"></a>[java:system.currentTimeMilis](#uxdp-1711469821742)

<a name="ccuo-1713164058800"></a>[通常与NTP同步，但举例NTP服务器太远，则可能被强制重置(及时跳回）](#gwyx-1711469840905)

<a name="qtwa-1713164058802"></a>[单调钟](#hl1a-1711387385739)

<a name="qot9-1713164058804"></a>[保证总是前进](#uzaz-1711470052827)

<a name="vyxj-1713164058806"></a>[Linux:CLOCK_MONOTONIC](#tbmn-1711469988760)

<a name="ikpa-1713164058808"></a>[java:System.nanoTime](#fb70-1711470014393)

<a name="bdza-1713164058810"></a>[调整频率：NTP检测到计算机石英钟更快或更慢，则调整单调钟频率（偏移skewing时钟）.](#sn42-1711470028035)

<a name="gnev-1713164058813"></a>[不假定不同节点时钟存在同步：分布式系统用单调钟效果好，对测量的不准确不敏感](#ct3v-1711470667953)

<a name="sn2l-1713164058815"></a>[时钟同步与准确性](#a7gy-1711387238026)

<a name="qvo8-1713164058817"></a>[漂移drifts: 计算机石英钟不准确原因,取决机器温度。](#pbyu-1711470750697)

<a name="8onk-1713164058819"></a>[实现精确度：GPS接收机，精确时间协议PTP](#kgdy-1711470917769)

<a name="ppqd-1713164058821"></a>[同步错误的原因：NTP守护进程配置错误，防火墙阻止NTP通信。](#kgez-1711470944635)

<a name="lqbp-1713164058823"></a>[依赖同步时钟](#vo0i-1711387245745)

<a name="xi6c-1713164058825"></a>[使用需要同步时钟的软件需监测所有机器间的时钟偏移](#zm2f-1711471000801)

<a name="uotn-1713164058827"></a>[有序事件的时间戳](#fnxq-1711387475761)

<a name="xyoi-1713164058829"></a>[写入排序问题：B客户端写入比A晚但具有更早的时间戳。 ](#n1pp-1711471283186)

<a name="jqvr-1713164058831"></a>[ 最后写入为准LWW](#50kp-1711471399605)

<a name="ytoc-1713164058833"></a>[ 版本向量](#axgx-1711471482711)

<a name="d6mn-1713164058835"></a>[时钟读数存在置信区间](#ofpq-1711387431462)

<a name="mhqi-1713164058837"></a>[ 置信区间的不确定性：NTP服务器的不去定性，加上服务器网络往返时间](#aihs-1711471513794)

<a name="6sep-1713164058839"></a>[当clock_gettime()返回值不会告诉你预期错误，不知道置信区间是5毫秒还是5年](#aave-1711471693187)

<a name="jpuz-1713164058841"></a>[例外：Spanner Google TureTime API明确报告本地时钟置信区间（最早，最晚）。](#znqm-1711471741654)

<a name="i17z-1713164058843"></a>[全局快照的同步时钟](#bfz6-1711387449885)

<a name="undb-1713164058845"></a>[分布式的事务快照隔离，分布式事务ID时序成为站不住脚瓶颈](#dpco-1711471815493)

<a name="sm4n-1713164058847"></a>[Spanner通过置信区间来比较A,B发生的时序。](#2ihe-1711471939317)

<a name="blo0-1713164058849"></a>[分布式事务语义使用时钟同步是一个活跃的研究领域，没有在谷歌之外的主流数据库中实现。](#9qfk-1711471991096)

<a name="pjnv-1713164058851"></a>[暂停进程](#3mnj-1711387250438)

<a name="vbky-1713164058853"></a>[如何确保分布式主节点仍未领导者](#ui0e-1711472636558)

<a name="z3sw-1713164058855"></a>[方式一：从其他节点获得租约lease, 类似一个带超时的锁，周期性过期前续约。-和redison续约类似](#yh9a-1711472775035)

<a name="21rz-1713164058857"></a>[过期时，由另一个节点接管。](#kqwv-1711472837428)

<a name="s6tq-1713164058859"></a>[缺点：依赖同步时钟](#gi5a-1711473874947)

<a name="xxrw-1713164058861"></a>[意外的时间停顿：](#93uw-1711473992955)

<a name="bs04-1713164058863"></a>[stop-the-world  HotSpot GC](#7kp7-1711474017909)

<a name="pao5-1713164058865"></a>[suspend虚拟机](#6ejp-1711474059672)

<a name="thxt-1713164058867"></a>[随意暂停恢复：关闭笔记本盖子](#92se-1711474080346)

<a name="fzos-1713164058869"></a>[窃取时间steal time:虚拟机切换或cpu上下文切换，在其他机器中花费的时间.](#tfxw-1711474128862)

<a name="mwcw-1713164058871"></a>[同步时的阻塞io：java惰性加载类文件；磁盘为网络文件系统或网络块设备-亚马逊EBS](#7jwg-1711474280466)

<a name="dzjd-1713164058873"></a>[磁盘交换内存抖动thrashing: 允许交换到磁盘（分页），内存访问可能导致页面错误page fault .话费大量时间将页面交换到内存，实际完成的工作很少thrashing。 服务器机器禁用页面调度，干掉进程释放内存。](#kvsa-1711474441136)

<a name="syil-1713164058875"></a>[SIGSTOP暂停unix进程:Ctrl-Z立即阻止进程的CPU周期](#ocvk-1711474648160)

<a name="0jnr-1713164058877"></a>[这些都可以随时抢占preempt正在运行的线程。](#t1w7-1711474768157)

<a name="vp5u-1713164058879"></a>[响应时间保证](#cirf-1711473855327)

<a name="0m2d-1713164058881"></a>[硬实时hard real-time系统: 不满足特定截止时间deadline可能会导致整个系统故障。](#r1ji-1711474887529)

<a name="aqqe-1713164058883"></a>[嵌入式系统精心设计和测试：安全气囊不会因系统GC暂停弹出。](#pgjw-1711475001376)

<a name="bijr-1713164058885"></a>[大量的额外工作，昂贵。](#urp5-1711475089330)

<a name="uvca-1713164058887"></a>[限制垃圾收集的影响](#i1wt-1711387521748)

<a name="mg2v-1713164058889"></a>[通知GC暂停，停止接收新请求-对延迟敏感的金融系统](#oxal-1711475134772)

<a name="ic0i-1713164058891"></a>[变种：GC只收集新生代，积累老年代，一次重启一个节点，类似滚动升级。](#ho3v-1711475217820)

<a name="m8bp-1713164058893"></a>[知识、真相与谎言](#ujyf-1711386681865)

<a name="aej6-1713164058895"></a>[真理由多数所定义](#hdwi-1711387268312)

<a name="4m03-1713164058897"></a>[stop the world 一分钟，被其他节点宣告死亡，重新选举。](#rxcy-1711561420884)

<a name="8f1f-1713164058900"></a>[领导者与锁定](#3zea-1711387542106)

<a name="mul2-1713164058902"></a>[数据库分区领导者只能有一个节点：避免脑裂](#b6am-1711561462773)

<a name="nduw-1713164058904"></a>[特定资源的锁和对象只允许一个事务/客户端持有](#3ynw-1711561525662)

<a name="wkfu-1713164058906"></a>[用户唯一标识](#hqa3-1711561556083)

<a name="cu14-1713164058908"></a>[节点认为它是天选者the choosen one](#rv2w-1711561875596)

<a name="h2oh-1713164058910"></a>[HBase例子：分布式锁的实现不正确，客户端1持有锁stop the world导致lease超时,客户端2获得锁进行处理，客户端1仍认为它具有有效的租约，即使它已经过期，从而破坏了存储的文件。](#gu25-1711561617808)

<a name="kdlo-1713164058912"></a>[防护令牌](#mhlf-1711387550649)

<a name="rbqs-1713164058914"></a>[解决天选者问题：防护fencing](#gw5w-1711561950975)

<a name="yjbd-1713164058916"></a>[fencing token :只允许增加屏蔽令牌的顺序进行写操作。](#vi5w-1711562021406)

<a name="yad2-1713164058918"></a>[服务器端检查token,获取锁时token增加33+1，存储服务器记录更高令牌34的写入，拒绝令牌33的请求。-一般是redisson续期，这个更像乐观锁。](#2yxl-1711562140276)

<a name="ew8m-1713164058920"></a>[ZooKeeper将事务标识zxid和节点版本conersion用作屏蔽令牌。保证了单调递增](#e6n2-1711562077138)

<a name="x9gt-1713164058922"></a>[如文件存储服务器可将令牌卸载文件命中](#uujk-1711564755459)

<a name="xyru-1713164058924"></a>[拜占庭故障](#bsay-1711387279845)

<a name="xo9p-1713164058926"></a>[拜占庭故障Byzantine fault: 在不信任的环境中达成共识的问题称为拜占庭将军问题。](#id0b-1711628556885)

<a name="i8ut-1713164058928"></a>[拜占庭将军问题：n位将军需要同意，一些叛徒通过发送虚假或不真实信息来混淆欺骗他人。](#lxw6-1711628612728)

<a name="htzb-1713164058930"></a>[拜占庭容错：系统在部分节点发生故障、不遵守协议，恶意攻击，扰乱网络时仍能继续正确工作：](#lpn6-1711628716132)

<a name="tguw-1713164058932"></a>[航空航天环境计算机被辐射破坏，不可预知方式响应其他节点](#py6z-1711638469892)

<a name="pyot-1713164058934"></a>[多个参与组织系统中，参与者试图欺骗他人。比特币等区块链对等网络让互不信任的各方同意交易不依赖中央当局。](#csli-1711638605446)

<a name="pd4z-1713164058936"></a>[弱谎言形式](#f38o-1711387557457)

<a name="jtrr-1713164058938"></a>[添加防止撒谎弱形式机制；](#eepx-1711638744038)

<a name="l8fe-1713164058940"></a>[校验和防止数据包被破坏](#yseh-1711638821915)

<a name="jfeg-1713164058942"></a>[公开访问的系统需仔细清理来自用户的任何输入](#2a8h-1711638847924)

<a name="ht5o-1713164058944"></a>[NTP多数对时间范围达成一致，配置错误的服务器将被排除](#zcdt-1711638888096)

<a name="xews-1713164058946"></a>[系统模型与实现](#x4lu-1711387293192)

<a name="au53-1713164058948"></a>[定时假设三种系统模型：](#iyps-1711639179162)

<a name="bzky-1713164058950"></a>[同步模型synchronous model: 网络延迟，暂停和时钟漂移不会超过某个固定上限；](#pgo0-1711640511485)

<a name="fkh6-1713164058952"></a>[部分同步模型partial synchronous：大多数情况像一个同步系统一样运行，有时出现超时，进程暂停和时钟漂移界限](#h1x4-1711640383000)

<a name="w4wl-1713164058954"></a>[异步模型：一个算法不允许对实际做任何假设，事实上它甚至没有时钟。](#vkkn-1711640459345)

<a name="dyqb-1713164058956"></a>[节点系统模型：-节点失效问题](#lg5f-1711640536166)

<a name="axnh-1713164058958"></a>[崩溃停止crash-stop:只能由崩溃失效，且永远不会回来。](#ahco-1711640498506)

<a name="x4lp-1713164058960"></a>[崩溃恢复crash-recovery: 具有稳定存储（非易失性磁盘），崩溃中保留，内存中状态会丢失-innodb三阶段提交](#35nl-1711640632666)

<a name="rvqz-1713164058962"></a>[拜占庭（任意）故障：节点可以做任何事情，包括戏弄和欺骗其他节点](#rpmc-1711640822813)

<a name="tia7-1713164058964"></a>[具有崩溃恢复的部分同步模型是最有用的模型。分布式算法如何应用这种模型](#6gea-1711640879281)

<a name="4d8o-1713164058966"></a>[算法的正确性](#hwoz-1711387576180)

<a name="xbv6-1713164058968"></a>[描述属性：定义算法的正确性](#i9kv-1711640972087)

<a name="0n63-1713164058970"></a>[锁生成屏蔽令牌，要求具有以下属性：](#qsck-1711641049261)

<a name="wfo4-1713164058972"></a>[唯一性：没有两个屏蔽令牌请求返回相同的值](#tvxj-1711641079676)

<a name="ng5q-1713164058974"></a>[单调序列：时序实现单调](#2d0a-1711641105012)

<a name="ax0d-1713164058976"></a>[可用性：请求防护令牌且不会崩溃的节点，最终会收到响应](#mlbd-1711641130527)

<a name="vgym-1713164058978"></a>[安全性和活性](#1lz8-1711387585629)

<a name="x7oq-1713164058980"></a>[澄清这种情况，需区分两种不同性质](#hctm-1711641203049)

<a name="6ub5-1713164058982"></a>[安全性safety: 唯一性和单调序列](#k48b-1711641295367)

<a name="xfl8-1713164058984"></a>[活性：可用性](#fmy7-1711641313609)

<a name="mnz6-1713164058986"></a>[将系统模型映射到现实世界](#ndiw-1711387592922)

<a name="64du-1713164058989"></a>[9.一致性共识](#rp9s-1705080859004)

<a name="xjlx-1713164058991"></a>[共识consensus: 让所有节点对某件事达成一致](#vrvh-1712996687843)

<a name="aoqc-1713164058993"></a>[脑裂brain split: 两个节点都认为自己是master, 经常导致数据丢失；](#oqcs-1712996726634)

<a name="4wcl-1713164058995"></a>[一致性保证](#obqn-1711730044966)

<a name="jcij-1713164058997"></a>[最终一致性：收敛convergence, 最终收敛到相同的值](#ku5g-1712996774138)

<a name="n5mg-1713164058999"></a>[事务一致性：避免同时执行事务导致的竞争状态](#ga60-1712996859001)

<a name="5e7d-1713164059001"></a>[分布式一致性模型：面对延迟和故障时，如何协调副本间的状态](#eovi-1712996916251)

<a name="tcb1-1713164059003"></a>[线性一致性](#thyh-1711730049653)

<a name="x9bj-1713164059005"></a>[背后的想法：原子一致性atomic consistency, 强一致性strong consistency, 立即一致性 immediate consistency ,外部一致性 external consistency](#bvre-1712997165569)

<a name="koyd-1713164059007"></a>[看起来只有一个数据副本，实际有多个副本 - 强一致性就是逆分布式化，看成一个整体。](#qbsw-1712997247742)

<a name="iayn-1713164059009"></a>[线性一致是一个新鲜度保证 recency gurantee;](#f0su-1712997377059)

<a name="g1qb-1713164059011"></a>[非线性一致的例子： world cup ,  alice refresh - DB1 return germany 1: 0 argentina won ;  bob refresh website - DB2(un asychronize) return still playing;](#mtb7-1712997407717)

<a name="tdq5-1713164059013"></a>[为什么使得系统线性一致？](#qimr-1711730403998)

<a name="lsid-1713164059015"></a>[例子：CAS使得多个客户端并发按序更新](#ffat-1712998155207)

<a name="sxm1-1713164059017"></a>[线性一致性与可序列化是两种完全不同的保证：](#3elk-1712997586736)

<a name="xpun-1713164059019"></a>[可序列化serializeble: 单对象或者多对象操作，确保按照某种顺序执行](#qpvu-1712998010030)

<a name="nzt9-1713164059021"></a>[线性一致性Linearizability:是读取和写入寄存器（单个对象）的新鲜度保证，不会将操作组合为事务，不会阻止写入偏差等问题](#ojsh-1712998125336)

<a name="fok9-1713164059023"></a>[单副本强可串行性strong-1SR: 一个数据库可提供可串行性和线性一致, 基于两阶段锁2PL和实际串行执行通常是线性一致的](#5hda-1712998332148)

<a name="cmy7-1713164059025"></a>[SSI一致性快照不是线性一致的：不会包括比快照更新的写入；-不会阻塞非写的读。](#obfn-1712998432352)

<a name="4nq6-1713164059027"></a>[依赖线性一致性](#bje8-1711730427157)

<a name="1wwn-1713164059029"></a>[锁定与领导选举](#xyll-1711730652620)

<a name="y8rj-1713164059031"></a>[领导选举的一种方法：每个节点启动时尝试获取锁，成功者称为领导者。](#2fqs-1712998599719)

<a name="e0od-1713164059033"></a>[保证锁时线性一致的： zookeeper 和 etcd 协调服务的一致性算法。curator基于zookeeper上更高级别的配方](#cbzr-1712998723133)

<a name="s7hd-1713164059035"></a>[约束和唯一性保证](#gpva-1711730659968)

<a name="q0s2-1713164059037"></a>[这种情况类似于一个锁，锁定用户名。该操作与原子性的cas类似：](#9jmj-1712998930168)

<a name="fgar-1713164059039"></a>[用户名和邮箱；](#lhyk-1712999021176)

<a name="2f2m-1713164059041"></a>[银行账号不为负数；](#7sgo-1712999031257)

<a name="0xtt-1713164059043"></a>[航班剧院预定了同一时间同一位置](#so5k-1712999045093)

<a name="8qxp-1713164059045"></a>[实际应用中，处理这些限制有时可以接受。如调换位置并补偿。](#q05j-1712999070223)

<a name="bbuj-1713164059047"></a>[跨信道的时序依赖](#7cbv-1711730671963)

<a name="4tjp-1713164059049"></a>[将用户上传的照片降低分辨率以加快下载速度：](#cqkp-1712999245541)

<a name="fedp-1713164059051"></a>[步骤：消息队列一般针对较短的消息而设计，一张图片可能达到几M.所以步骤为](#3zoo-1712999362806)

<a name="k4db-1713164059053"></a>[1.上传照片-  web server-2.  (store img) 存储文件服务器  ](#umkb-1712999318589)

<a name="zb7u-1713164059055"></a>[  | 3. send message  || 5.fetch full size img  6.store resized img](#er8u-1712999518585)

<a name="ydsd-1713164059057"></a>[消息队列   - 4.deliver message     image resizer](#iiv4-1712999532781)

<a name="ychz-1713164059059"></a>[问题：存储和缩放存在两个不同的信道，没有线性一致的新鲜度保证](#0yys-1712999647965)

<a name="7kch-1713164059061"></a>[3和4可能比存储服务器内部的复制更快，当5时，可能会看到图像旧版本或者什么都没有，如果处理的是旧版本，则产生不一致。](#xtun-1712999768959)

<a name="eevy-1713164059063"></a>[实现线性一致性的系统](#ytt0-1711730433598)

<a name="b1px-1713164059065"></a>[单主复制（可能线性一致）protential潜在线性一致：](#j997-1712999879559)

<a name="fcfs-1713164059067"></a>[快照隔离并发错误；](#t174-1712999979364)

<a name="jsuo-1713164059069"></a>[脑裂；异步复制延迟，故障切换](#hh6o-1712999996439)

<a name="rsuf-1713164059071"></a>[共识算法（线性一致）：共识算法可以安全实现线性一致性的存储，zookeeper 和 etcd](#z3nq-1713000050923)

<a name="tx7k-1713164059073"></a>[多主复制（非线性一致）：同时多个节点上处理写入，异步复制到其他节点，会产生冲突的写入](#q0kz-1713000066034)

<a name="2yo7-1713164059075"></a>[无主复制（也许不是线性一致的）：Dynamo风格，法定人数读写获得强一致性。通常不完全正确](#ca4m-1713030167882)

<a name="lsve-1713164059077"></a>[线性一致性和法定人数](#9gst-1711730681011)

<a name="0gua-1713164059080"></a>[最安全的做法是：假设采用Dynamo风格的无主复制的系统是不能提供线性一致性。](#sqvx-1713030399799)

<a name="eouc-1713164059082"></a>[线性一致性的代价](#vpxf-1711730440465)

<a name="fryy-1713164059084"></a>[CAP定理](#fqqf-1711730717308)

<a name="cgvm-1713164059086"></a>[不仅是单主多主复制的后果，任何线性一致性的数据库都有这个问题：](#8hzl-1713030564813)

<a name="mkmb-1713164059088"></a>[.应用需要线性一致性，副本因为网络问题断开连接，请求必须等到网络问题解决或直接返回错误（不可用unavailable）](#7lux-1713030592466)

<a name="ymn1-1713164059090"></a>[.网络断开也可独立处理请求（如多主复制），可以在网络问题前保持可用，但其行为不是线性一致的。](#48wk-1713031150235)

<a name="kddm-1713164059092"></a>[CAP定理没有帮助：网络分区是不可避免的，所以只能是AP 或 CP。](#lsdc-1713031249676)

<a name="5uyn-1713164059094"></a>[线性一致性和网络延迟](#kxsm-1711730728177)

<a name="9jyi-1713164059096"></a>[ 线性一致的系统惊人的少。例如多核CPU并没有保证一定能读到第一个线程写入的值（除非使用内存屏障memory barrier或围栏fence）](#lbl2-1713031508671)

<a name="jnwa-1713164059098"></a>[ 牺牲线性一致性的原因是性能performance. 内存访问先走缓存，副本都是异步更新的，所以失去了线性一致性。](#pnsn-1713031585885)

<a name="kwga-1713164059100"></a>[搞笑的线性一致性存储不可实现。](#8y6v-1713031685808)

<a name="9d5x-1713164059102"></a>[顺序保证](#on5f-1711730057760)

<a name="egf8-1713164059104"></a>[写入顺序order of write: 单主复制的主要目的就是复制日志中确定写入顺序。](#dhiv-1713031758875)

<a name="rpm2-1713164059106"></a>[序列顺序serial order：某种序列顺序some sequential order](#cyfr-1713031815356)

<a name="ffki-1713164059108"></a>[顺序与因果](#z48k-1711730472679)

<a name="inwh-1713164059110"></a>[顺序有助于保持因果关系causality](#khzl-1713031939113)

<a name="latb-1713164059112"></a>[一致前缀读：先看到答案再看到问题。违背因cause果effect. 存在因果依赖causal dependency](#nbes-1713031966982)

<a name="x1d6-1713164059114"></a>[更新不存在的记录：3位领导者间的复制，一些写入会压到其他写入。一条记录需被创建才能更新。](#xehj-1713032060272)

<a name="tjyw-1713164059116"></a>[检测并发写入：A和B并发，则不知道顺序，A和B不知道彼此。](#v1kv-1713032135082)

<a name="d4sq-1713164059118"></a>[快照隔离：写偏差read skew，读取的数据违反因果关系（不可重复读）](#ozi8-1713032226341)

<a name="wvkt-1713164059120"></a>[事务的写偏差write skew：幻读和值班。](#pgzq-1713032264605)

<a name="chso-1713164059122"></a>[世界杯球赛结果，跨信道的时序依赖。](#3ang-1713032756197)

<a name="g2ru-1713164059124"></a>[因果一致causally：系统服从因果关系锁规定的顺序。](#tryg-1713032788961)

<a name="m87q-1713164059126"></a>[因果顺序不是全序的](#niwx-1711730751513)

<a name="40i2-1713164059128"></a>[全序total order: 自然数更大或更小，总是有序的](#x8gk-1713086054855)

<a name="quub-1713164059130"></a>[偏序partially order: 一个集合大于另一个集合，但是其它情况下无法比较](#wvsa-1713086222914)

<a name="50vh-1713164059132"></a>[线性一致性：操作是全序的，系统表现好像只有一个副本，所有操作都是原子性的。意味对每个操作总能判定发生顺序](#u7jq-1713086312064)

<a name="bagw-1713164059134"></a>[因果性：两个操作没在彼此之前发生，即并发无法比较顺序，意味着因果关系定义了一个偏序，而不是全序。一些有序一些无序](#xa0w-1713086399916)

<a name="tlhi-1713164059136"></a>[线性一致的数据存储中是不存在并发操作的。确保每个请求都是在唯一时间线上自动处理](#uaxz-1713086531138)

<a name="qjpj-1713164059138"></a>[并发意味着时间线会分叉然后合并。操作的偏序：](#qs64-1713086635361)

<a name="l6p1-1713164059140"></a>[类似git系统，一个提交commit发生在另一个提交之后。分支合并merge会在这些并发创建的提交相融合时创建。](#ctkd-1713086670170)

<a name="wiz2-1713164059142"></a>[线性一致性强于因果一致性](#qdnf-1711730766239)

<a name="qcec-1713164059144"></a>[线性一致性隐含implies着因果关系;](#dam4-1713086279684)

<a name="wvr3-1713164059146"></a>[捕获因果关系](#uqqx-1711730776113)

<a name="cdht-1713164059148"></a>[为了维持因果性，需确认操作发生在哪个操作之前happened before:](#agrw-1713086796608)

<a name="xfe0-1713164059150"></a>[刑侦决定Y时是否知到X与Y因果关系](#rys3-1713086865582)

<a name="xlck-1713164059152"></a>[检测并发写入：推广版本向量解决因果依赖](#znup-1713086911030)

<a name="r3zd-1713164059154"></a>[SSI序列化隔离快照：事务提交时，检测读取是否最新，为此跟踪哪些事务被那些事务锁读取。](#1ivk-1713086936754)

<a name="tm3n-1713164059156"></a>[序列号顺序](#jsuf-1711730485869)

<a name="8khs-1713164059158"></a>[序列号sequence number或时间戳timestamp](#y9ti-1713091524670)

<a name="7fje-1713164059160"></a>[非因果序列号生成器](#qpya-1711730796494)

<a name="qz4g-1713164059162"></a>[兰伯特时间戳](#mtzj-1711730811106)

<a name="yd8x-1713164059164"></a>[兰伯特时间戳提供了与因果关系一致的总排序：施行一个全序](#f8uv-1713091653199)

<a name="se3v-1713164059166"></a>[检测并发写入有着不同目的：区分两个操作是并发的，一个因果依赖另一个。](#2ayx-1713091789731)

<a name="scap-1713164059169"></a>[光有时间戳排序还不够](#elc6-1711730816628)

<a name="czta-1713164059171"></a>[全序广播](#aw2l-1711730490423)

<a name="q0ir-1713164059173"></a>[可靠交付reliable delivery：没有消息丢失，如果消息被传递到一个节点，它将被传递到所有节点](#axul-1713091937508)

<a name="lywx-1713164059175"></a>[全序交付totally ordered delivery: 消息以相同的顺序传递给每个节点。](#cruc-1713091989510)

<a name="5nah-1713164059177"></a>[使用全序广播](#hp3a-1711730834892)

<a name="lffs-1713164059179"></a>[zookeeper和etcd共识服务实际上实现了全序广播](#ztws-1713108978601)

<a name="w099-1713164059181"></a>[状态机复制state machine repliacation: 每个副本都按相同的顺序处理相同的写入。](#i8bk-1713109007327)

<a name="237j-1713164059183"></a>[与之类似，使用全序广播来实现可序列化的事务：真的串行执行，确定的事务以存储过程来执行，每个节点以相同的顺序处理这些消息。](#8jch-1713109071990)

<a name="xdsv-1713164059185"></a>[以及防护令牌的锁服务，全序广播使得所有消息按顺序一次编号，序列号可当做防护令牌(单调递增)，zookeeper中这个序列号称为zxid;](#w19a-1713109204107)

<a name="4d4c-1713164059187"></a>[使用全序广播实现线性一致的存储](#i3vg-1711730844593)

<a name="st8z-1713164059189"></a>[使用线性一致性存储实现全序广播](#xlae-1711730855140)

<a name="xpde-1713164059191"></a>[分布式事务与共识](#y1bv-1711730380233)

<a name="g12x-1713164059193"></a>[让几个节点达成一致get serveral nodes to agree on somthing](#yt5r-1713109388776)

<a name="jo1c-1713164059195"></a>[领导选举：避免脑裂](#d7t7-1713109479427)

<a name="ktks-1713164059197"></a>[原子提交atomic commit：多节点事务提交/中止/回滚](#frsp-1713109508353)

<a name="sime-1713164059199"></a>[原子提交与两阶段提交2PC](#abk6-1711730509647)

<a name="xdoe-1713164059201"></a>[原子性可以避免中间态，多对象事务原子性确保二级索引与主数据库保持一致。](#0h2f-1713110484428)

<a name="18su-1713164059203"></a>[从单节点到分布式原子提交](#iqfd-1711730882368)

<a name="2ngu-1713164059205"></a>[从数据库的角度看，这是单独的事务，任何跨事务正确性的保证都是应用自己的问题。](#h1ym-1713110537245)

<a name="biny-1713164059207"></a>[2PC两阶段提交简介](#roa9-1711730906391)

<a name="2tak-1713164059209"></a>[coodinator协调子事务，子事务单独执行完，在准备阶段询问是否可提交](#vaax-1705118249954)

<a name="hgto-1713164059211"></a>[.全部为是，则分别提交。](#7zwc-1705118288968)

<a name="lfec-1713164059213"></a>[.其中有否，则中断回滚。](#3b8s-1705118337513)

<a name="3rpg-1713164059215"></a>[系统承诺](#kpgk-1711730913393)

<a name="uxcx-1713164059217"></a>[一旦协调者做出决定，这一决定是不可撤销的。](#wkui-1713110739239)

<a name="pr35-1713164059219"></a>[协调者失败](#qhdj-1711730921387)

<a name="ikaj-1713164059221"></a>[参与者投赞成票后，参与者协调者崩溃，数据库1不知道是否提交或中止。](#jpd8-1713110804532)

<a name="mxus-1713164059223"></a>[三阶段提交](#ixzv-1711730924556)

<a name="oumi-1713164059225"></a>[阻塞blocking原子提交协议, 2PC可能卡主等待协调者恢复的情况。](#edp3-1713111179295)

<a name="gmg9-1713164059227"></a>[在提交阶段，如果子事务进程crash,或者协调者崩溃的时的解决方案，弱原子性，最终一致性。](#llyc-1711731148564)

<a name="vpzx-1713164059229"></a>[许多coodinator不支持高可用或者只支持基本的复制](#nlrk-1705118500709)

<a name="yrjl-1713164059231"></a>[实践中的分布式事务](#xexf-1711730524691)

<a name="zl17-1713164059233"></a>[云服务由于其导致的运维问题而选择不实现分布式事务。](#inqh-1713111548114)

<a name="fu1u-1713164059235"></a>[两阶段难以实现安全保证，且导致的运维问题造成性能下降。](#zuho-1713111590325)

<a name="koio-1713164059237"></a>[数据库内部的分布式事务](#gf92-1711731287296)

<a name="snbw-1713164059239"></a>[VoltDB 与mysql Cluster 的NDB引擎就有这样的内部事务支持。](#jhqw-1705080950920)

<a name="fwif-1713164059241"></a>[异构分布式事务](#gvng-1713111648038)

<a name="bk1q-1713164059243"></a>[保证异构数据库的事务更有挑战性](#st60-1713111659854)

<a name="rhid-1713164059245"></a>[恰好一次的消息处理](#btdt-1711730944613)

<a name="wxcp-1713164059247"></a>[XA事务eXtended Architecture](#qvbk-1711730954739)

<a name="hbo7-1713164059250"></a>[怀疑时持有锁](#med0-1711730959684)

<a name="dtk6-1713164059252"></a>[从协调者故障中恢复](#ouyq-1711730969007)

<a name="4d8s-1713164059254"></a>[唯一的出路是让管理员手动决定提交还是回滚事务](#ouur-1713116418144)

<a name="2smx-1713164059256"></a>[分布式事务的限制](#gzya-1711730975747)

<a name="6xi7-1713164059258"></a>[协调者本身就是一种数据库，存储了事务的结果。](#jkt3-1713116480399)

<a name="flrl-1713164059260"></a>[协调者默认不是高可用的，只有基本的复制](#mcvv-1713116529836)

<a name="w7rn-1713164059262"></a>[应用服务器不再是无状态的了](#h6gt-1713116550997)

<a name="vrv9-1713164059264"></a>[不能检测不同系统间的死锁，且无法与SSI协同工作](#rrrl-1713116568769)

<a name="rjpi-1713164059266"></a>[与构建容错系统的目标背道而驰，分布式事务有扩大失效amplifying failures的趋势](#wbzw-1713116600081)

<a name="r7oq-1713164059268"></a>[容错共识](#npne-1713118985168)

<a name="de7r-1713164059270"></a>[一个或多个节点提议propose某些值，共识算法决定decides采用其中的某个值。](#beiq-1713118985169)

<a name="zgai-1713164059272"></a>[一致同意Uniform agreement:  没有两个节点的决定不同-核心 决定了相同的结果，一旦决定不能改变](#pq0x-1713118985170)

<a name="t5o1-1713164059274"></a>[完整性Integrity: 没有节点决定两次-核心](#xnwp-1713118985171)

<a name="3ira-1713164059276"></a>[有效性validity: 如果一个节点决定了值v, 则v由某个节点所提议-排除平凡的解决方案](#2bty-1713118985172)

<a name="ders-1713164059278"></a>[终止Termination由所有为崩溃的几点来最终决定值。-活性属性，必须取得进展，即使部分节点出现故障，其他节点也必须达成一致。不超过一般的节点崩溃或不可达](#9k32-1713118985173)

<a name="nkku-1713164059280"></a>[稳健达成共识：只要少于三分之一的节点存在拜占庭故障](#scne-1713118985174)

<a name="sypn-1713164059282"></a>[共识算法和全序广播](#prxr-1713118985175)

<a name="e71g-1713164059284"></a>[视图戳复制VSR viewstamped repliacation, Paxos，Raft, Zab](#zmcg-1713118985176)

<a name="mdec-1713164059286"></a>[全序广播相当于重复进行多轮共识：](#1u8f-1713118985177)

<a name="swis-1713164059288"></a>[一致同意属性，所有节点决定以相同的顺序传递相同的消息](#d2l2-1713118985178)

<a name="dz37-1713164059290"></a>[完整性属性，消息不会重复](#z7u4-1713118985179)

<a name="iz09-1713164059292"></a>[有效性属性，消息不会被破坏，也不能凭空编造](#pphb-1713118985180)

<a name="cpzx-1713164059294"></a>[终止属性,消息不会丢失](#gqmq-1713118985181)

<a name="xaxg-1713164059296"></a>[视图戳复制，raft和zab直接实现了全序广播，比重复一次一致one value a time的共识更高效， paxos 下这种优化称为multi-paxos.](#lxll-1713118985182)

<a name="p0pq-1713164059298"></a>[单领导者复制和共识](#krsz-1713118985183)

<a name="bikx-1713164059300"></a>[时代编号和法定人数](#90tt-1713118985184)

<a name="u7jp-1713164059302"></a>[共识的局限性](#qywj-1713118985185)

<a name="2nxl-1713164059304"></a>[成员与协调服务](#8qzt-1713118985186)

<a name="ltnw-1713164059306"></a>[将工作分配给节点](#4tlb-1713118985187)

<a name="5sdy-1713164059308"></a>[服务发现](#tbbj-1713118985188)

<a name="fb8i-1713164059310"></a>[成员服务](#1lld-1713118985189)

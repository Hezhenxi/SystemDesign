...
<a name="gslh-1704438926620"></a>[读写层面的优化](#3l0l-1704424353262)
...
<a name="3l0l-1704424353262"></a>**读写层面的优化**

<a name="a0bx-1704438677201"></a>  **.读优化**
1.缓存
2.索引
3.减少io/批量读
4.减少多余数据加载/列式存储读
<a name="a0bx-1704438677201"></a>  **.写优化**
1.异步写
2.并发写
3.批量写
4.优化算法和数据结构

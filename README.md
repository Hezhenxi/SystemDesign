...
<a name="tkjw-1709800428033"></a>**动态分区(适用键范围的分区)？切分节点/分区数量 还是 切分分区/分区数据量**

<a name="itsg-1709917825657"></a>**解决：使用键范围分区，固定边界的固定数量的分区不便。出现边界错误，手动重新陪去分区边界将非常繁琐。**
...
<a name="99kx-1709800132533"></a><a name="7qvp-1708523954496"></a>**7.事务**

...
<a name="3060-1621846615933"></a><a name="bpqj-1720972916154"></a>[一.数据库设计](#jeyl-1677787446995)

<a name="f1nk-1720972916156"></a>[1. 关系型数据库](#5hya-1677787446996)

<a name="ut2v-1720972916158"></a>[.E-R图，由台湾工程师提出的设计概念](#ohc5-1621692571287)

<a name="iujp-1720972916160"></a>[.流程图-业务逻辑相关，系统用户动作。抽象出E-R图](#5ocb-1645598528868)

<a name="pb0v-1720972916162"></a>[1.1 E-R图 ](#gzqe-1677787446997)

<a name="m8be-1720972916164"></a>[1.根据名词抽象出实体](#r1ac-1621692724628)

<a name="1z1j-1720972916166"></a>[2.名词找属性](#d2fl-1621692745600)

<a name="yz4n-1720972916168"></a>[3.实体间联系](#dwkp-1621692752824)

<a name="w164-1720972916170"></a>[.状态图](#53bo-1621692829033)

<a name="crqv-1720972916172"></a>[1.2 转化成数据库设计（公式）](#c2cy-1677787446998)

<a name="ck7r-1720972916174"></a>[.1 对1 关系 往记录少的乙方加主键](#xmox-1621692858500)

<a name="gemr-1720972916176"></a>[.1对n 关系 ，往 n 实体加关联主键 ](#mdr8-1621692924289)

<a name="e84i-1720972916178"></a>[. n对 m 关系，需要一个关联表作映射关联](#hd3i-1621692960576)

<a name="uny0-1720972916180"></a>[2.数据类型选择](#szqu-1715100194538)

<a name="eha9-1720972916182"></a>[整数类型（Integer Types）](#0rub-1715100184335)

<a name="c5gc-1720972916184"></a>[浮点数类型（Floating-Point Types）](#j4ut-1715100184343)

<a name="qtsm-1720972916186"></a>[日期和时间类型（Date and Time Types）](#fjm4-1715100184359)

<a name="4jsu-1720972916188"></a>[其他类型](#tofd-1715100184367)

<a name="qp14-1720972916190"></a>[二.系统优化](#cdso-1677787447000)

<a name="6f9v-1720972916192"></a>[应用整体的优化](#3qep-1642647362896)

<a name="7ns4-1720972916194"></a>[-cpu -> 纳秒级别](#knge-1642647371136)

<a name="nl8r-1720972916197"></a>[1.多线程和并发编程](#ovup-1704437622969)

<a name="pmmt-1720972916199"></a>[2.JNI ](#ufpl-1704437634986)

<a name="r3sv-1720972916201"></a>[3.JIT/AOT编译](#ixb5-1704437634987)

<a name="fzj4-1720972916203"></a>[4.算法优化](#kr1f-1704437634988)

<a name="igc8-1720972916205"></a>[-内存RAM（GB）/高速缓存(KB) -> 微秒级别(分级缓存)](#1xur-1642647384168)

<a name="4jjm-1720972916207"></a>[1.JVM内存管理](#7hi9-1704437851514)

<a name="m5cr-1720972916209"></a>[2.缓存](#te7c-1704437851799)

<a name="02za-1720972916211"></a>[3.消息中间件](#bqty-1704437851800)

<a name="tpqd-1720972916213"></a>[-磁盘（TB）-> 毫秒级别(减少io次数,减少随机io-redolog)](#ziti-1642647439005)

<a name="dpwz-1720972916215"></a>[1.减少磁盘io](#zups-1704437900079)

<a name="jlx0-1720972916217"></a>[2.数据压缩   ](#u3ok-1704438035018)

<a name="8mar-1720972916219"></a>[-网络传输/系统交互 -> 秒级 (减少io，连接池化) ](#irbp-1642647458856)

<a name="quq8-1720972916221"></a>[1.减少网络请求   ](#6qil-1704438276193)

<a name="txwe-1720972916223"></a>[2.使用CDN](#p5dt-1704438283633)

<a name="il43-1720972916225"></a>[3.Sockets异步通信                                      ](#zhp8-1704438283634)

<a name="xt2i-1720972916227"></a>[项目架构层面的优化](#3l0l-1704424353262)

<a name="tjvj-1720972916229"></a>[-多级缓存](#8o8s-1704424396933)

<a name="spq6-1720972916231"></a>[-应用层](#trcg-1704438366333)

<a name="utzi-1720972916233"></a>[.代码优化](#68oa-1704438530062)

<a name="mbkk-1720972916235"></a>[.数据库优化](#clmf-1704438530257)

<a name="txmo-1720972916237"></a>[.日志优化](#md03-1704438530259)

<a name="dhec-1720972916239"></a>[-监控与调优](#ocux-1704438477879)

<a name="d9bi-1720972916241"></a>[.性能监控：](#vdq2-1704438556836)

<a name="gifi-1720972916243"></a>[.分析和调优](#t29d-1704438557094)

<a name="prsm-1720972916245"></a>[-分布式系统架构](#ukjf-1704424419442)

<a name="rvve-1720972916247"></a>[ .负载均衡](#a0bx-1704438677201)

<a name="a2nw-1720972916249"></a>[.分布式缓存](#xn9x-1704438687994)

<a name="3wx8-1720972916251"></a>[.服务降级和容错](#zcdp-1704438687996)

<a name="ogdl-1720972916253"></a>[读写层面](#six7-1642647372926)

<a name="95cs-1720972916255"></a>[.读优化](#g4uv-1704732583614)

<a name="bncg-1720972916257"></a>[1.缓存](#uuzh-1704732602620)

<a name="e61w-1720972916259"></a>[2.索引](#qobc-1704732605892)

<a name="v0cu-1720972916261"></a>[3.减少io/批量读/非阻塞io](#zlg9-1704732609048)

<a name="lp9e-1720972916263"></a>[4.减少多余数据加载/列式存储读](#fpjd-1704732631316)

<a name="b2fc-1720972916265"></a>[.写优化](#oyob-1704732598377)

<a name="puyd-1720972916267"></a>[1.异步写](#6jmb-1704732509150)

<a name="fny1-1720972916269"></a>[2.并发写](#tkwp-1704732723564)

<a name="axj5-1720972916271"></a>[3.批量写](#hewz-1704732862030)

<a name="80uw-1720972916273"></a>[4.优化算法和数据结构](#ccd8-1704732727854)

<a name="32cx-1720972916275"></a>[5.缓存写](#eqd9-1704732736281)

<a name="fbqq-1720972916277"></a>[6.非阻塞io](#hyq8-1704732768916)

<a name="bedm-1720972916279"></a>[1.分控系统优化复盘](#tncv-1677787447001)

<a name="nwbe-1720972916281"></a>[1.1 数据库系统](#ydq7-1677787447002)

<a name="9fsq-1720972916283"></a>[1.2 sql慢](#wxdd-1677787447003)

<a name="xdzs-1720972916285"></a>[1.3 接口慢](#olpb-1677787447004)

<a name="h2hf-1720972916287"></a>[高并发系统设计](#wrwk-1642647280506)

<a name="1jkf-1720972916289"></a>[1.满足大规模用户同时访问，提供良好响应时间和性能](#8ien-1704757782146)

<a name="bdhb-1720972916291"></a>[2.设计之初就要考虑伸缩性和容错性是非常重要的](#xy0g-1704757785190)

<a name="2ruu-1720972916293"></a>[.垂直伸缩 ](#wr12-1704947861599)

<a name="tuwz-1720972916295"></a>[.水平伸缩](#bizh-1704947959744)

<a name="jzre-1720972916297"></a>[1.分布式架构](#fvzi-1704756770858)

<a name="zrua-1720972916299"></a>[.微服务架构](#ywzr-1704756872033)

<a name="jceh-1720972916301"></a>[.分布式计算](#xgna-1704756877646)

<a name="6rlz-1720972916303"></a>[2.负载均衡](#wnfy-1704756775272)

<a name="b9vk-1720972916305"></a>[.负载均衡](#h6nf-1704756891918)

<a name="izj5-1720972916307"></a>[.水平扩展](#c8zr-1704756894402)

<a name="rv5a-1720972916309"></a>[3.数据库设计](#wxjk-1704756782840)

<a name="kjfx-1720972916311"></a>[.读写分离](#lxca-1704756910837)

<a name="obpn-1720972916313"></a>[.数据库分片](#p7d2-1704756922362)

<a name="qsa0-1720972916315"></a>[.缓存](#hxjt-1704756963988)

<a name="lrb1-1720972916317"></a>[4.缓存优化](#iivs-1704756788012)

<a name="bqs7-1720972916319"></a>[.分布式缓存](#cvui-1704756971791)

<a name="nzh0-1720972916321"></a>[.本地缓存](#ysly-1704756979122)

<a name="xtfs-1720972916323"></a>[.缓存预热](#rqwj-1704756986363)

<a name="f1gl-1720972916325"></a>[5.消息队列](#so9h-1704756800253)

<a name="4lfa-1720972916327"></a>[.异步处理](#sxlo-1704756996000)

<a name="gorl-1720972916329"></a>[.削峰填谷](#llm2-1704757002994)

<a name="0jpl-1720972916331"></a>[6.分布式事务](#n39o-1704756805232)

<a name="dgtn-1720972916333"></a>[.两阶段提交](#5bhj-1704757017700)

<a name="lqnh-1720972916335"></a>[.补偿事务](#becc-1704757028036)

<a name="ihp5-1720972916337"></a>[7.高可用和容错](#wgkk-1704756813448)

<a name="c4hz-1720972916339"></a>[.多地域部署](#akwz-1704757035393)

<a name="oqbj-1720972916341"></a>[.设计容错](#3nxv-1704757055271)

<a name="isth-1720972916343"></a>[1. 熔断限流](#g3xx-1704757371028)

<a name="5r9r-1720972916345"></a>[2. 多节点服务](#jafy-1704757374368)

<a name="rq41-1720972916347"></a>[8.监控和性能调优](#ilyo-1704756820772)

<a name="oqlr-1720972916349"></a>[.实时监控](#kpwq-1704757064566)

<a name="gmsb-1720972916351"></a>[.性能测试](#shf4-1704757066453)

<a name="wouw-1720972916353"></a>[9.安全性设计](#2pry-1704756830245)

<a name="kfyb-1720972916355"></a>[.防御性编程](#pkiw-1704757078583)

<a name="ehks-1720972916357"></a>[.访问控制](#g4l1-1704757084924)

<a name="bnpb-1720972916359"></a>[10.水平扩展](#1tsd-1704756838192)

<a name="sa41-1720972916361"></a>[.自动化部署](#r1dd-1704757092061)

<a name="zefl-1720972916363"></a>[.云服务](#7mhk-1704757104117)

<a name="zffg-1720972916365"></a>[高并发性能指标](#rpxb-1677787447005)

<a name="oshv-1720972916367"></a>[QPS(每秒请求)](#klnv-1704761369323)

<a name="2b9z-1720972916369"></a>[TPS(每秒事务)](#zvlz-1704761369324)

<a name="appn-1720972916371"></a>[RT(响应时间)](#gvrn-1704761369325)

<a name="wlit-1720972916373"></a>[(原子操作)并发编程中保证数据一致性/安全的方法](#ysmj-1709309531982)

<a name="wpev-1720972916375"></a>[原子性+悲观锁：各种锁机制](#fdxy-1709308630108)

<a name="g143-1720972916377"></a>[.（锁+事务/ 分布式锁+分布式事务）](#v06l-1709312268021)

<a name="lw83-1720972916379"></a>[.  CASmysql版本号实现 (前提是数据库的update已经是原子写：mysql update排它锁）](#k0op-1709312304164)

<a name="mxua-1720972916381"></a>[原子性+乐观锁/不加锁: CAS原子操作(java原子类)，](#qth5-1709308703202)

<a name="urjr-1720972916383"></a>[CAS底层实现原理](#g3uo-1709309147469)

<a name="k0no-1720972916385"></a>[总线锁定（Bus Locking）：](#qpbw-1709308842021)

<a name="va2v-1720972916387"></a>[缓存一致性协议（Cache Coherence Protocol）：](#ikm2-1709308842025)

<a name="4uoh-1720972916389"></a>[指令序列化（Instruction Serialization）：](#wpeu-1709308842029)

<a name="nxvq-1720972916391"></a>[不同的场景适用哪种锁](#olfu-1709309769107)

<a name="e5cl-1720972916393"></a>[.共享数据的读写操作：](#y60t-1709309615585)

<a name="7hqf-1720972916395"></a>[适用措施：读写锁（ReadWrite Lock）、互斥锁（Mutex）、原子操作、无锁算法。Copy on Write优化读写锁](#lqad-1709309615587)

<a name="e9gk-1720972916397"></a>[.并发容器的操作：](#fsfa-1709309615591)

<a name="vhf8-1720972916399"></a>[适用措施：线程安全的容器类（如ConcurrentHashMap、ConcurrentLinkedQueue）、原子操作。](#rs2n-1709309615593)

<a name="chmf-1720972916401"></a>[.多个线程协作的场景：](#xdpv-1709309615597)

<a name="rky4-1720972916403"></a>[适用措施：信号量（Semaphore）、条件变量（Condition Variable）。](#uzlr-1709309615599)

<a name="gmzd-1720972916405"></a>[.分布式系统的并发操作：](#0aah-1709309615603)

<a name="emaq-1720972916407"></a>[适用措施：分布式锁、分布式事务。](#wlhe-1709309615605)

<a name="kja2-1720972916409"></a>[.不可变数据的并发访问：](#angi-1709309615609)

<a name="pzgn-1720972916411"></a>[适用措施：不可变数据结构、原子操作。](#pga0-1709309615611)

<a name="wd4r-1720972916413"></a>[.高性能要求的并发操作：](#pw5v-1709309615615)

<a name="86c1-1720972916415"></a>[适用措施：无锁算法、并发数据结构。 -CAS乐观锁](#plv6-1709309615617)

<a name="liei-1720972916417"></a>[互斥访问：](#62mg-1709309976431)

<a name="wujj-1720972916419"></a>[.互斥锁（Mutex）：](#0qt3-1709307350160)

<a name="5w1w-1720972916421"></a>[.原子操作：](#7xva-1709307350164)

<a name="uwfi-1720972916423"></a>[.临界区（Critical Section）：](#r8cl-1709307350168)

<a name="5w6d-1720972916425"></a>[.读写锁（ReadWrite Lock）：主要用于避免脏读](#occj-1709307350172)

<a name="ictq-1720972916427"></a>[.信号量（Semaphore）：](#vej9-1709307350176)

<a name="rmjk-1720972916429"></a>[.条件变量（Condition Variable）：](#ssge-1709307350180)

<a name="hipv-1720972916431"></a>[.无锁算法（Lock-Free Algorithms）：](#zk0j-1709307350184)

<a name="clez-1720972916433"></a>[.数据拷贝-写时复制（Copy-on-Write）：优化读写锁，写时复制且串行执行(锁)，读不加锁](#tiqo-1709307350188)

<a name="sjma-1720972916435"></a>[.线程安全的数据结构：](#b8ca-1709307350192)

<a name="wswu-1720972916437"></a>[===系统架构设计师===](#nyrv-1709307688718)

<a name="pty5-1720972916439"></a>[系统工程与信息系统基础](#mpwu-1704949756608)

<a name="sto4-1720972916441"></a>[.系统工程方法](#2gzz-1704980837071)

<a name="ik98-1720972916443"></a>[.系统工程生命周期阶段](#mk93-1704952875199)

<a name="f1bl-1720972916445"></a>[.系统工程生命周期方法](#ny2c-1704952893636)

<a name="e8ks-1720972916447"></a>[.信息系统建设原则](#shmt-1704952904062)

<a name="ivsr-1720972916449"></a>[.信息系统开发方法](#itje-1704951812273)

<a name="5dxy-1720972916451"></a>[原型法](#bnzq-1705819374009)

<a name="cygj-1720972916453"></a>[结构化法-瀑布型](#ujj3-1705819377863)

<a name="wtt0-1720972916455"></a>[形式化法-数模](#8wek-1705819398251)

<a name="wads-1720972916457"></a>[敏捷方法](#jeuk-1705819392097)

<a name="3kb5-1720972916459"></a>[.信息系统分类](#w8yd-1704980881013)

<a name="tgf6-1720972916461"></a>[业务处理系统TPS](#hlhq-1705819204285)

<a name="3afu-1720972916463"></a>[管理信息系统MIS](#oksn-1705819204735)

<a name="ufzb-1720972916465"></a>[决策支持系统DSS](#lwm7-1705819204736)

<a name="hycd-1720972916467"></a>[专家系统ES](#bmeu-1705819204737)

<a name="jaxb-1720972916469"></a>[办公自动化系统OAS](#kffq-1705819204738)

<a name="7pfv-1720972916471"></a>[企业资源系统ERP](#k2px-1705819204739)

<a name="lg11-1720972916473"></a>[过程模型](#f98t-1704981918920)

<a name="vxyj-1720972916475"></a>[瀑布模型](#yk4j-1705841608124)

<a name="8i3a-1720972916478"></a>[V模型【瀑布变种-测试贯穿】](#oryp-1705841608705)

<a name="8nni-1720972916480"></a>[原型模型](#b0cp-1705841621350)

<a name="0ext-1720972916482"></a>[螺旋模型【原型+瀑布 风险】](#sfqi-1705841608707)

<a name="qaxd-1720972916484"></a>[构件组装模型/基于构件的开发方法](#kbjw-1705841608709)

<a name="l5yv-1720972916486"></a>[快速应用开发RAD【瀑布+构件组装】](#mvze-1705841627436)

<a name="8a1w-1720972916488"></a>[统一过程/统一开发方法](#xici-1705841629815)

<a name="mcal-1720972916490"></a>[敏捷开发方法](#9jca-1705841608711)

<a name="gyou-1720972916492"></a>[XP](#28va-1705841590197)

<a name="ejyu-1720972916494"></a>[Scrum](#fyfq-1705938223773)

<a name="rvu1-1720972916496"></a>[逆向工程](#d5ko-1705938215067)

<a name="dbhw-1720972916498"></a>[实现级](#os3c-1706090901666)

<a name="wp1x-1720972916500"></a>[结构级](#irxb-1706090905276)

<a name="ysno-1720972916502"></a>[功能级](#rk8d-1706090908958)

<a name="gxme-1720972916504"></a>[领域级](#k3pt-1706090912460)

<a name="grrq-1720972916506"></a>[净室软件工程](#tybd-1705938215235)

<a name="efjc-1720972916508"></a>[需求工程](#ochn-1705940085547)

<a name="d5ka-1720972916510"></a>[.需求获取](#xdlf-1705940054108)

<a name="d1yl-1720972916512"></a>[用户面谈 ](#s1uq-1706090846730)

<a name="htyc-1720972916514"></a>[联合需求计划(JRP) ](#vuil-1706090851858)

<a name="vuah-1720972916516"></a>[问卷调查 ](#gpxg-1706090851859)

<a name="faqq-1720972916518"></a>[现场观察   ](#mg9n-1706090851860)

<a name="y9z2-1720972916520"></a>[原型化方法        ](#3ww6-1706090851861)

<a name="pol0-1720972916522"></a>[头脑风暴法](#0awr-1706090851863)

<a name="ut6v-1720972916524"></a>[.需求分析](#axny-1705940052332)

<a name="qbzk-1720972916526"></a>[1.功能模型(数据流图DFD)](#v8wz-1706090812929)

<a name="yabl-1720972916528"></a>[2.行为模型(状态转换图)](#3uls-1706090814821)

<a name="9q6q-1720972916530"></a>[3.实体模型(E-R图)](#69df-1706090816407)

<a name="ilq1-1720972916532"></a>[UML](#loq2-1705940640473)

<a name="bivc-1720972916534"></a>[需求定义](#4aeg-1706091062964)

<a name="hy4w-1720972916536"></a>[需求验证](#ud2s-1706090947930)

<a name="tpme-1720972916538"></a>[需求跟踪](#l03x-1705940634470)

<a name="1mxc-1720972916540"></a>[需求变更管理](#muqf-1706093218719)

<a name="x4uq-1720972916542"></a>[软件系统建模](#ilpb-1706093190683)

<a name="jxur-1720972916544"></a>[软件界面设计](#j396-1706094675778)

<a name="94yu-1720972916546"></a>[结构化设计](#vqsk-1706094478028)

<a name="j1vf-1720972916548"></a>[内聚](#jczo-1706095018132)

<a name="fgai-1720972916550"></a>[耦合](#qa8z-1706095402118)

<a name="xylz-1720972916552"></a>[模块四要素](#g1dc-1706095391028)

<a name="oycc-1720972916554"></a>[面相对象设计](#ydwa-1706095870710)

<a name="ekhk-1720972916556"></a>[类的分类](#fouz-1706095958643)

<a name="r3yh-1720972916558"></a>[基本过程](#9pd1-1706095996137)

<a name="z0rm-1720972916560"></a>[设计原则(同设计模式)](#k8lc-1706096001163)

<a name="k87c-1720972916562"></a>[计算机](#qvol-1706095952165)

<a name="2ub9-1720972916564"></a>[计算机结构(★)](#ef1b-1706108352037)

<a name="bbkr-1720972916566"></a>[存储系统(★★★★)](#4kj7-1706108373776)

<a name="xw7f-1720972916568"></a>[层次化存储结构](#ucta-1706109825295)

<a name="syvd-1720972916570"></a>[Cache](#j9hn-1706109828962)

<a name="spdc-1720972916572"></a>[主存编址计算](#pv51-1706109847372)

<a name="3onv-1720972916574"></a>[磁盘基本结构与存储过程](#jcqv-1706108377026)

<a name="akkp-1720972916576"></a>[磁盘优化分布存储](#puux-1706111215530)

<a name="llnl-1720972916578"></a>[磁盘单缓冲区与双缓冲区读取](#dvin-1706111222861)

<a name="2hcw-1720972916580"></a>[磁盘移臂调度算法](#jr2r-1706111239137)

<a name="ptuu-1720972916582"></a>[数据传输控制方式（★)](#sz2k-1706111188014)

<a name="e3zi-1720972916584"></a>[总线（★★)](#cbul-1706108378755)

<a name="ps3f-1720972916586"></a>[CISC与RISC(★)](#0hb5-1706108373778)

<a name="mkqp-1720972916588"></a>[流水线(★★)](#ernn-1706108380109)

<a name="56iv-1720972916590"></a>[校验码(★)](#grix-1706108381278)

<a name="fo4r-1720972916592"></a>[嵌入式（★)](#1p2v-1706108382511)

<a name="1eul-1720972916594"></a>[计算机网络](#8vmt-1706198382356)

<a name="jde2-1720972916596"></a>[TCP/IP协议族(7层/4层网络模型)](#a4es-1706106975412)

<a name="qtx3-1720972916598"></a>[.TCP与UDP (★★★)](#vwim-1706198561289)

<a name="jzkd-1720972916600"></a>[.DHCP与DNS (★★★)](#imsh-1706198537828)

<a name="usma-1720972916602"></a>[网络规划与设计](#u7sd-1706198559304)

<a name="lrao-1720972916604"></a>[1.逻辑设计与物理设计(★★★★）](#nov8-1706198591905)

<a name="g0p0-1720972916606"></a>[2.层次化网络设计](#sy2g-1706198599196)

<a name="dqor-1720972916608"></a>[3.网络冗余设计](#igl7-1706257923205)

<a name="be9k-1720972916610"></a>[网络存储（★★)](#zkxb-1706257899477)

<a name="yfnz-1720972916612"></a>[磁盘阵列Raid](#fxma-1706198636789)

<a name="zus1-1720972916614"></a>[lPv6 (★)](#vlem-1706259832461)

<a name="d9wp-1720972916616"></a>[网络接入(有线/无线)](#g438-1706198637653)

<a name="ojcl-1720972916618"></a>[综合布线(★)](#lxli-1706198497856)

<a name="ietp-1720972916620"></a>[网络技术扩展](#5dlt-1706198650540)

<a name="hq3c-1720972916622"></a>[物联网(IOT)](#jgll-1706198586849)

<a name="8if0-1720972916624"></a>[云计算(Saas/Paas/Iaas)](#pr8x-1706198586851)

<a name="y0mf-1720972916626"></a>[===系统架构设计case===](#1rnn-1706941312871)

<a name="fpxk-1720972916628"></a>[google L5设计一个分布式数据库架构](#nm5q-1706969255961)

<a name="xgiq-1720972916630"></a>[.what is total ordering(ordering first 100 custormer)](#g7yu-1707229908505)

<a name="tubt-1720972916632"></a>[.why single leader()](#ebxf-1707230056989)

<a name="bps4-1720972916634"></a>[.request router](#ttmg-1707230034624)

<a name="uyhf-1720972916636"></a>[.variations](#aftd-1707229925082)

<a name="jjip-1720972916638"></a>[1.Failover handing](#uk2k-1707457488655)

<a name="tp1c-1720972916640"></a>[2.Reblancing after new node added](#btbd-1707457496651)

<a name="ffem-1720972916642"></a>[3.Leaderless for heavy write-shard](#moaq-1707457524278)

<a name="zdbt-1720972916644"></a>[4.TicketMasler (and total ordering is necessary](#wyvq-1707458882987)

<a name="nfrq-1720972916646"></a>[===数据密集型应用===](#sswx-1706094478181)

<a name="gqwc-1720972916648"></a>[第一部分 数据系统的基石](#unbe-1677787447006)

<a name="mpz7-1720972916650"></a>[1.可靠性、可拓展性、可维护性能](#kwfx-1677787447007)

<a name="vyfs-1720972916652"></a>[-功能性需求：CRUD](#lykw-1644227240038)

<a name="slxq-1720972916654"></a>[-非功能性需求：安全性，可靠性，合规性，可扩展性，兼容性和可维护性](#b2tu-1644227249556)

<a name="egvm-1720972916656"></a>[.可靠性：](#qqm5-1644227303238)

<a name="ybyi-1720972916658"></a>[硬件故障](#7xms-1644228225080)

<a name="v9bb-1720972916660"></a>[软件错误](#dfpv-1708357497902)

<a name="bcaf-1720972916662"></a>[人为错误(如何让系统变得可靠)](#drpl-1708357507365)

<a name="uaei-1720972916664"></a>[如何让系统变得可靠：](#pqmh-1708523552230)

<a name="mtce-1720972916666"></a>[。最小化犯错机会的方式设计系统,  但如果限制太多，人们可能会忽略它们的好处而绕开，很难把握其中微妙的平衡](#i4we-1708358144376)

<a name="dhvx-1720972916668"></a>[。在易错地方和可能导致失效的地方解耦decouple,提供非生产环境沙箱sandbox-虚拟化环境，隔离真实系统进行安全测试](#xzfa-1708358243121)

<a name="ja2o-1720972916670"></a>[。彻底的测试，单元测试，集成测试，手动测试，自动化测试覆盖边缘场景corner case.](#9jaa-1708358634289)

<a name="umqe-1720972916672"></a>[。滚动发布，快速回滚](#zlp4-1708358698137)

<a name="mki7-1720972916674"></a>[。配置详细和明确的监控](#40us-1708358954660)

<a name="jirx-1720972916676"></a>[。良好的管理和充分的培训。一个复杂而重要的方面，但超出本书的范围](#o66x-1708358967000)

<a name="3drz-1720972916678"></a>[可靠性有多重要](#x7co-1708357515795)

<a name="zwg7-1720972916680"></a>[造成客户巨大损失-阿里云宕机造成的用户损失](#nc0w-1708358745350)

<a name="538z-1720972916682"></a>[家长将孩子照片存储在你的应用李，数据库损坏，客户有何体验，他们可能会知道如何从备份恢复吗？](#qopp-1708358856827)

<a name="c953-1720972916684"></a>[.可扩展性： ](#dsae-1708357483848)

<a name="rnsp-1720972916686"></a>[描述负载(tps-推特主页时间线扇出-查询性能优化)](#vja4-1708356470840)

<a name="lrdr-1720972916688"></a>[描述性能](#s6un-1708356581594)

<a name="hgso-1720972916690"></a>[吞吐量throughput](#fcez-1708523606684)

<a name="yrad-1720972916692"></a>[响应时间 response time.](#k30f-1708523620292)

<a name="nhgg-1720972916694"></a>[响应时间的高位百分点（也称为尾部延迟tail latencies](#bogk-1708523658968)

<a name="mltr-1720972916696"></a>[.可维护性：](#k1dg-1708355783343)

<a name="bhma-1720972916698"></a>[2.数据模型与查询语言](#jufm-1677787447008)

<a name="0hpe-1720972916700"></a>[-关系模型](#pgu6-1699844351041)

<a name="o7kq-1720972916702"></a>[-NoSql (es,redis)](#kfpd-1644410618294)

<a name="yxfp-1720972916704"></a>[1.文档数据库:MongoDB](#0p23-1644410807294)

<a name="5mt2-1720972916706"></a>[  2.图形数据库 ：](#09bl-1644410666587)

<a name="bw6i-1720972916708"></a>[-其它模型(基因序列)](#6fxw-1644410924417)

<a name="vkoy-1720972916710"></a>[3.存储与检索](#sm0u-1677787447009)

<a name="kbd1-1720972916712"></a>[-优化事务处理（OLTP）transaction ](#bhcv-1644935436804)

<a name="zndq-1720972916714"></a>[1.OLTP系统通常面向用户，大量的请求。](#tbhw-1699844517372)

<a name="ov3t-1720972916716"></a>[2.磁盘寻道时间往往是这里的瓶颈。](#fnev-1644935714127)

<a name="pg8b-1720972916718"></a>[3.应用程序使用某种键来请求记录，存储引擎使用索引来查找所请求额键的数据。](#cjwp-1644935609899)

<a name="xp18-1720972916720"></a>[-优化分析（OLAP）analys](#jg7s-1699844443567)

<a name="7t6v-1720972916722"></a>[1.列式储存(投影操作，压缩技术，聚合过滤)](#pjd1-1703887811615)

<a name="zp8t-1720972916724"></a>[-OLTP两大主流学派的存储引擎：](#8sgm-1644935924013)

<a name="bg3d-1720972916726"></a>[1.日志结构学派](#i55y-1644935943748)

<a name="hh84-1720972916728"></a>[2.就地更新学派](#h3il-1644935977285)

<a name="2kdr-1720972916730"></a>[4.编码（序列化）与演化(XML,JSON,CSV)](#lbs1-1677787447010)

<a name="zgdy-1720972916732"></a>[第二部分 分布式数据](#4p9n-1677787447012)

<a name="o0nv-1720972916734"></a>[1.高可用性/容错](#o4ag-1646310813851)

<a name="dizd-1720972916736"></a>[2.断开连接的操作](#snwm-1646310894841)

<a name="ruaq-1720972916738"></a>[3.减少延迟(节点近)](#evly-1646310918322)

<a name="8zsx-1720972916740"></a>[4.可拓展性](#itsh-1646310968967)

<a name="ojmt-1720972916742"></a>[.拓展至更高的载荷](#gjis-1708362947856)

<a name="cnfx-1720972916744"></a>[垂直扩展scale up ：购买更强大的机器 cpu](#mgia-1708362999715)

<a name="bkxe-1720972916746"></a>[共享内存架构shared-memory architecture：许多处理器、内存和磁盘再同一操作系统下相互连接，共享内存和磁盘](#pdo8-1708363038596)

<a name="8oyw-1720972916748"></a>[共享磁盘share-disk architecture：独立处理器和内存，数据存储在机器之间共享的磁盘阵列上，磁盘通过快速网络连接。数仓](#wgwl-1708363065800)

<a name="rnch-1720972916750"></a>[无共享架构](#klw2-1708363340866)

<a name="yaw4-1720972916752"></a>[.复制VS分区](#gbgq-1646311175182)

<a name="ffsp-1720972916754"></a>[5.复制](#gd4q-1708363438406)

<a name="nvox-1720972916756"></a>[.领导者与追随者-单主复制](#9hbs-1708441077626)

<a name="swul-1720972916758"></a>[客户端将所有写入操作发送到单个节点（领导者），该结点将数据更改事件流发送到其它副本（追随者）。](#aucb-1708528116000)

<a name="vomy-1720972916760"></a>[读取可以再任何副本中执行，但从追随者读取可能是陈旧的 （最终一致性问题）](#wgge-1646311567456)

<a name="cdq2-1720972916762"></a>[.同步复制与异步复制](#cbey-1646310922523)

<a name="026u-1720972916764"></a>[.设置新从库(快照复制+caught up binlog)](#j5o0-1704983008475)

<a name="5sqd-1720972916766"></a>[.处理宕机节点](#bcod-1708442233018)

<a name="eluv-1720972916768"></a>[从库失效：追赶恢复](#5ufz-1708443850274)

<a name="yb9i-1720972916770"></a>[主库失效：故障切换failover](#udix-1708443860752)

<a name="d2an-1720972916772"></a>[自动切换步骤：1.确认主库失效](#w3sj-1708523445192)

<a name="8b6c-1720972916774"></a>[2.选举新主库：共识](#y3qn-1708523480847)

<a name="abxn-1720972916776"></a>[3.配置系统启用新主库](#wua6-1708523497956)

<a name="npgh-1720972916778"></a>[failover的麻烦：1.异步复制数据丢失](#z7mn-1708523814309)

<a name="c7fd-1720972916780"></a>[2.自增主键冲突](#mnjx-1708523836932)

<a name="mf8z-1720972916782"></a>[3.脑裂split brain](#dbhg-1708523873194)

<a name="4lve-1720972916784"></a>[4.如何设置超时](#561v-1708523878338)

<a name="0wir-1720972916786"></a>[.复制日志的实现](#8mem-1708442228760)

<a name="ai5h-1720972916788"></a>[基于语句的复制(每个写入请求语句statment)](#k8yo-1708524004340)

<a name="qij9-1720972916790"></a>[记录每个写入请求语句statment，语句日志传输给从库](#hcqe-1708524155632)

<a name="kp02-1720972916792"></a>[问题：非确定函数nondeterministic, NOW()  RAND()](#9xml-1708524182083)

<a name="7own-1720972916794"></a>[    自增列- 造成差异](#il4a-1708524271564)

<a name="1cqb-1720972916796"></a>[副作用的语句：用户自定义函数，触发器，存储过程](#azmh-1708524331636)

<a name="guep-1720972916798"></a>[解决: 用固定值替换](#rcfb-1708524371120)

<a name="0a5b-1720972916800"></a>[  如语句存在任何不确定性，切换到基于行的数据](#6uy2-1708524426849)

<a name="bfiw-1720972916802"></a>[传输预写式日志(WAL)](#rnmz-1708524013585)

<a name="stec-1720972916804"></a>[日志存储引擎SSTables LSM树](#hze4-1708524498278)

<a name="qkor-1720972916806"></a>[磁盘块的B树  WAL, 崩溃恢复](#qzop-1708524541132)

<a name="vgo2-1720972916808"></a>[逻辑日志复制(基于行)](#a3ng-1708524040960)

<a name="7tvg-1720972916810"></a>[binlog](#jiiu-1708524648209)

<a name="xdet-1720972916812"></a>[基于触发器的复制](#ezoi-1708524083973)

<a name="qfvj-1720972916817"></a>[.复制延迟问题(解决方法都是反分布式，或者趋于单机一致性。数据一致性模型：https://jepsen.io/consistency)](#https://jepsen.io/consistency)

<a name="jmbd-1720972916820"></a>[读己之写(读主库或带写时间戳查询)](#w5nz-1708525244967)

<a name="7us5-1720972916822"></a>[写后从旧副本读取数据-未同步  ](#25nj-1708526407050)

<a name="vgas-1720972916824"></a>[解决：写后读read after write 一致性 或叫做 read your write consistency 防止这种异常](#4st1-1708525569674)

<a name="kuoz-1720972916826"></a>[1.都从主库读。适用仅由用户本人编辑的数据，如个人信息。大部分内容从主库读不适用，扩容读无效果](#v4r0-1708525736897)

<a name="jouf-1720972916828"></a>[2. 扩容读需要保证更新时间，监控复制延迟，防止滞后超过一分钟从从库发出查询](#vqjs-1708525818133)

<a name="ybpx-1720972916830"></a>[3. 客户端记录写入时间戳，系统确保从库提供查询时，版本时间已覆盖，否则从另一个从库读，或者等待caught up-  等待不就相当弱可用状态，且时钟不可靠](#nmrh-1708525971734)

<a name="ztaq-1720972916832"></a>[4. 副本在多个数据中心，复杂度高，都需经过主库IDC](#wmu9-1708526095856)

<a name="5xqo-1720972916834"></a>[单调读(基于id散列路由同一副本)](#kwrd-1708525264596)

<a name="hy22-1720972916836"></a>[先读到最新副本，后读到旧副本感觉数据消失](#npwe-1708527802311)

<a name="abvr-1720972916838"></a>[A看到B评论后消失，时光倒流moving backward in time ](#4cn0-1708526272081)

<a name="0cvx-1720972916840"></a>[解决：单调读monotonic reads总是从同一个副本进行读取(基于用户散列id，如果副本失效则重新路由)](#drqk-1708526396300)

<a name="bfmd-1720972916842"></a>[  比强一致性(同步复制/类比单机)弱，比最终一致性更强](#s6u3-1708526566643)

<a name="9wdi-1720972916844"></a>[一致前缀读(因果关系写到相同分区)](#bfps-1708525268614)

<a name="8ljq-1720972916846"></a>[consistent prefix reads](#q7p0-1711363121071)

<a name="byrc-1720972916848"></a>[不同分片副本同步先后问题导致读顺序错误](#rqcm-1708527879976)

<a name="hove-1720972916850"></a>[分区partition/分片sharded数据库中的一个特殊问题，全局写入顺序](#bwov-1708526677620)

<a name="khz8-1720972916852"></a>[分区主库1写入 A:你吃饭了吗？ 分区主库2写入B:没有。 分区1副本同步主库1落后分区2副本同步主库2    C读取1副本: 没有，后读取2副本。你吃饭了吗？](#7e9o-1708526727984)

<a name="ozry-1720972916854"></a>[解决：确保因果关系都写入到相同分区](#turn-1708527108521)

<a name="ctg2-1720972916856"></a>[复制延迟解决方案](#a2la-1708525420248)

<a name="ovod-1720972916858"></a>[趋于反分布式，局部或者部分看做一个单机，做到强一致性](#x8ng-1708527233293)

<a name="fdoz-1720972916860"></a>[写后读。](#gecf-1708527304184)

<a name="kju6-1720972916862"></a>[数据库通过事务提供强大保证。](#zsq6-1708527307246)

<a name="gosb-1720972916864"></a>[.多主复制(主主复制，互为副本-写冲突。多主复制被认为是危险的领域)](#pbfd-1708528009698)

<a name="mb7h-1720972916866"></a>[多主复制的应用场景](#kxkx-1708441627686)

<a name="ab4r-1720972916868"></a>[运维多个数据中心(IDC-主主间复制需要处理写冲突）](#xrso-1708700002291)

<a name="ngb9-1720972916870"></a>[性能(多活配置，写操作在本地IDC处理，其他IDC异步复制，性能更好)](#06t6-1708700132681)

<a name="kdvf-1720972916872"></a>[容忍IDC停机](#9sww-1708700267631)

<a name="zy3v-1720972916874"></a>[容忍网络问题(临时的网络中断不会妨碍正在写入的处理)](#dtkl-1708700295371)

<a name="blan-1720972916876"></a>[需要离线操作的客户端(支持多个终端离线操作couchDB)](#knxa-1708700020273)

<a name="qpmd-1720972916878"></a>[协同编辑](#hvwb-1708700115895)

<a name="4rja-1720972916880"></a>[处理写冲突(A将标题从1改2,B将1改3)](#fdot-1708700612321)

<a name="cnr4-1720972916882"></a>[同步于异步冲突检测](#u8bc-1708700824251)

<a name="ejnf-1720972916884"></a>[同步：单主程序复制 - 不允许每个副本独立接受写入](#wfgd-1708700957597)

<a name="hu4c-1720972916886"></a>[异步：独立接受写入- 异步检测，但为时已晚](#x6is-1708701017804)

<a name="m8bm-1720972916888"></a>[避免冲突(特定记录写入都通过同一个领导者，主库切换或者用户迁移至更近的主库时会有同时写入的可能性)](#xg2a-1708700840681)

<a name="u1bj-1720972916890"></a>[收敛convergent至一致的状态(副本主库和其副本在复制完成时收敛至一个相同的最终值)](#ucfn-1708700844474)

<a name="bpqw-1720972916892"></a>[最后写入胜利LWW,last write wins- 给每个写入一个唯一id, 挑选最高ID的写入作为胜利者，并丢弃其他写入-数据丢失](#cbla-1708701376316)

<a name="4vkj-1720972916894"></a>[为每个副本分配一个唯一ID,ID编号更高的具有高优先级。数据丢失](#40po-1708701481447)

<a name="kfdk-1720972916896"></a>[将值合并在一起](#p4m4-1708701593939)

<a name="tfha-1720972916898"></a>[记录冲突，并编写解决逻辑代码。如通过提醒用户方式](#8fcs-1708701611999)

<a name="4zuh-1720972916900"></a>[自定义冲突解决逻辑](#yrdi-1708700860148)

<a name="rpfp-1720972916902"></a>[自定义冲突解决逻辑(complex)](#t4i7-1708702160004)

<a name="r8hg-1720972916904"></a>[写时执行-后台处理](#pdql-1708702370625)

<a name="qydl-1720972916906"></a>[读时执行-提供多版本用户选择，回写数据库](#sksk-1708702376293)

<a name="stip-1720972916908"></a>[亚马逊购物车移除的商品重新出现](#4bqp-1708702425059)

<a name="oeez-1720972916910"></a>[什么是冲突(两个领导者预订同一个会议室，7章看冲突实例12章看检测解决)](#6x4i-1708700867996)

<a name="w1po-1720972916912"></a>[多主复制拓扑](#o41a-1708702111509)

<a name="sxta-1720972916914"></a>[环形，星型，all to all -mysql仅支持环形](#5feh-1708702903239)

<a name="9ola-1720972916916"></a>[问题：多主复制时，可能在某些副本中写入错误的顺序。like A写主库1，B写主库2，主库3先同步2，再同步1。类似一致前缀读。](#ddyu-1708702949257)

<a name="k3by-1720972916918"></a>[解决：时间戳是不够的-不可靠时钟，使用一种称为版本向量(version vectors)的技术-检测并发写入](#ghp3-1708703247102)

<a name="kzyl-1720972916920"></a>[无主复制leaderless](#bfz8-1708759285067)

<a name="t62j-1720972916922"></a>[Amazon的Dynomo系统。](#cvru-1708759359537)

<a name="kdqf-1720972916924"></a>[Riak, Cassandra，Voldmort 也称为Dynamo风格。](#wf6o-1708759707666)

<a name="im9c-1720972916926"></a>[类型1：客户端直接将写入发送到几个副本中](#xpqf-1708760120711)

<a name="bvzx-1720972916928"></a>[类型2：coordinator协调者节点代表客户端写入。](#pl2z-1708760121090)

<a name="o2ns-1720972916930"></a>[当节点故障时写入数据库(仲裁写⼊，法定读取，并在节点中断后读修复。)](#qgpe-1708760989905)

<a name="2ill-1720972916932"></a>[如果主从复制，主故障/重启系统更新 则需进行故障切换](#zfuz-1708760396929)

<a name="bird-1720972916934"></a>[无主复制： userA set piture_url   -> replica1 ok    Then version=7](#3soj-1708760452090)

<a name="1tsu-1720972916936"></a>[           user set piture_url   -> replica2 ok  Then version=7](#4f05-1708760543198)

<a name="1620-1720972916938"></a>[user set piture_url   -> replica3 offline  fail   version= 6](#ynls-1708759898772)

<a name="bhks-1720972916940"></a>[    userB get piture  :  rp3(version6) rp1(version7)  rp2(version7)  Than fix rp3 value to version7](#e1ur-1708760618873)

<a name="9cwt-1720972916942"></a>[ 读修复和反熵(失效节点重新连机后如何caught up)](#tyv3-1708760780373)

<a name="lciw-1720972916944"></a>[读修复like userB get piture fixed rp3](#wjho-1708761214792)

<a name="dnzj-1720972916946"></a>[反熵 后台进程不断查找副本之间的数据差异。Voldmort无反熵过程，副本可能丢失数据](#xblj-1708761286988)

<a name="kem5-1720972916948"></a>[ 读写的法定人数（仲裁）](#w3ia-1708761120623)

<a name="pibs-1720972916950"></a>[仲裁一致性的局限性-最终一致，更强的保证需要事务或共识](#oj1i-1708759830121)

<a name="gsmb-1720972916952"></a>[松散法定人数与带提示的接力](#cu5q-1708759841416)

<a name="smzu-1720972916954"></a>[运维多个数据中心-将写入发送到所有副本，仅需本地IDC内法定节点确认](#kzki-1708761744887)

<a name="uoe3-1720972916956"></a>[检测并发写入](#pt1k-1708759856530)

<a name="ybmp-1720972916958"></a>[Dynamo风格的数据存储，没有明确定义的顺序。](#mu89-1708761978075)

<a name="cfmw-1720972916960"></a>[userA set x=A   get x](#dbni-1708763823783)

<a name="oejx-1720972916962"></a>[rp 1 A ok    B unresponsive   A](#auce-1708763993783)

<a name="9mdx-1720972916964"></a>[rp2 A ok   B OK  B](#kteo-1708764011894)

<a name="8i4t-1720972916966"></a>[rp3 B ok A ok A](#9xyy-1708764019308)

<a name="y9ah-1720972916968"></a>[userB set x=B ](#esiv-1708702764305)

<a name="9mhe-1720972916970"></a>[最后写入胜利(丢弃并发写入)](#wd1i-1708764197180)

<a name="h5rh-1720972916972"></a>[LLW 无法确定真实排序，强制排序，选择最新的最大时间戳，并丢弃较早的任何写入.Cassandra唯一支持的方式，Riak可选](#uzhw-1708874432788)

<a name="zdec-1720972916974"></a>[缺点：数据丢失 ](#henp-1708874594301)

<a name="sfd2-1720972916976"></a>[此前发生的关系和并发](#hzwp-1708764215825)

<a name="2dct-1720972916978"></a>[因果依赖(causally dependent)  如果B后发与A, 则B因果依赖A, ](#3wp0-1708874672763)

<a name="8bva-1720972916980"></a>[如果是并发，则存在需要解决的冲突](#1wzv-1708875051673)

<a name="4k2z-1720972916982"></a>[捕获此前发生的关系](#j2r6-1708764228505)

<a name="ewxh-1720972916984"></a>[捕获两个客户端间的因果关系，同时编辑购物车(示例为单副本)](#vv7q-1708875756229)

<a name="az6s-1720972916986"></a>[合并同时写入的值](#zp0i-1708874374616)

<a name="p3d2-1720972916988"></a>[客户端需额外工作，合并并发写入的值来擦屁股。Riak称这些并发值兄弟(sibings)](#wawo-1708876272614)

<a name="noby-1720972916990"></a>[版本向量](#arlv-1708874381589)

<a name="ng7r-1720972916992"></a>[所有副本的版本号集合称为版本向量(version vector)](#b1ov-1708700703636)

<a name="9nls-1720972916994"></a>[6.分区](#dyz5-1709800112532)

<a name="ub8u-1720972916996"></a>[.分区与复制(分区与复制方案是独立的)](#twd1-1709800204792)

<a name="8q2s-1720972916998"></a>[.键值数据的分区](#fbqg-1709800263679)

<a name="nvup-1720972917000"></a>[偏斜skew：分区过多数据或过多查询](#s7ju-1709801062977)

<a name="deeg-1720972917002"></a>[热点hot spot:高负载的分区](#u0d3-1709801107270)

<a name="vpew-1720972917004"></a>[根据键的范围分区](#lqbu-1709800332210)

<a name="fec6-1720972917006"></a>[Bigtable, HBase, RethinkDB 和 MongoDB2.4](#i2ju-1709801151406)

<a name="q3u0-1720972917008"></a>[按照一定的顺序保存键（SSTbale和LSM-树）](#np00-1709801582805)

<a name="yqxx-1720972917010"></a>[按时间分区当日写过载（需加传感器保证日期+传感主键均匀分布）](#evhb-1709801683166)

<a name="rhok-1720972917012"></a>[根据键的散列分区(可将偏斜数据均匀分布)](#a1yy-1709800347130)

<a name="ie2d-1720972917014"></a>[不适合分区的简单哈希函数：java .hashCode-同键不同进程不同哈希值](#mdg4-1709801628016)

<a name="wjbq-1720972917016"></a>[一致性哈希consistent hashing:哈希键分区边界均匀间隔，也可伪随机选择（CDN均匀分配负载）。](#7rkg-1709802019859)

<a name="lkg2-1720972917018"></a>[缺点：无序，低效范围查询(需发送到所有分区)](#iktb-1709802309508)

<a name="u6to-1720972917020"></a>[折中方案：复合主键/组合索引。(uid,time).不同用户在不同分区，每个用户按时间搓顺序存储在单个分区上。](#zznq-1709802490074)

<a name="lygc-1720972917022"></a>[负载倾斜与消除热点](#ed70-1709800357523)

<a name="rwup-1720972917024"></a>[数百万追随者做某事-大量写入同一个键](#403a-1709802593546)

<a name="5djm-1720972917026"></a>[解决：火爆主键+随机数即可将主键分散为100个分区](#wx5s-1709802730512)

<a name="rvgp-1720972917028"></a>[缺点：数据合并，跟踪火爆主键。需权衡利弊。](#h0b7-1709802773377)

<a name="yvwy-1720972917030"></a>[.分片与次级索引](#ekdv-1709800287975)

<a name="jjsi-1720972917032"></a>[次级索引通常并不能唯一标识记录。](#n3vk-1709803239471)

<a name="ad6g-1720972917034"></a>[HBase Volde-mort为了减少实现复杂度放弃了次级索引。](#q1u5-1709803293988)

<a name="aoaq-1720972917036"></a>[Riak开始添加， 次索是Solr Elasticesearch 搜索的基石](#fhpr-1709803333585)

<a name="930e-1720972917038"></a>[按文档的二级索引](#mwm0-1709800370635)

<a name="yolh-1720972917040"></a>[文档分区索引/本地索引](#ud7o-1709803718409)

<a name="caow-1720972917042"></a>[每个分区独立维护自己的二级索引。](#zlhf-1709803740582)

<a name="bs1j-1720972917044"></a>[查询发送所有分区，并合并所有返回结果，分散/聚集scatter/gather-容易导致尾部延迟放大。](#bkj3-1709803789802)

<a name="hio5-1720972917046"></a>[缺点：可能使二级索引读取查询相当昂贵。](#ghpm-1709803878421)

<a name="3ovz-1720972917048"></a>[根据关键词(Term)的二级索引](#itl0-1709800380617)

<a name="2xhb-1720972917050"></a>[全局索引：覆盖所有分区数据的索引，也须分区。](#8bw4-1709804016790)

<a name="ntxn-1720972917052"></a>[关键词分区：关键词本身或它的散列进行分区。](#qc2d-1709913637902)

<a name="giv6-1720972917054"></a>[优点：只需请求包含关键词的分区，读取更有效率](#jmj8-1709913775261)

<a name="xbya-1720972917056"></a>[缺点：写入慢且复杂。需支持分布式事务。](#i7kp-1709913825503)

<a name="m5mz-1720972917058"></a>[理想下总是最新，实践中更新通常为异步。Amazon DynamoDB声称全局次级索引不到1s内更新。](#mv7j-1709913923874)

<a name="fag3-1720972917060"></a>[.分区再平衡(reblancing)](#hpnd-1709800294747)

<a name="bmwu-1720972917062"></a>[吞吐量增加：加cpu](#1f0n-1709914101899)

<a name="nzv9-1720972917064"></a>[数据集大小增加：加磁盘和RAM](#vjb0-1709914129763)

<a name="romg-1720972917066"></a>[机器故障：其他机器接管](#smcd-1709914153882)

<a name="dyig-1720972917068"></a>[----------再平衡应满足--------------](#2efu-1709916803909)

<a name="pszi-1720972917070"></a>[发生时：数据库应该继续接受读取和写入](#20wj-1709916807951)

<a name="upzd-1720972917072"></a>[节点之间只移动必须数据(分区)，以便快速再平衡，减少网络和磁盘io负载。](#cxoi-1709916893371)

<a name="yea5-1720972917074"></a>[平衡后：存储，读取和写入公平共享](#cj8j-1709916938075)

<a name="dt51-1720972917076"></a>[平衡策略](#cavd-1709800402611)

<a name="efph-1720972917078"></a>[反面教材：hash mod N](#6f6z-1709800409866)

<a name="gqjn-1720972917080"></a>[$hash(key)=22  22mod10..2  22mod 11...0  22 mod 9 ...4 ](#anib-1709916997775)

<a name="8i3g-1720972917082"></a>[节点需要转移秘钥及次数过多，过于昂贵。](#anz7-1709917243580)

<a name="vifn-1720972917084"></a>[解决：更换为只移动必须数据的方法。](#7ytl-1709917334275)

<a name="bfym-1720972917086"></a>[固定数量的分区(加节点时分配分区)](#8l9j-1709800420954)

<a name="hhql-1720972917088"></a>[新增/减少节点时，将现存部分数据转移到节点新增/现存节点(Riak,es,couchbase Voldemort使用这种再平衡）](#vmsm-1709917322722)

<a name="8b58-1720972917090"></a>[适用：分区数量第一次建立时确定。](#ktrd-1709917648400)

<a name="zlvu-1720972917092"></a>[缺点：数据集总量大小难以预估时；分区大再平衡代价昂贵，分区小产生额外开销。](#vw7j-1709917692466)

<a name="gjsi-1720972917094"></a>[分区大小与集群数据总量成比例增长](#eszc-1709921747523)

<a name="xo1s-1720972917096"></a>[动态分区(适用键范围的分区)](#tkjw-1709800428033)

<a name="yc1i-1720972917098"></a>[解决：使用键范围分区，固定边界的固定数量的分区不便。出现边界错误，手动重新去配分区边界将非常繁琐。](#itsg-1709917825657)

<a name="uzza-1720972917100"></a>[动态分区：与B树类似，分区数据增长超过配置时将分成两区，大量数据删除分区缩小低于阈值则合并(HBase RethinkDB)](#05rm-1709917996703)

<a name="pl6a-1720972917102"></a>[优点：分区数量适应总数据量-动态划分分区数量。](#v8uv-1709918235496)

<a name="lnc5-1720972917104"></a>[注意：空库分区开始，未绘制边界先验信息。所有写操作都必须由单个节点处理。其它节点空闲](#cdjv-1709918375629)

<a name="tdnp-1720972917106"></a>[解决：配置一组初始分区-预分割 Hbase MongoDb。配需提前知道键分配方式。](#3uee-1709918458100)

<a name="b9i7-1720972917108"></a>[MongoDB同时支持范围和哈希分区且动态分割分区。](#tlmq-1709918504615)

<a name="3wut-1720972917110"></a>[分区数量与数据集大小成正比](#xqee-1709921516740)

<a name="qikn-1720972917112"></a>[按节点比列分区](#kcsr-1709800432396)

<a name="mven-1720972917114"></a>[新增节点，分区将变小。随机选择固定数量的现有分区进行拆分,最终获得公平的负载份额。cassandre ketama.](#xscz-1709920011051)

<a name="rfka-1720972917116"></a>[随机选择分区边界要求使用基于散列的分区-一致性哈希。](#pmpc-1709920187661)

<a name="wmmb-1720972917118"></a>[分区数量与节点数量无关](#a0l0-1709923420226)

<a name="5zs3-1720972917120"></a>[ 运维：手动还是自动平衡](#w6ob-1709800443454)

<a name="ekau-1720972917122"></a>[自动：与故障检测结合将十分危险，高负载节点响应慢被视为死亡被踢掉，重新平衡集群时其他超负荷节点可能级联失败](#qobk-1709920292898)

<a name="6gxb-1720972917124"></a>[手动人为监控+自动](#a05n-1709920414620)

<a name="qhwc-1720972917126"></a>[.请求路由](#qxk3-1709800301840)

<a name="9dhf-1720972917128"></a>[分区再平衡后的服务发现(IP 端口)](#sd2e-1709921854453)

<a name="oc67-1720972917130"></a>[-------方案-------](#gliq-1709921964410)

<a name="qjey-1720972917132"></a>[1.循环策略：Round-Robin load balancer，轮询节点看是否有请求的分区。](#ibln-1709921978507)

<a name="avqs-1720972917134"></a>[2.路由层：有中间层的路由决定请求的节点，由路由层负载均衡](#gjxa-1709922094115)

<a name="nhu4-1720972917136"></a>[3.要求客户端知道分区和节点的分配。客户端可直连节点。](#ukz9-1709922149547)

<a name="3ay1-1720972917138"></a>[具有挑战性的问题。重要的是所有参与者都同意-否则将被发送到错误的节点，而不是正确处理。分布式中的共识协议-但很难正确实现。](#1c54-1709922244119)

<a name="accu-1720972917140"></a>[Zookeper分区分配改变时通知路由层保持最新信息。](#c7dc-1709922373821)

<a name="6o6g-1720972917142"></a>[LinkedIn的Espressor使用Heix进行集群管理(依靠Zookeeper）](#ne7u-1709922442881)

<a name="v9lc-1720972917145"></a>[Hbase,SolrCloud 和kafka也是用Zookeeper来跟踪分区分配。](#41cr-1709922584212)

<a name="k6ux-1720972917147"></a>[Cassandra  Riaks节点间使用留言协议gossip protocol来传播群集状态变化。请求发送任意节点，该节点转发到含有请求分区的节点。模型增加数据库节点的复杂性。但避免对Zookeeper这类外部协调服务的依赖](#kg5k-1709922347652)

<a name="d0sk-1720972917149"></a>[Couchbash不会自动再平衡，简化了设计。moxi路由层。](#uohs-1709922928889)

<a name="w5kv-1720972917151"></a>[执行并行查询](#h26t-1709800460759)

<a name="uqdg-1720972917153"></a>[大规模并行处理(MPP,massively parallel processing)-数仓](#oj8k-1709923010027)

<a name="za76-1720972917155"></a>[7.事务](#7qvp-1708523954496)

<a name="rvhv-1720972917157"></a>[简化故障失败的机制-强大的事务！！](#wk3n-1710172857428)

<a name="qzsu-1720972917159"></a>[故障](#pzui-1710172844274)

<a name="ssid-1720972917161"></a>[崩溃](#znoj-1710172848152)

<a name="xi1p-1720972917163"></a>[网络中断](#vovu-1710172885568)

<a name="s1ck-1720972917165"></a>[多线程/客户端写入覆盖](#sxty-1710172894683)

<a name="m76c-1720972917167"></a>[读取无意义中间态数据](#hbqy-1710172933218)

<a name="0bfp-1720972917169"></a>[多线程/客户端竞争](#jlng-1710172974900)

<a name="casd-1720972917171"></a>[.事务的棘手概念](#58hv-1710167822460)

<a name="4dcu-1720972917173"></a>[ACID的含义](#yxrp-1710167867782)

<a name="0rw3-1720972917175"></a>[原子性atomicity](#hryj-1710167943276)

<a name="9bkd-1720972917177"></a>[一致性consistency](#9aal-1710167983379)

<a name="3idr-1720972917179"></a>[—致性这个词重载的很厉害:](#jkse-1710173130714)

<a name="qziz-1720972917181"></a>[隔离性isolation](#gfkv-1710171645686)

<a name="79wk-1720972917183"></a>[持久性durability](#7kja-1710171663168)

<a name="gyiz-1720972917185"></a>[单对象与多对象操作](#pblh-1710167919896)

<a name="g6vt-1720972917187"></a>[违反隔离性：一个事务读取另一个事务未被执行的写入（脏读）](#42qx-1710250188446)

<a name="7rhp-1720972917189"></a>[ 原⼦性确保发⽣错误时，事务先前的任何写⼊都会被撤消，以避免状态不⼀致（all or nothing）](#daxd-1710250201202)

<a name="eq8r-1720972917191"></a>[单对象写入](#7ymn-1710171710772)

<a name="sd2y-1720972917193"></a>[单对象写入崩溃，原子性通过日志实现恢复](#h5aa-1710250215106)

<a name="sbs1-1720972917195"></a>[原子操作：CAS也是流行的操作](#ihdr-1710250368749)

<a name="yxwn-1720972917197"></a>[事务通常被理解为：将多个对象上的多个操作合并为一个执行单元的机制](#a1qj-1710250481310)

<a name="uold-1720972917199"></a>[多对象事务的需求](#afyc-1710171718578)

<a name="dbnw-1720972917201"></a>[是否需要多对象事务？ ](#t9gh-1710251706186)

<a name="cb8z-1720972917203"></a>[是否有可能只用键值模型和单对象来实现应用程序？](#9b6e-1710251739137)

<a name="zxfo-1720972917205"></a>[ 关系型数据库：多表关联插入操作](#ormg-1710250533532)

<a name="mo0m-1720972917207"></a>[ 文档数据模型：多个字段常在同一个文档(被视为单个对象），缺乏连接功能的文档DB会鼓励非规范化(操作非规范化信息需要更新多个文档)。事务可防止非规范化数据不同步。](#opfe-1710250566216)

<a name="zsvc-1720972917209"></a>[ 二级索引的数据库中：一二级索引的同步更新](#syt6-1710251863622)

<a name="s1t7-1720972917211"></a>[无原子性:复杂的错误处理](#ymgi-1710251891615)

<a name="5i2l-1720972917213"></a>[无隔离性：并发问题](#ovhl-1710251918119)

<a name="bkfw-1720972917215"></a>[处理错误和中止](#g5o1-1710171723084)

<a name="r2qs-1720972917217"></a>[···   ACID哲学：违反规则宁可放弃，不留半成品。](#ygfp-1710251941752)

<a name="kbk0-1720972917219"></a>[无主复制则是尽力而为：数据库将做尽可能多的事。错误时不会撤销已经完成的事。-错误恢复是应用程序的责任。](#0hze-1710252188073)

<a name="kv97-1720972917221"></a>[Rails的ActiveRecord、Django这样的orm框架不会重试中断的事务。丢弃用户输入。](#7mbo-1710252298563)

<a name="xepm-1720972917223"></a>[中止的重点应该是允许安全的重试。但它并不完美：](#p2mf-1710253466041)

<a name="mpuy-1720972917225"></a>[事务成功，网络故障可能导致执行两次。除非有额外应用级除重机制。](#lmfw-1710253530673)

<a name="zuya-1720972917227"></a>[负载过大，重试将更槽糕。限制重试次数，指数退避算法。并单独处理和过载相关的错误](#nxyx-1710253675080)

<a name="qwrs-1720972917229"></a>[仅在临时性错误才值得重试（死锁，异常，网络中断和切换）。发生永久性错误的重试是无意义的](#njy9-1710253740189)

<a name="4fjs-1720972917231"></a>[数据库外的副作用：重试每次重发电子邮件。不同系统事务。两阶段提交2PC.](#auy9-1710253799114)

<a name="snyf-1720972917233"></a>[ 客户端重试失效则丢失数据。](#mtpo-1710253936214)

<a name="v3jo-1720972917235"></a>[.弱隔离级别](#jngf-1710167840980)

<a name="vbdx-1720972917237"></a>[安全并行parallel：事务不触及相同数据](#wdhp-1710263089880)

<a name="apjl-1720972917239"></a>[竞争条件：](#ykgs-1710263216103)

<a name="n6kl-1720972917241"></a>[读：事务读取另一个事务同时修改的数据](#er05-1710263177909)

<a name="fm1e-1720972917243"></a>[写：事务同时修改相同的数据](#pypw-1710263203957)

<a name="mb30-1720972917245"></a>[事务隔离：](#xps5-1710263234506)

<a name="vlwv-1720972917247"></a>[可序列化(一次一个执行，没有任何并发)](#ghkk-1710263260640)

<a name="jvjj-1720972917249"></a>[性能损失](#a876-1710263299289)

<a name="t4rw-1720972917251"></a>[弱隔离级别(非串行化nonserializable)](#nqm3-1710263313752)

<a name="8aab-1720972917253"></a>[较弱的隔离级别防止一部分，而非全部的并发问题](#e7nl-1710263334073)

<a name="gdpj-1720972917255"></a>[资金损失，耗费财务调查，财务数据请使用ACID数据库(注意：流行的数据库也使用弱隔离级别，不一定能防止并发错误)](#2xxd-1710331395046)

<a name="lfaz-1720972917257"></a>[读已提交](#pjqb-1710171742279)

<a name="ug52-1720972917259"></a>[没有脏读](#7h42-1710171796899)

<a name="zzoy-1720972917261"></a>[dirty reads：事务看到另一个事务未提交的值](#lyju-1710332135761)

<a name="dgw2-1720972917263"></a>[为什么要防止dirty reads：](#x8ch-1710333899846)

<a name="f4kz-1720972917265"></a>[更新多对象：脏读以为只看到部分数据](#pwpa-1710333902582)

<a name="ysli-1720972917267"></a>[事务中止：回滚后，看到的是未提交的数据](#jcj0-1710333902583)

<a name="xrty-1720972917269"></a>[解决：只能读取提交后的数据，且不会阻塞，并行时保存已提交的旧值 -mvcc](#3mi1-1710332238978)

<a name="dglt-1720972917271"></a>[没有脏写](#vmfl-1710171803833)

<a name="mtsm-1720972917273"></a>[dirty write: 事务同时更新相同对象。后面的写入覆盖尚未提交的值。](#hvah-1710332040048)

<a name="hpm0-1720972917275"></a>[避免的问题：](#chr0-1710333916523)

<a name="9rh0-1720972917277"></a>[混乱写入，导致bob后买车先更新发票commit而alic先买车后更新发票commit(buyer=bob but recipient=alice)](#14wx-1710333919188)

<a name="rkep-1720972917279"></a>[解决：延迟/阻塞第二次的写入，直到第一次写入事务提交或终止。](#g1sw-1710332222649)

<a name="fzzj-1720972917281"></a>[但不能防止计数器增量的竞争状态。(读写非原子性，写依赖读的副本)](#ujzx-1710333397576)

<a name="ubss-1720972917283"></a>[计数器增量安全：防止更新丢失 -版本号](#ugiq-1710333641028)

<a name="yczp-1720972917285"></a>[实现读已提交](#z96g-1710171821987)

<a name="oncd-1720972917287"></a>[默认的隔离级别：oracle,postgreSQL,sql server ,memSql](#tays-1710333754461)

<a name="xun0-1720972917289"></a>[行锁row-level lock](#svaf-1710333809593)

<a name="tfrp-1720972917291"></a>[读写锁防止脏读：读写锁互斥，只有读锁拥有者可持有写锁。](#fsbu-1710334081090)

<a name="ubwt-1720972917293"></a>[缺点：阻塞，性能损失。](#xj1j-1710334321006)

<a name="laws-1720972917295"></a>[优化：所以一般用mvcc的模式。-或者copy on write](#7klj-1710334353854)

<a name="b3ow-1720972917297"></a>[快照隔离和可重复读](#bww4-1710171760070)

<a name="bqv8-1720972917299"></a>[不可重复读nonrepeatable read/读取偏差read skew](#wjut-1710343195467)

<a name="d4yj-1720972917301"></a>[skew重载：在热点指的是不平衡，这里指异常时机  alice两个账号各500，alice先读acount1=500,转账员将acount1+100,acount2-100后commit，alice读acount2=400.commit.导致Alice看起来少了100。-暂时不一致。](#jmuu-1710343248537)

<a name="nffc-1720972917303"></a>[提交后，刷新网页即可。有些情况不能容忍暂时不一致：](#gwgf-1710343469620)

<a name="voes-1720972917305"></a>[备份：数据库备份需要几小时，期间接收写入包含新老数据。如果备份用于恢复，不一致就变成永久的了。-解决：全局锁/快照备份](#m0km-1710345572560)

<a name="izvb-1720972917307"></a>[分析查询和完整性检查：扫描大部分数据库，查询在不同时间点观察数据库产生不同，可能返回无意义的结果。](#i5pt-1710345666724)

<a name="bccj-1720972917309"></a>[ 快照隔离snapshot isolation 对长时间运行的只读查询非常有用（备份和分析）。](#p7tm-1710345899708)

<a name="8nqa-1720972917311"></a>[ 即 一致快照consistent snapshot,即使被另一个事务更改，每个事务只能看到该特定时间的旧数据（特定时间点冻结的一致快照）。](#q8oz-1710345935366)

<a name="oxxj-1720972917313"></a>[PostgerSQL, mysql innoDB, Oracle, sqlServer](#mo1i-1710346175801)

<a name="pzji-1720972917315"></a>[实现快照隔离](#2hpt-1710171981487)

<a name="hn0z-1720972917317"></a>[关键原则：读不阻塞写，写不阻塞读。两者没有任何锁定争用。](#49s0-1710346236063)

<a name="fjna-1720972917319"></a>[多版本并发控制mvcc,multi-version concurrentcy contorl](#w8v8-1710346319154)

<a name="0o5g-1720972917321"></a>[读已提交不提供快照隔离，保留对象的一两个版本就足够。通常支持快照隔离也是用mvcc来实现读已提交隔离级别：](#fh82-1710346453757)

<a name="lb1s-1720972917323"></a>[读已提交为每个查询使用单独的快照-每个select单独生成。](#3xbw-1710346540026)

<a name="chwv-1720972917325"></a>[快照隔离对整个事务使用相同的快照-复用第一个select生成的快照](#xqhm-1710346554737)

<a name="fd3r-1720972917327"></a>[update操作在内部翻译为Delete 和 insert](#pmk8-1710351883488)

<a name="sxv4-1720972917329"></a>[-innoDB实际上delete将旧数据版本移到undolog版本链中。垃圾收集会删除任何事务不可见的就对象版本。](#vnfd-1710351911457)

<a name="ijmw-1720972917331"></a>[观察一致性快照的可见性规则](#box0-1710171988275)

<a name="yoyd-1720972917333"></a>[从来不更新值，而是每次值改变时创建一个新版本。使得数据库提供一致快照产生的开销很小。](#yapf-1710408915465)

<a name="2qru-1720972917335"></a>[事务id决定它可以看到哪些对象，规则如下：](#ecrk-1710408160769)

<a name="hp2f-1720972917337"></a>[事务开始时列出当时所有事务清单，即使之后提交，这些事务的写入也都会被忽略。](#ogtp-1710408539120)

<a name="ao58-1720972917339"></a>[忽略被中止事务任何写入](#unjc-1710408595672)

<a name="uraf-1720972917341"></a>[较晚(当前事务之后开始)的写入都被忽略，不管是否提交](#ofbz-1710408626209)

<a name="vilz-1720972917343"></a>[所有其他写入，对应用都是可见的。](#hgwi-1710408682423)

<a name="bdso-1720972917345"></a>[对象可见的两条规则](#rg1c-1710408738736)

<a name="awjb-1720972917347"></a>[读事务开始时，创建该对象的事务已提交。](#weyp-1710408754844)

<a name="kovx-1720972917349"></a>[请求删除的事务在读事务开始时未提交。](#xqky-1710408773006)

<a name="5ifp-1720972917351"></a>[索引和快照隔离(索引如何在多版本数据库中工作)](#ai77-1710171999516)

<a name="3r9d-1720972917353"></a>[同一对象不同版本放在同一个页面中，PostgreSQL的优化可以避免更新索引](#kanl-1710410047690)

<a name="ejdb-1720972917355"></a>[仅追加/写时拷贝apeend-only/copy-on-wirte的变体B树：更新不覆盖树的页面，为每个修改页创建副本。](#yv2q-1710410120895)

<a name="rijy-1720972917357"></a>[每个写入事务/一批事务都会创建一个新的B树，当创建时，从该特定树根生长的树就是数据库的一个一致性快照。](#etza-1710410471666)

<a name="e5pb-1720972917359"></a>[需要负责压缩和垃圾收集的后台进程。](#79xv-1710410561061)

<a name="5xlx-1720972917361"></a>[可重复读与命名混淆](#xr4f-1710172004472)

<a name="jzji-1720972917363"></a>[原因：System R定义隔离级别时并未有快照隔离](#nohd-1710417835613)

<a name="fy5b-1720972917365"></a>[oracle DB2 称为序列化](#uwdp-1710417928621)

<a name="q9zc-1720972917367"></a>[postgreSql mySql称为可重复读](#f5te-1710417946615)

<a name="y6pp-1720972917369"></a>[防止丢失更新](#e9wg-1710171770800)

<a name="nqco-1720972917371"></a>[脏写导致丢失更新lost update](#ajmt-1710418075399)

<a name="vmls-1720972917373"></a>[读取-修改-写入序列的狠揍clobber：第二个事务并没有包括第一个事务的修改: -写依赖读](#c7rv-1710418271703)

<a name="ajen-1720972917375"></a>[增加计数器或更新账户余额(需读取当前值，计算新值并写回更新后的值)](#uvoq-1710418375497)

<a name="dv45-1720972917377"></a>[进行本地修改： 解析文档，更改后回写修改的文档](#ro12-1710418458493)

<a name="rrbe-1720972917379"></a>[同时编辑wiki页面：整个页面覆盖当前内容。](#9n83-1710418515773)

<a name="pnoz-1720972917381"></a>[原子写(x排它锁)](#lftw-1710172034957)

<a name="zh1a-1720972917383"></a>[数据库原子更新操作保证并发安全](#6jim-1710418574114)

<a name="eeax-1720972917385"></a>[mysql: 行级写锁](#dxgy-1710419672127)

<a name="zapo-1720972917387"></a>[MongoDB：对JSON文档一部分进行本地修改的原子操作](#bqxj-1710419591972)

<a name="b5pw-1720972917389"></a>[redis提供了优先队列等修改数据的原子操作。](#wxju-1710419646040)

<a name="nxa0-1720972917391"></a>[原子操作/游标稳定性cursor stability：通常在读取对象时获取其上的排它锁，以便提交前没有事务可以读取它。另一个选择是将所有原子操作在单一线程上执行。-redis](#h0ip-1710421887552)

<a name="0abq-1720972917393"></a>[unfortunately,ORM框架易执行读取-修改-写入序列，而不是使用数据库提供的原子操作。如果你知道自己在做什么那当然不是问题](#6hwo-1710422121598)

<a name="tygr-1720972917395"></a>[显式锁定(for update：读-改-写序列)](#vysa-1710172041914)

<a name="ej06-1720972917397"></a>[让应用程序显示锁定更新的对象，直到一个读取-修改-写入序列完成](#oknq-1710422501689)

<a name="nctl-1720972917399"></a>[select ..... for update;](#89ij-1710422624973)

<a name="ekmj-1720972917401"></a>[--更新先前select 返回棋子的位置。](#50q1-1710422845671)

<a name="dimo-1720972917403"></a>[ update](#rmgw-1710422637550)

<a name="6lav-1720972917405"></a>[for update-对返回的所有行加锁，忘记加锁很容易引入竞争条件(同时修改)](#euv5-1710422671170)

<a name="s4pb-1720972917407"></a>[自动检测丢失的更新(管理器检测处理并发问题)](#jpu5-1710172058032)

<a name="pkcn-1720972917409"></a>[允许并行执行，事务管理器检测到丢失更新，中止事务并强制重试读-改-写序列。](#8ytj-1710423161566)

<a name="3frl-1720972917411"></a>[Oracle可串行化(快照隔离)和sqlServer的快照隔离级别会自动检测到丢失更新，中止惹麻烦的事务。一些作者认为能防止丢失更新才算提供快照隔离。这个定义下，mysql不算提供快照隔离](#w9el-1710423029153)

<a name="ggc1-1720972917413"></a>[优点：是一个很好的功能，不需要应用代码使用任何特殊数据库功能。允许你忘记加锁或原子操作，由管理器检测丢失更新。](#qg6e-1710423330067)

<a name="2mqo-1720972917415"></a>[比较并设置(CAS)](#ftwe-1710172063360)

<a name="c9yl-1720972917417"></a>[不提供事务的数据库中的原子操作：比较并设置（CAS compare and set）](#os3h-1710424617661)

<a name="hgql-1720972917419"></a>[update table set content='new content' where id=123 and content = 'old content'  必要时重试](#hlfh-1710425612756)

<a name="mwxu-1720972917421"></a>[问题：数据库允许where子句从旧快照读取，此语句无法防止丢失更新。即另一个并发写入，where条件也为真。-非当前读或非原子写。](#rxcv-1710425806449)

<a name="xeeq-1720972917423"></a>[解决：检查数据库的CAS是否安全。保证比较交换为当前读且写是否加锁/原子写](#zss4-1710425865867)

<a name="gfdb-1720972917425"></a>[冲突解决与复制(多个数据库副本的并发)](#bvrp-1710172079412)

<a name="xmem-1720972917427"></a>[基于锁和cas操作不适用于多个数据库副本](#ewf7-1710434904534)

<a name="n5tx-1720972917429"></a>[如检测并发写入：允许并发吸入创建多个冲突版本(也称兄弟），应用代码或特殊数据结构在发生之后解决合并这些版本。](#8dx4-1710434970886)

<a name="klqp-1720972917431"></a>[原子操作可在复制的上下文中很好工作，尤其具有可交换性时。Riak2.0不同客户端同时更新一个值是，Riak将自动更新合并在一起，以免丢失更新。防止复制副本丢失更新。](#gl8j-1710435048968)

<a name="ijqn-1720972917433"></a>[最后写入LWW解决冲突很容易丢失更新。unfortunately,许多复制数据库默认LWW。](#gdtn-1710435259414)

<a name="g64l-1720972917435"></a>[写入偏差与幻读（两个事务更新两个不同的对象）](#rkev-1710172453385)

<a name="nklj-1720972917437"></a>[select count(*) where oncall=true....alice 和 bob分别查在职医生人数](#itfd-1710436127298)

<a name="oqrc-1720972917439"></a>[update...set oncall=false 然后将自己的记录更新为请假，违反至少一医生在职。](#leam-1710436160580)

<a name="rkvm-1720972917441"></a>[写偏差的特征](#ovid-1710172462835)

<a name="qmkl-1720972917443"></a>[特征：涉及多个对象，单对象的原子操作不起作用](#iedp-1710437034438)

<a name="qhwc-1720972917445"></a>[快照隔离实现中，自动检测丢失更新对此无帮助。postgred,innodb的可重复读，oracle序列化或sql server的快照隔离级别中，都不会自动检测写入偏差。写入偏差需要真正的可序列隔离-业务上的问题。](#wszw-1710437034814)

<a name="oq2t-1720972917447"></a>[数据库配置约束，指定至少一个值为true.大多数不支持这种配置，可以使用触发器或者物化视图实现。](#hn04-1710437034815)

<a name="mprb-1720972917449"></a>[显示锁定。 select ...fro update -锁定返回的所有行，锁定两个医生](#crrt-1710437034816)

<a name="5lkl-1720972917451"></a>[写偏差的更多例子](#4jr1-1710172470885)

<a name="mxau-1720972917453"></a>[读数据为空，分别插入一条数据的会议室预定系统：select count(*) from bookings where roomid=123 and time...，insert into bookings....不能防止另一个用户插入冲突会议。解决：又需要串行化执行。](#0hyt-1710437389755)

<a name="elgy-1720972917455"></a>[多人游戏：棋盘用锁防止丢失更新，但锁定不能妨碍将不同的棋子放在相同位置。产生写入偏差 。解决：使用唯一约束。](#pgcb-1710437636980)

<a name="jjcg-1720972917457"></a>[抢注用户名：和会议系统一样。不过唯一性约束可以解决该问题。](#bwel-1710437042998)

<a name="qskn-1720972917459"></a>[防止双重开支；用户花钱和积分服务，检查支付数不超过余额，有了写入偏差，可能会发生两个支出项目同时插入，导致余额变为负值，两个事务都不会注意到另一个。](#ogt8-1710438166946)

<a name="hjnv-1720972917461"></a>[导致写入偏差的幻读](#8gty-1710172478550)

<a name="4jlv-1720972917463"></a>[所有以上例子都遵循类似的模式](#tw0y-1710438423955)

<a name="p9nl-1720972917465"></a>[Select查询符合条件的行，至少两名医生值班；不存在该会议室同一时段的预定；棋盘位置未被占据；用户未被抢注；账户还有足够余额](#bngi-1710438445792)

<a name="t1ff-1720972917467"></a>[按照第一个查询的结果，应用代码决定是否继续](#l6p0-1710438590471)

<a name="ljmt-1720972917469"></a>[应用决定继续操作，执行写入(插入更新删除），并提交事务](#qt10-1710438739456)

<a name="ybj7-1720972917471"></a>[步骤3修改的行，是步骤1中返回的行之一，可以使用select for update来使事务安全避免写入偏差.](#cdmo-1710438899441)

<a name="9qjj-1720972917473"></a>[但检查是否不存在满足条件行，写入添加一个匹配相同条件的行。select for update 锁不了任何东西。](#caet-1710439501945)

<a name="3dmi-1720972917475"></a>[       这种效应：一个事务中的写入改变另一个事务的搜索查询结果，被称为幻读。快照隔离避免了只读查询中的幻读。以上的读写事务中，幻影会导致特别棘手的写歪斜情况。](#cwgh-1710440241091)

<a name="o1zt-1720972917477"></a>[物化冲突](#1cjy-1710172485201)

<a name="gdxi-1720972917479"></a>[物化冲突：将幻读变为数据库中一组具体行上的锁冲突。](#fv3x-1710440426895)

<a name="dslc-1720972917481"></a>[通过创建时间槽和房间的表，提前出入房间和时间的所有可能组合。创建预定的事务可以select for update锁定房间和时间段对应的行，在获得锁定后，可以检查重叠的预定并插入新的预定。该表不是存储预定相关的信息，它完全就是一组锁，用于防止同时修改同一房间和时间范围内的预定。](#laff-1710440634993)

<a name="i19u-1720972917483"></a>[缺点：弄清除如何物化冲突可能很难，也很容易出错，而让并发控制机制泄露到应用数据模型是很丑陋的做法。](#dngy-1710441936216)

<a name="vn2s-1720972917485"></a>[物化重入应为最后的手段。可序列化Serializeble级别是更可取的。](#i0he-1710441997817)

<a name="alx5-1720972917487"></a>[.可序列化](#di29-1710167844061)

<a name="lkla-1720972917489"></a>[弱隔离级别读已提交和快照隔离不能解决写入偏差幻读：](#ztac-1710587737356)

<a name="stxt-1720972917492"></a>[隔离级别难以理解，且不同数据库中实现不一致，可重复读概念不一样](#ky3h-1710588699885)

<a name="phto-1720972917494"></a>[光检查应用代码很难判定在特定隔离界别是否安全](#tpbs-1710588738858)

<a name="fog1-1720972917496"></a>[无检测竞争条件的好工具，往往倒霉时才会出现问题。](#jp98-1710588779920)

<a name="kf11-1720972917498"></a>[20世纪70年代system R就已经是这样，研究人员的答案都很简单：可序列化（serializeble）级别（但非人见人爱），都使用三种技术之一。](#sqvc-1710588820273)

<a name="pr8k-1720972917500"></a>[字面意义上的串行顺序执行事务](#mqa4-1710589545518)

<a name="oivx-1720972917502"></a>[两相锁定2PL two-phase locking,几十年来唯一的可行选择](#neot-1710589568078)

<a name="sc4d-1720972917504"></a>[乐观并发控制，可序列话的快照隔离serializable snapshot isolation](#pizj-1710589721553)

<a name="kjbz-1720972917506"></a>[真的串行执行(单线程执行事务)](#2oi3-1710172506817)

<a name="wwrg-1720972917508"></a>[数据库设计人员07年才确定，单线程循环执行事务时可行的。（多线程过去30年中被认为是获得良好性能的关键所在）](#o5af-1710589822067)

<a name="qwup-1720972917510"></a>[两个进展引发了这个反思：](#phuh-1710609564138)

<a name="flar-1720972917512"></a>[RAM足够便宜，许多场景可以将完整的活跃数据保存在内存中。-redis](#owi7-1710609747624)

<a name="valq-1720972917514"></a>[数据库设计人员意识到OLTP事务很短，只进行少量的读写操作。长时间的分析查询通常是只读的，可以用一致快照（快照隔离）上运行。](#vhy4-1710609817752)

<a name="vpbn-1720972917516"></a>[VoltDB/H-Store, Redis 和 Datomic中实现。避免锁的协调开销。吞吐量仅限单个cpu](#xcax-1710609934885)

<a name="ejoy-1720972917518"></a>[在存储过程中封装事务(优化交互式单线程事务)](#xh4n-1710172519134)

<a name="jpzq-1720972917520"></a>[数据库设计者认为，机票全流程是一个事务，可以被原子化执行。缺点：交互式会使流程性能直接下降。](#xthc-1710757083497)

<a name="nitc-1720972917522"></a>[解决：单线程串行执行事务的系统不允许交互式的多语句事务。提前将整个事务作为存储过程提交数据库：](#oo8b-1710757291600)

<a name="blzr-1720972917524"></a>[Interactive transaction :bob医生请假 1.select count  2.if count>=2 3.update false](#9fzd-1710757436562)

<a name="m2e9-1720972917526"></a>[stored procedure: execute stored take doctor of call](#gegl-1710763202697)

<a name="dgcq-1720972917528"></a>[事务所需的数据都在内存中，快速执行，无需等待网络和磁盘IO](#t47s-1710763179337)

<a name="tbix-1720972917530"></a>[存储过程的优点和缺点](#7ksv-1710172529258)

<a name="7kfa-1720972917532"></a>[名声不好：](#jfoa-1710763413471)

<a name="ye5m-1720972917534"></a>[陈旧丑陋无库生态，数据库存储过程各自的语言没跟上通用编程语言的发展](#4qhf-1710763421594)

<a name="tkgn-1720972917536"></a>[管理困难，调试困难，版本控制测试部署困难，和监控指标的系统集成困难](#96la-1710763483936)

<a name="u5z8-1720972917538"></a>[单个数据库通常由多个应用共享，写得不好的存储过程（占用大量内存和cpu）会比代码造成更大麻烦](#idii-1710763602399)

<a name="09vb-1720972917540"></a>[ 这些问题都可以克服。现代存储过程放弃了PL/SQL,使用现有通用编程语言：VoltDB使用java或Groovy, Datomic使用Java或Clojure, Redis使用Lua.](#1w0a-1710763899035)

<a name="elsy-1720972917542"></a>[存储过程与内存存储，使得单线程执行事务可行，](#bp68-1710767504595)

<a name="gxfv-1720972917544"></a>[无需等待I/O,](#ahfz-1710767568244)

<a name="fyfk-1720972917546"></a>[避免并发控制机制的开销，可以在单线程实现相当好吞吐量](#mfvt-1710767570930)

<a name="em73-1720972917548"></a>[VoltDB还用存储过程进行复制，在每个节点上执行相同的存储过程，所以要求存储过程是确定性的。比如使用当前日期，需要通过特殊的确定性API实现。](#7m1p-1710767621202)

<a name="tv35-1720972917550"></a>[分区](#xxtp-1710172539181)

<a name="dtux-1720972917552"></a>[顺序执行事务使并发控制简单多，但吞吐限制为单机单核。吞吐量高的应用，单线程将可能成为严重瓶颈。](#rqu5-1710767939361)

<a name="tutb-1720972917554"></a>[扩展多核多节点，可以对数据进行分区，每个事务只需在单个分区中读写数据，事务吞度量就可以与cpu保持现行扩展。](#puih-1710768082742)

<a name="npyr-1720972917556"></a>[对于需要访问多个分区的任务事务，需要进行协调，存储过程跨所有分区锁定执行，保证串行。](#jpiw-1710768164695)

<a name="s5zl-1720972917558"></a>[缺点：协调开销性能比单区事务慢得多。VoltDB吞吐量每秒1000个跨分区写入，比单分区低几个数量级，且通过增加机器来提高](#fgu3-1710768218238)

<a name="xsvw-1720972917560"></a>[事务是否可划分-应用的数据结构，键值数据，多个二级索的数据引需要大量跨分区协调。](#8lf4-1710768407791)

<a name="gf19-1720972917562"></a>[串行执行小结](#zyih-1710172540516)

<a name="cs9t-1720972917564"></a>[需每个事务小而快，一个缓慢的事务拖慢所有事务。](#dibg-1710768638498)

<a name="n9ts-1720972917566"></a>[可放入内存仅限活跃数据集，少量数据会移动到磁盘。但需要访问执行中的事务，系统会变慢。](#22nq-1710768681244)

<a name="daly-1720972917568"></a>[写入吞吐量必须低到能在单个cpu运行，否则事务能划分至但分区，且无需分区协调](#jmsk-1710768781527)

<a name="zvrq-1720972917570"></a>[跨分区事务使用程度受限。](#wlnd-1710769060180)

<a name="woj8-1720972917572"></a>[两阶段锁定（2PL）](#uhxa-1710172558745)

<a name="d5yu-1720972917574"></a>[30年高使用的序列化算法：两阶段锁定2PL two phase locking ,独占访问exclusive access:](#nhdj-1710769248115)

<a name="g5zt-1720972917576"></a>[事务A读取对象，阻塞B写入，直至A提交；](#khdp-1710769659952)

<a name="ww8m-1720972917578"></a>[事务A写入对象，阻塞B读取,直至A提交；](#elpw-1710769685611)

<a name="vrbv-1720972917580"></a>[快照隔离使得不会阻塞读，2PL提高序列化性质，解决丢失更新和写入偏差。](#6ja2-1710769959539)

<a name="wt8j-1720972917582"></a>[实现两阶段锁](#lfuv-1710172605096)

<a name="xnyo-1720972917584"></a>[2PL即innoDB可序列化级别及DB2可重复读隔离级别。](#8oif-1710770052594)

<a name="b7ug-1720972917586"></a>[读写阻塞为每个对象添加锁。共享模式shared mode 与独占模式exclusive mode:](#6wad-1710770158675)

<a name="gykw-1720972917588"></a>[读取对象需以共享模式获取锁。读共享](#1dyc-1710770195788)

<a name="ebzr-1720972917590"></a>[写入需独占模式取锁。写互斥。](#bshw-1710770251530)

<a name="vfqu-1720972917592"></a>[事务获得锁必须持有锁知道事务结束(提交或中止)。即一阶段获取锁，二阶段释放所有锁。](#r0b0-1711207524774)

<a name="vlkk-1720972917594"></a>[死锁deadlock, 数据库会自动检测死锁，并中止其中一个。被中止的事务充实需应用程序实现。](#iuyh-1710770211133)

<a name="njzs-1720972917596"></a>[两阶段锁定的性能](#qi7j-1710172616303)

<a name="mhlx-1720972917598"></a>[比弱隔离差得多](#vz0p-1711207837446)

<a name="iyvg-1720972917600"></a>[锁开销、串行并发性降低](#ienx-1711207878742)

<a name="241u-1720972917602"></a>[交互式事务形成等待队列、高百分位响应慢](#z85f-1711207913718)

<a name="aqke-1720972917604"></a>[死锁频繁时重试造成浪费](#kmkr-1711207799940)

<a name="oy52-1720972917606"></a>[谓词锁predicate lock](#ccq8-1710172621528)

<a name="c2oc-1720972917608"></a>[谓词锁：属于符合搜索条件的对象，解决幻读phantoms](#kfpi-1711208306292)

<a name="jgyy-1720972917610"></a>[事务A获取共享谓词锁shared-mode predicate lock读取匹配对象，与排它互斥](#6dqd-1711208459688)

<a name="udbr-1720972917612"></a>[事务A写入需等待其他事务谓词锁释放。](#p3er-1711208588906)

<a name="a0xd-1720972917614"></a>[适用于尚不存在，将可能添加的对象（幻象），如果两阶段包含谓词锁，可实现串行化。](#bdwj-1711208433268)

<a name="tlvf-1720972917616"></a>[索引范围锁next-key lock](#zv5c-1710172626404)

<a name="ktcw-1720972917618"></a>[谓词锁性能不佳：活跃事务持锁多，检查匹配非常耗时](#a3ce-1711208973949)

<a name="7bvf-1720972917620"></a>[2PL采用索引范围锁-简化版谓词锁：](#ayfb-1711209059199)

<a name="k1pl-1720972917622"></a>[索引位于roomid, 指示room123用于预定](#qmbu-1711212311152)

<a name="tcz7-1720972917624"></a>[或者索引位于时间上，指示12:00~13:00用于预定。](#ajbo-1711212362665)

<a name="wuaj-1720972917626"></a>[以上任何一条件，当另一个事务想写入时，需要更新索引-叶子节点，会收到共享锁。解决幻读和写入偏差](#k1ie-1711212755816)

<a name="dllh-1720972917628"></a>[索引范围锁不如谓词锁精确，但开销低](#6lzs-1711212829915)

<a name="rtyr-1720972917630"></a>[无可挂载索引，将退化为表锁，性能不利，但这是回退到一个安全位置。](#bofb-1711212877091)

<a name="0y5l-1720972917632"></a>[序列化快照隔离SSI（高性能序列化算法）](#slwa-1710172573367)

<a name="pbag-1720972917634"></a>[新算法：可序列化快照隔离SSI serializeble snapshot isolation 仅与快照隔离有很小性能损失. 08年 micheal cahill博士论文。](#lnci-1711213123166)

<a name="j1ng-1720972917636"></a>[用于单节点PostgreSQL9.1后序列化和分布式数据库](#weo0-1711213307841)

<a name="sf3m-1720972917638"></a>[处于实践证明阶段](#ue1s-1711213377985)

<a name="5pba-1720972917640"></a>[悲观pessimistic与乐观optimistic的并发控制](#yq9i-1710172639651)

<a name="nb4x-1720972917642"></a>[极致悲观：串行排它锁](#54jr-1711213690005)

<a name="hske-1720972917644"></a>[序列化快照隔离SSI是乐观技术： ](#bjxf-1711213769533)

<a name="xdq2-1720972917646"></a>[缺点：多事务争用contention时性能不佳，大部分事务中止，吞吐量极限下有重试机制将使性能变差。](#mefw-1711213819265)

<a name="8c62-1720972917648"></a>[优点：有备用容量，竞争不高场景比悲观好，可交换的原子操作可减少争用。](#nk1s-1711213915330)

<a name="ek4c-1720972917650"></a>[SSI在快照隔离基础上添加算法检测写入的序列化冲突，并决定中止哪些事务。](#snvf-1711214019984)

<a name="gnsu-1720972917652"></a>[基于过时前提的决策](#9lgw-1710172651041)

<a name="9yok-1720972917654"></a>[医生值班读取-修改-写入。数据库检测过时并终止：](#td4m-1711214184809)

<a name="ezpf-1720972917656"></a>[检测对旧MVCC对象版本的读取(读之前存在未提交的写入)](#t08a-1711215992016)

<a name="ccjs-1720972917658"></a>[检测影响先前读取的写入（读之后发生写入）](#aego-1711216030637)

<a name="vvrb-1720972917660"></a>[检测旧MVCC读取](#5smj-1710172660675)

<a name="rc10-1720972917662"></a>[事务提交时，检测是否有被忽略的写入已被提交。](#z7u2-1711216050316)

<a name="uu0c-1720972917664"></a>[SSI支持一致快照中长时间运行的读取-仅在提交时中止检测的陈旧读取。因为只读不产生幻读和写入偏差风险](#afqq-1711216243096)

<a name="dw3j-1720972917666"></a>[检测影响之前读取的写入](#mvok-1710172671381)

<a name="fhp2-1720972917668"></a>[事务写入提交时，在索引中查找最近读取受影响的其他事务，通知读取的事务非最新。并中止未提交写入的其他事务。](#mo5j-1711216452745)

<a name="weyy-1720972917670"></a>[可序列化的快照隔离的性能](#0sq6-1710172685702)

<a name="1rca-1720972917672"></a>[粒度granularity，精准哪些事务需要中止，但簿记开销显著。](#g2eg-1711216636788)

<a name="kgm3-1720972917674"></a>[简略的跟踪速度快（粗粒度），但导致不必要的事务中止。](#ux2m-1711216812849)

<a name="l6fr-1720972917676"></a>[相比2PL, 不需要锁定阻塞，读性能高](#jzqb-1711216700614)

<a name="fnwh-1720972917678"></a>[相比串行化，可扩展多台机器提高吞吐量，可跨分区读。](#qm51-1710756953994)

<a name="tsvu-1720972917680"></a>[SSI要求事务尽量短，避免长事务发生冲突中止。慢事务SSI比2PL或串行执行更不敏感](#wvsk-1711216911828)

<a name="lpy0-1720972917682"></a>[8.分布式系统的麻烦](#enui-1704985776096)

<a name="xilx-1720972917684"></a>[前几章failover故障切换, 复制延迟 与事务控制 处理各种可能发生的边缘情况，本章则是彻底的悲观总结。](#e2bp-1711387736669)

<a name="rxg3-1720972917686"></a>[故障与部分失效](#4yaw-1711386647072)

<a name="nm3a-1720972917688"></a>[部分失效partial failure  不确定性的nondeterministic: IDC配电单元故障](#9d0g-1711387883443)

<a name="iwak-1720972917690"></a>[云计算与超级计算机](#w7ln-1711386736921)

<a name="8zsz-1720972917692"></a>[不可靠的网络(Timeout)](#ynhs-1711386665148)

<a name="tgkd-1720972917694"></a>[请求丢失： 拔网线](#fav6-1711388032544)

<a name="nbbv-1720972917696"></a>[请求排队：](#znsf-1711388048086)

<a name="zfxf-1720972917698"></a>[请求失效：](#gmdu-1711388084834)

<a name="xvon-1720972917700"></a>[.....](#dssu-1711388054944)

<a name="uy1h-1720972917702"></a>[真实世界的网络故障](#y933-1711387087536)

<a name="s1no-1720972917704"></a>[检测故障](#aywv-1711387099045)

<a name="4zdw-1720972917706"></a>[超时与无穷的延迟](#z4hi-1711387103669)

<a name="cr3h-1720972917708"></a>[级联失效cascading failure](#qs2e-1711388153448)

<a name="8uwr-1720972917710"></a>[网络拥塞和排队](#gttn-1711387323883)

<a name="ptav-1720972917712"></a>[TCP执行流量控制flow control](#v9f2-1711388199023)

<a name="untd-1720972917714"></a>[视频、语音会议使用UDP，折中丢包与流畅](#up7k-1711389082773)

<a name="1hgu-1720972917716"></a>[同步网络vs异步网络](#t56p-1711387113980)

<a name="lsvc-1720972917718"></a>[有限延迟bounded delay：同步网络，不收排队影响](#fmrl-1711389283437)

<a name="lfyf-1720972917720"></a>[我们不能简单地使用网络延迟可预测吗](#bwvp-1711387335617)

<a name="bzw5-1720972917722"></a>[不可靠的时钟](#l3p1-1711386676597)

<a name="d48x-1720972917724"></a>[机器的时钟：硬件设备，石英振荡器，](#faqp-1711469591901)

<a name="7d0h-1720972917726"></a>[不是完全准确的。](#xtjc-1711469629964)

<a name="lfh9-1720972917728"></a>[同步时钟：网络时间协议NTP](#knwp-1711469656643)

<a name="hjwh-1720972917730"></a>[服务器从精确时间源获取时间-GPS接收器](#pfpq-1711469689783)

<a name="t6al-1720972917732"></a>[单调钟与时钟](#qoxv-1711387218692)

<a name="yget-1720972917734"></a>[时钟](#wu2k-1711387376627)

<a name="ptop-1720972917736"></a>[Linux: clock_gettime(CLOCK_REALTIME)](#obwb-1711469781129)

<a name="xuyj-1720972917738"></a>[java:system.currentTimeMilis](#uxdp-1711469821742)

<a name="fj7c-1720972917740"></a>[通常与NTP同步，但举例NTP服务器太远，则可能被强制重置(及时跳回）](#gwyx-1711469840905)

<a name="oqgc-1720972917742"></a>[单调钟](#hl1a-1711387385739)

<a name="aciw-1720972917744"></a>[保证总是前进](#uzaz-1711470052827)

<a name="79fl-1720972917746"></a>[Linux:CLOCK_MONOTONIC](#tbmn-1711469988760)

<a name="lslq-1720972917748"></a>[java:System.nanoTime](#fb70-1711470014393)

<a name="ssv6-1720972917750"></a>[调整频率：NTP检测到计算机石英钟更快或更慢，则调整单调钟频率（偏移skewing时钟）.](#sn42-1711470028035)

<a name="0onc-1720972917752"></a>[不假定不同节点时钟存在同步：分布式系统用单调钟效果好，对测量的不准确不敏感](#ct3v-1711470667953)

<a name="hxq2-1720972917754"></a>[时钟同步与准确性](#a7gy-1711387238026)

<a name="jt9b-1720972917756"></a>[漂移drifts: 计算机石英钟不准确原因,取决机器温度。](#pbyu-1711470750697)

<a name="jrpm-1720972917758"></a>[实现精确度：GPS接收机，精确时间协议PTP](#kgdy-1711470917769)

<a name="bgva-1720972917760"></a>[同步错误的原因：NTP守护进程配置错误，防火墙阻止NTP通信。](#kgez-1711470944635)

<a name="qm9m-1720972917762"></a>[依赖同步时钟](#vo0i-1711387245745)

<a name="pa3z-1720972917764"></a>[使用需要同步时钟的软件需监测所有机器间的时钟偏移](#zm2f-1711471000801)

<a name="bpst-1720972917766"></a>[有序事件的时间戳](#fnxq-1711387475761)

<a name="j4g9-1720972917768"></a>[写入排序问题：B客户端写入比A晚但具有更早的时间戳。 ](#n1pp-1711471283186)

<a name="m4ye-1720972917770"></a>[ 最后写入为准LWW](#50kp-1711471399605)

<a name="gq2k-1720972917772"></a>[ 版本向量](#axgx-1711471482711)

<a name="unpw-1720972917774"></a>[时钟读数存在置信区间](#ofpq-1711387431462)

<a name="z62n-1720972917776"></a>[ 置信区间的不确定性：NTP服务器的不去定性，加上服务器网络往返时间](#aihs-1711471513794)

<a name="movy-1720972917778"></a>[当clock_gettime()返回值不会告诉你预期错误，不知道置信区间是5毫秒还是5年](#aave-1711471693187)

<a name="wsjp-1720972917780"></a>[例外：Spanner Google TureTime API明确报告本地时钟置信区间（最早，最晚）。](#znqm-1711471741654)

<a name="gmxj-1720972917782"></a>[全局快照的同步时钟](#bfz6-1711387449885)

<a name="ch6d-1720972917784"></a>[分布式的事务快照隔离，分布式事务ID时序成为站不住脚瓶颈](#dpco-1711471815493)

<a name="5q92-1720972917786"></a>[Spanner通过置信区间来比较A,B发生的时序。](#2ihe-1711471939317)

<a name="xmr8-1720972917788"></a>[分布式事务语义使用时钟同步是一个活跃的研究领域，没有在谷歌之外的主流数据库中实现。](#9qfk-1711471991096)

<a name="fcke-1720972917790"></a>[暂停进程](#3mnj-1711387250438)

<a name="nagd-1720972917792"></a>[如何确保分布式主节点仍未领导者](#ui0e-1711472636558)

<a name="cnmz-1720972917794"></a>[方式一：从其他节点获得租约lease, 类似一个带超时的锁，周期性过期前续约。-和redison续约类似](#yh9a-1711472775035)

<a name="xclv-1720972917796"></a>[过期时，由另一个节点接管。](#kqwv-1711472837428)

<a name="8ewf-1720972917798"></a>[缺点：依赖同步时钟](#gi5a-1711473874947)

<a name="dftg-1720972917800"></a>[意外的时间停顿：](#93uw-1711473992955)

<a name="qaev-1720972917802"></a>[stop-the-world  HotSpot GC](#7kp7-1711474017909)

<a name="6uzj-1720972917804"></a>[suspend虚拟机](#6ejp-1711474059672)

<a name="ieyk-1720972917806"></a>[随意暂停恢复：关闭笔记本盖子](#92se-1711474080346)

<a name="zmnr-1720972917808"></a>[窃取时间steal time:虚拟机切换或cpu上下文切换，在其他机器中花费的时间.](#tfxw-1711474128862)

<a name="dm8i-1720972917810"></a>[同步时的阻塞io：java惰性加载类文件；磁盘为网络文件系统或网络块设备-亚马逊EBS](#7jwg-1711474280466)

<a name="hes3-1720972917812"></a>[磁盘交换内存抖动thrashing: 允许交换到磁盘（分页），内存访问可能导致页面错误page fault .话费大量时间将页面交换到内存，实际完成的工作很少thrashing。 服务器机器禁用页面调度，干掉进程释放内存。](#kvsa-1711474441136)

<a name="7753-1720972917814"></a>[SIGSTOP暂停unix进程:Ctrl-Z立即阻止进程的CPU周期](#ocvk-1711474648160)

<a name="lgws-1720972917816"></a>[这些都可以随时抢占preempt正在运行的线程。](#t1w7-1711474768157)

<a name="1cu7-1720972917818"></a>[响应时间保证](#cirf-1711473855327)

<a name="sjbv-1720972917820"></a>[硬实时hard real-time系统: 不满足特定截止时间deadline可能会导致整个系统故障。](#r1ji-1711474887529)

<a name="zbxx-1720972917822"></a>[嵌入式系统精心设计和测试：安全气囊不会因系统GC暂停弹出。](#pgjw-1711475001376)

<a name="aqbk-1720972917824"></a>[大量的额外工作，昂贵。](#urp5-1711475089330)

<a name="odzp-1720972917826"></a>[限制垃圾收集的影响](#i1wt-1711387521748)

<a name="x1vd-1720972917828"></a>[通知GC暂停，停止接收新请求-对延迟敏感的金融系统](#oxal-1711475134772)

<a name="0svs-1720972917830"></a>[变种：GC只收集新生代，积累老年代，一次重启一个节点，类似滚动升级。](#ho3v-1711475217820)

<a name="tikf-1720972917832"></a>[知识、真相与谎言](#ujyf-1711386681865)

<a name="fpcp-1720972917834"></a>[真理由多数所定义](#hdwi-1711387268312)

<a name="7m3h-1720972917836"></a>[stop the world 一分钟，被其他节点宣告死亡，重新选举。](#rxcy-1711561420884)

<a name="j5lo-1720972917838"></a>[领导者与锁定](#3zea-1711387542106)

<a name="ymwe-1720972917840"></a>[数据库分区领导者只能有一个节点：避免脑裂](#b6am-1711561462773)

<a name="eg4c-1720972917842"></a>[特定资源的锁和对象只允许一个事务/客户端持有](#3ynw-1711561525662)

<a name="g5ew-1720972917844"></a>[用户唯一标识](#hqa3-1711561556083)

<a name="0bx6-1720972917846"></a>[节点认为它是天选者the choosen one](#rv2w-1711561875596)

<a name="0i7t-1720972917848"></a>[HBase例子：分布式锁的实现不正确，客户端1持有锁stop the world导致lease超时,客户端2获得锁进行处理，客户端1仍认为它具有有效的租约，即使它已经过期，从而破坏了存储的文件。](#gu25-1711561617808)

<a name="wgdw-1720972917850"></a>[防护令牌](#mhlf-1711387550649)

<a name="dufj-1720972917852"></a>[解决天选者问题：防护fencing](#gw5w-1711561950975)

<a name="muel-1720972917854"></a>[fencing token :只允许增加屏蔽令牌的顺序进行写操作。](#vi5w-1711562021406)

<a name="pecs-1720972917856"></a>[服务器端检查token,获取锁时token增加33+1，存储服务器记录更高令牌34的写入，拒绝令牌33的请求。-一般是redisson续期，这个更像乐观锁。](#2yxl-1711562140276)

<a name="rpe3-1720972917858"></a>[ZooKeeper将事务标识zxid和节点版本conersion用作屏蔽令牌。保证了单调递增](#e6n2-1711562077138)

<a name="7gx2-1720972917861"></a>[如文件存储服务器可将令牌卸载文件命中](#uujk-1711564755459)

<a name="nsfk-1720972917863"></a>[拜占庭故障](#bsay-1711387279845)

<a name="bbh8-1720972917865"></a>[拜占庭故障Byzantine fault: 在不信任的环境中达成共识的问题称为拜占庭将军问题。](#id0b-1711628556885)

<a name="qsii-1720972917867"></a>[拜占庭将军问题：n位将军需要同意，一些叛徒通过发送虚假或不真实信息来混淆欺骗他人。](#lxw6-1711628612728)

<a name="mwda-1720972917869"></a>[拜占庭容错：系统在部分节点发生故障、不遵守协议，恶意攻击，扰乱网络时仍能继续正确工作：](#lpn6-1711628716132)

<a name="shk3-1720972917871"></a>[航空航天环境计算机被辐射破坏，不可预知方式响应其他节点](#py6z-1711638469892)

<a name="bxhv-1720972917873"></a>[多个参与组织系统中，参与者试图欺骗他人。比特币等区块链对等网络让互不信任的各方同意交易不依赖中央当局。](#csli-1711638605446)

<a name="m4k9-1720972917875"></a>[弱谎言形式](#f38o-1711387557457)

<a name="bcyn-1720972917877"></a>[添加防止撒谎弱形式机制；](#eepx-1711638744038)

<a name="e2ul-1720972917879"></a>[校验和防止数据包被破坏](#yseh-1711638821915)

<a name="6gch-1720972917881"></a>[公开访问的系统需仔细清理来自用户的任何输入](#2a8h-1711638847924)

<a name="vfqp-1720972917883"></a>[NTP多数对时间范围达成一致，配置错误的服务器将被排除](#zcdt-1711638888096)

<a name="kw27-1720972917885"></a>[系统模型与实现](#x4lu-1711387293192)

<a name="4iw2-1720972917887"></a>[定时假设三种系统模型：](#iyps-1711639179162)

<a name="wmib-1720972917889"></a>[同步模型synchronous model: 网络延迟，暂停和时钟漂移不会超过某个固定上限；](#pgo0-1711640511485)

<a name="wfm4-1720972917891"></a>[部分同步模型partial synchronous：大多数情况像一个同步系统一样运行，有时出现超时，进程暂停和时钟漂移界限](#h1x4-1711640383000)

<a name="paum-1720972917893"></a>[异步模型：一个算法不允许对实际做任何假设，事实上它甚至没有时钟。](#vkkn-1711640459345)

<a name="dwvh-1720972917895"></a>[节点系统模型：-节点失效问题](#lg5f-1711640536166)

<a name="gu2f-1720972917897"></a>[崩溃停止crash-stop:只能由崩溃失效，且永远不会回来。](#ahco-1711640498506)

<a name="byel-1720972917899"></a>[崩溃恢复crash-recovery: 具有稳定存储（非易失性磁盘），崩溃中保留，内存中状态会丢失-innodb三阶段提交](#35nl-1711640632666)

<a name="37zc-1720972917901"></a>[拜占庭（任意）故障：节点可以做任何事情，包括戏弄和欺骗其他节点](#rpmc-1711640822813)

<a name="qcr5-1720972917903"></a>[具有崩溃恢复的部分同步模型是最有用的模型。分布式算法如何应用这种模型](#6gea-1711640879281)

<a name="kxxx-1720972917905"></a>[算法的正确性](#hwoz-1711387576180)

<a name="tlkp-1720972917907"></a>[描述属性：定义算法的正确性](#i9kv-1711640972087)

<a name="5kw9-1720972917909"></a>[锁生成屏蔽令牌，要求具有以下属性：](#qsck-1711641049261)

<a name="zkem-1720972917911"></a>[唯一性：没有两个屏蔽令牌请求返回相同的值](#tvxj-1711641079676)

<a name="iszo-1720972917913"></a>[单调序列：时序实现单调](#2d0a-1711641105012)

<a name="h9t2-1720972917915"></a>[可用性：请求防护令牌且不会崩溃的节点，最终会收到响应](#mlbd-1711641130527)

<a name="5aav-1720972917917"></a>[安全性和活性](#1lz8-1711387585629)

<a name="akg2-1720972917919"></a>[澄清这种情况，需区分两种不同性质](#hctm-1711641203049)

<a name="9e2m-1720972917921"></a>[安全性safety: 唯一性和单调序列](#k48b-1711641295367)

<a name="ulbn-1720972917923"></a>[活性：可用性](#fmy7-1711641313609)

<a name="zmfo-1720972917925"></a>[将系统模型映射到现实世界](#ndiw-1711387592922)

<a name="h7el-1720972917927"></a>[9.一致性共识](#rp9s-1705080859004)

<a name="iljt-1720972917929"></a>[共识consensus: 让所有节点对某件事达成一致](#vrvh-1712996687843)

<a name="adpq-1720972917931"></a>[脑裂brain split: 两个节点都认为自己是master, 经常导致数据丢失；](#oqcs-1712996726634)

<a name="7an7-1720972917933"></a>[一致性保证](#obqn-1711730044966)

<a name="hsqt-1720972917935"></a>[最终一致性：收敛convergence, 最终收敛到相同的值](#ku5g-1712996774138)

<a name="ahut-1720972917937"></a>[事务一致性：避免同时执行事务导致的竞争状态](#ga60-1712996859001)

<a name="i1zx-1720972917939"></a>[分布式一致性模型：面对延迟和故障时，如何协调副本间的状态](#eovi-1712996916251)

<a name="ekqg-1720972917941"></a>[线性一致性](#thyh-1711730049653)

<a name="dfto-1720972917943"></a>[背后的想法：原子一致性atomic consistency, 强一致性strong consistency, 立即一致性 immediate consistency ,外部一致性 external consistency](#bvre-1712997165569)

<a name="exyg-1720972917945"></a>[看起来只有一个数据副本，实际有多个副本 - 强一致性就是逆分布式化，看成一个整体。](#qbsw-1712997247742)

<a name="nkay-1720972917947"></a>[线性一致是一个新鲜度保证 recency gurantee;](#f0su-1712997377059)

<a name="iife-1720972917949"></a>[非线性一致的例子： world cup ,  alice refresh - DB1 return germany 1: 0 argentina won ;  bob refresh website - DB2(un asychronize) return still playing;](#mtb7-1712997407717)

<a name="bvc9-1720972917951"></a>[为什么使得系统线性一致？](#qimr-1711730403998)

<a name="strj-1720972917953"></a>[例子：CAS使得多个客户端并发按序更新](#ffat-1712998155207)

<a name="iooo-1720972917955"></a>[线性一致性与可序列化是两种完全不同的保证：](#3elk-1712997586736)

<a name="4lw7-1720972917957"></a>[可序列化serializeble: 单对象或者多对象操作，确保按照某种顺序执行](#qpvu-1712998010030)

<a name="vwlf-1720972917959"></a>[线性一致性Linearizability:是读取和写入寄存器（单个对象）的新鲜度保证，不会将操作组合为事务，不会阻止写入偏差等问题](#ojsh-1712998125336)

<a name="okon-1720972917961"></a>[单副本强可串行性strong-1SR: 一个数据库可提供可串行性和线性一致, 基于两阶段锁2PL和实际串行执行通常是线性一致的](#5hda-1712998332148)

<a name="joos-1720972917963"></a>[SSI一致性快照不是线性一致的：不会包括比快照更新的写入；-不会阻塞非写的读。](#obfn-1712998432352)

<a name="ilcd-1720972917965"></a>[依赖线性一致性](#bje8-1711730427157)

<a name="e9ju-1720972917967"></a>[锁定与领导选举](#xyll-1711730652620)

<a name="rcfh-1720972917969"></a>[领导选举的一种方法：每个节点启动时尝试获取锁，成功者称为领导者。](#2fqs-1712998599719)

<a name="blsa-1720972917971"></a>[保证锁时线性一致的： zookeeper 和 etcd 协调服务的一致性算法。curator基于zookeeper上更高级别的配方](#cbzr-1712998723133)

<a name="bfpz-1720972917973"></a>[约束和唯一性保证](#gpva-1711730659968)

<a name="xhr7-1720972917975"></a>[这种情况类似于一个锁，锁定用户名。该操作与原子性的cas类似：](#9jmj-1712998930168)

<a name="bbpo-1720972917977"></a>[用户名和邮箱；](#lhyk-1712999021176)

<a name="wxcp-1720972917979"></a>[银行账号不为负数；](#7sgo-1712999031257)

<a name="hbv9-1720972917981"></a>[航班剧院预定了同一时间同一位置](#so5k-1712999045093)

<a name="swb8-1720972917983"></a>[实际应用中，处理这些限制有时可以接受。如调换位置并补偿。](#q05j-1712999070223)

<a name="rqro-1720972917985"></a>[跨信道的时序依赖](#7cbv-1711730671963)

<a name="loo5-1720972917987"></a>[将用户上传的照片降低分辨率以加快下载速度：](#cqkp-1712999245541)

<a name="rylj-1720972917989"></a>[步骤：消息队列一般针对较短的消息而设计，一张图片可能达到几M.所以步骤为](#3zoo-1712999362806)

<a name="3vz3-1720972917991"></a>[1.上传照片-  web server-2.  (store img) 存储文件服务器  ](#umkb-1712999318589)

<a name="d7vj-1720972917993"></a>[  | 3. send message  || 5.fetch full size img  6.store resized img](#er8u-1712999518585)

<a name="5mwu-1720972917995"></a>[消息队列   - 4.deliver message     image resizer](#iiv4-1712999532781)

<a name="yypz-1720972917997"></a>[问题：存储和缩放存在两个不同的信道，没有线性一致的新鲜度保证](#0yys-1712999647965)

<a name="zfvx-1720972917999"></a>[3和4可能比存储服务器内部的复制更快，当5时，可能会看到图像旧版本或者什么都没有，如果处理的是旧版本，则产生不一致。](#xtun-1712999768959)

<a name="legm-1720972918001"></a>[实现线性一致性的系统](#ytt0-1711730433598)

<a name="4uwy-1720972918003"></a>[单主复制（可能线性一致）protential潜在线性一致：](#j997-1712999879559)

<a name="chj7-1720972918005"></a>[快照隔离并发错误；](#t174-1712999979364)

<a name="ruom-1720972918007"></a>[脑裂；异步复制延迟，故障切换](#hh6o-1712999996439)

<a name="vx51-1720972918009"></a>[共识算法（线性一致）：共识算法可以安全实现线性一致性的存储，zookeeper 和 etcd](#z3nq-1713000050923)

<a name="wr2o-1720972918011"></a>[多主复制（非线性一致）：同时多个节点上处理写入，异步复制到其他节点，会产生冲突的写入](#q0kz-1713000066034)

<a name="bjlv-1720972918013"></a>[无主复制（也许不是线性一致的）：Dynamo风格，法定人数读写获得强一致性。通常不完全正确](#ca4m-1713030167882)

<a name="fnl6-1720972918015"></a>[线性一致性和法定人数](#9gst-1711730681011)

<a name="nfw9-1720972918017"></a>[最安全的做法是：假设采用Dynamo风格的无主复制的系统是不能提供线性一致性。](#sqvx-1713030399799)

<a name="cdbk-1720972918019"></a>[线性一致性的代价](#vpxf-1711730440465)

<a name="nyj6-1720972918021"></a>[CAP定理](#fqqf-1711730717308)

<a name="bln9-1720972918023"></a>[不仅是单主多主复制的后果，任何线性一致性的数据库都有这个问题：](#8hzl-1713030564813)

<a name="kyzv-1720972918025"></a>[.应用需要线性一致性，副本因为网络问题断开连接，请求必须等到网络问题解决或直接返回错误（不可用unavailable）](#7lux-1713030592466)

<a name="hbgv-1720972918027"></a>[.网络断开也可独立处理请求（如多主复制），可以在网络问题前保持可用，但其行为不是线性一致的。](#48wk-1713031150235)

<a name="jbbc-1720972918029"></a>[CAP定理没有帮助：网络分区是不可避免的，所以只能是AP 或 CP。](#lsdc-1713031249676)

<a name="eekk-1720972918031"></a>[线性一致性和网络延迟](#kxsm-1711730728177)

<a name="wguh-1720972918033"></a>[ 线性一致的系统惊人的少。例如多核CPU并没有保证一定能读到第一个线程写入的值（除非使用内存屏障memory barrier或围栏fence）](#lbl2-1713031508671)

<a name="la4s-1720972918035"></a>[ 牺牲线性一致性的原因是性能performance. 内存访问先走缓存，副本都是异步更新的，所以失去了线性一致性。](#pnsn-1713031585885)

<a name="agcq-1720972918037"></a>[搞笑的线性一致性存储不可实现。](#8y6v-1713031685808)

<a name="lxzl-1720972918039"></a>[顺序保证](#on5f-1711730057760)

<a name="lkqi-1720972918041"></a>[写入顺序order of write: 单主复制的主要目的就是复制日志中确定写入顺序。](#dhiv-1713031758875)

<a name="onrs-1720972918043"></a>[序列顺序serial order：某种序列顺序some sequential order](#cyfr-1713031815356)

<a name="acku-1720972918045"></a>[顺序与因果](#z48k-1711730472679)

<a name="a112-1720972918047"></a>[顺序有助于保持因果关系causality](#khzl-1713031939113)

<a name="qcpa-1720972918049"></a>[一致前缀读：先看到答案再看到问题。违背因cause果effect. 存在因果依赖causal dependency](#nbes-1713031966982)

<a name="5nea-1720972918051"></a>[更新不存在的记录：3位领导者间的复制，一些写入会压到其他写入。一条记录需被创建才能更新。](#xehj-1713032060272)

<a name="stwj-1720972918053"></a>[检测并发写入：A和B并发，则不知道顺序，A和B不知道彼此。](#v1kv-1713032135082)

<a name="4yyc-1720972918055"></a>[快照隔离：写偏差read skew，读取的数据违反因果关系（不可重复读）](#ozi8-1713032226341)

<a name="8rly-1720972918057"></a>[事务的写偏差write skew：幻读和值班。](#pgzq-1713032264605)

<a name="tzoj-1720972918059"></a>[世界杯球赛结果，跨信道的时序依赖。](#3ang-1713032756197)

<a name="xcov-1720972918061"></a>[因果一致causally：系统服从因果关系锁规定的顺序。](#tryg-1713032788961)

<a name="xuuu-1720972918063"></a>[因果顺序不是全序的](#niwx-1711730751513)

<a name="tyas-1720972918065"></a>[全序total order: 自然数更大或更小，总是有序的](#x8gk-1713086054855)

<a name="1qov-1720972918067"></a>[偏序partially order: 一个集合大于另一个集合，但是其它情况下无法比较](#wvsa-1713086222914)

<a name="jcwo-1720972918069"></a>[线性一致性：操作是全序的，系统表现好像只有一个副本，所有操作都是原子性的。意味对每个操作总能判定发生顺序](#u7jq-1713086312064)

<a name="rfkj-1720972918071"></a>[因果性：两个操作没在彼此之前发生，即并发无法比较顺序，意味着因果关系定义了一个偏序，而不是全序。一些有序一些无序](#xa0w-1713086399916)

<a name="pbei-1720972918073"></a>[线性一致的数据存储中是不存在并发操作的。确保每个请求都是在唯一时间线上自动处理](#uaxz-1713086531138)

<a name="v3dy-1720972918075"></a>[并发意味着时间线会分叉然后合并。操作的偏序：](#qs64-1713086635361)

<a name="8sig-1720972918077"></a>[类似git系统，一个提交commit发生在另一个提交之后。分支合并merge会在这些并发创建的提交相融合时创建。](#ctkd-1713086670170)

<a name="seja-1720972918079"></a>[线性一致性强于因果一致性](#qdnf-1711730766239)

<a name="3aqu-1720972918081"></a>[线性一致性隐含implies着因果关系;](#dam4-1713086279684)

<a name="hflc-1720972918083"></a>[捕获因果关系](#uqqx-1711730776113)

<a name="bwdy-1720972918085"></a>[为了维持因果性，需确认操作发生在哪个操作之前happened before:](#agrw-1713086796608)

<a name="3hv4-1720972918087"></a>[刑侦决定Y时是否知到X与Y因果关系](#rys3-1713086865582)

<a name="4wx3-1720972918089"></a>[检测并发写入：推广版本向量解决因果依赖](#znup-1713086911030)

<a name="hfz0-1720972918091"></a>[SSI序列化隔离快照：事务提交时，检测读取是否最新，为此跟踪哪些事务被那些事务锁读取。](#1ivk-1713086936754)

<a name="vuct-1720972918093"></a>[序列号顺序](#jsuf-1711730485869)

<a name="xrfh-1720972918095"></a>[序列号sequence number或时间戳timestamp](#y9ti-1713091524670)

<a name="5qhn-1720972918097"></a>[非因果序列号生成器](#qpya-1711730796494)

<a name="jbyp-1720972918099"></a>[兰伯特时间戳](#mtzj-1711730811106)

<a name="dokv-1720972918101"></a>[兰伯特时间戳提供了与因果关系一致的总排序：施行一个全序](#f8uv-1713091653199)

<a name="qn7n-1720972918103"></a>[检测并发写入有着不同目的：区分两个操作是并发的，一个因果依赖另一个。](#2ayx-1713091789731)

<a name="irih-1720972918105"></a>[光有时间戳排序还不够](#elc6-1711730816628)

<a name="clhc-1720972918107"></a>[全序广播](#aw2l-1711730490423)

<a name="m0nx-1720972918109"></a>[可靠交付reliable delivery：没有消息丢失，如果消息被传递到一个节点，它将被传递到所有节点](#axul-1713091937508)

<a name="o3xf-1720972918111"></a>[全序交付totally ordered delivery: 消息以相同的顺序传递给每个节点。](#cruc-1713091989510)

<a name="z1xw-1720972918113"></a>[使用全序广播](#hp3a-1711730834892)

<a name="tky7-1720972918115"></a>[zookeeper和etcd共识服务实际上实现了全序广播](#ztws-1713108978601)

<a name="y1f4-1720972918117"></a>[状态机复制state machine repliacation: 每个副本都按相同的顺序处理相同的写入。](#i8bk-1713109007327)

<a name="rv7t-1720972918119"></a>[与之类似，使用全序广播来实现可序列化的事务：真的串行执行，确定的事务以存储过程来执行，每个节点以相同的顺序处理这些消息。](#8jch-1713109071990)

<a name="za19-1720972918121"></a>[以及防护令牌的锁服务，全序广播使得所有消息按顺序一次编号，序列号可当做防护令牌(单调递增)，zookeeper中这个序列号称为zxid;](#w19a-1713109204107)

<a name="pjt5-1720972918123"></a>[使用全序广播实现线性一致的存储](#i3vg-1711730844593)

<a name="jpso-1720972918125"></a>[使用线性一致性存储实现全序广播](#xlae-1711730855140)

<a name="hceb-1720972918127"></a>[分布式事务与共识](#y1bv-1711730380233)

<a name="6wnv-1720972918129"></a>[让几个节点达成一致get serveral nodes to agree on somthing](#yt5r-1713109388776)

<a name="tkpr-1720972918131"></a>[领导选举：避免脑裂](#d7t7-1713109479427)

<a name="spec-1720972918133"></a>[原子提交atomic commit：多节点事务提交/中止/回滚](#frsp-1713109508353)

<a name="tzwv-1720972918135"></a>[原子提交与两阶段提交2PC](#abk6-1711730509647)

<a name="wn2b-1720972918137"></a>[原子性可以避免中间态，多对象事务原子性确保二级索引与主数据库保持一致。](#0h2f-1713110484428)

<a name="dvna-1720972918139"></a>[从单节点到分布式原子提交](#iqfd-1711730882368)

<a name="003p-1720972918141"></a>[从数据库的角度看，这是单独的事务，任何跨事务正确性的保证都是应用自己的问题。](#h1ym-1713110537245)

<a name="ri88-1720972918143"></a>[2PC两阶段提交简介](#roa9-1711730906391)

<a name="dveu-1720972918145"></a>[coodinator协调子事务，子事务单独执行完，在准备阶段询问是否可提交](#vaax-1705118249954)

<a name="aojn-1720972918147"></a>[.全部为是，则分别提交。](#7zwc-1705118288968)

<a name="9w9g-1720972918149"></a>[.其中有否，则中断回滚。](#3b8s-1705118337513)

<a name="ehu2-1720972918151"></a>[系统承诺](#kpgk-1711730913393)

<a name="rgzj-1720972918153"></a>[一旦协调者做出决定，这一决定是不可撤销的。](#wkui-1713110739239)

<a name="s4kc-1720972918155"></a>[协调者失败](#qhdj-1711730921387)

<a name="drth-1720972918157"></a>[参与者投赞成票后，参与者协调者崩溃，数据库1不知道是否提交或中止。](#jpd8-1713110804532)

<a name="l2lf-1720972918159"></a>[三阶段提交](#ixzv-1711730924556)

<a name="cfa7-1720972918161"></a>[阻塞blocking原子提交协议, 2PC可能卡主等待协调者恢复的情况。](#edp3-1713111179295)

<a name="8ppz-1720972918163"></a>[在提交阶段，如果子事务进程crash,或者协调者崩溃的时的解决方案，弱原子性，最终一致性。](#llyc-1711731148564)

<a name="ijo3-1720972918165"></a>[许多coodinator不支持高可用或者只支持基本的复制](#nlrk-1705118500709)

<a name="6zha-1720972918167"></a>[实践中的分布式事务](#xexf-1711730524691)

<a name="hqot-1720972918169"></a>[云服务由于其导致的运维问题而选择不实现分布式事务。](#inqh-1713111548114)

<a name="w46d-1720972918171"></a>[两阶段难以实现安全保证，且导致的运维问题造成性能下降。](#zuho-1713111590325)

<a name="6me1-1720972918173"></a>[数据库内部的分布式事务](#gf92-1711731287296)

<a name="6mqp-1720972918175"></a>[VoltDB 与mysql Cluster 的NDB引擎就有这样的内部事务支持。](#jhqw-1705080950920)

<a name="wmif-1720972918177"></a>[异构分布式事务](#gvng-1713111648038)

<a name="lwid-1720972918179"></a>[保证异构数据库的事务更有挑战性](#st60-1713111659854)

<a name="y2no-1720972918181"></a>[恰好一次的消息处理](#btdt-1711730944613)

<a name="igdx-1720972918183"></a>[XA事务eXtended Architecture](#qvbk-1711730954739)

<a name="ow5k-1720972918185"></a>[怀疑时持有锁](#med0-1711730959684)

<a name="iqbq-1720972918187"></a>[从协调者故障中恢复](#ouyq-1711730969007)

<a name="2tbd-1720972918189"></a>[唯一的出路是让管理员手动决定提交还是回滚事务](#ouur-1713116418144)

<a name="erxw-1720972918191"></a>[分布式事务的限制](#gzya-1711730975747)

<a name="pi1j-1720972918193"></a>[协调者本身就是一种数据库，存储了事务的结果。](#jkt3-1713116480399)

<a name="4yyi-1720972918195"></a>[协调者默认不是高可用的，只有基本的复制](#mcvv-1713116529836)

<a name="suk4-1720972918197"></a>[应用服务器不再是无状态的了](#h6gt-1713116550997)

<a name="5ipc-1720972918199"></a>[不能检测不同系统间的死锁，且无法与SSI协同工作](#rrrl-1713116568769)

<a name="vgtp-1720972918201"></a>[与构建容错系统的目标背道而驰，分布式事务有扩大失效amplifying failures的趋势](#wbzw-1713116600081)

<a name="gtnt-1720972918203"></a>[容错共识](#npne-1713118985168)

<a name="zj6u-1720972918205"></a>[一个或多个节点提议propose某些值，共识算法决定decides采用其中的某个值。](#beiq-1713118985169)

<a name="lhej-1720972918207"></a>[一致同意Uniform agreement:  没有两个节点的决定不同-核心 决定了相同的结果，一旦决定不能改变](#pq0x-1713118985170)

<a name="w9xb-1720972918209"></a>[完整性Integrity: 没有节点决定两次-核心](#xnwp-1713118985171)

<a name="stfr-1720972918211"></a>[有效性validity: 如果一个节点决定了值v, 则v由某个节点所提议-排除平凡的解决方案](#2bty-1713118985172)

<a name="wzbq-1720972918213"></a>[终止Termination由所有为崩溃的几点来最终决定值。-活性属性，必须取得进展，即使部分节点出现故障，其他节点也必须达成一致。不超过一般的节点崩溃或不可达](#9k32-1713118985173)

<a name="ws3m-1720972918215"></a>[稳健达成共识：只要少于三分之一的节点存在拜占庭故障](#scne-1713118985174)

<a name="qhuc-1720972918217"></a>[共识算法和全序广播](#prxr-1713118985175)

<a name="l8kb-1720972918219"></a>[视图戳复制VSR viewstamped repliacation, Paxos，Raft, Zab](#zmcg-1713118985176)

<a name="hzwn-1720972918221"></a>[全序广播相当于重复进行多轮共识：](#1u8f-1713118985177)

<a name="vnmy-1720972918223"></a>[一致同意属性，所有节点决定以相同的顺序传递相同的消息](#d2l2-1713118985178)

<a name="5uik-1720972918225"></a>[完整性属性，消息不会重复](#z7u4-1713118985179)

<a name="x9ne-1720972918227"></a>[有效性属性，消息不会被破坏，也不能凭空编造](#pphb-1713118985180)

<a name="a6em-1720972918229"></a>[终止属性,消息不会丢失](#gqmq-1713118985181)

<a name="yht0-1720972918231"></a>[视图戳复制，raft和zab直接实现了全序广播，比重复一次一致one value a time的共识更高效， paxos 下这种优化称为multi-paxos.](#lxll-1713118985182)

<a name="diac-1720972918233"></a>[单领导者复制和共识](#krsz-1713118985183)

<a name="kcfx-1720972918235"></a>[时代编号和法定人数](#90tt-1713118985184)

<a name="jjdq-1720972918237"></a>[共识的局限性](#qywj-1713118985185)

<a name="vdij-1720972918239"></a>[成员与协调服务](#8qzt-1713118985186)

<a name="kevd-1720972918241"></a>[将工作分配给节点](#4tlb-1713118985187)

<a name="qqdy-1720972918243"></a>[服务发现](#tbbj-1713118985188)

<a name="5vxa-1720972918245"></a>[成员服务](#1lld-1713118985189)

<a name="zpsn-1720972918247"></a>[第三部分：衍生数据](#46k8-1705118453932)

<a name="p6un-1720972918249"></a>[记录和衍生数据系统](#rboc-1716226529015)

<a name="f7vh-1720972918251"></a>[从高层次看，存储和处理数据的系统可以分为两大类](#cmdh-1716226737947)

<a name="d192-1720972918253"></a>[记录系统System of record](#1dmv-1716226552894)

<a name="0r4s-1720972918255"></a>[真相源source of truth. 记录用户输入新数据，标准化normalized](#dh96-1716226777418)

<a name="rkva-1720972918257"></a>[衍生数据系统Derived data system](#qjlf-1716226568395)

<a name="ogom-1720972918259"></a>[缓存cache, 衍生数据是冗余的，重复了已有的信息。](#igtl-1716226871151)

<a name="eu0k-1720972918261"></a>[10.批处理](#0bgb-1716226496297)

<a name="xiio-1720972918263"></a>[服务（在线系统）：高可用性，性能指标-响应时间](#yygb-1720542683707)

<a name="symq-1720972918266"></a>[批处理系统（离线系统）：定时任务job，性能指标-吞吐量](#goo7-1720542700859)

<a name="8mdj-1720972918268"></a>[流处理系统（准实时系统）：介于在线离线系统之间](#mv2a-1720542952432)

<a name="ozej-1720972918270"></a>[使用Unix工具的批处理](#6lu4-1716228538928)

<a name="203q-1720972918272"></a>[分析简单日志](#hyii-1716228597300)

<a name="hkgh-1720972918274"></a>[Unix命令链：网站上找到五个最受欢迎的网页（nginx/access.log）](#smoq-1720543218731)

<a name="wz3k-1720972918276"></a>[命令链与自定义程序Ruby](#ukyi-1716228816049)

<a name="txzl-1720972918278"></a>[排序 VS 内存中的聚合](#cnuw-1716228829632)

<a name="tb4m-1720972918280"></a>[工作集working set(作业需要随机访问的内存大小)，单个url 重复出现百万次，哈希表性能好](#siiu-1720543940755)

<a name="rdiy-1720972918282"></a>[工作集大于内存，排序优，与SSTables 和 LSM树一样，内存聚合归并排序，GNU 中的sort通过溢出至磁盘自动应该大于内存大额数据集，瓶颈可能是磁盘io。-MQ的死信处理也是溢出到磁盘。](#lms0-1720544023798)

<a name="fdjs-1720972918284"></a>[Unix哲学](#mgei-1716228613042)

<a name="yggo-1720972918286"></a>[统一的接口](#sk3b-1716228852580)

<a name="y7di-1720972918288"></a>[Unix中统一的接口是一个文件file](#33ju-1720874904091)

<a name="o31b-1720972918290"></a>[ASCII文本，\n 分隔，](#yogq-1720875513301)

<a name="dhps-1720972918292"></a>[CSV， ，号分隔](#7fvb-1720875542091)

<a name="ddsx-1720972918294"></a>[逻辑与布线相分离](#3oxq-1716228869387)

<a name="aaps-1720972918296"></a>[松耦合loose coupling](#0zy9-1720876020643)

<a name="e4mw-1720972918298"></a>[晚期绑定late binding](#226j-1720876035472)

<a name="kesn-1720972918300"></a>[控制反转inversion of control](#zedb-1720876065554)

<a name="ykjm-1720972918302"></a>[透明度与实验](#ftj8-1716228879278)

<a name="pjcv-1720972918304"></a>[MapReduce和分布式文件系统](#djdy-1716228554334)

<a name="u9wh-1720972918306"></a>[MapReduce像是分布在数前台机器上的Unix。](#illh-1720876369554)

<a name="xaii-1720972918308"></a>[Hadoop的Map-Reduce视线中，文件系统成为HDFS,基于google文件系统GFS的开源实现。](#e1cy-1720876447842)

<a name="xoal-1720972918310"></a>[Amazon S3，  Azure blob ](#mapk-1720876955975)

<a name="a1cd-1720972918312"></a>[MapReduce作业执行](#kdge-1716228625984)

<a name="6cow-1720972918314"></a>[Mapper在每条输入记录上调用一次,从输入记录中提取键值（提取键值）](#vleh-1720877349422)

<a name="9nd4-1720972918316"></a>[Reduce拉取Mapper生成的键值对，收集属于同一个键的所有值。（收集同键的所有值）](#aol7-1720877397533)

<a name="rmgr-1720972918318"></a>[分布式执行MapReduce](#kv6u-1716231603620)

<a name="zi9c-1720972918320"></a>[即在不同服务器上执行mapper reduce 的task。](#wy7r-1720877483243)

<a name="ylbk-1720972918322"></a>[MapReduce工作流](#d0qe-1716231619319)

<a name="m64h-1720972918324"></a>[workflow。一系列命令，输出写入临时文件，下一个命令从临时文件中读取-物化中间状态](#rvme-1720877910897)

<a name="gy04-1720972918326"></a>[Reduce端连接与分组](#pyoc-1716228643855)

<a name="rogm-1720972918328"></a>[用户活动事件](#1pza-1716231634942)

<a name="zoyx-1720972918330"></a>[左侧是事件日志/活动事件activity events/点击流事件clickstream evnets](#4l72-1720878002631)

<a name="y26c-1720972918332"></a>[右侧是用户数据库](#hivt-1720878131008)

<a name="bkq6-1720972918334"></a>[用户行为日志与用户档案的连接](#cvii-1720878237531)

<a name="vc17-1720972918336"></a>[原始:逐个遍历活动事件关联查询。缺点：吞吐量受限数据库服务器且容易压垮](#eiqe-1720878248508)

<a name="ecdg-1720972918338"></a>[改良：获取用户数据库副本（ETL进程从数据库备份中提取数据，参考数仓），放在同一个分布式文件系统中。将用户数据库存储HDFS中的一组文件中，用户活动记录存储另一组文件中，](#iueg-1720878322010)

<a name="cmqr-1720972918340"></a>[并能用MapReduce将左右相关记录集中到同一个地方进行高效处理。](#ruua-1720878498786)

<a name="f729-1720972918342"></a>[排序合并连接](#fihy-1716231663765)

<a name="vxdh-1720972918344"></a>[1.map提取键值(userid-url  usrid-do)和reduce(userid all url do)](#q51q-1720947527716)

<a name="vqhq-1720972918346"></a>[2.二次排序secondary sort ：对1的合并按时间戳排序](#4kvv-1720947648039)

<a name="qcr2-1720972918348"></a>[排序合并连接sort-merge join: reduce一次处理一个特定用户所有记录，只需将一条用户记录保存在内存中，无需发送网络请求](#j8br-1720947805879)

<a name="r6ld-1720972918350"></a>[把相关数据放在一起](#8vrk-1716231670998)

<a name="z39y-1720972918352"></a>[Mapper和排序过程确保特定用户id连接操作的必须数据都放在同一个地方](#t1tc-1720947947656)

<a name="h9wj-1720972918354"></a>[GROUP BY](#9j4s-1716228658160)

<a name="ce6m-1720972918356"></a>[除了连接之外，“把相关数据放在一起”的常见模式是记录分组。SQL中的Group By](#a6wg-1720952083180)

<a name="910o-1720972918358"></a>[处理倾斜](#qa24-1716231688547)

<a name="wfhe-1720972918360"></a>[名流热点数据hot spot](#f55j-1720952155251)

<a name="nwhz-1720972918362"></a>[参考负载倾斜和消除热点](#julg-1720952222343)

<a name="luqn-1720972918364"></a>[Mapper将热键的关联记录随机发送到几个Reduce之一](#akfb-1720952286891)

<a name="rhue-1720972918366"></a>[Map端连接](#2tox-1716228671225)

<a name="sayc-1720972918368"></a>[预处理输入数据](#qiil-1720971178915)

<a name="aoow-1720972918370"></a>[广播散列连接](#wjhj-1716231713037)

<a name="it61-1720972918372"></a>[broadcast hash join](#k3se-1720971260954)

<a name="6bbo-1720972918374"></a>[分区散列连接](#su27-1716231723170)

<a name="yg6a-1720972918376"></a>[Map桶端连接bucketd map jons](#5h9a-1720971514797)

<a name="stly-1720972918378"></a>[Map端合并连接](#ftdq-1716231736611)

<a name="jyti-1720972918380"></a>[MapReduce工作流与Map端连接](#yrmc-1716231744413)

<a name="qzqb-1720972918382"></a>[批处理工作流的输入](#zzir-1716228678980)

<a name="qqcf-1720972918384"></a>[OLTP ：查找少量记录，使用索引，呈现给用户](#hiqn-1720971586510)

<a name="vzqq-1720972918386"></a>[OLAP：扫描大量记录，执行分组与聚合，输出有着报告的形式，商业决策的分析。](#cqba-1720971612883)

<a name="nz4d-1720972918388"></a>[建立搜索索引](#bwjf-1716231761454)

<a name="jm8y-1720972918390"></a>[MapReduce最初作为google搜索引擎的索引](#lypn-1720971694941)

<a name="zb5c-1720972918392"></a>[全文搜索和模糊索引  Lucene](#iijq-1720971776882)

<a name="fnkp-1720972918394"></a>[分区和二级索引](#vcun-1720971828838)

<a name="dwvw-1720972918396"></a>[键值存储作为批处理输入](#8fix-1716231782091)

<a name="sgxw-1720972918398"></a>[批处理输入的哲学](#audd-1716231802005)

<a name="m9fk-1720972918400"></a>[视为不可变且避免副作用：](#6i34-1720972317458)

<a name="wqqa-1720972918402"></a>[人类容错human fault tolerance](#zciu-1720972319614)

<a name="h4wo-1720972918404"></a>[最小化不可逆性mininizing irreversibility](#oolm-1720972319615)

<a name="fjkk-1720972918406"></a>[Hadoop与分布式数据库的对比](#lp33-1716228684462)

<a name="n51u-1720972918408"></a>[Hadoop 像Unix的分布式版本，HDFS是它的文件系统，而MapReduce是Unix进程的怪异实现](#g0vj-1720972341966)

<a name="z5fp-1720972918410"></a>[MapReduce论文发表前，并行连接算法已在数据库实现-大规模并行处理MPP massively parallel processing ](#gjbt-1720972427948)

<a name="io8f-1720972918412"></a>[Gamma database machine, Teradata, Tandem NonStop SQL](#go7m-1720972523351)

<a name="lozg-1720972918414"></a>[区别：MMP专注一组及骑行并行执行分析SQL 查询](#5mnr-1720972551600)

<a name="34gd-1720972918416"></a>[MapReduce和分布式文件系统的组合是一个可以运行任意程序的通用操作系统](#gx7b-1720972580058)

<a name="srgc-1720972918418"></a>[存储多样性](#eebl-1716231817367)

<a name="4hme-1720972918420"></a>[数据湖data lake / 企业数据中心enterprise data hub](#5lga-1720972673599)

<a name="dn4j-1720972918422"></a>[Hadoop 常用于实现数仓ETL Extract, Transform, Load](#jrhw-1720972777529)

<a name="b5uu-1720972918424"></a>[处理模型多样](#ysfv-1716231826972)

<a name="lm9s-1720972918426"></a>[针对频繁故障设计](#kwz4-1716231831752)

<a name="uevo-1720972918428"></a>[MapReduce之后](#p0zx-1716228568687)

<a name="y9vt-1720972918430"></a>[物化中间状态](#fvak-1716228706372)

<a name="s0eo-1720972918432"></a>[数据流引擎](#sdac-1716231877023)

<a name="sfnq-1720972918434"></a>[容错](#glfr-1716231882229)

<a name="nnuk-1720972918436"></a>[关于物化的讨论](#npsg-1716231884238)

<a name="dbwr-1720972918438"></a>[图与迭代处理](#dvkh-1716228727874)

<a name="6e0u-1720972918440"></a>[Pregel处理模型](#lf5y-1716231892007)

<a name="ghsq-1720972918442"></a>[容错](#pxnd-1716231909468)

<a name="4to4-1720972918444"></a>[并行执行](#v8gr-1716231912877)

<a name="5jyx-1720972918446"></a>[高级API和语言](#cxqk-1716228736349)

<a name="lcx6-1720972918448"></a>[向声明式查询语言的转变](#dfa6-1716231923208)

<a name="v9qb-1720972918450"></a>[专业化的不同领域](#m2pu-1716231937991)

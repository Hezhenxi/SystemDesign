...
<a name="3060-1621846615933"></a><a name="zpsa-1715100353914"></a>[一.数据库设计](#jeyl-1677787446995)

<a name="eatu-1715100353916"></a>[1. 关系型数据库](#5hya-1677787446996)

<a name="czot-1715100353918"></a>[.E-R图，由台湾工程师提出的设计概念](#ohc5-1621692571287)

<a name="lunj-1715100353920"></a>[.流程图-业务逻辑相关，系统用户动作。抽象出E-R图](#5ocb-1645598528868)

<a name="ot41-1715100353922"></a>[1.1 E-R图 ](#gzqe-1677787446997)

<a name="twgd-1715100353924"></a>[1.根据名词抽象出实体](#r1ac-1621692724628)

<a name="dru9-1715100353926"></a>[2.名词找属性](#d2fl-1621692745600)

<a name="p9dl-1715100353928"></a>[3.实体间联系](#dwkp-1621692752824)

<a name="cg9f-1715100353930"></a>[.状态图](#53bo-1621692829033)

<a name="swfi-1715100353932"></a>[1.2 转化成数据库设计（公式）](#c2cy-1677787446998)

<a name="ybbh-1715100353934"></a>[.1 对1 关系 往记录少的乙方加主键](#xmox-1621692858500)

<a name="xnad-1715100353936"></a>[.1对n 关系 ，往 n 实体加关联主键 ](#mdr8-1621692924289)

<a name="ngfx-1715100353938"></a>[. n对 m 关系，需要一个关联表作映射关联](#hd3i-1621692960576)

<a name="05r1-1715100353940"></a>[2.数据类型选择](#szqu-1715100194538)

<a name="kcsp-1715100353942"></a>[整数类型（Integer Types）](#0rub-1715100184335)

<a name="nnjj-1715100353945"></a>[浮点数类型（Floating-Point Types）](#j4ut-1715100184343)

<a name="rxa7-1715100353947"></a>[日期和时间类型（Date and Time Types）](#fjm4-1715100184359)

<a name="l7nc-1715100353949"></a>[其他类型](#tofd-1715100184367)

<a name="ewez-1715100353951"></a>[二.系统优化](#cdso-1677787447000)

<a name="2ttt-1715100353953"></a>[应用整体的优化](#3qep-1642647362896)

<a name="delm-1715100353955"></a>[-cpu -> 纳秒级别](#knge-1642647371136)

<a name="iivr-1715100353957"></a>[1.多线程和并发编程](#ovup-1704437622969)

<a name="ahhy-1715100353959"></a>[2.JNI ](#ufpl-1704437634986)

<a name="vmiv-1715100353961"></a>[3.JIT/AOT编译](#ixb5-1704437634987)

<a name="waeg-1715100353963"></a>[4.算法优化](#kr1f-1704437634988)

<a name="de5c-1715100353965"></a>[-内存RAM（GB）/高速缓存(KB) -> 微秒级别(分级缓存)](#1xur-1642647384168)

<a name="5ktl-1715100353967"></a>[1.JVM内存管理](#7hi9-1704437851514)

<a name="smjt-1715100353969"></a>[2.缓存](#te7c-1704437851799)

<a name="ccoa-1715100353971"></a>[3.消息中间件](#bqty-1704437851800)

<a name="f5yj-1715100353973"></a>[-磁盘（TB）-> 毫秒级别(减少io次数,减少随机io-redolog)](#ziti-1642647439005)

<a name="9zc9-1715100353975"></a>[1.减少磁盘io](#zups-1704437900079)

<a name="sel3-1715100353977"></a>[2.数据压缩   ](#u3ok-1704438035018)

<a name="sapq-1715100353979"></a>[-网络传输/系统交互 -> 秒级 (减少io，连接池化) ](#irbp-1642647458856)

<a name="i5kz-1715100353981"></a>[1.减少网络请求   ](#6qil-1704438276193)

<a name="faeq-1715100353983"></a>[2.使用CDN](#p5dt-1704438283633)

<a name="tbwt-1715100353985"></a>[3.Sockets异步通信                                      ](#zhp8-1704438283634)

<a name="vptb-1715100353987"></a>[项目架构层面的优化](#3l0l-1704424353262)

<a name="rvnu-1715100353989"></a>[-多级缓存](#8o8s-1704424396933)

<a name="onlo-1715100353991"></a>[-应用层](#trcg-1704438366333)

<a name="fved-1715100353993"></a>[.代码优化](#68oa-1704438530062)

<a name="fgnt-1715100353995"></a>[.数据库优化](#clmf-1704438530257)

<a name="ylz1-1715100353997"></a>[.日志优化](#md03-1704438530259)

<a name="lrh2-1715100353999"></a>[-监控与调优](#ocux-1704438477879)

<a name="dcki-1715100354001"></a>[.性能监控：](#vdq2-1704438556836)

<a name="mjox-1715100354003"></a>[.分析和调优](#t29d-1704438557094)

<a name="twdz-1715100354005"></a>[-分布式系统架构](#ukjf-1704424419442)

<a name="jpoi-1715100354007"></a>[ .负载均衡](#a0bx-1704438677201)

<a name="4u7c-1715100354009"></a>[.分布式缓存](#xn9x-1704438687994)

<a name="hnpe-1715100354011"></a>[.服务降级和容错](#zcdp-1704438687996)

<a name="d90o-1715100354014"></a>[读写层面](#six7-1642647372926)

<a name="jh3q-1715100354016"></a>[.读优化](#g4uv-1704732583614)

<a name="qbcw-1715100354018"></a>[1.缓存](#uuzh-1704732602620)

<a name="u5bo-1715100354020"></a>[2.索引](#qobc-1704732605892)

<a name="4jzr-1715100354022"></a>[3.减少io/批量读/非阻塞io](#zlg9-1704732609048)

<a name="o3cq-1715100354024"></a>[4.减少多余数据加载/列式存储读](#fpjd-1704732631316)

<a name="1fj6-1715100354026"></a>[.写优化](#oyob-1704732598377)

<a name="b20h-1715100354028"></a>[1.异步写](#6jmb-1704732509150)

<a name="y765-1715100354030"></a>[2.并发写](#tkwp-1704732723564)

<a name="kcwn-1715100354032"></a>[3.批量写](#hewz-1704732862030)

<a name="yntk-1715100354034"></a>[4.优化算法和数据结构](#ccd8-1704732727854)

<a name="geoz-1715100354036"></a>[5.缓存写](#eqd9-1704732736281)

<a name="lmxt-1715100354038"></a>[6.非阻塞io](#hyq8-1704732768916)

<a name="4rwg-1715100354040"></a>[1.分控系统优化复盘](#tncv-1677787447001)

<a name="vvpq-1715100354042"></a>[1.1 数据库系统](#ydq7-1677787447002)

<a name="cfih-1715100354044"></a>[1.2 sql慢](#wxdd-1677787447003)

<a name="hlaq-1715100354046"></a>[1.3 接口慢](#olpb-1677787447004)

<a name="zmwc-1715100354048"></a>[高并发系统设计](#wrwk-1642647280506)

<a name="rjam-1715100354050"></a>[1.满足大规模用户同时访问，提供良好响应时间和性能](#8ien-1704757782146)

<a name="sxit-1715100354052"></a>[2.设计之初就要考虑伸缩性和容错性是非常重要的](#xy0g-1704757785190)

<a name="myvq-1715100354054"></a>[.垂直伸缩 ](#wr12-1704947861599)

<a name="ajwd-1715100354056"></a>[.水平伸缩](#bizh-1704947959744)

<a name="gomm-1715100354058"></a>[1.分布式架构](#fvzi-1704756770858)

<a name="42y0-1715100354060"></a>[.微服务架构](#ywzr-1704756872033)

<a name="17vm-1715100354062"></a>[.分布式计算](#xgna-1704756877646)

<a name="ylo6-1715100354064"></a>[2.负载均衡](#wnfy-1704756775272)

<a name="9r2p-1715100354066"></a>[.负载均衡](#h6nf-1704756891918)

<a name="sbqi-1715100354068"></a>[.水平扩展](#c8zr-1704756894402)

<a name="kke2-1715100354070"></a>[3.数据库设计](#wxjk-1704756782840)

<a name="j08j-1715100354072"></a>[.读写分离](#lxca-1704756910837)

<a name="iihc-1715100354074"></a>[.数据库分片](#p7d2-1704756922362)

<a name="t6ij-1715100354076"></a>[.缓存](#hxjt-1704756963988)

<a name="kuc1-1715100354078"></a>[4.缓存优化](#iivs-1704756788012)

<a name="xewc-1715100354080"></a>[.分布式缓存](#cvui-1704756971791)

<a name="zwhj-1715100354082"></a>[.本地缓存](#ysly-1704756979122)

<a name="fqvi-1715100354084"></a>[.缓存预热](#rqwj-1704756986363)

<a name="siyp-1715100354087"></a>[5.消息队列](#so9h-1704756800253)

<a name="nmdi-1715100354089"></a>[.异步处理](#sxlo-1704756996000)

<a name="lgyi-1715100354091"></a>[.削峰填谷](#llm2-1704757002994)

<a name="5k83-1715100354093"></a>[6.分布式事务](#n39o-1704756805232)

<a name="nv0e-1715100354095"></a>[.两阶段提交](#5bhj-1704757017700)

<a name="oqqc-1715100354097"></a>[.补偿事务](#becc-1704757028036)

<a name="cyti-1715100354099"></a>[7.高可用和容错](#wgkk-1704756813448)

<a name="vxpg-1715100354101"></a>[.多地域部署](#akwz-1704757035393)

<a name="5owa-1715100354103"></a>[.设计容错](#3nxv-1704757055271)

<a name="m5bd-1715100354105"></a>[1. 熔断限流](#g3xx-1704757371028)

<a name="kk2j-1715100354107"></a>[2. 多节点服务](#jafy-1704757374368)

<a name="fcyu-1715100354109"></a>[8.监控和性能调优](#ilyo-1704756820772)

<a name="asbm-1715100354111"></a>[.实时监控](#kpwq-1704757064566)

<a name="flqf-1715100354113"></a>[.性能测试](#shf4-1704757066453)

<a name="l0ro-1715100354115"></a>[9.安全性设计](#2pry-1704756830245)

<a name="9fuo-1715100354117"></a>[.防御性编程](#pkiw-1704757078583)

<a name="4l77-1715100354119"></a>[.访问控制](#g4l1-1704757084924)

<a name="rlr0-1715100354121"></a>[10.水平扩展](#1tsd-1704756838192)

<a name="roaz-1715100354123"></a>[.自动化部署](#r1dd-1704757092061)

<a name="fhwk-1715100354125"></a>[.云服务](#7mhk-1704757104117)

<a name="vrly-1715100354127"></a>[高并发性能指标](#rpxb-1677787447005)

<a name="aiwu-1715100354129"></a>[QPS(每秒请求)](#klnv-1704761369323)

<a name="rrtq-1715100354131"></a>[TPS(每秒事务)](#zvlz-1704761369324)

<a name="rvds-1715100354133"></a>[RT(响应时间)](#gvrn-1704761369325)

<a name="gwaf-1715100354135"></a>[(原子操作)并发编程中保证数据一致性/安全的方法](#ysmj-1709309531982)

<a name="bjnm-1715100354137"></a>[原子性+悲观锁：各种锁机制](#fdxy-1709308630108)

<a name="nby7-1715100354139"></a>[.（锁+事务/ 分布式锁+分布式事务）](#v06l-1709312268021)

<a name="uhgv-1715100354141"></a>[.  CASmysql版本号实现 (前提是数据库的update已经是原子写：mysql update排它锁）](#k0op-1709312304164)

<a name="qswh-1715100354143"></a>[原子性+乐观锁/不加锁: CAS原子操作(java原子类)，](#qth5-1709308703202)

<a name="yiar-1715100354145"></a>[CAS底层实现原理](#g3uo-1709309147469)

<a name="hqg6-1715100354147"></a>[总线锁定（Bus Locking）：](#qpbw-1709308842021)

<a name="a3sd-1715100354149"></a>[缓存一致性协议（Cache Coherence Protocol）：](#ikm2-1709308842025)

<a name="2zcp-1715100354151"></a>[指令序列化（Instruction Serialization）：](#wpeu-1709308842029)

<a name="mcxu-1715100354153"></a>[不同的场景适用哪种锁](#olfu-1709309769107)

<a name="b9pu-1715100354155"></a>[.共享数据的读写操作：](#y60t-1709309615585)

<a name="lq9l-1715100354157"></a>[适用措施：读写锁（ReadWrite Lock）、互斥锁（Mutex）、原子操作、无锁算法。Copy on Write优化读写锁](#lqad-1709309615587)

<a name="awy1-1715100354160"></a>[.并发容器的操作：](#fsfa-1709309615591)

<a name="wrgo-1715100354162"></a>[适用措施：线程安全的容器类（如ConcurrentHashMap、ConcurrentLinkedQueue）、原子操作。](#rs2n-1709309615593)

<a name="utm6-1715100354164"></a>[.多个线程协作的场景：](#xdpv-1709309615597)

<a name="uany-1715100354166"></a>[适用措施：信号量（Semaphore）、条件变量（Condition Variable）。](#uzlr-1709309615599)

<a name="pemh-1715100354168"></a>[.分布式系统的并发操作：](#0aah-1709309615603)

<a name="1t4q-1715100354170"></a>[适用措施：分布式锁、分布式事务。](#wlhe-1709309615605)

<a name="0vxw-1715100354172"></a>[.不可变数据的并发访问：](#angi-1709309615609)

<a name="qwgt-1715100354174"></a>[适用措施：不可变数据结构、原子操作。](#pga0-1709309615611)

<a name="ssa2-1715100354176"></a>[.高性能要求的并发操作：](#pw5v-1709309615615)

<a name="ulda-1715100354178"></a>[适用措施：无锁算法、并发数据结构。 -CAS乐观锁](#plv6-1709309615617)

<a name="dxha-1715100354180"></a>[互斥访问：](#62mg-1709309976431)

<a name="fizs-1715100354182"></a>[.互斥锁（Mutex）：](#0qt3-1709307350160)

<a name="bqkx-1715100354184"></a>[.原子操作：](#7xva-1709307350164)

<a name="zync-1715100354186"></a>[.临界区（Critical Section）：](#r8cl-1709307350168)

<a name="4z1b-1715100354188"></a>[.读写锁（ReadWrite Lock）：主要用于避免脏读](#occj-1709307350172)

<a name="uj5o-1715100354190"></a>[.信号量（Semaphore）：](#vej9-1709307350176)

<a name="nfv0-1715100354192"></a>[.条件变量（Condition Variable）：](#ssge-1709307350180)

<a name="xjvs-1715100354194"></a>[.无锁算法（Lock-Free Algorithms）：](#zk0j-1709307350184)

<a name="4pu0-1715100354196"></a>[.数据拷贝-写时复制（Copy-on-Write）：优化读写锁，写时复制且串行执行(锁)，读不加锁](#tiqo-1709307350188)

<a name="atib-1715100354198"></a>[.线程安全的数据结构：](#b8ca-1709307350192)

<a name="enng-1715100354200"></a>[===系统架构设计师===](#nyrv-1709307688718)

<a name="deqs-1715100354202"></a>[系统工程与信息系统基础](#mpwu-1704949756608)

<a name="9cl2-1715100354204"></a>[.系统工程方法](#2gzz-1704980837071)

<a name="f5qn-1715100354206"></a>[.系统工程生命周期阶段](#mk93-1704952875199)

<a name="swhu-1715100354208"></a>[.系统工程生命周期方法](#ny2c-1704952893636)

<a name="hfrp-1715100354211"></a>[.信息系统建设原则](#shmt-1704952904062)

<a name="hcbh-1715100354213"></a>[.信息系统开发方法](#itje-1704951812273)

<a name="w0zw-1715100354215"></a>[原型法](#bnzq-1705819374009)

<a name="xzap-1715100354217"></a>[结构化法-瀑布型](#ujj3-1705819377863)

<a name="xv4t-1715100354219"></a>[形式化法-数模](#8wek-1705819398251)

<a name="8muw-1715100354221"></a>[敏捷方法](#jeuk-1705819392097)

<a name="jgpr-1715100354223"></a>[.信息系统分类](#w8yd-1704980881013)

<a name="kgnc-1715100354225"></a>[业务处理系统TPS](#hlhq-1705819204285)

<a name="bcdc-1715100354227"></a>[管理信息系统MIS](#oksn-1705819204735)

<a name="ymq4-1715100354229"></a>[决策支持系统DSS](#lwm7-1705819204736)

<a name="eyhj-1715100354231"></a>[专家系统ES](#bmeu-1705819204737)

<a name="gskv-1715100354233"></a>[办公自动化系统OAS](#kffq-1705819204738)

<a name="wsrz-1715100354235"></a>[企业资源系统ERP](#k2px-1705819204739)

<a name="ahgx-1715100354237"></a>[过程模型](#f98t-1704981918920)

<a name="4xw2-1715100354239"></a>[瀑布模型](#yk4j-1705841608124)

<a name="uglp-1715100354241"></a>[V模型【瀑布变种-测试贯穿】](#oryp-1705841608705)

<a name="9rlt-1715100354243"></a>[原型模型](#b0cp-1705841621350)

<a name="ezku-1715100354245"></a>[螺旋模型【原型+瀑布 风险】](#sfqi-1705841608707)

<a name="u8xl-1715100354247"></a>[构件组装模型/基于构件的开发方法](#kbjw-1705841608709)

<a name="fo0n-1715100354249"></a>[快速应用开发RAD【瀑布+构件组装】](#mvze-1705841627436)

<a name="owca-1715100354251"></a>[统一过程/统一开发方法](#xici-1705841629815)

<a name="evmh-1715100354253"></a>[敏捷开发方法](#9jca-1705841608711)

<a name="wtwp-1715100354255"></a>[XP](#28va-1705841590197)

<a name="oxlr-1715100354257"></a>[Scrum](#fyfq-1705938223773)

<a name="x9e3-1715100354259"></a>[逆向工程](#d5ko-1705938215067)

<a name="xl4w-1715100354261"></a>[实现级](#os3c-1706090901666)

<a name="cynv-1715100354263"></a>[结构级](#irxb-1706090905276)

<a name="ja94-1715100354265"></a>[功能级](#rk8d-1706090908958)

<a name="ckuk-1715100354267"></a>[领域级](#k3pt-1706090912460)

<a name="ysxc-1715100354269"></a>[净室软件工程](#tybd-1705938215235)

<a name="fj7p-1715100354271"></a>[需求工程](#ochn-1705940085547)

<a name="l4rz-1715100354273"></a>[.需求获取](#xdlf-1705940054108)

<a name="injv-1715100354275"></a>[用户面谈 ](#s1uq-1706090846730)

<a name="xoer-1715100354277"></a>[联合需求计划(JRP) ](#vuil-1706090851858)

<a name="w0xq-1715100354279"></a>[问卷调查 ](#gpxg-1706090851859)

<a name="vvih-1715100354282"></a>[现场观察   ](#mg9n-1706090851860)

<a name="p0fo-1715100354284"></a>[原型化方法        ](#3ww6-1706090851861)

<a name="3eka-1715100354286"></a>[头脑风暴法](#0awr-1706090851863)

<a name="50e0-1715100354288"></a>[.需求分析](#axny-1705940052332)

<a name="ybvt-1715100354290"></a>[1.功能模型(数据流图DFD)](#v8wz-1706090812929)

<a name="wdij-1715100354292"></a>[2.行为模型(状态转换图)](#3uls-1706090814821)

<a name="uwjd-1715100354294"></a>[3.实体模型(E-R图)](#69df-1706090816407)

<a name="o7zj-1715100354296"></a>[UML](#loq2-1705940640473)

<a name="cg4n-1715100354298"></a>[需求定义](#4aeg-1706091062964)

<a name="pobv-1715100354300"></a>[需求验证](#ud2s-1706090947930)

<a name="z0et-1715100354302"></a>[需求跟踪](#l03x-1705940634470)

<a name="kqrb-1715100354304"></a>[需求变更管理](#muqf-1706093218719)

<a name="pqj0-1715100354306"></a>[软件系统建模](#ilpb-1706093190683)

<a name="oqdm-1715100354308"></a>[软件界面设计](#j396-1706094675778)

<a name="qatr-1715100354310"></a>[结构化设计](#vqsk-1706094478028)

<a name="ggnd-1715100354312"></a>[内聚](#jczo-1706095018132)

<a name="lbxh-1715100354314"></a>[耦合](#qa8z-1706095402118)

<a name="enzq-1715100354316"></a>[模块四要素](#g1dc-1706095391028)

<a name="w0xw-1715100354318"></a>[面相对象设计](#ydwa-1706095870710)

<a name="dslk-1715100354320"></a>[类的分类](#fouz-1706095958643)

<a name="08i1-1715100354322"></a>[基本过程](#9pd1-1706095996137)

<a name="rjt6-1715100354324"></a>[设计原则(同设计模式)](#k8lc-1706096001163)

<a name="fye9-1715100354326"></a>[计算机](#qvol-1706095952165)

<a name="pijj-1715100354328"></a>[计算机结构(★)](#ef1b-1706108352037)

<a name="e0cn-1715100354330"></a>[存储系统(★★★★)](#4kj7-1706108373776)

<a name="bi0g-1715100354332"></a>[层次化存储结构](#ucta-1706109825295)

<a name="6qhe-1715100354334"></a>[Cache](#j9hn-1706109828962)

<a name="cgom-1715100354336"></a>[主存编址计算](#pv51-1706109847372)

<a name="kqan-1715100354338"></a>[磁盘基本结构与存储过程](#jcqv-1706108377026)

<a name="v2nv-1715100354340"></a>[磁盘优化分布存储](#puux-1706111215530)

<a name="jmez-1715100354342"></a>[磁盘单缓冲区与双缓冲区读取](#dvin-1706111222861)

<a name="gkup-1715100354344"></a>[磁盘移臂调度算法](#jr2r-1706111239137)

<a name="iz65-1715100354346"></a>[数据传输控制方式（★)](#sz2k-1706111188014)

<a name="nbpp-1715100354348"></a>[总线（★★)](#cbul-1706108378755)

<a name="y1fr-1715100354350"></a>[CISC与RISC(★)](#0hb5-1706108373778)

<a name="zhtc-1715100354352"></a>[流水线(★★)](#ernn-1706108380109)

<a name="cspn-1715100354354"></a>[校验码(★)](#grix-1706108381278)

<a name="ybaw-1715100354357"></a>[嵌入式（★)](#1p2v-1706108382511)

<a name="fdbq-1715100354359"></a>[计算机网络](#8vmt-1706198382356)

<a name="9fsm-1715100354361"></a>[TCP/IP协议族(7层/4层网络模型)](#a4es-1706106975412)

<a name="x5qk-1715100354363"></a>[.TCP与UDP (★★★)](#vwim-1706198561289)

<a name="zsqg-1715100354365"></a>[.DHCP与DNS (★★★)](#imsh-1706198537828)

<a name="vina-1715100354367"></a>[网络规划与设计](#u7sd-1706198559304)

<a name="pnkv-1715100354369"></a>[1.逻辑设计与物理设计(★★★★）](#nov8-1706198591905)

<a name="ehtu-1715100354371"></a>[2.层次化网络设计](#sy2g-1706198599196)

<a name="ucvw-1715100354373"></a>[3.网络冗余设计](#igl7-1706257923205)

<a name="ph4a-1715100354375"></a>[网络存储（★★)](#zkxb-1706257899477)

<a name="txhh-1715100354377"></a>[磁盘阵列Raid](#fxma-1706198636789)

<a name="mt1m-1715100354379"></a>[lPv6 (★)](#vlem-1706259832461)

<a name="evkx-1715100354381"></a>[网络接入(有线/无线)](#g438-1706198637653)

<a name="ore0-1715100354383"></a>[综合布线(★)](#lxli-1706198497856)

<a name="mude-1715100354385"></a>[网络技术扩展](#5dlt-1706198650540)

<a name="8wz4-1715100354387"></a>[物联网(IOT)](#jgll-1706198586849)

<a name="glnm-1715100354389"></a>[云计算(Saas/Paas/Iaas)](#pr8x-1706198586851)

<a name="lbpj-1715100354391"></a>[===系统架构设计case===](#1rnn-1706941312871)

<a name="1oij-1715100354393"></a>[google L5设计一个分布式数据库架构](#nm5q-1706969255961)

<a name="bqiq-1715100354395"></a>[.what is total ordering(ordering first 100 custormer)](#g7yu-1707229908505)

<a name="h17w-1715100354397"></a>[.why single leader()](#ebxf-1707230056989)

<a name="uv1d-1715100354399"></a>[.request router](#ttmg-1707230034624)

<a name="elu9-1715100354401"></a>[.variations](#aftd-1707229925082)

<a name="1jmf-1715100354403"></a>[1.Failover handing](#uk2k-1707457488655)

<a name="xo8f-1715100354405"></a>[2.Reblancing after new node added](#btbd-1707457496651)

<a name="xccf-1715100354407"></a>[3.Leaderless for heavy write-shard](#moaq-1707457524278)

<a name="1k2y-1715100354409"></a>[4.TicketMasler (and total ordering is necessary](#wyvq-1707458882987)

<a name="ctvo-1715100354411"></a>[===数据密集型应用===](#sswx-1706094478181)

<a name="ibbp-1715100354413"></a>[第一部分 数据系统的基石](#unbe-1677787447006)

<a name="4abd-1715100354415"></a>[1.可靠性、可拓展性、可维护性能](#kwfx-1677787447007)

<a name="cgzl-1715100354417"></a>[-功能性需求：CRUD](#lykw-1644227240038)

<a name="kyxg-1715100354419"></a>[-非功能性需求：安全性，可靠性，合规性，可扩展性，兼容性和可维护性](#b2tu-1644227249556)

<a name="jljb-1715100354421"></a>[.可靠性：](#qqm5-1644227303238)

<a name="ky0f-1715100354423"></a>[硬件故障](#7xms-1644228225080)

<a name="bzbo-1715100354425"></a>[软件错误](#dfpv-1708357497902)

<a name="c5xh-1715100354427"></a>[人为错误(如何让系统变得可靠)](#drpl-1708357507365)

<a name="otcb-1715100354429"></a>[如何让系统变得可靠：](#pqmh-1708523552230)

<a name="scvl-1715100354431"></a>[。最小化犯错机会的方式设计系统,  但如果限制太多，人们可能会忽略它们的好处而绕开，很难把握其中微妙的平衡](#i4we-1708358144376)

<a name="mynn-1715100354433"></a>[。在易错地方和可能导致失效的地方解耦decouple,提供非生产环境沙箱sandbox-虚拟化环境，隔离真实系统进行安全测试](#xzfa-1708358243121)

<a name="v0am-1715100354435"></a>[。彻底的测试，单元测试，集成测试，手动测试，自动化测试覆盖边缘场景corner case.](#9jaa-1708358634289)

<a name="kxkb-1715100354437"></a>[。滚动发布，快速回滚](#zlp4-1708358698137)

<a name="qtci-1715100354439"></a>[。配置详细和明确的监控](#40us-1708358954660)

<a name="qi7c-1715100354442"></a>[。良好的管理和充分的培训。一个复杂而重要的方面，但超出本书的范围](#o66x-1708358967000)

<a name="gieq-1715100354444"></a>[可靠性有多重要](#x7co-1708357515795)

<a name="pfet-1715100354446"></a>[造成客户巨大损失-阿里云宕机造成的用户损失](#nc0w-1708358745350)

<a name="vprj-1715100354448"></a>[家长将孩子照片存储在你的应用李，数据库损坏，客户有何体验，他们可能会知道如何从备份恢复吗？](#qopp-1708358856827)

<a name="wrfk-1715100354450"></a>[.可扩展性： ](#dsae-1708357483848)

<a name="l7o0-1715100354452"></a>[描述负载(tps-推特主页时间线扇出-查询性能优化)](#vja4-1708356470840)

<a name="chrc-1715100354454"></a>[描述性能](#s6un-1708356581594)

<a name="dhiu-1715100354456"></a>[吞吐量throughput](#fcez-1708523606684)

<a name="zz81-1715100354458"></a>[响应时间 response time.](#k30f-1708523620292)

<a name="vrfo-1715100354460"></a>[响应时间的高位百分点（也称为尾部延迟tail latencies](#bogk-1708523658968)

<a name="js5z-1715100354462"></a>[.可维护性：](#k1dg-1708355783343)

<a name="yayo-1715100354464"></a>[2.数据模型与查询语言](#jufm-1677787447008)

<a name="onuk-1715100354466"></a>[-关系模型](#pgu6-1699844351041)

<a name="t5hg-1715100354468"></a>[-NoSql (es,redis)](#kfpd-1644410618294)

<a name="1s4q-1715100354470"></a>[1.文档数据库:MongoDB](#0p23-1644410807294)

<a name="udex-1715100354472"></a>[  2.图形数据库 ：](#09bl-1644410666587)

<a name="oeh7-1715100354474"></a>[-其它模型(基因序列)](#6fxw-1644410924417)

<a name="mtq2-1715100354476"></a>[3.存储与检索](#sm0u-1677787447009)

<a name="db49-1715100354478"></a>[-优化事务处理（OLTP）transaction ](#bhcv-1644935436804)

<a name="zdi0-1715100354480"></a>[1.OLTP系统通常面向用户，大量的请求。](#tbhw-1699844517372)

<a name="dvs3-1715100354482"></a>[2.磁盘寻道时间往往是这里的瓶颈。](#fnev-1644935714127)

<a name="haak-1715100354484"></a>[3.应用程序使用某种键来请求记录，存储引擎使用索引来查找所请求额键的数据。](#cjwp-1644935609899)

<a name="fuyt-1715100354486"></a>[-优化分析（OLAP）analys](#jg7s-1699844443567)

<a name="ouhj-1715100354488"></a>[1.列式储存(投影操作，压缩技术，聚合过滤)](#pjd1-1703887811615)

<a name="3opq-1715100354490"></a>[-OLTP两大主流学派的存储引擎：](#8sgm-1644935924013)

<a name="blsa-1715100354492"></a>[1.日志结构学派](#i55y-1644935943748)

<a name="hnxy-1715100354495"></a>[2.就地更新学派](#h3il-1644935977285)

<a name="ccrg-1715100354497"></a>[4.编码（序列化）与演化(XML,JSON,CSV)](#lbs1-1677787447010)

<a name="9tbl-1715100354499"></a>[第二部分 分布式数据](#4p9n-1677787447012)

<a name="gydr-1715100354501"></a>[1.高可用性/容错](#o4ag-1646310813851)

<a name="jni1-1715100354503"></a>[2.断开连接的操作](#snwm-1646310894841)

<a name="xer7-1715100354505"></a>[3.减少延迟(节点近)](#evly-1646310918322)

<a name="rhbh-1715100354507"></a>[4.可拓展性](#itsh-1646310968967)

<a name="xwxs-1715100354509"></a>[.拓展至更高的载荷](#gjis-1708362947856)

<a name="u05u-1715100354511"></a>[垂直扩展scale up ：购买更强大的机器 cpu](#mgia-1708362999715)

<a name="fsy7-1715100354513"></a>[共享内存架构shared-memory architecture：许多处理器、内存和磁盘再同一操作系统下相互连接，共享内存和磁盘](#pdo8-1708363038596)

<a name="xxqe-1715100354515"></a>[共享磁盘share-disk architecture：独立处理器和内存，数据存储在机器之间共享的磁盘阵列上，磁盘通过快速网络连接。数仓](#wgwl-1708363065800)

<a name="aiz4-1715100354517"></a>[无共享架构](#klw2-1708363340866)

<a name="jxou-1715100354519"></a>[.复制VS分区](#gbgq-1646311175182)

<a name="ljfp-1715100354521"></a>[5.复制](#gd4q-1708363438406)

<a name="dojx-1715100354523"></a>[.领导者与追随者-单主复制](#9hbs-1708441077626)

<a name="vcsh-1715100354525"></a>[客户端将所有写入操作发送到单个节点（领导者），该结点将数据更改事件流发送到其它副本（追随者）。](#aucb-1708528116000)

<a name="xcub-1715100354527"></a>[读取可以再任何副本中执行，但从追随者读取可能是陈旧的 （最终一致性问题）](#wgge-1646311567456)

<a name="hzp8-1715100354529"></a>[.同步复制与异步复制](#cbey-1646310922523)

<a name="vedz-1715100354531"></a>[.设置新从库(快照复制+caught up binlog)](#j5o0-1704983008475)

<a name="6rf5-1715100354534"></a>[.处理宕机节点](#bcod-1708442233018)

<a name="fwkx-1715100354536"></a>[从库失效：追赶恢复](#5ufz-1708443850274)

<a name="oiht-1715100354538"></a>[主库失效：故障切换failover](#udix-1708443860752)

<a name="pq2f-1715100354540"></a>[自动切换步骤：1.确认主库失效](#w3sj-1708523445192)

<a name="2ypw-1715100354542"></a>[2.选举新主库：共识](#y3qn-1708523480847)

<a name="qnbf-1715100354544"></a>[3.配置系统启用新主库](#wua6-1708523497956)

<a name="fumw-1715100354546"></a>[failover的麻烦：1.异步复制数据丢失](#z7mn-1708523814309)

<a name="xkhk-1715100354548"></a>[2.自增主键冲突](#mnjx-1708523836932)

<a name="1gjy-1715100354550"></a>[3.脑裂split brain](#dbhg-1708523873194)

<a name="hyhl-1715100354552"></a>[4.如何设置超时](#561v-1708523878338)

<a name="6vba-1715100354554"></a>[.复制日志的实现](#8mem-1708442228760)

<a name="oa3j-1715100354556"></a>[基于语句的复制(每个写入请求语句statment)](#k8yo-1708524004340)

<a name="phru-1715100354558"></a>[记录每个写入请求语句statment，语句日志传输给从库](#hcqe-1708524155632)

<a name="5thq-1715100354560"></a>[问题：非确定函数nondeterministic, NOW()  RAND()](#9xml-1708524182083)

<a name="0o4r-1715100354562"></a>[    自增列- 造成差异](#il4a-1708524271564)

<a name="hybj-1715100354564"></a>[副作用的语句：用户自定义函数，触发器，存储过程](#azmh-1708524331636)

<a name="yt6b-1715100354566"></a>[解决: 用固定值替换](#rcfb-1708524371120)

<a name="xnb7-1715100354568"></a>[  如语句存在任何不确定性，切换到基于行的数据](#6uy2-1708524426849)

<a name="d0rz-1715100354570"></a>[传输预写式日志(WAL)](#rnmz-1708524013585)

<a name="ufwn-1715100354572"></a>[日志存储引擎SSTables LSM树](#hze4-1708524498278)

<a name="fb7r-1715100354574"></a>[磁盘块的B树  WAL, 崩溃恢复](#qzop-1708524541132)

<a name="pavh-1715100354576"></a>[逻辑日志复制(基于行)](#a3ng-1708524040960)

<a name="wnuk-1715100354578"></a>[binlog](#jiiu-1708524648209)

<a name="gmhz-1715100354580"></a>[基于触发器的复制](#ezoi-1708524083973)

<a name="c8k9-1715100354585"></a>[.复制延迟问题(解决方法都是反分布式，或者趋于单机一致性。数据一致性模型：https://jepsen.io/consistency)](#https://jepsen.io/consistency)

<a name="sps9-1715100354587"></a>[读己之写(读主库或带写时间戳查询)](#w5nz-1708525244967)

<a name="5dfg-1715100354589"></a>[写后从旧副本读取数据-未同步  ](#25nj-1708526407050)

<a name="qron-1715100354591"></a>[解决：写后读read after write 一致性 或叫做 read your write consistency 防止这种异常](#4st1-1708525569674)

<a name="cwjq-1715100354593"></a>[1.都从主库读。适用仅由用户本人编辑的数据，如个人信息。大部分内容从主库读不适用，扩容读无效果](#v4r0-1708525736897)

<a name="ukoz-1715100354596"></a>[2. 扩容读需要保证更新时间，监控复制延迟，防止滞后超过一分钟从从库发出查询](#vqjs-1708525818133)

<a name="emlw-1715100354598"></a>[3. 客户端记录写入时间戳，系统确保从库提供查询时，版本时间已覆盖，否则从另一个从库读，或者等待caught up-  等待不就相当弱可用状态，且时钟不可靠](#nmrh-1708525971734)

<a name="etjo-1715100354600"></a>[4. 副本在多个数据中心，复杂度高，都需经过主库IDC](#wmu9-1708526095856)

<a name="z7nm-1715100354602"></a>[单调读(基于id散列路由同一副本)](#kwrd-1708525264596)

<a name="eose-1715100354604"></a>[先读到最新副本，后读到旧副本感觉数据消失](#npwe-1708527802311)

<a name="bhqt-1715100354606"></a>[A看到B评论后消失，时光倒流moving backward in time ](#4cn0-1708526272081)

<a name="jegm-1715100354608"></a>[解决：单调读monotonic reads总是从同一个副本进行读取(基于用户散列id，如果副本失效则重新路由)](#drqk-1708526396300)

<a name="mzkh-1715100354610"></a>[  比强一致性(同步复制/类比单机)弱，比最终一致性更强](#s6u3-1708526566643)

<a name="mbde-1715100354612"></a>[一致前缀读(因果关系写到相同分区)](#bfps-1708525268614)

<a name="hm52-1715100354614"></a>[consistent prefix reads](#q7p0-1711363121071)

<a name="jjsp-1715100354616"></a>[不同分片副本同步先后问题导致读顺序错误](#rqcm-1708527879976)

<a name="d8ee-1715100354618"></a>[分区partition/分片sharded数据库中的一个特殊问题，全局写入顺序](#bwov-1708526677620)

<a name="k3ch-1715100354620"></a>[分区主库1写入 A:你吃饭了吗？ 分区主库2写入B:没有。 分区1副本同步主库1落后分区2副本同步主库2    C读取1副本: 没有，后读取2副本。你吃饭了吗？](#7e9o-1708526727984)

<a name="zljv-1715100354622"></a>[解决：确保因果关系都写入到相同分区](#turn-1708527108521)

<a name="yvg2-1715100354624"></a>[复制延迟解决方案](#a2la-1708525420248)

<a name="jz41-1715100354626"></a>[趋于反分布式，局部或者部分看做一个单机，做到强一致性](#x8ng-1708527233293)

<a name="w43l-1715100354628"></a>[写后读。](#gecf-1708527304184)

<a name="yneo-1715100354630"></a>[数据库通过事务提供强大保证。](#zsq6-1708527307246)

<a name="j7ze-1715100354632"></a>[.多主复制(主主复制，互为副本-写冲突。多主复制被认为是危险的领域)](#pbfd-1708528009698)

<a name="7brb-1715100354634"></a>[多主复制的应用场景](#kxkx-1708441627686)

<a name="tsrn-1715100354636"></a>[运维多个数据中心(IDC-主主间复制需要处理写冲突）](#xrso-1708700002291)

<a name="y862-1715100354638"></a>[性能(多活配置，写操作在本地IDC处理，其他IDC异步复制，性能更好)](#06t6-1708700132681)

<a name="psem-1715100354640"></a>[容忍IDC停机](#9sww-1708700267631)

<a name="wml1-1715100354642"></a>[容忍网络问题(临时的网络中断不会妨碍正在写入的处理)](#dtkl-1708700295371)

<a name="xjty-1715100354644"></a>[需要离线操作的客户端(支持多个终端离线操作couchDB)](#knxa-1708700020273)

<a name="xo4n-1715100354646"></a>[协同编辑](#hvwb-1708700115895)

<a name="dg2s-1715100354648"></a>[处理写冲突(A将标题从1改2,B将1改3)](#fdot-1708700612321)

<a name="sb1f-1715100354650"></a>[同步于异步冲突检测](#u8bc-1708700824251)

<a name="fcgo-1715100354652"></a>[同步：单主程序复制 - 不允许每个副本独立接受写入](#wfgd-1708700957597)

<a name="4i7x-1715100354654"></a>[异步：独立接受写入- 异步检测，但为时已晚](#x6is-1708701017804)

<a name="qasx-1715100354656"></a>[避免冲突(特定记录写入都通过同一个领导者，主库切换或者用户迁移至更近的主库时会有同时写入的可能性)](#xg2a-1708700840681)

<a name="kbvg-1715100354659"></a>[收敛convergent至一致的状态(副本主库和其副本在复制完成时收敛至一个相同的最终值)](#ucfn-1708700844474)

<a name="oc0p-1715100354661"></a>[最后写入胜利LWW,last write wins- 给每个写入一个唯一id, 挑选最高ID的写入作为胜利者，并丢弃其他写入-数据丢失](#cbla-1708701376316)

<a name="fhw8-1715100354663"></a>[为每个副本分配一个唯一ID,ID编号更高的具有高优先级。数据丢失](#40po-1708701481447)

<a name="ajsc-1715100354665"></a>[将值合并在一起](#p4m4-1708701593939)

<a name="yjae-1715100354667"></a>[记录冲突，并编写解决逻辑代码。如通过提醒用户方式](#8fcs-1708701611999)

<a name="ewxx-1715100354669"></a>[自定义冲突解决逻辑](#yrdi-1708700860148)

<a name="lpr5-1715100354671"></a>[自定义冲突解决逻辑(complex)](#t4i7-1708702160004)

<a name="ojll-1715100354673"></a>[写时执行-后台处理](#pdql-1708702370625)

<a name="cifc-1715100354675"></a>[读时执行-提供多版本用户选择，回写数据库](#sksk-1708702376293)

<a name="ulmg-1715100354677"></a>[亚马逊购物车移除的商品重新出现](#4bqp-1708702425059)

<a name="z2em-1715100354679"></a>[什么是冲突(两个领导者预订同一个会议室，7章看冲突实例12章看检测解决)](#6x4i-1708700867996)

<a name="p0zd-1715100354681"></a>[多主复制拓扑](#o41a-1708702111509)

<a name="wbxe-1715100354683"></a>[环形，星型，all to all -mysql仅支持环形](#5feh-1708702903239)

<a name="jtc9-1715100354685"></a>[问题：多主复制时，可能在某些副本中写入错误的顺序。like A写主库1，B写主库2，主库3先同步2，再同步1。类似一致前缀读。](#ddyu-1708702949257)

<a name="amqi-1715100354687"></a>[解决：时间戳是不够的-不可靠时钟，使用一种称为版本向量(version vectors)的技术-检测并发写入](#ghp3-1708703247102)

<a name="a1oe-1715100354689"></a>[无主复制leaderless](#bfz8-1708759285067)

<a name="1pfs-1715100354691"></a>[Amazon的Dynomo系统。](#cvru-1708759359537)

<a name="6j5g-1715100354693"></a>[Riak, Cassandra，Voldmort 也称为Dynamo风格。](#wf6o-1708759707666)

<a name="utsg-1715100354695"></a>[类型1：客户端直接将写入发送到几个副本中](#xpqf-1708760120711)

<a name="9arl-1715100354697"></a>[类型2：coordinator协调者节点代表客户端写入。](#pl2z-1708760121090)

<a name="ydyh-1715100354699"></a>[当节点故障时写入数据库(仲裁写⼊，法定读取，并在节点中断后读修复。)](#qgpe-1708760989905)

<a name="rwde-1715100354701"></a>[如果主从复制，主故障/重启系统更新 则需进行故障切换](#zfuz-1708760396929)

<a name="lpnq-1715100354703"></a>[无主复制： userA set piture_url   -> replica1 ok    Then version=7](#3soj-1708760452090)

<a name="l0m4-1715100354705"></a>[           user set piture_url   -> replica2 ok  Then version=7](#4f05-1708760543198)

<a name="jqzd-1715100354707"></a>[user set piture_url   -> replica3 offline  fail   version= 6](#ynls-1708759898772)

<a name="vmb9-1715100354709"></a>[    userB get piture  :  rp3(version6) rp1(version7)  rp2(version7)  Than fix rp3 value to version7](#e1ur-1708760618873)

<a name="l5nr-1715100354711"></a>[ 读修复和反熵(失效节点重新连机后如何caught up)](#tyv3-1708760780373)

<a name="v7rh-1715100354713"></a>[读修复like userB get piture fixed rp3](#wjho-1708761214792)

<a name="gtob-1715100354716"></a>[反熵 后台进程不断查找副本之间的数据差异。Voldmort无反熵过程，副本可能丢失数据](#xblj-1708761286988)

<a name="o7cp-1715100354718"></a>[ 读写的法定人数（仲裁）](#w3ia-1708761120623)

<a name="o1wy-1715100354720"></a>[仲裁一致性的局限性-最终一致，更强的保证需要事务或共识](#oj1i-1708759830121)

<a name="uxzk-1715100354722"></a>[松散法定人数与带提示的接力](#cu5q-1708759841416)

<a name="svgi-1715100354724"></a>[运维多个数据中心-将写入发送到所有副本，仅需本地IDC内法定节点确认](#kzki-1708761744887)

<a name="nwth-1715100354726"></a>[检测并发写入](#pt1k-1708759856530)

<a name="ja3i-1715100354728"></a>[Dynamo风格的数据存储，没有明确定义的顺序。](#mu89-1708761978075)

<a name="uliv-1715100354730"></a>[userA set x=A   get x](#dbni-1708763823783)

<a name="ajqy-1715100354732"></a>[rp 1 A ok    B unresponsive   A](#auce-1708763993783)

<a name="qxom-1715100354734"></a>[rp2 A ok   B OK  B](#kteo-1708764011894)

<a name="yd8q-1715100354736"></a>[rp3 B ok A ok A](#9xyy-1708764019308)

<a name="wwrd-1715100354738"></a>[userB set x=B ](#esiv-1708702764305)

<a name="pris-1715100354740"></a>[最后写入胜利(丢弃并发写入)](#wd1i-1708764197180)

<a name="cvxh-1715100354742"></a>[LLW 无法确定真实排序，强制排序，选择最新的最大时间戳，并丢弃较早的任何写入.Cassandra唯一支持的方式，Riak可选](#uzhw-1708874432788)

<a name="1ytr-1715100354744"></a>[缺点：数据丢失 ](#henp-1708874594301)

<a name="l5h5-1715100354746"></a>[此前发生的关系和并发](#hzwp-1708764215825)

<a name="iytp-1715100354748"></a>[因果依赖(causally dependent)  如果B后发与A, 则B因果依赖A, ](#3wp0-1708874672763)

<a name="bw0s-1715100354750"></a>[如果是并发，则存在需要解决的冲突](#1wzv-1708875051673)

<a name="k3cb-1715100354752"></a>[捕获此前发生的关系](#j2r6-1708764228505)

<a name="1tmw-1715100354754"></a>[捕获两个客户端间的因果关系，同时编辑购物车(示例为单副本)](#vv7q-1708875756229)

<a name="q4xr-1715100354756"></a>[合并同时写入的值](#zp0i-1708874374616)

<a name="jg38-1715100354758"></a>[客户端需额外工作，合并并发写入的值来擦屁股。Riak称这些并发值兄弟(sibings)](#wawo-1708876272614)

<a name="oq3e-1715100354760"></a>[版本向量](#arlv-1708874381589)

<a name="75ld-1715100354762"></a>[所有副本的版本号集合称为版本向量(version vector)](#b1ov-1708700703636)

<a name="fmt5-1715100354764"></a>[6.分区](#dyz5-1709800112532)

<a name="htj2-1715100354766"></a>[.分区与复制(分区与复制方案是独立的)](#twd1-1709800204792)

<a name="rzpn-1715100354768"></a>[.键值数据的分区](#fbqg-1709800263679)

<a name="yhlc-1715100354770"></a>[偏斜skew：分区过多数据或过多查询](#s7ju-1709801062977)

<a name="emcv-1715100354772"></a>[热点hot spot:高负载的分区](#u0d3-1709801107270)

<a name="cmjc-1715100354774"></a>[根据键的范围分区](#lqbu-1709800332210)

<a name="8lr6-1715100354776"></a>[Bigtable, HBase, RethinkDB 和 MongoDB2.4](#i2ju-1709801151406)

<a name="a6bs-1715100354778"></a>[按照一定的顺序保存键（SSTbale和LSM-树）](#np00-1709801582805)

<a name="qnra-1715100354780"></a>[按时间分区当日写过载（需加传感器保证日期+传感主键均匀分布）](#evhb-1709801683166)

<a name="xksm-1715100354782"></a>[根据键的散列分区(可将偏斜数据均匀分布)](#a1yy-1709800347130)

<a name="wvkp-1715100354784"></a>[不适合分区的简单哈希函数：java .hashCode-同键不同进程不同哈希值](#mdg4-1709801628016)

<a name="ip1p-1715100354786"></a>[一致性哈希consistent hashing:哈希键分区边界均匀间隔，也可伪随机选择（CDN均匀分配负载）。](#7rkg-1709802019859)

<a name="odme-1715100354788"></a>[缺点：无序，低效范围查询(需发送到所有分区)](#iktb-1709802309508)

<a name="mn57-1715100354790"></a>[折中方案：复合主键/组合索引。(uid,time).不同用户在不同分区，每个用户按时间搓顺序存储在单个分区上。](#zznq-1709802490074)

<a name="avzx-1715100354792"></a>[负载倾斜与消除热点](#ed70-1709800357523)

<a name="v27e-1715100354794"></a>[数百万追随者做某事-大量写入同一个键](#403a-1709802593546)

<a name="cbgi-1715100354796"></a>[解决：火爆主键+随机数即可将主键分散为100个分区](#wx5s-1709802730512)

<a name="wtmx-1715100354798"></a>[缺点：数据合并，跟踪火爆主键。需权衡利弊。](#h0b7-1709802773377)

<a name="9vcb-1715100354800"></a>[.分片与次级索引](#ekdv-1709800287975)

<a name="2zsp-1715100354803"></a>[次级索引通常并不能唯一标识记录。](#n3vk-1709803239471)

<a name="zm3u-1715100354805"></a>[HBase Volde-mort为了减少实现复杂度放弃了次级索引。](#q1u5-1709803293988)

<a name="ma5u-1715100354807"></a>[Riak开始添加， 次索是Solr Elasticesearch 搜索的基石](#fhpr-1709803333585)

<a name="sgme-1715100354809"></a>[按文档的二级索引](#mwm0-1709800370635)

<a name="3eey-1715100354811"></a>[文档分区索引/本地索引](#ud7o-1709803718409)

<a name="qajh-1715100354813"></a>[每个分区独立维护自己的二级索引。](#zlhf-1709803740582)

<a name="8vnq-1715100354815"></a>[查询发送所有分区，并合并所有返回结果，分散/聚集scatter/gather-容易导致尾部延迟放大。](#bkj3-1709803789802)

<a name="lmpi-1715100354817"></a>[缺点：可能使二级索引读取查询相当昂贵。](#ghpm-1709803878421)

<a name="u3qt-1715100354819"></a>[根据关键词(Term)的二级索引](#itl0-1709800380617)

<a name="wbu3-1715100354821"></a>[全局索引：覆盖所有分区数据的索引，也须分区。](#8bw4-1709804016790)

<a name="0eax-1715100354823"></a>[关键词分区：关键词本身或它的散列进行分区。](#qc2d-1709913637902)

<a name="5fod-1715100354825"></a>[优点：只需请求包含关键词的分区，读取更有效率](#jmj8-1709913775261)

<a name="pqg4-1715100354827"></a>[缺点：写入慢且复杂。需支持分布式事务。](#i7kp-1709913825503)

<a name="mmof-1715100354829"></a>[理想下总是最新，实践中更新通常为异步。Amazon DynamoDB声称全局次级索引不到1s内更新。](#mv7j-1709913923874)

<a name="wakq-1715100354831"></a>[.分区再平衡(reblancing)](#hpnd-1709800294747)

<a name="t2ok-1715100354833"></a>[吞吐量增加：加cpu](#1f0n-1709914101899)

<a name="ydee-1715100354835"></a>[数据集大小增加：加磁盘和RAM](#vjb0-1709914129763)

<a name="343z-1715100354837"></a>[机器故障：其他机器接管](#smcd-1709914153882)

<a name="tmon-1715100354839"></a>[----------再平衡应满足--------------](#2efu-1709916803909)

<a name="t8ws-1715100354841"></a>[发生时：数据库应该继续接受读取和写入](#20wj-1709916807951)

<a name="wykm-1715100354843"></a>[节点之间只移动必须数据(分区)，以便快速再平衡，减少网络和磁盘io负载。](#cxoi-1709916893371)

<a name="h70p-1715100354845"></a>[平衡后：存储，读取和写入公平共享](#cj8j-1709916938075)

<a name="heht-1715100354847"></a>[平衡策略](#cavd-1709800402611)

<a name="dwd3-1715100354849"></a>[反面教材：hash mod N](#6f6z-1709800409866)

<a name="g4lo-1715100354851"></a>[$hash(key)=22  22mod10..2  22mod 11...0  22 mod 9 ...4 ](#anib-1709916997775)

<a name="gcbc-1715100354853"></a>[节点需要转移秘钥及次数过多，过于昂贵。](#anz7-1709917243580)

<a name="f9n1-1715100354855"></a>[解决：更换为只移动必须数据的方法。](#7ytl-1709917334275)

<a name="ymnj-1715100354857"></a>[固定数量的分区(加节点时分配分区)](#8l9j-1709800420954)

<a name="lbsv-1715100354859"></a>[新增/减少节点时，将现存部分数据转移到节点新增/现存节点(Riak,es,couchbase Voldemort使用这种再平衡）](#vmsm-1709917322722)

<a name="jvbr-1715100354861"></a>[适用：分区数量第一次建立时确定。](#ktrd-1709917648400)

<a name="tckm-1715100354863"></a>[缺点：数据集总量大小难以预估时；分区大再平衡代价昂贵，分区小产生额外开销。](#vw7j-1709917692466)

<a name="ihyh-1715100354865"></a>[分区大小与集群数据总量成比例增长](#eszc-1709921747523)

<a name="0n3d-1715100354867"></a>[动态分区(适用键范围的分区)](#tkjw-1709800428033)

<a name="tsvy-1715100354869"></a>[解决：使用键范围分区，固定边界的固定数量的分区不便。出现边界错误，手动重新去配分区边界将非常繁琐。](#itsg-1709917825657)

<a name="ftbb-1715100354871"></a>[动态分区：与B树类似，分区数据增长超过配置时将分成两区，大量数据删除分区缩小低于阈值则合并(HBase RethinkDB)](#05rm-1709917996703)

<a name="vc7q-1715100354873"></a>[优点：分区数量适应总数据量-动态划分分区数量。](#v8uv-1709918235496)

<a name="zsgd-1715100354875"></a>[注意：空库分区开始，未绘制边界先验信息。所有写操作都必须由单个节点处理。其它节点空闲](#cdjv-1709918375629)

<a name="chrt-1715100354877"></a>[解决：配置一组初始分区-预分割 Hbase MongoDb。配需提前知道键分配方式。](#3uee-1709918458100)

<a name="sxwy-1715100354879"></a>[MongoDB同时支持范围和哈希分区且动态分割分区。](#tlmq-1709918504615)

<a name="gsvg-1715100354881"></a>[分区数量与数据集大小成正比](#xqee-1709921516740)

<a name="eqvl-1715100354883"></a>[按节点比列分区](#kcsr-1709800432396)

<a name="ifxf-1715100354885"></a>[新增节点，分区将变小。随机选择固定数量的现有分区进行拆分,最终获得公平的负载份额。cassandre ketama.](#xscz-1709920011051)

<a name="btvm-1715100354887"></a>[随机选择分区边界要求使用基于散列的分区-一致性哈希。](#pmpc-1709920187661)

<a name="1iag-1715100354889"></a>[分区数量与节点数量无关](#a0l0-1709923420226)

<a name="zygz-1715100354891"></a>[ 运维：手动还是自动平衡](#w6ob-1709800443454)

<a name="yzmm-1715100354894"></a>[自动：与故障检测结合将十分危险，高负载节点响应慢被视为死亡被踢掉，重新平衡集群时其他超负荷节点可能级联失败](#qobk-1709920292898)

<a name="zrlc-1715100354896"></a>[手动人为监控+自动](#a05n-1709920414620)

<a name="txom-1715100354898"></a>[.请求路由](#qxk3-1709800301840)

<a name="ewks-1715100354900"></a>[分区再平衡后的服务发现(IP 端口)](#sd2e-1709921854453)

<a name="psds-1715100354902"></a>[-------方案-------](#gliq-1709921964410)

<a name="yuna-1715100354904"></a>[1.循环策略：Round-Robin load balancer，轮询节点看是否有请求的分区。](#ibln-1709921978507)

<a name="jzw2-1715100354906"></a>[2.路由层：有中间层的路由决定请求的节点，由路由层负载均衡](#gjxa-1709922094115)

<a name="jpxx-1715100354908"></a>[3.要求客户端知道分区和节点的分配。客户端可直连节点。](#ukz9-1709922149547)

<a name="opjm-1715100354910"></a>[具有挑战性的问题。重要的是所有参与者都同意-否则将被发送到错误的节点，而不是正确处理。分布式中的共识协议-但很难正确实现。](#1c54-1709922244119)

<a name="stog-1715100354912"></a>[Zookeper分区分配改变时通知路由层保持最新信息。](#c7dc-1709922373821)

<a name="cmnn-1715100354914"></a>[LinkedIn的Espressor使用Heix进行集群管理(依靠Zookeeper）](#ne7u-1709922442881)

<a name="hvkz-1715100354916"></a>[Hbase,SolrCloud 和kafka也是用Zookeeper来跟踪分区分配。](#41cr-1709922584212)

<a name="tbx2-1715100354918"></a>[Cassandra  Riaks节点间使用留言协议gossip protocol来传播群集状态变化。请求发送任意节点，该节点转发到含有请求分区的节点。模型增加数据库节点的复杂性。但避免对Zookeeper这类外部协调服务的依赖](#kg5k-1709922347652)

<a name="want-1715100354920"></a>[Couchbash不会自动再平衡，简化了设计。moxi路由层。](#uohs-1709922928889)

<a name="mlgo-1715100354922"></a>[执行并行查询](#h26t-1709800460759)

<a name="kuoe-1715100354924"></a>[大规模并行处理(MPP,massively parallel processing)-数仓](#oj8k-1709923010027)

<a name="mu9i-1715100354926"></a>[7.事务](#7qvp-1708523954496)

<a name="2x3b-1715100354928"></a>[简化故障失败的机制-强大的事务！！](#wk3n-1710172857428)

<a name="un8g-1715100354930"></a>[故障](#pzui-1710172844274)

<a name="oies-1715100354932"></a>[崩溃](#znoj-1710172848152)

<a name="jdsm-1715100354934"></a>[网络中断](#vovu-1710172885568)

<a name="rbqo-1715100354936"></a>[多线程/客户端写入覆盖](#sxty-1710172894683)

<a name="nwht-1715100354938"></a>[读取无意义中间态数据](#hbqy-1710172933218)

<a name="hpff-1715100354940"></a>[多线程/客户端竞争](#jlng-1710172974900)

<a name="ynif-1715100354942"></a>[.事务的棘手概念](#58hv-1710167822460)

<a name="lhx6-1715100354944"></a>[ACID的含义](#yxrp-1710167867782)

<a name="xl8z-1715100354946"></a>[原子性atomicity](#hryj-1710167943276)

<a name="h7oz-1715100354948"></a>[一致性consistency](#9aal-1710167983379)

<a name="uug9-1715100354950"></a>[—致性这个词重载的很厉害:](#jkse-1710173130714)

<a name="u0gr-1715100354952"></a>[隔离性isolation](#gfkv-1710171645686)

<a name="jsq9-1715100354954"></a>[持久性durability](#7kja-1710171663168)

<a name="rgth-1715100354956"></a>[单对象与多对象操作](#pblh-1710167919896)

<a name="c256-1715100354958"></a>[违反隔离性：一个事务读取另一个事务未被执行的写入（脏读）](#42qx-1710250188446)

<a name="hpf8-1715100354960"></a>[ 原⼦性确保发⽣错误时，事务先前的任何写⼊都会被撤消，以避免状态不⼀致（all or nothing）](#daxd-1710250201202)

<a name="19so-1715100354962"></a>[单对象写入](#7ymn-1710171710772)

<a name="qizt-1715100354964"></a>[单对象写入崩溃，原子性通过日志实现恢复](#h5aa-1710250215106)

<a name="wlj7-1715100354966"></a>[原子操作：CAS也是流行的操作](#ihdr-1710250368749)

<a name="hsul-1715100354968"></a>[事务通常被理解为：将多个对象上的多个操作合并为一个执行单元的机制](#a1qj-1710250481310)

<a name="mot9-1715100354971"></a>[多对象事务的需求](#afyc-1710171718578)

<a name="odxl-1715100354973"></a>[是否需要多对象事务？ ](#t9gh-1710251706186)

<a name="wlsu-1715100354975"></a>[是否有可能只用键值模型和单对象来实现应用程序？](#9b6e-1710251739137)

<a name="druq-1715100354977"></a>[ 关系型数据库：多表关联插入操作](#ormg-1710250533532)

<a name="4alx-1715100354979"></a>[ 文档数据模型：多个字段常在同一个文档(被视为单个对象），缺乏连接功能的文档DB会鼓励非规范化(操作非规范化信息需要更新多个文档)。事务可防止非规范化数据不同步。](#opfe-1710250566216)

<a name="fnrv-1715100354981"></a>[ 二级索引的数据库中：一二级索引的同步更新](#syt6-1710251863622)

<a name="dy2m-1715100354983"></a>[无原子性:复杂的错误处理](#ymgi-1710251891615)

<a name="hr86-1715100354985"></a>[无隔离性：并发问题](#ovhl-1710251918119)

<a name="z2bh-1715100354987"></a>[处理错误和中止](#g5o1-1710171723084)

<a name="1z3s-1715100354989"></a>[···   ACID哲学：违反规则宁可放弃，不留半成品。](#ygfp-1710251941752)

<a name="my1q-1715100354991"></a>[无主复制则是尽力而为：数据库将做尽可能多的事。错误时不会撤销已经完成的事。-错误恢复是应用程序的责任。](#0hze-1710252188073)

<a name="6e3g-1715100354993"></a>[Rails的ActiveRecord、Django这样的orm框架不会重试中断的事务。丢弃用户输入。](#7mbo-1710252298563)

<a name="a67j-1715100354995"></a>[中止的重点应该是允许安全的重试。但它并不完美：](#p2mf-1710253466041)

<a name="vlec-1715100354997"></a>[事务成功，网络故障可能导致执行两次。除非有额外应用级除重机制。](#lmfw-1710253530673)

<a name="2l7l-1715100354999"></a>[负载过大，重试将更槽糕。限制重试次数，指数退避算法。并单独处理和过载相关的错误](#nxyx-1710253675080)

<a name="1qxy-1715100355001"></a>[仅在临时性错误才值得重试（死锁，异常，网络中断和切换）。发生永久性错误的重试是无意义的](#njy9-1710253740189)

<a name="cbqz-1715100355003"></a>[数据库外的副作用：重试每次重发电子邮件。不同系统事务。两阶段提交2PC.](#auy9-1710253799114)

<a name="zex8-1715100355005"></a>[ 客户端重试失效则丢失数据。](#mtpo-1710253936214)

<a name="5h9i-1715100355007"></a>[.弱隔离级别](#jngf-1710167840980)

<a name="xcor-1715100355009"></a>[安全并行parallel：事务不触及相同数据](#wdhp-1710263089880)

<a name="xtve-1715100355011"></a>[竞争条件：](#ykgs-1710263216103)

<a name="a9hn-1715100355013"></a>[读：事务读取另一个事务同时修改的数据](#er05-1710263177909)

<a name="9zx8-1715100355015"></a>[写：事务同时修改相同的数据](#pypw-1710263203957)

<a name="3lrm-1715100355017"></a>[事务隔离：](#xps5-1710263234506)

<a name="umtu-1715100355019"></a>[可序列化(一次一个执行，没有任何并发)](#ghkk-1710263260640)

<a name="c5a3-1715100355021"></a>[性能损失](#a876-1710263299289)

<a name="x5tr-1715100355023"></a>[弱隔离级别(非串行化nonserializable)](#nqm3-1710263313752)

<a name="jkoa-1715100355025"></a>[较弱的隔离级别防止一部分，而非全部的并发问题](#e7nl-1710263334073)

<a name="gmll-1715100355027"></a>[资金损失，耗费财务调查，财务数据请使用ACID数据库(注意：流行的数据库也使用弱隔离级别，不一定能防止并发错误)](#2xxd-1710331395046)

<a name="2yee-1715100355029"></a>[读已提交](#pjqb-1710171742279)

<a name="nqzh-1715100355031"></a>[没有脏读](#7h42-1710171796899)

<a name="yqhc-1715100355033"></a>[dirty reads：事务看到另一个事务未提交的值](#lyju-1710332135761)

<a name="fmoo-1715100355035"></a>[为什么要防止dirty reads：](#x8ch-1710333899846)

<a name="7jr0-1715100355037"></a>[更新多对象：脏读以为只看到部分数据](#pwpa-1710333902582)

<a name="dxeo-1715100355039"></a>[事务中止：回滚后，看到的是未提交的数据](#jcj0-1710333902583)

<a name="baq1-1715100355041"></a>[解决：只能读取提交后的数据，且不会阻塞，并行时保存已提交的旧值 -mvcc](#3mi1-1710332238978)

<a name="gvuh-1715100355043"></a>[没有脏写](#vmfl-1710171803833)

<a name="i3rn-1715100355045"></a>[dirty write: 事务同时更新相同对象。后面的写入覆盖尚未提交的值。](#hvah-1710332040048)

<a name="qpzo-1715100355047"></a>[避免的问题：](#chr0-1710333916523)

<a name="fd3f-1715100355050"></a>[混乱写入，导致bob后买车先更新发票commit而alic先买车后更新发票commit(buyer=bob but recipient=alice)](#14wx-1710333919188)

<a name="zgzw-1715100355052"></a>[解决：延迟/阻塞第二次的写入，直到第一次写入事务提交或终止。](#g1sw-1710332222649)

<a name="1v17-1715100355054"></a>[但不能防止计数器增量的竞争状态。(读写非原子性，写依赖读的副本)](#ujzx-1710333397576)

<a name="qg64-1715100355056"></a>[计数器增量安全：防止更新丢失 -版本号](#ugiq-1710333641028)

<a name="ssxw-1715100355058"></a>[实现读已提交](#z96g-1710171821987)

<a name="lgao-1715100355060"></a>[默认的隔离级别：oracle,postgreSQL,sql server ,memSql](#tays-1710333754461)

<a name="evrz-1715100355062"></a>[行锁row-level lock](#svaf-1710333809593)

<a name="fztg-1715100355064"></a>[读写锁防止脏读：读写锁互斥，只有读锁拥有者可持有写锁。](#fsbu-1710334081090)

<a name="lpkp-1715100355066"></a>[缺点：阻塞，性能损失。](#xj1j-1710334321006)

<a name="et8n-1715100355068"></a>[优化：所以一般用mvcc的模式。-或者copy on write](#7klj-1710334353854)

<a name="gvks-1715100355070"></a>[快照隔离和可重复读](#bww4-1710171760070)

<a name="aflg-1715100355072"></a>[不可重复读nonrepeatable read/读取偏差read skew](#wjut-1710343195467)

<a name="gid9-1715100355074"></a>[skew重载：在热点指的是不平衡，这里指异常时机  alice两个账号各500，alice先读acount1=500,转账员将acount1+100,acount2-100后commit，alice读acount2=400.commit.导致Alice看起来少了100。-暂时不一致。](#jmuu-1710343248537)

<a name="ev4i-1715100355076"></a>[提交后，刷新网页即可。有些情况不能容忍暂时不一致：](#gwgf-1710343469620)

<a name="qkzs-1715100355078"></a>[备份：数据库备份需要几小时，期间接收写入包含新老数据。如果备份用于恢复，不一致就变成永久的了。-解决：全局锁/快照备份](#m0km-1710345572560)

<a name="g6iw-1715100355080"></a>[分析查询和完整性检查：扫描大部分数据库，查询在不同时间点观察数据库产生不同，可能返回无意义的结果。](#i5pt-1710345666724)

<a name="1h1g-1715100355082"></a>[ 快照隔离snapshot isolation 对长时间运行的只读查询非常有用（备份和分析）。](#p7tm-1710345899708)

<a name="cvnc-1715100355084"></a>[ 即 一致快照consistent snapshot,即使被另一个事务更改，每个事务只能看到该特定时间的旧数据（特定时间点冻结的一致快照）。](#q8oz-1710345935366)

<a name="cbdf-1715100355086"></a>[PostgerSQL, mysql innoDB, Oracle, sqlServer](#mo1i-1710346175801)

<a name="f6td-1715100355088"></a>[实现快照隔离](#2hpt-1710171981487)

<a name="hjgi-1715100355090"></a>[关键原则：读不阻塞写，写不阻塞读。两者没有任何锁定争用。](#49s0-1710346236063)

<a name="e7g3-1715100355092"></a>[多版本并发控制mvcc,multi-version concurrentcy contorl](#w8v8-1710346319154)

<a name="zm3h-1715100355094"></a>[读已提交不提供快照隔离，保留对象的一两个版本就足够。通常支持快照隔离也是用mvcc来实现读已提交隔离级别：](#fh82-1710346453757)

<a name="4lrc-1715100355096"></a>[读已提交为每个查询使用单独的快照-每个select单独生成。](#3xbw-1710346540026)

<a name="otk8-1715100355098"></a>[快照隔离对整个事务使用相同的快照-复用第一个select生成的快照](#xqhm-1710346554737)

<a name="absa-1715100355100"></a>[update操作在内部翻译为Delete 和 insert](#pmk8-1710351883488)

<a name="yrre-1715100355102"></a>[-innoDB实际上delete将旧数据版本移到undolog版本链中。垃圾收集会删除任何事务不可见的就对象版本。](#vnfd-1710351911457)

<a name="96wa-1715100355104"></a>[观察一致性快照的可见性规则](#box0-1710171988275)

<a name="busk-1715100355106"></a>[从来不更新值，而是每次值改变时创建一个新版本。使得数据库提供一致快照产生的开销很小。](#yapf-1710408915465)

<a name="qtsz-1715100355108"></a>[事务id决定它可以看到哪些对象，规则如下：](#ecrk-1710408160769)

<a name="blph-1715100355110"></a>[事务开始时列出当时所有事务清单，即使之后提交，这些事务的写入也都会被忽略。](#ogtp-1710408539120)

<a name="izbm-1715100355112"></a>[忽略被中止事务任何写入](#unjc-1710408595672)

<a name="hwy3-1715100355114"></a>[较晚(当前事务之后开始)的写入都被忽略，不管是否提交](#ofbz-1710408626209)

<a name="hcia-1715100355117"></a>[所有其他写入，对应用都是可见的。](#hgwi-1710408682423)

<a name="kalg-1715100355119"></a>[对象可见的两条规则](#rg1c-1710408738736)

<a name="xefd-1715100355121"></a>[读事务开始时，创建该对象的事务已提交。](#weyp-1710408754844)

<a name="0cgc-1715100355123"></a>[请求删除的事务在读事务开始时未提交。](#xqky-1710408773006)

<a name="lcjl-1715100355125"></a>[索引和快照隔离(索引如何在多版本数据库中工作)](#ai77-1710171999516)

<a name="wcnc-1715100355127"></a>[同一对象不同版本放在同一个页面中，PostgreSQL的优化可以避免更新索引](#kanl-1710410047690)

<a name="fjxp-1715100355129"></a>[仅追加/写时拷贝apeend-only/copy-on-wirte的变体B树：更新不覆盖树的页面，为每个修改页创建副本。](#yv2q-1710410120895)

<a name="gbrc-1715100355131"></a>[每个写入事务/一批事务都会创建一个新的B树，当创建时，从该特定树根生长的树就是数据库的一个一致性快照。](#etza-1710410471666)

<a name="qdyu-1715100355133"></a>[需要负责压缩和垃圾收集的后台进程。](#79xv-1710410561061)

<a name="0bwa-1715100355135"></a>[可重复读与命名混淆](#xr4f-1710172004472)

<a name="n7dx-1715100355137"></a>[原因：System R定义隔离级别时并未有快照隔离](#nohd-1710417835613)

<a name="52gi-1715100355139"></a>[oracle DB2 称为序列化](#uwdp-1710417928621)

<a name="mrwz-1715100355141"></a>[postgreSql mySql称为可重复读](#f5te-1710417946615)

<a name="emuo-1715100355143"></a>[防止丢失更新](#e9wg-1710171770800)

<a name="fcvb-1715100355145"></a>[脏写导致丢失更新lost update](#ajmt-1710418075399)

<a name="oriz-1715100355147"></a>[读取-修改-写入序列的狠揍clobber：第二个事务并没有包括第一个事务的修改: -写依赖读](#c7rv-1710418271703)

<a name="bxe7-1715100355149"></a>[增加计数器或更新账户余额(需读取当前值，计算新值并写回更新后的值)](#uvoq-1710418375497)

<a name="dwqv-1715100355151"></a>[进行本地修改： 解析文档，更改后回写修改的文档](#ro12-1710418458493)

<a name="2yiq-1715100355153"></a>[同时编辑wiki页面：整个页面覆盖当前内容。](#9n83-1710418515773)

<a name="goi1-1715100355155"></a>[原子写(x排它锁)](#lftw-1710172034957)

<a name="09za-1715100355157"></a>[数据库原子更新操作保证并发安全](#6jim-1710418574114)

<a name="8ohx-1715100355159"></a>[mysql: 行级写锁](#dxgy-1710419672127)

<a name="auah-1715100355161"></a>[MongoDB：对JSON文档一部分进行本地修改的原子操作](#bqxj-1710419591972)

<a name="3osa-1715100355163"></a>[redis提供了优先队列等修改数据的原子操作。](#wxju-1710419646040)

<a name="ubx3-1715100355165"></a>[原子操作/游标稳定性cursor stability：通常在读取对象时获取其上的排它锁，以便提交前没有事务可以读取它。另一个选择是将所有原子操作在单一线程上执行。-redis](#h0ip-1710421887552)

<a name="h3kw-1715100355167"></a>[unfortunately,ORM框架易执行读取-修改-写入序列，而不是使用数据库提供的原子操作。如果你知道自己在做什么那当然不是问题](#6hwo-1710422121598)

<a name="xgal-1715100355169"></a>[显式锁定(for update：读-改-写序列)](#vysa-1710172041914)

<a name="lxah-1715100355171"></a>[让应用程序显示锁定更新的对象，直到一个读取-修改-写入序列完成](#oknq-1710422501689)

<a name="qex5-1715100355173"></a>[select ..... for update;](#89ij-1710422624973)

<a name="xshd-1715100355175"></a>[--更新先前select 返回棋子的位置。](#50q1-1710422845671)

<a name="xkvl-1715100355177"></a>[ update](#rmgw-1710422637550)

<a name="h0mm-1715100355179"></a>[for update-对返回的所有行加锁，忘记加锁很容易引入竞争条件(同时修改)](#euv5-1710422671170)

<a name="2ffb-1715100355181"></a>[自动检测丢失的更新(管理器检测处理并发问题)](#jpu5-1710172058032)

<a name="hxlg-1715100355183"></a>[允许并行执行，事务管理器检测到丢失更新，中止事务并强制重试读-改-写序列。](#8ytj-1710423161566)

<a name="guhj-1715100355185"></a>[Oracle可串行化(快照隔离)和sqlServer的快照隔离级别会自动检测到丢失更新，中止惹麻烦的事务。一些作者认为能防止丢失更新才算提供快照隔离。这个定义下，mysql不算提供快照隔离](#w9el-1710423029153)

<a name="93tx-1715100355187"></a>[优点：是一个很好的功能，不需要应用代码使用任何特殊数据库功能。允许你忘记加锁或原子操作，由管理器检测丢失更新。](#qg6e-1710423330067)

<a name="lck9-1715100355190"></a>[比较并设置(CAS)](#ftwe-1710172063360)

<a name="cyfn-1715100355192"></a>[不提供事务的数据库中的原子操作：比较并设置（CAS compare and set）](#os3h-1710424617661)

<a name="ymjq-1715100355194"></a>[update table set content='new content' where id=123 and content = 'old content'  必要时重试](#hlfh-1710425612756)

<a name="cuu2-1715100355196"></a>[问题：数据库允许where子句从旧快照读取，此语句无法防止丢失更新。即另一个并发写入，where条件也为真。-非当前读或非原子写。](#rxcv-1710425806449)

<a name="15ku-1715100355198"></a>[解决：检查数据库的CAS是否安全。保证比较交换为当前读且写是否加锁/原子写](#zss4-1710425865867)

<a name="9url-1715100355200"></a>[冲突解决与复制(多个数据库副本的并发)](#bvrp-1710172079412)

<a name="c3ke-1715100355202"></a>[基于锁和cas操作不适用于多个数据库副本](#ewf7-1710434904534)

<a name="o9hw-1715100355204"></a>[如检测并发写入：允许并发吸入创建多个冲突版本(也称兄弟），应用代码或特殊数据结构在发生之后解决合并这些版本。](#8dx4-1710434970886)

<a name="oy5b-1715100355206"></a>[原子操作可在复制的上下文中很好工作，尤其具有可交换性时。Riak2.0不同客户端同时更新一个值是，Riak将自动更新合并在一起，以免丢失更新。防止复制副本丢失更新。](#gl8j-1710435048968)

<a name="5ssn-1715100355208"></a>[最后写入LWW解决冲突很容易丢失更新。unfortunately,许多复制数据库默认LWW。](#gdtn-1710435259414)

<a name="wg14-1715100355210"></a>[写入偏差与幻读（两个事务更新两个不同的对象）](#rkev-1710172453385)

<a name="sygy-1715100355212"></a>[select count(*) where oncall=true....alice 和 bob分别查在职医生人数](#itfd-1710436127298)

<a name="d9pc-1715100355214"></a>[update...set oncall=false 然后将自己的记录更新为请假，违反至少一医生在职。](#leam-1710436160580)

<a name="pwif-1715100355216"></a>[写偏差的特征](#ovid-1710172462835)

<a name="weuo-1715100355218"></a>[特征：涉及多个对象，单对象的原子操作不起作用](#iedp-1710437034438)

<a name="kkwf-1715100355220"></a>[快照隔离实现中，自动检测丢失更新对此无帮助。postgred,innodb的可重复读，oracle序列化或sql server的快照隔离级别中，都不会自动检测写入偏差。写入偏差需要真正的可序列隔离-业务上的问题。](#wszw-1710437034814)

<a name="utof-1715100355222"></a>[数据库配置约束，指定至少一个值为true.大多数不支持这种配置，可以使用触发器或者物化视图实现。](#hn04-1710437034815)

<a name="aqra-1715100355224"></a>[显示锁定。 select ...fro update -锁定返回的所有行，锁定两个医生](#crrt-1710437034816)

<a name="imh1-1715100355226"></a>[写偏差的更多例子](#4jr1-1710172470885)

<a name="wohp-1715100355228"></a>[读数据为空，分别插入一条数据的会议室预定系统：select count(*) from bookings where roomid=123 and time...，insert into bookings....不能防止另一个用户插入冲突会议。解决：又需要串行化执行。](#0hyt-1710437389755)

<a name="4r60-1715100355230"></a>[多人游戏：棋盘用锁防止丢失更新，但锁定不能妨碍将不同的棋子放在相同位置。产生写入偏差 。解决：使用唯一约束。](#pgcb-1710437636980)

<a name="py3t-1715100355232"></a>[抢注用户名：和会议系统一样。不过唯一性约束可以解决该问题。](#bwel-1710437042998)

<a name="alcx-1715100355234"></a>[防止双重开支；用户花钱和积分服务，检查支付数不超过余额，有了写入偏差，可能会发生两个支出项目同时插入，导致余额变为负值，两个事务都不会注意到另一个。](#ogt8-1710438166946)

<a name="w7kp-1715100355236"></a>[导致写入偏差的幻读](#8gty-1710172478550)

<a name="7cxl-1715100355238"></a>[所有以上例子都遵循类似的模式](#tw0y-1710438423955)

<a name="oray-1715100355240"></a>[Select查询符合条件的行，至少两名医生值班；不存在该会议室同一时段的预定；棋盘位置未被占据；用户未被抢注；账户还有足够余额](#bngi-1710438445792)

<a name="apdh-1715100355242"></a>[按照第一个查询的结果，应用代码决定是否继续](#l6p0-1710438590471)

<a name="r9um-1715100355244"></a>[应用决定继续操作，执行写入(插入更新删除），并提交事务](#qt10-1710438739456)

<a name="x1gc-1715100355246"></a>[步骤3修改的行，是步骤1中返回的行之一，可以使用select for update来使事务安全避免写入偏差.](#cdmo-1710438899441)

<a name="ljc9-1715100355248"></a>[但检查是否不存在满足条件行，写入添加一个匹配相同条件的行。select for update 锁不了任何东西。](#caet-1710439501945)

<a name="arzd-1715100355250"></a>[       这种效应：一个事务中的写入改变另一个事务的搜索查询结果，被称为幻读。快照隔离避免了只读查询中的幻读。以上的读写事务中，幻影会导致特别棘手的写歪斜情况。](#cwgh-1710440241091)

<a name="vhnl-1715100355252"></a>[物化冲突](#1cjy-1710172485201)

<a name="rihw-1715100355254"></a>[物化冲突：将幻读变为数据库中一组具体行上的锁冲突。](#fv3x-1710440426895)

<a name="xy3n-1715100355256"></a>[通过创建时间槽和房间的表，提前出入房间和时间的所有可能组合。创建预定的事务可以select for update锁定房间和时间段对应的行，在获得锁定后，可以检查重叠的预定并插入新的预定。该表不是存储预定相关的信息，它完全就是一组锁，用于防止同时修改同一房间和时间范围内的预定。](#laff-1710440634993)

<a name="1e1r-1715100355258"></a>[缺点：弄清除如何物化冲突可能很难，也很容易出错，而让并发控制机制泄露到应用数据模型是很丑陋的做法。](#dngy-1710441936216)

<a name="aiel-1715100355260"></a>[物化重入应为最后的手段。可序列化Serializeble级别是更可取的。](#i0he-1710441997817)

<a name="p7ok-1715100355262"></a>[.可序列化](#di29-1710167844061)

<a name="zoht-1715100355264"></a>[弱隔离级别读已提交和快照隔离不能解决写入偏差幻读：](#ztac-1710587737356)

<a name="govz-1715100355266"></a>[隔离级别难以理解，且不同数据库中实现不一致，可重复读概念不一样](#ky3h-1710588699885)

<a name="0m9y-1715100355268"></a>[光检查应用代码很难判定在特定隔离界别是否安全](#tpbs-1710588738858)

<a name="dl6c-1715100355270"></a>[无检测竞争条件的好工具，往往倒霉时才会出现问题。](#jp98-1710588779920)

<a name="ujzz-1715100355272"></a>[20世纪70年代system R就已经是这样，研究人员的答案都很简单：可序列化（serializeble）级别（但非人见人爱），都使用三种技术之一。](#sqvc-1710588820273)

<a name="sk1e-1715100355274"></a>[字面意义上的串行顺序执行事务](#mqa4-1710589545518)

<a name="sy81-1715100355277"></a>[两相锁定2PL two-phase locking,几十年来唯一的可行选择](#neot-1710589568078)

<a name="pcg0-1715100355279"></a>[乐观并发控制，可序列话的快照隔离serializable snapshot isolation](#pizj-1710589721553)

<a name="jjnr-1715100355281"></a>[真的串行执行(单线程执行事务)](#2oi3-1710172506817)

<a name="yax2-1715100355283"></a>[数据库设计人员07年才确定，单线程循环执行事务时可行的。（多线程过去30年中被认为是获得良好性能的关键所在）](#o5af-1710589822067)

<a name="qjyv-1715100355285"></a>[两个进展引发了这个反思：](#phuh-1710609564138)

<a name="fbln-1715100355287"></a>[RAM足够便宜，许多场景可以将完整的活跃数据保存在内存中。-redis](#owi7-1710609747624)

<a name="kuqu-1715100355289"></a>[数据库设计人员意识到OLTP事务很短，只进行少量的读写操作。长时间的分析查询通常是只读的，可以用一致快照（快照隔离）上运行。](#vhy4-1710609817752)

<a name="k6jl-1715100355291"></a>[VoltDB/H-Store, Redis 和 Datomic中实现。避免锁的协调开销。吞吐量仅限单个cpu](#xcax-1710609934885)

<a name="pmiv-1715100355293"></a>[在存储过程中封装事务(优化交互式单线程事务)](#xh4n-1710172519134)

<a name="3bj4-1715100355295"></a>[数据库设计者认为，机票全流程是一个事务，可以被原子化执行。缺点：交互式会使流程性能直接下降。](#xthc-1710757083497)

<a name="7gnf-1715100355297"></a>[解决：单线程串行执行事务的系统不允许交互式的多语句事务。提前将整个事务作为存储过程提交数据库：](#oo8b-1710757291600)

<a name="terg-1715100355299"></a>[Interactive transaction :bob医生请假 1.select count  2.if count>=2 3.update false](#9fzd-1710757436562)

<a name="kksc-1715100355301"></a>[stored procedure: execute stored take doctor of call](#gegl-1710763202697)

<a name="vhas-1715100355303"></a>[事务所需的数据都在内存中，快速执行，无需等待网络和磁盘IO](#t47s-1710763179337)

<a name="uivo-1715100355305"></a>[存储过程的优点和缺点](#7ksv-1710172529258)

<a name="jgw9-1715100355307"></a>[名声不好：](#jfoa-1710763413471)

<a name="9drw-1715100355309"></a>[陈旧丑陋无库生态，数据库存储过程各自的语言没跟上通用编程语言的发展](#4qhf-1710763421594)

<a name="rw6h-1715100355311"></a>[管理困难，调试困难，版本控制测试部署困难，和监控指标的系统集成困难](#96la-1710763483936)

<a name="mvxm-1715100355313"></a>[单个数据库通常由多个应用共享，写得不好的存储过程（占用大量内存和cpu）会比代码造成更大麻烦](#idii-1710763602399)

<a name="nmar-1715100355315"></a>[ 这些问题都可以克服。现代存储过程放弃了PL/SQL,使用现有通用编程语言：VoltDB使用java或Groovy, Datomic使用Java或Clojure, Redis使用Lua.](#1w0a-1710763899035)

<a name="4ith-1715100355317"></a>[存储过程与内存存储，使得单线程执行事务可行，](#bp68-1710767504595)

<a name="busi-1715100355319"></a>[无需等待I/O,](#ahfz-1710767568244)

<a name="dvbc-1715100355321"></a>[避免并发控制机制的开销，可以在单线程实现相当好吞吐量](#mfvt-1710767570930)

<a name="yzl5-1715100355323"></a>[VoltDB还用存储过程进行复制，在每个节点上执行相同的存储过程，所以要求存储过程是确定性的。比如使用当前日期，需要通过特殊的确定性API实现。](#7m1p-1710767621202)

<a name="p3ym-1715100355325"></a>[分区](#xxtp-1710172539181)

<a name="tjhw-1715100355327"></a>[顺序执行事务使并发控制简单多，但吞吐限制为单机单核。吞吐量高的应用，单线程将可能成为严重瓶颈。](#rqu5-1710767939361)

<a name="sbkc-1715100355329"></a>[扩展多核多节点，可以对数据进行分区，每个事务只需在单个分区中读写数据，事务吞度量就可以与cpu保持现行扩展。](#puih-1710768082742)

<a name="pb8s-1715100355331"></a>[对于需要访问多个分区的任务事务，需要进行协调，存储过程跨所有分区锁定执行，保证串行。](#jpiw-1710768164695)

<a name="k3m3-1715100355333"></a>[缺点：协调开销性能比单区事务慢得多。VoltDB吞吐量每秒1000个跨分区写入，比单分区低几个数量级，且通过增加机器来提高](#fgu3-1710768218238)

<a name="7i6o-1715100355335"></a>[事务是否可划分-应用的数据结构，键值数据，多个二级索的数据引需要大量跨分区协调。](#8lf4-1710768407791)

<a name="5dol-1715100355337"></a>[串行执行小结](#zyih-1710172540516)

<a name="2flh-1715100355339"></a>[需每个事务小而快，一个缓慢的事务拖慢所有事务。](#dibg-1710768638498)

<a name="qaef-1715100355341"></a>[可放入内存仅限活跃数据集，少量数据会移动到磁盘。但需要访问执行中的事务，系统会变慢。](#22nq-1710768681244)

<a name="sdap-1715100355343"></a>[写入吞吐量必须低到能在单个cpu运行，否则事务能划分至但分区，且无需分区协调](#jmsk-1710768781527)

<a name="nj6o-1715100355345"></a>[跨分区事务使用程度受限。](#wlnd-1710769060180)

<a name="lr6d-1715100355347"></a>[两阶段锁定（2PL）](#uhxa-1710172558745)

<a name="ddqr-1715100355349"></a>[30年高使用的序列化算法：两阶段锁定2PL two phase locking ,独占访问exclusive access:](#nhdj-1710769248115)

<a name="btfb-1715100355351"></a>[事务A读取对象，阻塞B写入，直至A提交；](#khdp-1710769659952)

<a name="v3p6-1715100355353"></a>[事务A写入对象，阻塞B读取,直至A提交；](#elpw-1710769685611)

<a name="6jdu-1715100355355"></a>[快照隔离使得不会阻塞读，2PL提高序列化性质，解决丢失更新和写入偏差。](#6ja2-1710769959539)

<a name="i7g2-1715100355357"></a>[实现两阶段锁](#lfuv-1710172605096)

<a name="6vcj-1715100355359"></a>[2PL即innoDB可序列化级别及DB2可重复读隔离级别。](#8oif-1710770052594)

<a name="tgwq-1715100355361"></a>[读写阻塞为每个对象添加锁。共享模式shared mode 与独占模式exclusive mode:](#6wad-1710770158675)

<a name="27vx-1715100355363"></a>[读取对象需以共享模式获取锁。读共享](#1dyc-1710770195788)

<a name="yfhi-1715100355365"></a>[写入需独占模式取锁。写互斥。](#bshw-1710770251530)

<a name="bbon-1715100355367"></a>[事务获得锁必须持有锁知道事务结束(提交或中止)。即一阶段获取锁，二阶段释放所有锁。](#r0b0-1711207524774)

<a name="qsxe-1715100355370"></a>[死锁deadlock, 数据库会自动检测死锁，并中止其中一个。被中止的事务充实需应用程序实现。](#iuyh-1710770211133)

<a name="icdj-1715100355372"></a>[两阶段锁定的性能](#qi7j-1710172616303)

<a name="jjhr-1715100355374"></a>[比弱隔离差得多](#vz0p-1711207837446)

<a name="eldq-1715100355376"></a>[锁开销、串行并发性降低](#ienx-1711207878742)

<a name="7a8k-1715100355378"></a>[交互式事务形成等待队列、高百分位响应慢](#z85f-1711207913718)

<a name="4the-1715100355380"></a>[死锁频繁时重试造成浪费](#kmkr-1711207799940)

<a name="chmt-1715100355382"></a>[谓词锁predicate lock](#ccq8-1710172621528)

<a name="znix-1715100355384"></a>[谓词锁：属于符合搜索条件的对象，解决幻读phantoms](#kfpi-1711208306292)

<a name="jtvx-1715100355386"></a>[事务A获取共享谓词锁shared-mode predicate lock读取匹配对象，与排它互斥](#6dqd-1711208459688)

<a name="syix-1715100355388"></a>[事务A写入需等待其他事务谓词锁释放。](#p3er-1711208588906)

<a name="wh8g-1715100355390"></a>[适用于尚不存在，将可能添加的对象（幻象），如果两阶段包含谓词锁，可实现串行化。](#bdwj-1711208433268)

<a name="uk6g-1715100355392"></a>[索引范围锁next-key lock](#zv5c-1710172626404)

<a name="hemh-1715100355394"></a>[谓词锁性能不佳：活跃事务持锁多，检查匹配非常耗时](#a3ce-1711208973949)

<a name="0xzz-1715100355396"></a>[2PL采用索引范围锁-简化版谓词锁：](#ayfb-1711209059199)

<a name="qyd6-1715100355398"></a>[索引位于roomid, 指示room123用于预定](#qmbu-1711212311152)

<a name="ye73-1715100355400"></a>[或者索引位于时间上，指示12:00~13:00用于预定。](#ajbo-1711212362665)

<a name="dzb0-1715100355402"></a>[以上任何一条件，当另一个事务想写入时，需要更新索引-叶子节点，会收到共享锁。解决幻读和写入偏差](#k1ie-1711212755816)

<a name="qihy-1715100355404"></a>[索引范围锁不如谓词锁精确，但开销低](#6lzs-1711212829915)

<a name="lpt9-1715100355406"></a>[无可挂载索引，将退化为表锁，性能不利，但这是回退到一个安全位置。](#bofb-1711212877091)

<a name="ewq0-1715100355408"></a>[序列化快照隔离SSI（高性能序列化算法）](#slwa-1710172573367)

<a name="ncsc-1715100355410"></a>[新算法：可序列化快照隔离SSI serializeble snapshot isolation 仅与快照隔离有很小性能损失. 08年 micheal cahill博士论文。](#lnci-1711213123166)

<a name="2ty9-1715100355412"></a>[用于单节点PostgreSQL9.1后序列化和分布式数据库](#weo0-1711213307841)

<a name="qrlb-1715100355414"></a>[处于实践证明阶段](#ue1s-1711213377985)

<a name="0to1-1715100355416"></a>[悲观pessimistic与乐观optimistic的并发控制](#yq9i-1710172639651)

<a name="t48r-1715100355418"></a>[极致悲观：串行排它锁](#54jr-1711213690005)

<a name="ncpz-1715100355420"></a>[序列化快照隔离SSI是乐观技术： ](#bjxf-1711213769533)

<a name="xtbr-1715100355422"></a>[缺点：多事务争用contention时性能不佳，大部分事务中止，吞吐量极限下有重试机制将使性能变差。](#mefw-1711213819265)

<a name="0hus-1715100355424"></a>[优点：有备用容量，竞争不高场景比悲观好，可交换的原子操作可减少争用。](#nk1s-1711213915330)

<a name="0hyv-1715100355426"></a>[SSI在快照隔离基础上添加算法检测写入的序列化冲突，并决定中止哪些事务。](#snvf-1711214019984)

<a name="xv9k-1715100355428"></a>[基于过时前提的决策](#9lgw-1710172651041)

<a name="8syb-1715100355430"></a>[医生值班读取-修改-写入。数据库检测过时并终止：](#td4m-1711214184809)

<a name="xqcu-1715100355432"></a>[检测对旧MVCC对象版本的读取(读之前存在未提交的写入)](#t08a-1711215992016)

<a name="chtx-1715100355434"></a>[检测影响先前读取的写入（读之后发生写入）](#aego-1711216030637)

<a name="txes-1715100355436"></a>[检测旧MVCC读取](#5smj-1710172660675)

<a name="1wxf-1715100355438"></a>[事务提交时，检测是否有被忽略的写入已被提交。](#z7u2-1711216050316)

<a name="74yv-1715100355440"></a>[SSI支持一致快照中长时间运行的读取-仅在提交时中止检测的陈旧读取。因为只读不产生幻读和写入偏差风险](#afqq-1711216243096)

<a name="qspv-1715100355442"></a>[检测影响之前读取的写入](#mvok-1710172671381)

<a name="rxc6-1715100355444"></a>[事务写入提交时，在索引中查找最近读取受影响的其他事务，通知读取的事务非最新。并中止未提交写入的其他事务。](#mo5j-1711216452745)

<a name="awge-1715100355446"></a>[可序列化的快照隔离的性能](#0sq6-1710172685702)

<a name="bkzd-1715100355448"></a>[粒度granularity，精准哪些事务需要中止，但簿记开销显著。](#g2eg-1711216636788)

<a name="giuv-1715100355450"></a>[简略的跟踪速度快（粗粒度），但导致不必要的事务中止。](#ux2m-1711216812849)

<a name="7yxt-1715100355452"></a>[相比2PL, 不需要锁定阻塞，读性能高](#jzqb-1711216700614)

<a name="ycis-1715100355454"></a>[相比串行化，可扩展多台机器提高吞吐量，可跨分区读。](#qm51-1710756953994)

<a name="wdbn-1715100355456"></a>[SSI要求事务尽量短，避免长事务发生冲突中止。慢事务SSI比2PL或串行执行更不敏感](#wvsk-1711216911828)

<a name="p2le-1715100355458"></a>[8.分布式系统的麻烦](#enui-1704985776096)

<a name="gqgn-1715100355460"></a>[前几章failover故障切换, 复制延迟 与事务控制 处理各种可能发生的边缘情况，本章则是彻底的悲观总结。](#e2bp-1711387736669)

<a name="rb70-1715100355463"></a>[故障与部分失效](#4yaw-1711386647072)

<a name="zvmj-1715100355465"></a>[部分失效partial failure  不确定性的nondeterministic: IDC配电单元故障](#9d0g-1711387883443)

<a name="hj80-1715100355467"></a>[云计算与超级计算机](#w7ln-1711386736921)

<a name="cnxz-1715100355469"></a>[不可靠的网络(Timeout)](#ynhs-1711386665148)

<a name="fhq5-1715100355471"></a>[请求丢失： 拔网线](#fav6-1711388032544)

<a name="zaot-1715100355473"></a>[请求排队：](#znsf-1711388048086)

<a name="83fk-1715100355475"></a>[请求失效：](#gmdu-1711388084834)

<a name="a3bp-1715100355477"></a>[.....](#dssu-1711388054944)

<a name="x3lj-1715100355479"></a>[真实世界的网络故障](#y933-1711387087536)

<a name="i2wt-1715100355481"></a>[检测故障](#aywv-1711387099045)

<a name="6td5-1715100355483"></a>[超时与无穷的延迟](#z4hi-1711387103669)

<a name="ooto-1715100355485"></a>[级联失效cascading failure](#qs2e-1711388153448)

<a name="tfo8-1715100355487"></a>[网络拥塞和排队](#gttn-1711387323883)

<a name="hjjt-1715100355489"></a>[TCP执行流量控制flow control](#v9f2-1711388199023)

<a name="k2ah-1715100355491"></a>[视频、语音会议使用UDP，折中丢包与流畅](#up7k-1711389082773)

<a name="axzq-1715100355493"></a>[同步网络vs异步网络](#t56p-1711387113980)

<a name="kyap-1715100355495"></a>[有限延迟bounded delay：同步网络，不收排队影响](#fmrl-1711389283437)

<a name="phnd-1715100355497"></a>[我们不能简单地使用网络延迟可预测吗](#bwvp-1711387335617)

<a name="kyiw-1715100355499"></a>[不可靠的时钟](#l3p1-1711386676597)

<a name="ypcm-1715100355501"></a>[机器的时钟：硬件设备，石英振荡器，](#faqp-1711469591901)

<a name="ha5o-1715100355503"></a>[不是完全准确的。](#xtjc-1711469629964)

<a name="ugpp-1715100355505"></a>[同步时钟：网络时间协议NTP](#knwp-1711469656643)

<a name="il2w-1715100355507"></a>[服务器从精确时间源获取时间-GPS接收器](#pfpq-1711469689783)

<a name="evol-1715100355509"></a>[单调钟与时钟](#qoxv-1711387218692)

<a name="ykzf-1715100355511"></a>[时钟](#wu2k-1711387376627)

<a name="cwbh-1715100355513"></a>[Linux: clock_gettime(CLOCK_REALTIME)](#obwb-1711469781129)

<a name="2rgz-1715100355515"></a>[java:system.currentTimeMilis](#uxdp-1711469821742)

<a name="dolh-1715100355517"></a>[通常与NTP同步，但举例NTP服务器太远，则可能被强制重置(及时跳回）](#gwyx-1711469840905)

<a name="x11v-1715100355519"></a>[单调钟](#hl1a-1711387385739)

<a name="zzbw-1715100355521"></a>[保证总是前进](#uzaz-1711470052827)

<a name="fnuf-1715100355523"></a>[Linux:CLOCK_MONOTONIC](#tbmn-1711469988760)

<a name="fr37-1715100355525"></a>[java:System.nanoTime](#fb70-1711470014393)

<a name="2wgi-1715100355527"></a>[调整频率：NTP检测到计算机石英钟更快或更慢，则调整单调钟频率（偏移skewing时钟）.](#sn42-1711470028035)

<a name="c8xj-1715100355529"></a>[不假定不同节点时钟存在同步：分布式系统用单调钟效果好，对测量的不准确不敏感](#ct3v-1711470667953)

<a name="lcq9-1715100355532"></a>[时钟同步与准确性](#a7gy-1711387238026)

<a name="ow0e-1715100355534"></a>[漂移drifts: 计算机石英钟不准确原因,取决机器温度。](#pbyu-1711470750697)

<a name="zbck-1715100355536"></a>[实现精确度：GPS接收机，精确时间协议PTP](#kgdy-1711470917769)

<a name="nlsu-1715100355538"></a>[同步错误的原因：NTP守护进程配置错误，防火墙阻止NTP通信。](#kgez-1711470944635)

<a name="kyjs-1715100355540"></a>[依赖同步时钟](#vo0i-1711387245745)

<a name="5tyo-1715100355542"></a>[使用需要同步时钟的软件需监测所有机器间的时钟偏移](#zm2f-1711471000801)

<a name="foac-1715100355544"></a>[有序事件的时间戳](#fnxq-1711387475761)

<a name="j0qt-1715100355546"></a>[写入排序问题：B客户端写入比A晚但具有更早的时间戳。 ](#n1pp-1711471283186)

<a name="cpif-1715100355548"></a>[ 最后写入为准LWW](#50kp-1711471399605)

<a name="tnx4-1715100355550"></a>[ 版本向量](#axgx-1711471482711)

<a name="d8yo-1715100355552"></a>[时钟读数存在置信区间](#ofpq-1711387431462)

<a name="yzvr-1715100355554"></a>[ 置信区间的不确定性：NTP服务器的不去定性，加上服务器网络往返时间](#aihs-1711471513794)

<a name="ujkh-1715100355556"></a>[当clock_gettime()返回值不会告诉你预期错误，不知道置信区间是5毫秒还是5年](#aave-1711471693187)

<a name="lrb1-1715100355558"></a>[例外：Spanner Google TureTime API明确报告本地时钟置信区间（最早，最晚）。](#znqm-1711471741654)

<a name="qbnb-1715100355560"></a>[全局快照的同步时钟](#bfz6-1711387449885)

<a name="w3mu-1715100355562"></a>[分布式的事务快照隔离，分布式事务ID时序成为站不住脚瓶颈](#dpco-1711471815493)

<a name="bsuj-1715100355564"></a>[Spanner通过置信区间来比较A,B发生的时序。](#2ihe-1711471939317)

<a name="fh7p-1715100355566"></a>[分布式事务语义使用时钟同步是一个活跃的研究领域，没有在谷歌之外的主流数据库中实现。](#9qfk-1711471991096)

<a name="ecm7-1715100355568"></a>[暂停进程](#3mnj-1711387250438)

<a name="39am-1715100355570"></a>[如何确保分布式主节点仍未领导者](#ui0e-1711472636558)

<a name="6f3m-1715100355572"></a>[方式一：从其他节点获得租约lease, 类似一个带超时的锁，周期性过期前续约。-和redison续约类似](#yh9a-1711472775035)

<a name="yr3e-1715100355574"></a>[过期时，由另一个节点接管。](#kqwv-1711472837428)

<a name="dcfv-1715100355576"></a>[缺点：依赖同步时钟](#gi5a-1711473874947)

<a name="4x8t-1715100355578"></a>[意外的时间停顿：](#93uw-1711473992955)

<a name="10ud-1715100355580"></a>[stop-the-world  HotSpot GC](#7kp7-1711474017909)

<a name="17xz-1715100355582"></a>[suspend虚拟机](#6ejp-1711474059672)

<a name="eqv9-1715100355584"></a>[随意暂停恢复：关闭笔记本盖子](#92se-1711474080346)

<a name="frem-1715100355586"></a>[窃取时间steal time:虚拟机切换或cpu上下文切换，在其他机器中花费的时间.](#tfxw-1711474128862)

<a name="fipj-1715100355588"></a>[同步时的阻塞io：java惰性加载类文件；磁盘为网络文件系统或网络块设备-亚马逊EBS](#7jwg-1711474280466)

<a name="wual-1715100355590"></a>[磁盘交换内存抖动thrashing: 允许交换到磁盘（分页），内存访问可能导致页面错误page fault .话费大量时间将页面交换到内存，实际完成的工作很少thrashing。 服务器机器禁用页面调度，干掉进程释放内存。](#kvsa-1711474441136)

<a name="or9y-1715100355592"></a>[SIGSTOP暂停unix进程:Ctrl-Z立即阻止进程的CPU周期](#ocvk-1711474648160)

<a name="6o5y-1715100355594"></a>[这些都可以随时抢占preempt正在运行的线程。](#t1w7-1711474768157)

<a name="rlaf-1715100355596"></a>[响应时间保证](#cirf-1711473855327)

<a name="zt9e-1715100355598"></a>[硬实时hard real-time系统: 不满足特定截止时间deadline可能会导致整个系统故障。](#r1ji-1711474887529)

<a name="dehq-1715100355600"></a>[嵌入式系统精心设计和测试：安全气囊不会因系统GC暂停弹出。](#pgjw-1711475001376)

<a name="dixg-1715100355602"></a>[大量的额外工作，昂贵。](#urp5-1711475089330)

<a name="1k2m-1715100355605"></a>[限制垃圾收集的影响](#i1wt-1711387521748)

<a name="urmo-1715100355607"></a>[通知GC暂停，停止接收新请求-对延迟敏感的金融系统](#oxal-1711475134772)

<a name="oren-1715100355609"></a>[变种：GC只收集新生代，积累老年代，一次重启一个节点，类似滚动升级。](#ho3v-1711475217820)

<a name="ywcm-1715100355611"></a>[知识、真相与谎言](#ujyf-1711386681865)

<a name="idgo-1715100355613"></a>[真理由多数所定义](#hdwi-1711387268312)

<a name="4vw1-1715100355615"></a>[stop the world 一分钟，被其他节点宣告死亡，重新选举。](#rxcy-1711561420884)

<a name="odez-1715100355617"></a>[领导者与锁定](#3zea-1711387542106)

<a name="ytj5-1715100355619"></a>[数据库分区领导者只能有一个节点：避免脑裂](#b6am-1711561462773)

<a name="mhkr-1715100355621"></a>[特定资源的锁和对象只允许一个事务/客户端持有](#3ynw-1711561525662)

<a name="hppx-1715100355623"></a>[用户唯一标识](#hqa3-1711561556083)

<a name="bg74-1715100355625"></a>[节点认为它是天选者the choosen one](#rv2w-1711561875596)

<a name="knz4-1715100355627"></a>[HBase例子：分布式锁的实现不正确，客户端1持有锁stop the world导致lease超时,客户端2获得锁进行处理，客户端1仍认为它具有有效的租约，即使它已经过期，从而破坏了存储的文件。](#gu25-1711561617808)

<a name="bnqh-1715100355629"></a>[防护令牌](#mhlf-1711387550649)

<a name="pzkm-1715100355631"></a>[解决天选者问题：防护fencing](#gw5w-1711561950975)

<a name="l0ym-1715100355633"></a>[fencing token :只允许增加屏蔽令牌的顺序进行写操作。](#vi5w-1711562021406)

<a name="vbkl-1715100355635"></a>[服务器端检查token,获取锁时token增加33+1，存储服务器记录更高令牌34的写入，拒绝令牌33的请求。-一般是redisson续期，这个更像乐观锁。](#2yxl-1711562140276)

<a name="vuno-1715100355637"></a>[ZooKeeper将事务标识zxid和节点版本conersion用作屏蔽令牌。保证了单调递增](#e6n2-1711562077138)

<a name="qwhl-1715100355639"></a>[如文件存储服务器可将令牌卸载文件命中](#uujk-1711564755459)

<a name="qndr-1715100355641"></a>[拜占庭故障](#bsay-1711387279845)

<a name="rdvs-1715100355643"></a>[拜占庭故障Byzantine fault: 在不信任的环境中达成共识的问题称为拜占庭将军问题。](#id0b-1711628556885)

<a name="efhw-1715100355645"></a>[拜占庭将军问题：n位将军需要同意，一些叛徒通过发送虚假或不真实信息来混淆欺骗他人。](#lxw6-1711628612728)

<a name="eurr-1715100355652"></a>[拜占庭容错：系统在部分节点发生故障、不遵守协议，恶意攻击，扰乱网络时仍能继续正确工作：](#lpn6-1711628716132)

<a name="eu3z-1715100355654"></a>[航空航天环境计算机被辐射破坏，不可预知方式响应其他节点](#py6z-1711638469892)

<a name="9302-1715100355656"></a>[多个参与组织系统中，参与者试图欺骗他人。比特币等区块链对等网络让互不信任的各方同意交易不依赖中央当局。](#csli-1711638605446)

<a name="fdnj-1715100355658"></a>[弱谎言形式](#f38o-1711387557457)

<a name="riqn-1715100355660"></a>[添加防止撒谎弱形式机制；](#eepx-1711638744038)

<a name="zzqj-1715100355662"></a>[校验和防止数据包被破坏](#yseh-1711638821915)

<a name="iosk-1715100355664"></a>[公开访问的系统需仔细清理来自用户的任何输入](#2a8h-1711638847924)

<a name="gupi-1715100355666"></a>[NTP多数对时间范围达成一致，配置错误的服务器将被排除](#zcdt-1711638888096)

<a name="s0bb-1715100355668"></a>[系统模型与实现](#x4lu-1711387293192)

<a name="lodx-1715100355670"></a>[定时假设三种系统模型：](#iyps-1711639179162)

<a name="cnxz-1715100355672"></a>[同步模型synchronous model: 网络延迟，暂停和时钟漂移不会超过某个固定上限；](#pgo0-1711640511485)

<a name="fp4n-1715100355674"></a>[部分同步模型partial synchronous：大多数情况像一个同步系统一样运行，有时出现超时，进程暂停和时钟漂移界限](#h1x4-1711640383000)

<a name="5jcz-1715100355676"></a>[异步模型：一个算法不允许对实际做任何假设，事实上它甚至没有时钟。](#vkkn-1711640459345)

<a name="jm1m-1715100355678"></a>[节点系统模型：-节点失效问题](#lg5f-1711640536166)

<a name="iqwe-1715100355680"></a>[崩溃停止crash-stop:只能由崩溃失效，且永远不会回来。](#ahco-1711640498506)

<a name="ljuu-1715100355682"></a>[崩溃恢复crash-recovery: 具有稳定存储（非易失性磁盘），崩溃中保留，内存中状态会丢失-innodb三阶段提交](#35nl-1711640632666)

<a name="uvif-1715100355684"></a>[拜占庭（任意）故障：节点可以做任何事情，包括戏弄和欺骗其他节点](#rpmc-1711640822813)

<a name="eyqa-1715100355686"></a>[具有崩溃恢复的部分同步模型是最有用的模型。分布式算法如何应用这种模型](#6gea-1711640879281)

<a name="agr8-1715100355688"></a>[算法的正确性](#hwoz-1711387576180)

<a name="8snk-1715100355690"></a>[描述属性：定义算法的正确性](#i9kv-1711640972087)

<a name="h18x-1715100355692"></a>[锁生成屏蔽令牌，要求具有以下属性：](#qsck-1711641049261)

<a name="zv2u-1715100355694"></a>[唯一性：没有两个屏蔽令牌请求返回相同的值](#tvxj-1711641079676)

<a name="893g-1715100355696"></a>[单调序列：时序实现单调](#2d0a-1711641105012)

<a name="oegr-1715100355698"></a>[可用性：请求防护令牌且不会崩溃的节点，最终会收到响应](#mlbd-1711641130527)

<a name="uqy7-1715100355700"></a>[安全性和活性](#1lz8-1711387585629)

<a name="cvuk-1715100355702"></a>[澄清这种情况，需区分两种不同性质](#hctm-1711641203049)

<a name="zyzh-1715100355704"></a>[安全性safety: 唯一性和单调序列](#k48b-1711641295367)

<a name="oxwe-1715100355706"></a>[活性：可用性](#fmy7-1711641313609)

<a name="nmk9-1715100355708"></a>[将系统模型映射到现实世界](#ndiw-1711387592922)

<a name="yjxp-1715100355710"></a>[9.一致性共识](#rp9s-1705080859004)

<a name="zhdk-1715100355712"></a>[共识consensus: 让所有节点对某件事达成一致](#vrvh-1712996687843)

<a name="dtat-1715100355714"></a>[脑裂brain split: 两个节点都认为自己是master, 经常导致数据丢失；](#oqcs-1712996726634)

<a name="swdw-1715100355716"></a>[一致性保证](#obqn-1711730044966)

<a name="joe8-1715100355719"></a>[最终一致性：收敛convergence, 最终收敛到相同的值](#ku5g-1712996774138)

<a name="x5d8-1715100355721"></a>[事务一致性：避免同时执行事务导致的竞争状态](#ga60-1712996859001)

<a name="fdzh-1715100355723"></a>[分布式一致性模型：面对延迟和故障时，如何协调副本间的状态](#eovi-1712996916251)

<a name="7rya-1715100355725"></a>[线性一致性](#thyh-1711730049653)

<a name="a7gi-1715100355727"></a>[背后的想法：原子一致性atomic consistency, 强一致性strong consistency, 立即一致性 immediate consistency ,外部一致性 external consistency](#bvre-1712997165569)

<a name="auye-1715100355729"></a>[看起来只有一个数据副本，实际有多个副本 - 强一致性就是逆分布式化，看成一个整体。](#qbsw-1712997247742)

<a name="2u7k-1715100355731"></a>[线性一致是一个新鲜度保证 recency gurantee;](#f0su-1712997377059)

<a name="5h9c-1715100355733"></a>[非线性一致的例子： world cup ,  alice refresh - DB1 return germany 1: 0 argentina won ;  bob refresh website - DB2(un asychronize) return still playing;](#mtb7-1712997407717)

<a name="pfdn-1715100355735"></a>[为什么使得系统线性一致？](#qimr-1711730403998)

<a name="irog-1715100355737"></a>[例子：CAS使得多个客户端并发按序更新](#ffat-1712998155207)

<a name="vbg5-1715100355739"></a>[线性一致性与可序列化是两种完全不同的保证：](#3elk-1712997586736)

<a name="wdzh-1715100355741"></a>[可序列化serializeble: 单对象或者多对象操作，确保按照某种顺序执行](#qpvu-1712998010030)

<a name="ibfr-1715100355743"></a>[线性一致性Linearizability:是读取和写入寄存器（单个对象）的新鲜度保证，不会将操作组合为事务，不会阻止写入偏差等问题](#ojsh-1712998125336)

<a name="n7er-1715100355745"></a>[单副本强可串行性strong-1SR: 一个数据库可提供可串行性和线性一致, 基于两阶段锁2PL和实际串行执行通常是线性一致的](#5hda-1712998332148)

<a name="tmrm-1715100355747"></a>[SSI一致性快照不是线性一致的：不会包括比快照更新的写入；-不会阻塞非写的读。](#obfn-1712998432352)

<a name="49em-1715100355749"></a>[依赖线性一致性](#bje8-1711730427157)

<a name="rebd-1715100355751"></a>[锁定与领导选举](#xyll-1711730652620)

<a name="a9dm-1715100355753"></a>[领导选举的一种方法：每个节点启动时尝试获取锁，成功者称为领导者。](#2fqs-1712998599719)

<a name="u6f0-1715100355755"></a>[保证锁时线性一致的： zookeeper 和 etcd 协调服务的一致性算法。curator基于zookeeper上更高级别的配方](#cbzr-1712998723133)

<a name="o3ns-1715100355757"></a>[约束和唯一性保证](#gpva-1711730659968)

<a name="8w9y-1715100355759"></a>[这种情况类似于一个锁，锁定用户名。该操作与原子性的cas类似：](#9jmj-1712998930168)

<a name="issp-1715100355761"></a>[用户名和邮箱；](#lhyk-1712999021176)

<a name="jlxu-1715100355763"></a>[银行账号不为负数；](#7sgo-1712999031257)

<a name="sey2-1715100355765"></a>[航班剧院预定了同一时间同一位置](#so5k-1712999045093)

<a name="3jbi-1715100355767"></a>[实际应用中，处理这些限制有时可以接受。如调换位置并补偿。](#q05j-1712999070223)

<a name="yzua-1715100355769"></a>[跨信道的时序依赖](#7cbv-1711730671963)

<a name="gelp-1715100355771"></a>[将用户上传的照片降低分辨率以加快下载速度：](#cqkp-1712999245541)

<a name="kf8l-1715100355773"></a>[步骤：消息队列一般针对较短的消息而设计，一张图片可能达到几M.所以步骤为](#3zoo-1712999362806)

<a name="dwok-1715100355775"></a>[1.上传照片-  web server-2.  (store img) 存储文件服务器  ](#umkb-1712999318589)

<a name="6ojz-1715100355777"></a>[  | 3. send message  || 5.fetch full size img  6.store resized img](#er8u-1712999518585)

<a name="lcd6-1715100355779"></a>[消息队列   - 4.deliver message     image resizer](#iiv4-1712999532781)

<a name="i4gb-1715100355781"></a>[问题：存储和缩放存在两个不同的信道，没有线性一致的新鲜度保证](#0yys-1712999647965)

<a name="wtie-1715100355783"></a>[3和4可能比存储服务器内部的复制更快，当5时，可能会看到图像旧版本或者什么都没有，如果处理的是旧版本，则产生不一致。](#xtun-1712999768959)

<a name="7egz-1715100355785"></a>[实现线性一致性的系统](#ytt0-1711730433598)

<a name="ewqd-1715100355787"></a>[单主复制（可能线性一致）protential潜在线性一致：](#j997-1712999879559)

<a name="tr2e-1715100355789"></a>[快照隔离并发错误；](#t174-1712999979364)

<a name="efzb-1715100355791"></a>[脑裂；异步复制延迟，故障切换](#hh6o-1712999996439)

<a name="gvni-1715100355793"></a>[共识算法（线性一致）：共识算法可以安全实现线性一致性的存储，zookeeper 和 etcd](#z3nq-1713000050923)

<a name="jfvc-1715100355795"></a>[多主复制（非线性一致）：同时多个节点上处理写入，异步复制到其他节点，会产生冲突的写入](#q0kz-1713000066034)

<a name="khdh-1715100355797"></a>[无主复制（也许不是线性一致的）：Dynamo风格，法定人数读写获得强一致性。通常不完全正确](#ca4m-1713030167882)

<a name="ezix-1715100355799"></a>[线性一致性和法定人数](#9gst-1711730681011)

<a name="ftsk-1715100355801"></a>[最安全的做法是：假设采用Dynamo风格的无主复制的系统是不能提供线性一致性。](#sqvx-1713030399799)

<a name="nqxp-1715100355803"></a>[线性一致性的代价](#vpxf-1711730440465)

<a name="c0wz-1715100355805"></a>[CAP定理](#fqqf-1711730717308)

<a name="7dgi-1715100355808"></a>[不仅是单主多主复制的后果，任何线性一致性的数据库都有这个问题：](#8hzl-1713030564813)

<a name="7pmm-1715100355810"></a>[.应用需要线性一致性，副本因为网络问题断开连接，请求必须等到网络问题解决或直接返回错误（不可用unavailable）](#7lux-1713030592466)

<a name="imtm-1715100355812"></a>[.网络断开也可独立处理请求（如多主复制），可以在网络问题前保持可用，但其行为不是线性一致的。](#48wk-1713031150235)

<a name="mkdp-1715100355814"></a>[CAP定理没有帮助：网络分区是不可避免的，所以只能是AP 或 CP。](#lsdc-1713031249676)

<a name="gqji-1715100355816"></a>[线性一致性和网络延迟](#kxsm-1711730728177)

<a name="qjbh-1715100355818"></a>[ 线性一致的系统惊人的少。例如多核CPU并没有保证一定能读到第一个线程写入的值（除非使用内存屏障memory barrier或围栏fence）](#lbl2-1713031508671)

<a name="8rh6-1715100355820"></a>[ 牺牲线性一致性的原因是性能performance. 内存访问先走缓存，副本都是异步更新的，所以失去了线性一致性。](#pnsn-1713031585885)

<a name="culc-1715100355822"></a>[搞笑的线性一致性存储不可实现。](#8y6v-1713031685808)

<a name="2ix0-1715100355824"></a>[顺序保证](#on5f-1711730057760)

<a name="yv8o-1715100355826"></a>[写入顺序order of write: 单主复制的主要目的就是复制日志中确定写入顺序。](#dhiv-1713031758875)

<a name="lcu1-1715100355828"></a>[序列顺序serial order：某种序列顺序some sequential order](#cyfr-1713031815356)

<a name="xtjl-1715100355830"></a>[顺序与因果](#z48k-1711730472679)

<a name="1sop-1715100355832"></a>[顺序有助于保持因果关系causality](#khzl-1713031939113)

<a name="2sox-1715100355834"></a>[一致前缀读：先看到答案再看到问题。违背因cause果effect. 存在因果依赖causal dependency](#nbes-1713031966982)

<a name="bxem-1715100355836"></a>[更新不存在的记录：3位领导者间的复制，一些写入会压到其他写入。一条记录需被创建才能更新。](#xehj-1713032060272)

<a name="b82g-1715100355838"></a>[检测并发写入：A和B并发，则不知道顺序，A和B不知道彼此。](#v1kv-1713032135082)

<a name="iter-1715100355840"></a>[快照隔离：写偏差read skew，读取的数据违反因果关系（不可重复读）](#ozi8-1713032226341)

<a name="hqs3-1715100355842"></a>[事务的写偏差write skew：幻读和值班。](#pgzq-1713032264605)

<a name="7q29-1715100355844"></a>[世界杯球赛结果，跨信道的时序依赖。](#3ang-1713032756197)

<a name="hi4s-1715100355846"></a>[因果一致causally：系统服从因果关系锁规定的顺序。](#tryg-1713032788961)

<a name="b5r0-1715100355848"></a>[因果顺序不是全序的](#niwx-1711730751513)

<a name="mdtq-1715100355850"></a>[全序total order: 自然数更大或更小，总是有序的](#x8gk-1713086054855)

<a name="uis3-1715100355852"></a>[偏序partially order: 一个集合大于另一个集合，但是其它情况下无法比较](#wvsa-1713086222914)

<a name="zipw-1715100355854"></a>[线性一致性：操作是全序的，系统表现好像只有一个副本，所有操作都是原子性的。意味对每个操作总能判定发生顺序](#u7jq-1713086312064)

<a name="mufs-1715100355856"></a>[因果性：两个操作没在彼此之前发生，即并发无法比较顺序，意味着因果关系定义了一个偏序，而不是全序。一些有序一些无序](#xa0w-1713086399916)

<a name="mnm4-1715100355858"></a>[线性一致的数据存储中是不存在并发操作的。确保每个请求都是在唯一时间线上自动处理](#uaxz-1713086531138)

<a name="mg7n-1715100355860"></a>[并发意味着时间线会分叉然后合并。操作的偏序：](#qs64-1713086635361)

<a name="wezi-1715100355862"></a>[类似git系统，一个提交commit发生在另一个提交之后。分支合并merge会在这些并发创建的提交相融合时创建。](#ctkd-1713086670170)

<a name="c749-1715100355864"></a>[线性一致性强于因果一致性](#qdnf-1711730766239)

<a name="7ksb-1715100355866"></a>[线性一致性隐含implies着因果关系;](#dam4-1713086279684)

<a name="gfwb-1715100355868"></a>[捕获因果关系](#uqqx-1711730776113)

<a name="1elx-1715100355870"></a>[为了维持因果性，需确认操作发生在哪个操作之前happened before:](#agrw-1713086796608)

<a name="uryf-1715100355873"></a>[刑侦决定Y时是否知到X与Y因果关系](#rys3-1713086865582)

<a name="p2hx-1715100355875"></a>[检测并发写入：推广版本向量解决因果依赖](#znup-1713086911030)

<a name="chdp-1715100355877"></a>[SSI序列化隔离快照：事务提交时，检测读取是否最新，为此跟踪哪些事务被那些事务锁读取。](#1ivk-1713086936754)

<a name="f33q-1715100355879"></a>[序列号顺序](#jsuf-1711730485869)

<a name="sydt-1715100355881"></a>[序列号sequence number或时间戳timestamp](#y9ti-1713091524670)

<a name="ixa2-1715100355883"></a>[非因果序列号生成器](#qpya-1711730796494)

<a name="q2nz-1715100355885"></a>[兰伯特时间戳](#mtzj-1711730811106)

<a name="t0lk-1715100355887"></a>[兰伯特时间戳提供了与因果关系一致的总排序：施行一个全序](#f8uv-1713091653199)

<a name="24je-1715100355889"></a>[检测并发写入有着不同目的：区分两个操作是并发的，一个因果依赖另一个。](#2ayx-1713091789731)

<a name="d5kl-1715100355891"></a>[光有时间戳排序还不够](#elc6-1711730816628)

<a name="c18w-1715100355893"></a>[全序广播](#aw2l-1711730490423)

<a name="cnrg-1715100355895"></a>[可靠交付reliable delivery：没有消息丢失，如果消息被传递到一个节点，它将被传递到所有节点](#axul-1713091937508)

<a name="shoo-1715100355897"></a>[全序交付totally ordered delivery: 消息以相同的顺序传递给每个节点。](#cruc-1713091989510)

<a name="ue9c-1715100355899"></a>[使用全序广播](#hp3a-1711730834892)

<a name="szfu-1715100355901"></a>[zookeeper和etcd共识服务实际上实现了全序广播](#ztws-1713108978601)

<a name="wors-1715100355903"></a>[状态机复制state machine repliacation: 每个副本都按相同的顺序处理相同的写入。](#i8bk-1713109007327)

<a name="haaq-1715100355905"></a>[与之类似，使用全序广播来实现可序列化的事务：真的串行执行，确定的事务以存储过程来执行，每个节点以相同的顺序处理这些消息。](#8jch-1713109071990)

<a name="rrsp-1715100355907"></a>[以及防护令牌的锁服务，全序广播使得所有消息按顺序一次编号，序列号可当做防护令牌(单调递增)，zookeeper中这个序列号称为zxid;](#w19a-1713109204107)

<a name="xqad-1715100355909"></a>[使用全序广播实现线性一致的存储](#i3vg-1711730844593)

<a name="bcmv-1715100355911"></a>[使用线性一致性存储实现全序广播](#xlae-1711730855140)

<a name="bfkd-1715100355913"></a>[分布式事务与共识](#y1bv-1711730380233)

<a name="yhcg-1715100355915"></a>[让几个节点达成一致get serveral nodes to agree on somthing](#yt5r-1713109388776)

<a name="1nee-1715100355917"></a>[领导选举：避免脑裂](#d7t7-1713109479427)

<a name="mydq-1715100355919"></a>[原子提交atomic commit：多节点事务提交/中止/回滚](#frsp-1713109508353)

<a name="uflj-1715100355921"></a>[原子提交与两阶段提交2PC](#abk6-1711730509647)

<a name="u60u-1715100355923"></a>[原子性可以避免中间态，多对象事务原子性确保二级索引与主数据库保持一致。](#0h2f-1713110484428)

<a name="zsqs-1715100355925"></a>[从单节点到分布式原子提交](#iqfd-1711730882368)

<a name="3k22-1715100355927"></a>[从数据库的角度看，这是单独的事务，任何跨事务正确性的保证都是应用自己的问题。](#h1ym-1713110537245)

<a name="6oeb-1715100355929"></a>[2PC两阶段提交简介](#roa9-1711730906391)

<a name="58rf-1715100355931"></a>[coodinator协调子事务，子事务单独执行完，在准备阶段询问是否可提交](#vaax-1705118249954)

<a name="c2ls-1715100355933"></a>[.全部为是，则分别提交。](#7zwc-1705118288968)

<a name="ly48-1715100355935"></a>[.其中有否，则中断回滚。](#3b8s-1705118337513)

<a name="zogq-1715100355937"></a>[系统承诺](#kpgk-1711730913393)

<a name="bhdy-1715100355939"></a>[一旦协调者做出决定，这一决定是不可撤销的。](#wkui-1713110739239)

<a name="tjfz-1715100355941"></a>[协调者失败](#qhdj-1711730921387)

<a name="5o3l-1715100355943"></a>[参与者投赞成票后，参与者协调者崩溃，数据库1不知道是否提交或中止。](#jpd8-1713110804532)

<a name="jmty-1715100355945"></a>[三阶段提交](#ixzv-1711730924556)

<a name="qzqy-1715100355947"></a>[阻塞blocking原子提交协议, 2PC可能卡主等待协调者恢复的情况。](#edp3-1713111179295)

<a name="btkl-1715100355949"></a>[在提交阶段，如果子事务进程crash,或者协调者崩溃的时的解决方案，弱原子性，最终一致性。](#llyc-1711731148564)

<a name="qseb-1715100355951"></a>[许多coodinator不支持高可用或者只支持基本的复制](#nlrk-1705118500709)

<a name="yk7d-1715100355953"></a>[实践中的分布式事务](#xexf-1711730524691)

<a name="qn9b-1715100355956"></a>[云服务由于其导致的运维问题而选择不实现分布式事务。](#inqh-1713111548114)

<a name="jyby-1715100355958"></a>[两阶段难以实现安全保证，且导致的运维问题造成性能下降。](#zuho-1713111590325)

<a name="0agu-1715100355960"></a>[数据库内部的分布式事务](#gf92-1711731287296)

<a name="drk0-1715100355962"></a>[VoltDB 与mysql Cluster 的NDB引擎就有这样的内部事务支持。](#jhqw-1705080950920)

<a name="eawf-1715100355964"></a>[异构分布式事务](#gvng-1713111648038)

<a name="aekk-1715100355966"></a>[保证异构数据库的事务更有挑战性](#st60-1713111659854)

<a name="igv2-1715100355968"></a>[恰好一次的消息处理](#btdt-1711730944613)

<a name="yadk-1715100355970"></a>[XA事务eXtended Architecture](#qvbk-1711730954739)

<a name="uarf-1715100355972"></a>[怀疑时持有锁](#med0-1711730959684)

<a name="wltk-1715100355974"></a>[从协调者故障中恢复](#ouyq-1711730969007)

<a name="wc4u-1715100355976"></a>[唯一的出路是让管理员手动决定提交还是回滚事务](#ouur-1713116418144)

<a name="bzbx-1715100355978"></a>[分布式事务的限制](#gzya-1711730975747)

<a name="gwpd-1715100355980"></a>[协调者本身就是一种数据库，存储了事务的结果。](#jkt3-1713116480399)

<a name="xgih-1715100355982"></a>[协调者默认不是高可用的，只有基本的复制](#mcvv-1713116529836)

<a name="yxbl-1715100355984"></a>[应用服务器不再是无状态的了](#h6gt-1713116550997)

<a name="nmj1-1715100355986"></a>[不能检测不同系统间的死锁，且无法与SSI协同工作](#rrrl-1713116568769)

<a name="bn6c-1715100355988"></a>[与构建容错系统的目标背道而驰，分布式事务有扩大失效amplifying failures的趋势](#wbzw-1713116600081)

<a name="psbj-1715100355990"></a>[容错共识](#npne-1713118985168)

<a name="gmca-1715100355992"></a>[一个或多个节点提议propose某些值，共识算法决定decides采用其中的某个值。](#beiq-1713118985169)

<a name="jaa0-1715100355994"></a>[一致同意Uniform agreement:  没有两个节点的决定不同-核心 决定了相同的结果，一旦决定不能改变](#pq0x-1713118985170)

<a name="yczo-1715100355996"></a>[完整性Integrity: 没有节点决定两次-核心](#xnwp-1713118985171)

<a name="h8kd-1715100355998"></a>[有效性validity: 如果一个节点决定了值v, 则v由某个节点所提议-排除平凡的解决方案](#2bty-1713118985172)

<a name="ox0p-1715100356000"></a>[终止Termination由所有为崩溃的几点来最终决定值。-活性属性，必须取得进展，即使部分节点出现故障，其他节点也必须达成一致。不超过一般的节点崩溃或不可达](#9k32-1713118985173)

<a name="vkbx-1715100356002"></a>[稳健达成共识：只要少于三分之一的节点存在拜占庭故障](#scne-1713118985174)

<a name="wa7h-1715100356004"></a>[共识算法和全序广播](#prxr-1713118985175)

<a name="wcfw-1715100356006"></a>[视图戳复制VSR viewstamped repliacation, Paxos，Raft, Zab](#zmcg-1713118985176)

<a name="wx3r-1715100356008"></a>[全序广播相当于重复进行多轮共识：](#1u8f-1713118985177)

<a name="1kxo-1715100356010"></a>[一致同意属性，所有节点决定以相同的顺序传递相同的消息](#d2l2-1713118985178)

<a name="y72w-1715100356012"></a>[完整性属性，消息不会重复](#z7u4-1713118985179)

<a name="fcnn-1715100356014"></a>[有效性属性，消息不会被破坏，也不能凭空编造](#pphb-1713118985180)

<a name="vixd-1715100356016"></a>[终止属性,消息不会丢失](#gqmq-1713118985181)

<a name="xzsq-1715100356018"></a>[视图戳复制，raft和zab直接实现了全序广播，比重复一次一致one value a time的共识更高效， paxos 下这种优化称为multi-paxos.](#lxll-1713118985182)

<a name="wzdn-1715100356020"></a>[单领导者复制和共识](#krsz-1713118985183)

<a name="dt5k-1715100356022"></a>[时代编号和法定人数](#90tt-1713118985184)

<a name="qpkb-1715100356024"></a>[共识的局限性](#qywj-1713118985185)

<a name="b7tx-1715100356026"></a>[成员与协调服务](#8qzt-1713118985186)

<a name="lk1g-1715100356028"></a>[将工作分配给节点](#4tlb-1713118985187)

<a name="wj1n-1715100356030"></a>[服务发现](#tbbj-1713118985188)

<a name="hzxq-1715100356032"></a>[成员服务](#1lld-1713118985189)

...
<a name="3060-1621846615933"></a><a name="jdkc-1721843512455"></a>[一.数据库设计](#jeyl-1677787446995)

<a name="ypyn-1721843512457"></a>[1. 关系型数据库](#5hya-1677787446996)

<a name="iybe-1721843512459"></a>[.E-R图，由台湾工程师提出的设计概念](#ohc5-1621692571287)

<a name="73qc-1721843512461"></a>[.流程图-业务逻辑相关，系统用户动作。抽象出E-R图](#5ocb-1645598528868)

<a name="bx3m-1721843512463"></a>[1.1 E-R图 ](#gzqe-1677787446997)

<a name="vubk-1721843512465"></a>[1.根据名词抽象出实体](#r1ac-1621692724628)

<a name="pwa4-1721843512467"></a>[2.名词找属性](#d2fl-1621692745600)

<a name="0hux-1721843512469"></a>[3.实体间联系](#dwkp-1621692752824)

<a name="bfjp-1721843512471"></a>[.状态图](#53bo-1621692829033)

<a name="2mbg-1721843512473"></a>[1.2 转化成数据库设计（公式）](#c2cy-1677787446998)

<a name="nc3s-1721843512475"></a>[.1 对1 关系 往记录少的乙方加主键](#xmox-1621692858500)

<a name="kmjn-1721843512477"></a>[.1对n 关系 ，往 n 实体加关联主键 ](#mdr8-1621692924289)

<a name="m639-1721843512479"></a>[. n对 m 关系，需要一个关联表作映射关联](#hd3i-1621692960576)

<a name="axln-1721843512481"></a>[2.数据类型选择](#szqu-1715100194538)

<a name="scrv-1721843512483"></a>[整数类型（Integer Types）](#0rub-1715100184335)

<a name="4aqk-1721843512485"></a>[浮点数类型（Floating-Point Types）](#j4ut-1715100184343)

<a name="olxk-1721843512487"></a>[日期和时间类型（Date and Time Types）](#fjm4-1715100184359)

<a name="inbi-1721843512489"></a>[其他类型](#tofd-1715100184367)

<a name="zxgj-1721843512491"></a>[二.系统优化](#cdso-1677787447000)

<a name="29az-1721843512493"></a>[应用整体的优化](#3qep-1642647362896)

<a name="u97m-1721843512495"></a>[-cpu -> 纳秒级别](#knge-1642647371136)

<a name="6bnp-1721843512497"></a>[1.多线程和并发编程](#ovup-1704437622969)

<a name="pwtv-1721843512499"></a>[2.JNI ](#ufpl-1704437634986)

<a name="fpar-1721843512501"></a>[3.JIT/AOT编译](#ixb5-1704437634987)

<a name="h0v7-1721843512503"></a>[4.算法优化](#kr1f-1704437634988)

<a name="ufov-1721843512505"></a>[-内存RAM（GB）/高速缓存(KB) -> 微秒级别(分级缓存)](#1xur-1642647384168)

<a name="ji0n-1721843512507"></a>[1.JVM内存管理](#7hi9-1704437851514)

<a name="ljij-1721843512509"></a>[2.缓存](#te7c-1704437851799)

<a name="fu8e-1721843512511"></a>[3.消息中间件](#bqty-1704437851800)

<a name="muji-1721843512513"></a>[-磁盘（TB）-> 毫秒级别(减少io次数,减少随机io-redolog)](#ziti-1642647439005)

<a name="2c96-1721843512515"></a>[1.减少磁盘io](#zups-1704437900079)

<a name="vbpw-1721843512517"></a>[2.数据压缩   ](#u3ok-1704438035018)

<a name="cnyz-1721843512519"></a>[-网络传输/系统交互 -> 秒级 (减少io，连接池化) ](#irbp-1642647458856)

<a name="drw1-1721843512521"></a>[1.减少网络请求   ](#6qil-1704438276193)

<a name="pkpm-1721843512523"></a>[2.使用CDN](#p5dt-1704438283633)

<a name="wlcw-1721843512525"></a>[3.Sockets异步通信                                      ](#zhp8-1704438283634)

<a name="f5hw-1721843512527"></a>[项目架构层面的优化](#3l0l-1704424353262)

<a name="8vto-1721843512529"></a>[-多级缓存](#8o8s-1704424396933)

<a name="8uwa-1721843512531"></a>[-应用层](#trcg-1704438366333)

<a name="obp0-1721843512533"></a>[.代码优化](#68oa-1704438530062)

<a name="crka-1721843512535"></a>[.数据库优化](#clmf-1704438530257)

<a name="9hhv-1721843512537"></a>[.日志优化](#md03-1704438530259)

<a name="wnxh-1721843512539"></a>[-监控与调优](#ocux-1704438477879)

<a name="vdd8-1721843512541"></a>[.性能监控：](#vdq2-1704438556836)

<a name="hv6p-1721843512543"></a>[.分析和调优](#t29d-1704438557094)

<a name="2tid-1721843512545"></a>[-分布式系统架构](#ukjf-1704424419442)

<a name="wude-1721843512547"></a>[ .负载均衡](#a0bx-1704438677201)

<a name="khjw-1721843512549"></a>[.分布式缓存](#xn9x-1704438687994)

<a name="0s42-1721843512551"></a>[.服务降级和容错](#zcdp-1704438687996)

<a name="jtps-1721843512553"></a>[读写层面](#six7-1642647372926)

<a name="bglk-1721843512555"></a>[.读优化](#g4uv-1704732583614)

<a name="bqai-1721843512557"></a>[1.缓存](#uuzh-1704732602620)

<a name="8yhl-1721843512559"></a>[2.索引](#qobc-1704732605892)

<a name="tvf3-1721843512561"></a>[3.减少io/批量读/非阻塞io](#zlg9-1704732609048)

<a name="rr8t-1721843512563"></a>[4.减少多余数据加载/列式存储读](#fpjd-1704732631316)

<a name="rshp-1721843512565"></a>[.写优化](#oyob-1704732598377)

<a name="cqbj-1721843512567"></a>[1.异步写](#6jmb-1704732509150)

<a name="kiih-1721843512569"></a>[2.并发写](#tkwp-1704732723564)

<a name="gbml-1721843512571"></a>[3.批量写](#hewz-1704732862030)

<a name="nnrb-1721843512573"></a>[4.优化算法和数据结构](#ccd8-1704732727854)

<a name="51d3-1721843512575"></a>[5.缓存写](#eqd9-1704732736281)

<a name="qy9b-1721843512577"></a>[6.非阻塞io](#hyq8-1704732768916)

<a name="cfo0-1721843512579"></a>[1.分控系统优化复盘](#tncv-1677787447001)

<a name="459f-1721843512581"></a>[1.1 数据库系统](#ydq7-1677787447002)

<a name="hwck-1721843512583"></a>[1.2 sql慢](#wxdd-1677787447003)

<a name="b3ej-1721843512585"></a>[1.3 接口慢](#olpb-1677787447004)

<a name="pmek-1721843512587"></a>[高并发系统设计](#wrwk-1642647280506)

<a name="bkrg-1721843512589"></a>[1.满足大规模用户同时访问，提供良好响应时间和性能](#8ien-1704757782146)

<a name="gltj-1721843512591"></a>[2.设计之初就要考虑伸缩性和容错性是非常重要的](#xy0g-1704757785190)

<a name="stik-1721843512593"></a>[.垂直伸缩 ](#wr12-1704947861599)

<a name="bhc3-1721843512595"></a>[.水平伸缩](#bizh-1704947959744)

<a name="imne-1721843512597"></a>[1.分布式架构](#fvzi-1704756770858)

<a name="hdcp-1721843512599"></a>[.微服务架构](#ywzr-1704756872033)

<a name="7znl-1721843512601"></a>[.分布式计算](#xgna-1704756877646)

<a name="xu44-1721843512603"></a>[2.负载均衡](#wnfy-1704756775272)

<a name="mvty-1721843512605"></a>[.负载均衡](#h6nf-1704756891918)

<a name="l1ss-1721843512607"></a>[.水平扩展](#c8zr-1704756894402)

<a name="aa3p-1721843512609"></a>[3.数据库设计](#wxjk-1704756782840)

<a name="dcpc-1721843512611"></a>[.读写分离](#lxca-1704756910837)

<a name="ql2f-1721843512613"></a>[.数据库分片](#p7d2-1704756922362)

<a name="imfz-1721843512615"></a>[.缓存](#hxjt-1704756963988)

<a name="yixm-1721843512617"></a>[4.缓存优化](#iivs-1704756788012)

<a name="azyf-1721843512619"></a>[.分布式缓存](#cvui-1704756971791)

<a name="jdpt-1721843512621"></a>[.本地缓存](#ysly-1704756979122)

<a name="djel-1721843512623"></a>[.缓存预热](#rqwj-1704756986363)

<a name="cjdu-1721843512625"></a>[5.消息队列](#so9h-1704756800253)

<a name="oenf-1721843512627"></a>[.异步处理](#sxlo-1704756996000)

<a name="vphh-1721843512629"></a>[.削峰填谷](#llm2-1704757002994)

<a name="ghxq-1721843512631"></a>[6.分布式事务](#n39o-1704756805232)

<a name="cmga-1721843512633"></a>[.两阶段提交](#5bhj-1704757017700)

<a name="1boc-1721843512635"></a>[.补偿事务](#becc-1704757028036)

<a name="9cgr-1721843512637"></a>[7.高可用和容错](#wgkk-1704756813448)

<a name="0nal-1721843512639"></a>[.多地域部署](#akwz-1704757035393)

<a name="hphw-1721843512641"></a>[.设计容错](#3nxv-1704757055271)

<a name="miyh-1721843512643"></a>[1. 熔断限流](#g3xx-1704757371028)

<a name="scg5-1721843512645"></a>[2. 多节点服务](#jafy-1704757374368)

<a name="12hr-1721843512647"></a>[8.监控和性能调优](#ilyo-1704756820772)

<a name="u0ik-1721843512649"></a>[.实时监控](#kpwq-1704757064566)

<a name="wnde-1721843512651"></a>[.性能测试](#shf4-1704757066453)

<a name="ajwx-1721843512653"></a>[9.安全性设计](#2pry-1704756830245)

<a name="4tku-1721843512655"></a>[.防御性编程](#pkiw-1704757078583)

<a name="fcoi-1721843512657"></a>[.访问控制](#g4l1-1704757084924)

<a name="xrue-1721843512659"></a>[10.水平扩展](#1tsd-1704756838192)

<a name="sgl1-1721843512661"></a>[.自动化部署](#r1dd-1704757092061)

<a name="azfb-1721843512663"></a>[.云服务](#7mhk-1704757104117)

<a name="2a1m-1721843512665"></a>[高并发性能指标](#rpxb-1677787447005)

<a name="znyu-1721843512667"></a>[QPS(每秒请求)](#klnv-1704761369323)

<a name="zhmg-1721843512669"></a>[TPS(每秒事务)](#zvlz-1704761369324)

<a name="lthj-1721843512671"></a>[RT(响应时间)](#gvrn-1704761369325)

<a name="gpyr-1721843512673"></a>[(原子操作)并发编程中保证数据一致性/安全的方法](#ysmj-1709309531982)

<a name="fvpl-1721843512675"></a>[原子性+悲观锁：各种锁机制](#fdxy-1709308630108)

<a name="8sd9-1721843512677"></a>[.（锁+事务/ 分布式锁+分布式事务）](#v06l-1709312268021)

<a name="xocn-1721843512679"></a>[.  CASmysql版本号实现 (前提是数据库的update已经是原子写：mysql update排它锁）](#k0op-1709312304164)

<a name="phiz-1721843512681"></a>[原子性+乐观锁/不加锁: CAS原子操作(java原子类)，](#qth5-1709308703202)

<a name="mkhz-1721843512683"></a>[CAS底层实现原理](#g3uo-1709309147469)

<a name="fqtg-1721843512685"></a>[总线锁定（Bus Locking）：](#qpbw-1709308842021)

<a name="ecxh-1721843512687"></a>[缓存一致性协议（Cache Coherence Protocol）：](#ikm2-1709308842025)

<a name="xodv-1721843512689"></a>[指令序列化（Instruction Serialization）：](#wpeu-1709308842029)

<a name="emvt-1721843512691"></a>[不同的场景适用哪种锁](#olfu-1709309769107)

<a name="8zav-1721843512693"></a>[.共享数据的读写操作：](#y60t-1709309615585)

<a name="2sq9-1721843512695"></a>[适用措施：读写锁（ReadWrite Lock）、互斥锁（Mutex）、原子操作、无锁算法。Copy on Write优化读写锁](#lqad-1709309615587)

<a name="da5z-1721843512697"></a>[.并发容器的操作：](#fsfa-1709309615591)

<a name="bajj-1721843512699"></a>[适用措施：线程安全的容器类（如ConcurrentHashMap、ConcurrentLinkedQueue）、原子操作。](#rs2n-1709309615593)

<a name="izoh-1721843512701"></a>[.多个线程协作的场景：](#xdpv-1709309615597)

<a name="6gwj-1721843512703"></a>[适用措施：信号量（Semaphore）、条件变量（Condition Variable）。](#uzlr-1709309615599)

<a name="dei3-1721843512705"></a>[.分布式系统的并发操作：](#0aah-1709309615603)

<a name="k6bu-1721843512707"></a>[适用措施：分布式锁、分布式事务。](#wlhe-1709309615605)

<a name="cmg8-1721843512709"></a>[.不可变数据的并发访问：](#angi-1709309615609)

<a name="esae-1721843512711"></a>[适用措施：不可变数据结构、原子操作。](#pga0-1709309615611)

<a name="q43n-1721843512713"></a>[.高性能要求的并发操作：](#pw5v-1709309615615)

<a name="paea-1721843512715"></a>[适用措施：无锁算法、并发数据结构。 -CAS乐观锁](#plv6-1709309615617)

<a name="3uok-1721843512717"></a>[互斥访问：](#62mg-1709309976431)

<a name="gl92-1721843512719"></a>[.互斥锁（Mutex）：](#0qt3-1709307350160)

<a name="2tru-1721843512721"></a>[.原子操作：](#7xva-1709307350164)

<a name="svex-1721843512723"></a>[.临界区（Critical Section）：](#r8cl-1709307350168)

<a name="097y-1721843512725"></a>[.读写锁（ReadWrite Lock）：主要用于避免脏读](#occj-1709307350172)

<a name="iw3i-1721843512727"></a>[.信号量（Semaphore）：](#vej9-1709307350176)

<a name="fepn-1721843512729"></a>[.条件变量（Condition Variable）：](#ssge-1709307350180)

<a name="rpba-1721843512731"></a>[.无锁算法（Lock-Free Algorithms）：](#zk0j-1709307350184)

<a name="odga-1721843512733"></a>[.数据拷贝-写时复制（Copy-on-Write）：优化读写锁，写时复制且串行执行(锁)，读不加锁](#tiqo-1709307350188)

<a name="avsh-1721843512735"></a>[.线程安全的数据结构：](#b8ca-1709307350192)

<a name="6s5c-1721843512737"></a>[===系统架构设计师===](#nyrv-1709307688718)

<a name="whq5-1721843512739"></a>[系统工程与信息系统基础](#mpwu-1704949756608)

<a name="i7cl-1721843512741"></a>[.系统工程方法](#2gzz-1704980837071)

<a name="46ls-1721843512743"></a>[.系统工程生命周期阶段](#mk93-1704952875199)

<a name="jtfn-1721843512745"></a>[.系统工程生命周期方法](#ny2c-1704952893636)

<a name="u2sb-1721843512747"></a>[.信息系统建设原则](#shmt-1704952904062)

<a name="lvui-1721843512749"></a>[.信息系统开发方法](#itje-1704951812273)

<a name="12w7-1721843512751"></a>[原型法](#bnzq-1705819374009)

<a name="f2vk-1721843512753"></a>[结构化法-瀑布型](#ujj3-1705819377863)

<a name="wdq2-1721843512755"></a>[形式化法-数模](#8wek-1705819398251)

<a name="euwy-1721843512757"></a>[敏捷方法](#jeuk-1705819392097)

<a name="jbdm-1721843512759"></a>[.信息系统分类](#w8yd-1704980881013)

<a name="qbdk-1721843512761"></a>[业务处理系统TPS](#hlhq-1705819204285)

<a name="aquh-1721843512763"></a>[管理信息系统MIS](#oksn-1705819204735)

<a name="r0cx-1721843512765"></a>[决策支持系统DSS](#lwm7-1705819204736)

<a name="uonr-1721843512767"></a>[专家系统ES](#bmeu-1705819204737)

<a name="wgyf-1721843512769"></a>[办公自动化系统OAS](#kffq-1705819204738)

<a name="ga0p-1721843512771"></a>[企业资源系统ERP](#k2px-1705819204739)

<a name="r0sr-1721843512773"></a>[过程模型](#f98t-1704981918920)

<a name="rbwe-1721843512775"></a>[瀑布模型](#yk4j-1705841608124)

<a name="iqdv-1721843512777"></a>[V模型【瀑布变种-测试贯穿】](#oryp-1705841608705)

<a name="fuwa-1721843512779"></a>[原型模型](#b0cp-1705841621350)

<a name="knfz-1721843512781"></a>[螺旋模型【原型+瀑布 风险】](#sfqi-1705841608707)

<a name="m0fu-1721843512783"></a>[构件组装模型/基于构件的开发方法](#kbjw-1705841608709)

<a name="sap6-1721843512785"></a>[快速应用开发RAD【瀑布+构件组装】](#mvze-1705841627436)

<a name="jdl4-1721843512787"></a>[统一过程/统一开发方法](#xici-1705841629815)

<a name="kl3w-1721843512789"></a>[敏捷开发方法](#9jca-1705841608711)

<a name="nexy-1721843512791"></a>[XP](#28va-1705841590197)

<a name="dsbv-1721843512793"></a>[Scrum](#fyfq-1705938223773)

<a name="vocn-1721843512795"></a>[逆向工程](#d5ko-1705938215067)

<a name="bfkl-1721843512797"></a>[实现级](#os3c-1706090901666)

<a name="xosk-1721843512799"></a>[结构级](#irxb-1706090905276)

<a name="w5vx-1721843512801"></a>[功能级](#rk8d-1706090908958)

<a name="mnue-1721843512803"></a>[领域级](#k3pt-1706090912460)

<a name="fxau-1721843512805"></a>[净室软件工程](#tybd-1705938215235)

<a name="awgp-1721843512807"></a>[需求工程](#ochn-1705940085547)

<a name="uh9d-1721843512809"></a>[.需求获取](#xdlf-1705940054108)

<a name="zexy-1721843512811"></a>[用户面谈 ](#s1uq-1706090846730)

<a name="w2jp-1721843512813"></a>[联合需求计划(JRP) ](#vuil-1706090851858)

<a name="jsqb-1721843512815"></a>[问卷调查 ](#gpxg-1706090851859)

<a name="c5ui-1721843512817"></a>[现场观察   ](#mg9n-1706090851860)

<a name="r8e2-1721843512819"></a>[原型化方法        ](#3ww6-1706090851861)

<a name="xgsw-1721843512821"></a>[头脑风暴法](#0awr-1706090851863)

<a name="qviz-1721843512823"></a>[.需求分析](#axny-1705940052332)

<a name="bwle-1721843512825"></a>[1.功能模型(数据流图DFD)](#v8wz-1706090812929)

<a name="gaxw-1721843512827"></a>[2.行为模型(状态转换图)](#3uls-1706090814821)

<a name="yppz-1721843512829"></a>[3.实体模型(E-R图)](#69df-1706090816407)

<a name="pja6-1721843512831"></a>[UML](#loq2-1705940640473)

<a name="nwoq-1721843512833"></a>[需求定义](#4aeg-1706091062964)

<a name="kmsa-1721843512836"></a>[需求验证](#ud2s-1706090947930)

<a name="fgxy-1721843512838"></a>[需求跟踪](#l03x-1705940634470)

<a name="murg-1721843512840"></a>[需求变更管理](#muqf-1706093218719)

<a name="tgwf-1721843512842"></a>[软件系统建模](#ilpb-1706093190683)

<a name="csdh-1721843512844"></a>[软件界面设计](#j396-1706094675778)

<a name="6vut-1721843512846"></a>[结构化设计](#vqsk-1706094478028)

<a name="bc5s-1721843512848"></a>[内聚](#jczo-1706095018132)

<a name="q6zn-1721843512850"></a>[耦合](#qa8z-1706095402118)

<a name="0s2x-1721843512852"></a>[模块四要素](#g1dc-1706095391028)

<a name="wl8m-1721843512854"></a>[面相对象设计](#ydwa-1706095870710)

<a name="hhzp-1721843512856"></a>[类的分类](#fouz-1706095958643)

<a name="98gn-1721843512858"></a>[基本过程](#9pd1-1706095996137)

<a name="770u-1721843512860"></a>[设计原则(同设计模式)](#k8lc-1706096001163)

<a name="ae5t-1721843512862"></a>[计算机](#qvol-1706095952165)

<a name="bf9p-1721843512864"></a>[计算机结构(★)](#ef1b-1706108352037)

<a name="jddi-1721843512866"></a>[存储系统(★★★★)](#4kj7-1706108373776)

<a name="xwr0-1721843512868"></a>[层次化存储结构](#ucta-1706109825295)

<a name="9ush-1721843512870"></a>[Cache](#j9hn-1706109828962)

<a name="xchv-1721843512872"></a>[主存编址计算](#pv51-1706109847372)

<a name="qcd4-1721843512874"></a>[磁盘基本结构与存储过程](#jcqv-1706108377026)

<a name="qcts-1721843512876"></a>[磁盘优化分布存储](#puux-1706111215530)

<a name="fc1n-1721843512878"></a>[磁盘单缓冲区与双缓冲区读取](#dvin-1706111222861)

<a name="bjjp-1721843512880"></a>[磁盘移臂调度算法](#jr2r-1706111239137)

<a name="gxvf-1721843512882"></a>[数据传输控制方式（★)](#sz2k-1706111188014)

<a name="z54u-1721843512884"></a>[总线（★★)](#cbul-1706108378755)

<a name="0kvt-1721843512886"></a>[CISC与RISC(★)](#0hb5-1706108373778)

<a name="w3ty-1721843512888"></a>[流水线(★★)](#ernn-1706108380109)

<a name="udrl-1721843512890"></a>[校验码(★)](#grix-1706108381278)

<a name="ie2y-1721843512892"></a>[嵌入式（★)](#1p2v-1706108382511)

<a name="zlzk-1721843512894"></a>[计算机网络](#8vmt-1706198382356)

<a name="vv0t-1721843512896"></a>[TCP/IP协议族(7层/4层网络模型)](#a4es-1706106975412)

<a name="mkeb-1721843512898"></a>[.TCP与UDP (★★★)](#vwim-1706198561289)

<a name="wvih-1721843512900"></a>[.DHCP与DNS (★★★)](#imsh-1706198537828)

<a name="0bs1-1721843512902"></a>[网络规划与设计](#u7sd-1706198559304)

<a name="zgs5-1721843512904"></a>[1.逻辑设计与物理设计(★★★★）](#nov8-1706198591905)

<a name="nzlj-1721843512906"></a>[2.层次化网络设计](#sy2g-1706198599196)

<a name="hdns-1721843512908"></a>[3.网络冗余设计](#igl7-1706257923205)

<a name="3iha-1721843512910"></a>[网络存储（★★)](#zkxb-1706257899477)

<a name="r9oj-1721843512912"></a>[磁盘阵列Raid](#fxma-1706198636789)

<a name="miwl-1721843512914"></a>[lPv6 (★)](#vlem-1706259832461)

<a name="fxcu-1721843512916"></a>[网络接入(有线/无线)](#g438-1706198637653)

<a name="wdk4-1721843512918"></a>[综合布线(★)](#lxli-1706198497856)

<a name="yvdj-1721843512920"></a>[网络技术扩展](#5dlt-1706198650540)

<a name="oh1r-1721843512922"></a>[物联网(IOT)](#jgll-1706198586849)

<a name="xrao-1721843512924"></a>[云计算(Saas/Paas/Iaas)](#pr8x-1706198586851)

<a name="dpvf-1721843512926"></a>[===系统架构设计case===](#1rnn-1706941312871)

<a name="xjad-1721843512928"></a>[google L5设计一个分布式数据库架构](#nm5q-1706969255961)

<a name="ch3u-1721843512930"></a>[.what is total ordering(ordering first 100 custormer)](#g7yu-1707229908505)

<a name="qs7j-1721843512932"></a>[.why single leader()](#ebxf-1707230056989)

<a name="yga5-1721843512934"></a>[.request router](#ttmg-1707230034624)

<a name="urpu-1721843512936"></a>[.variations](#aftd-1707229925082)

<a name="k8hf-1721843512938"></a>[1.Failover handing](#uk2k-1707457488655)

<a name="onrt-1721843512940"></a>[2.Reblancing after new node added](#btbd-1707457496651)

<a name="zbjm-1721843512942"></a>[3.Leaderless for heavy write-shard](#moaq-1707457524278)

<a name="mlbb-1721843512944"></a>[4.TicketMasler (and total ordering is necessary](#wyvq-1707458882987)

<a name="jjcb-1721843512946"></a>[===数据密集型应用===](#sswx-1706094478181)

<a name="aebh-1721843512948"></a>[第一部分 数据系统的基石](#unbe-1677787447006)

<a name="tymd-1721843512950"></a>[1.可靠性、可拓展性、可维护性能](#kwfx-1677787447007)

<a name="hmdi-1721843512952"></a>[-功能性需求：CRUD](#lykw-1644227240038)

<a name="u38n-1721843512954"></a>[-非功能性需求：安全性，可靠性，合规性，可扩展性，兼容性和可维护性](#b2tu-1644227249556)

<a name="yguw-1721843512956"></a>[.可靠性：](#qqm5-1644227303238)

<a name="hqjo-1721843512958"></a>[硬件故障](#7xms-1644228225080)

<a name="h24b-1721843512960"></a>[软件错误](#dfpv-1708357497902)

<a name="ckuh-1721843512962"></a>[人为错误(如何让系统变得可靠)](#drpl-1708357507365)

<a name="yuyb-1721843512964"></a>[如何让系统变得可靠：](#pqmh-1708523552230)

<a name="2cr9-1721843512966"></a>[。最小化犯错机会的方式设计系统,  但如果限制太多，人们可能会忽略它们的好处而绕开，很难把握其中微妙的平衡](#i4we-1708358144376)

<a name="9uyo-1721843512968"></a>[。在易错地方和可能导致失效的地方解耦decouple,提供非生产环境沙箱sandbox-虚拟化环境，隔离真实系统进行安全测试](#xzfa-1708358243121)

<a name="n0tr-1721843512970"></a>[。彻底的测试，单元测试，集成测试，手动测试，自动化测试覆盖边缘场景corner case.](#9jaa-1708358634289)

<a name="cnyz-1721843512972"></a>[。滚动发布，快速回滚](#zlp4-1708358698137)

<a name="gorh-1721843512974"></a>[。配置详细和明确的监控](#40us-1708358954660)

<a name="awtz-1721843512976"></a>[。良好的管理和充分的培训。一个复杂而重要的方面，但超出本书的范围](#o66x-1708358967000)

<a name="pq2i-1721843512978"></a>[可靠性有多重要](#x7co-1708357515795)

<a name="fyn0-1721843512980"></a>[造成客户巨大损失-阿里云宕机造成的用户损失](#nc0w-1708358745350)

<a name="aqdy-1721843512982"></a>[家长将孩子照片存储在你的应用李，数据库损坏，客户有何体验，他们可能会知道如何从备份恢复吗？](#qopp-1708358856827)

<a name="vn6r-1721843512984"></a>[.可扩展性： ](#dsae-1708357483848)

<a name="zmjy-1721843512986"></a>[描述负载(tps-推特主页时间线扇出-查询性能优化)](#vja4-1708356470840)

<a name="jxgx-1721843512988"></a>[描述性能](#s6un-1708356581594)

<a name="xadh-1721843512990"></a>[吞吐量throughput](#fcez-1708523606684)

<a name="te3g-1721843512992"></a>[响应时间 response time.](#k30f-1708523620292)

<a name="wkgn-1721843512994"></a>[响应时间的高位百分点（也称为尾部延迟tail latencies](#bogk-1708523658968)

<a name="tzas-1721843512996"></a>[.可维护性：](#k1dg-1708355783343)

<a name="c11v-1721843512998"></a>[2.数据模型与查询语言](#jufm-1677787447008)

<a name="dncx-1721843513000"></a>[-关系模型](#pgu6-1699844351041)

<a name="3lak-1721843513002"></a>[-NoSql (es,redis)](#kfpd-1644410618294)

<a name="7j5h-1721843513004"></a>[1.文档数据库:MongoDB](#0p23-1644410807294)

<a name="olzt-1721843513006"></a>[  2.图形数据库 ：](#09bl-1644410666587)

<a name="5cjq-1721843513008"></a>[-其它模型(基因序列)](#6fxw-1644410924417)

<a name="li12-1721843513010"></a>[3.存储与检索](#sm0u-1677787447009)

<a name="hfq5-1721843513012"></a>[-优化事务处理（OLTP）transaction ](#bhcv-1644935436804)

<a name="tcii-1721843513014"></a>[1.OLTP系统通常面向用户，大量的请求。](#tbhw-1699844517372)

<a name="lfri-1721843513016"></a>[2.磁盘寻道时间往往是这里的瓶颈。](#fnev-1644935714127)

<a name="wgks-1721843513018"></a>[3.应用程序使用某种键来请求记录，存储引擎使用索引来查找所请求额键的数据。](#cjwp-1644935609899)

<a name="6vut-1721843513020"></a>[-优化分析（OLAP）analys](#jg7s-1699844443567)

<a name="krxr-1721843513022"></a>[1.列式储存(投影操作，压缩技术，聚合过滤)](#pjd1-1703887811615)

<a name="umpm-1721843513024"></a>[-OLTP两大主流学派的存储引擎：](#8sgm-1644935924013)

<a name="nvnx-1721843513026"></a>[1.日志结构学派](#i55y-1644935943748)

<a name="nf4k-1721843513028"></a>[2.就地更新学派](#h3il-1644935977285)

<a name="7yjs-1721843513030"></a>[4.编码（序列化）与演化(XML,JSON,CSV)](#lbs1-1677787447010)

<a name="c0bn-1721843513032"></a>[第二部分 分布式数据](#4p9n-1677787447012)

<a name="os9d-1721843513034"></a>[1.高可用性/容错](#o4ag-1646310813851)

<a name="wxta-1721843513036"></a>[2.断开连接的操作](#snwm-1646310894841)

<a name="jef9-1721843513038"></a>[3.减少延迟(节点近)](#evly-1646310918322)

<a name="ibp6-1721843513040"></a>[4.可拓展性](#itsh-1646310968967)

<a name="psqz-1721843513042"></a>[.拓展至更高的载荷](#gjis-1708362947856)

<a name="xxk8-1721843513044"></a>[垂直扩展scale up ：购买更强大的机器 cpu](#mgia-1708362999715)

<a name="ukyl-1721843513046"></a>[共享内存架构shared-memory architecture：许多处理器、内存和磁盘再同一操作系统下相互连接，共享内存和磁盘](#pdo8-1708363038596)

<a name="ks5x-1721843513048"></a>[共享磁盘share-disk architecture：独立处理器和内存，数据存储在机器之间共享的磁盘阵列上，磁盘通过快速网络连接。数仓](#wgwl-1708363065800)

<a name="hb6f-1721843513050"></a>[无共享架构](#klw2-1708363340866)

<a name="dvf7-1721843513052"></a>[.复制VS分区](#gbgq-1646311175182)

<a name="ipjf-1721843513054"></a>[5.复制](#gd4q-1708363438406)

<a name="cr0y-1721843513056"></a>[.领导者与追随者-单主复制](#9hbs-1708441077626)

<a name="2stj-1721843513058"></a>[客户端将所有写入操作发送到单个节点（领导者），该结点将数据更改事件流发送到其它副本（追随者）。](#aucb-1708528116000)

<a name="mwie-1721843513060"></a>[读取可以再任何副本中执行，但从追随者读取可能是陈旧的 （最终一致性问题）](#wgge-1646311567456)

<a name="sg1u-1721843513062"></a>[.同步复制与异步复制](#cbey-1646310922523)

<a name="t3n5-1721843513064"></a>[.设置新从库(快照复制+caught up binlog)](#j5o0-1704983008475)

<a name="04ne-1721843513066"></a>[.处理宕机节点](#bcod-1708442233018)

<a name="xmje-1721843513068"></a>[从库失效：追赶恢复](#5ufz-1708443850274)

<a name="opmh-1721843513070"></a>[主库失效：故障切换failover](#udix-1708443860752)

<a name="5td7-1721843513072"></a>[自动切换步骤：1.确认主库失效](#w3sj-1708523445192)

<a name="vv1p-1721843513074"></a>[2.选举新主库：共识](#y3qn-1708523480847)

<a name="glx9-1721843513076"></a>[3.配置系统启用新主库](#wua6-1708523497956)

<a name="im4h-1721843513078"></a>[failover的麻烦：1.异步复制数据丢失](#z7mn-1708523814309)

<a name="cnpf-1721843513080"></a>[2.自增主键冲突](#mnjx-1708523836932)

<a name="sipa-1721843513082"></a>[3.脑裂split brain](#dbhg-1708523873194)

<a name="bt9t-1721843513084"></a>[4.如何设置超时](#561v-1708523878338)

<a name="ucgm-1721843513086"></a>[.复制日志的实现](#8mem-1708442228760)

<a name="2wvw-1721843513088"></a>[基于语句的复制(每个写入请求语句statment)](#k8yo-1708524004340)

<a name="nhgy-1721843513090"></a>[记录每个写入请求语句statment，语句日志传输给从库](#hcqe-1708524155632)

<a name="4r34-1721843513092"></a>[问题：非确定函数nondeterministic, NOW()  RAND()](#9xml-1708524182083)

<a name="hpvd-1721843513094"></a>[    自增列- 造成差异](#il4a-1708524271564)

<a name="mrhd-1721843513096"></a>[副作用的语句：用户自定义函数，触发器，存储过程](#azmh-1708524331636)

<a name="ymnw-1721843513098"></a>[解决: 用固定值替换](#rcfb-1708524371120)

<a name="eaom-1721843513100"></a>[  如语句存在任何不确定性，切换到基于行的数据](#6uy2-1708524426849)

<a name="r7yh-1721843513102"></a>[传输预写式日志(WAL)](#rnmz-1708524013585)

<a name="qzds-1721843513104"></a>[日志存储引擎SSTables LSM树](#hze4-1708524498278)

<a name="ladr-1721843513106"></a>[磁盘块的B树  WAL, 崩溃恢复](#qzop-1708524541132)

<a name="p1su-1721843513108"></a>[逻辑日志复制(基于行)](#a3ng-1708524040960)

<a name="3s8e-1721843513110"></a>[binlog](#jiiu-1708524648209)

<a name="5kas-1721843513112"></a>[基于触发器的复制](#ezoi-1708524083973)

<a name="yvhb-1721843513117"></a>[.复制延迟问题(解决方法都是反分布式，或者趋于单机一致性。数据一致性模型：https://jepsen.io/consistency)](#https://jepsen.io/consistency)

<a name="2jzy-1721843513119"></a>[读己之写(读主库或带写时间戳查询)](#w5nz-1708525244967)

<a name="zbbh-1721843513121"></a>[写后从旧副本读取数据-未同步  ](#25nj-1708526407050)

<a name="pk8n-1721843513123"></a>[解决：写后读read after write 一致性 或叫做 read your write consistency 防止这种异常](#4st1-1708525569674)

<a name="cl0m-1721843513125"></a>[1.都从主库读。适用仅由用户本人编辑的数据，如个人信息。大部分内容从主库读不适用，扩容读无效果](#v4r0-1708525736897)

<a name="buy5-1721843513127"></a>[2. 扩容读需要保证更新时间，监控复制延迟，防止滞后超过一分钟从从库发出查询](#vqjs-1708525818133)

<a name="zseu-1721843513129"></a>[3. 客户端记录写入时间戳，系统确保从库提供查询时，版本时间已覆盖，否则从另一个从库读，或者等待caught up-  等待不就相当弱可用状态，且时钟不可靠](#nmrh-1708525971734)

<a name="wplz-1721843513131"></a>[4. 副本在多个数据中心，复杂度高，都需经过主库IDC](#wmu9-1708526095856)

<a name="ajh2-1721843513133"></a>[单调读(基于id散列路由同一副本)](#kwrd-1708525264596)

<a name="aowe-1721843513135"></a>[先读到最新副本，后读到旧副本感觉数据消失](#npwe-1708527802311)

<a name="93sm-1721843513137"></a>[A看到B评论后消失，时光倒流moving backward in time ](#4cn0-1708526272081)

<a name="etap-1721843513139"></a>[解决：单调读monotonic reads总是从同一个副本进行读取(基于用户散列id，如果副本失效则重新路由)](#drqk-1708526396300)

<a name="08gi-1721843513141"></a>[  比强一致性(同步复制/类比单机)弱，比最终一致性更强](#s6u3-1708526566643)

<a name="uvzs-1721843513143"></a>[一致前缀读(因果关系写到相同分区)](#bfps-1708525268614)

<a name="7ncu-1721843513145"></a>[consistent prefix reads](#q7p0-1711363121071)

<a name="et17-1721843513147"></a>[不同分片副本同步先后问题导致读顺序错误](#rqcm-1708527879976)

<a name="prak-1721843513149"></a>[分区partition/分片sharded数据库中的一个特殊问题，全局写入顺序](#bwov-1708526677620)

<a name="ushr-1721843513151"></a>[分区主库1写入 A:你吃饭了吗？ 分区主库2写入B:没有。 分区1副本同步主库1落后分区2副本同步主库2    C读取1副本: 没有，后读取2副本。你吃饭了吗？](#7e9o-1708526727984)

<a name="xovn-1721843513153"></a>[解决：确保因果关系都写入到相同分区](#turn-1708527108521)

<a name="zizp-1721843513155"></a>[复制延迟解决方案](#a2la-1708525420248)

<a name="d37g-1721843513157"></a>[趋于反分布式，局部或者部分看做一个单机，做到强一致性](#x8ng-1708527233293)

<a name="92ja-1721843513159"></a>[写后读。](#gecf-1708527304184)

<a name="ijbv-1721843513161"></a>[数据库通过事务提供强大保证。](#zsq6-1708527307246)

<a name="khxi-1721843513163"></a>[.多主复制(主主复制，互为副本-写冲突。多主复制被认为是危险的领域)](#pbfd-1708528009698)

<a name="fgie-1721843513165"></a>[多主复制的应用场景](#kxkx-1708441627686)

<a name="j1cx-1721843513167"></a>[运维多个数据中心(IDC-主主间复制需要处理写冲突）](#xrso-1708700002291)

<a name="bhad-1721843513169"></a>[性能(多活配置，写操作在本地IDC处理，其他IDC异步复制，性能更好)](#06t6-1708700132681)

<a name="mlkp-1721843513171"></a>[容忍IDC停机](#9sww-1708700267631)

<a name="d2bs-1721843513173"></a>[容忍网络问题(临时的网络中断不会妨碍正在写入的处理)](#dtkl-1708700295371)

<a name="7qlt-1721843513175"></a>[需要离线操作的客户端(支持多个终端离线操作couchDB)](#knxa-1708700020273)

<a name="yppm-1721843513177"></a>[协同编辑](#hvwb-1708700115895)

<a name="7z9e-1721843513179"></a>[处理写冲突(A将标题从1改2,B将1改3)](#fdot-1708700612321)

<a name="ibeg-1721843513181"></a>[同步于异步冲突检测](#u8bc-1708700824251)

<a name="fzn4-1721843513183"></a>[同步：单主程序复制 - 不允许每个副本独立接受写入](#wfgd-1708700957597)

<a name="x7q0-1721843513185"></a>[异步：独立接受写入- 异步检测，但为时已晚](#x6is-1708701017804)

<a name="yvbg-1721843513187"></a>[避免冲突(特定记录写入都通过同一个领导者，主库切换或者用户迁移至更近的主库时会有同时写入的可能性)](#xg2a-1708700840681)

<a name="btxp-1721843513189"></a>[收敛convergent至一致的状态(副本主库和其副本在复制完成时收敛至一个相同的最终值)](#ucfn-1708700844474)

<a name="re0h-1721843513191"></a>[最后写入胜利LWW,last write wins- 给每个写入一个唯一id, 挑选最高ID的写入作为胜利者，并丢弃其他写入-数据丢失](#cbla-1708701376316)

<a name="rmx9-1721843513193"></a>[为每个副本分配一个唯一ID,ID编号更高的具有高优先级。数据丢失](#40po-1708701481447)

<a name="yz5h-1721843513195"></a>[将值合并在一起](#p4m4-1708701593939)

<a name="dwbq-1721843513197"></a>[记录冲突，并编写解决逻辑代码。如通过提醒用户方式](#8fcs-1708701611999)

<a name="gj9h-1721843513199"></a>[自定义冲突解决逻辑](#yrdi-1708700860148)

<a name="fizd-1721843513201"></a>[自定义冲突解决逻辑(complex)](#t4i7-1708702160004)

<a name="xxpj-1721843513203"></a>[写时执行-后台处理](#pdql-1708702370625)

<a name="aqcc-1721843513205"></a>[读时执行-提供多版本用户选择，回写数据库](#sksk-1708702376293)

<a name="0bxn-1721843513207"></a>[亚马逊购物车移除的商品重新出现](#4bqp-1708702425059)

<a name="h9jl-1721843513209"></a>[什么是冲突(两个领导者预订同一个会议室，7章看冲突实例12章看检测解决)](#6x4i-1708700867996)

<a name="wst4-1721843513211"></a>[多主复制拓扑](#o41a-1708702111509)

<a name="tb2d-1721843513213"></a>[环形，星型，all to all -mysql仅支持环形](#5feh-1708702903239)

<a name="qhxl-1721843513215"></a>[问题：多主复制时，可能在某些副本中写入错误的顺序。like A写主库1，B写主库2，主库3先同步2，再同步1。类似一致前缀读。](#ddyu-1708702949257)

<a name="seen-1721843513217"></a>[解决：时间戳是不够的-不可靠时钟，使用一种称为版本向量(version vectors)的技术-检测并发写入](#ghp3-1708703247102)

<a name="kqnj-1721843513219"></a>[无主复制leaderless](#bfz8-1708759285067)

<a name="rmys-1721843513221"></a>[Amazon的Dynomo系统。](#cvru-1708759359537)

<a name="hwbh-1721843513223"></a>[Riak, Cassandra，Voldmort 也称为Dynamo风格。](#wf6o-1708759707666)

<a name="b5nu-1721843513225"></a>[类型1：客户端直接将写入发送到几个副本中](#xpqf-1708760120711)

<a name="agfk-1721843513227"></a>[类型2：coordinator协调者节点代表客户端写入。](#pl2z-1708760121090)

<a name="fchb-1721843513229"></a>[当节点故障时写入数据库(仲裁写⼊，法定读取，并在节点中断后读修复。)](#qgpe-1708760989905)

<a name="esmo-1721843513231"></a>[如果主从复制，主故障/重启系统更新 则需进行故障切换](#zfuz-1708760396929)

<a name="icoq-1721843513233"></a>[无主复制： userA set piture_url   -> replica1 ok    Then version=7](#3soj-1708760452090)

<a name="nuly-1721843513235"></a>[           user set piture_url   -> replica2 ok  Then version=7](#4f05-1708760543198)

<a name="fujs-1721843513237"></a>[user set piture_url   -> replica3 offline  fail   version= 6](#ynls-1708759898772)

<a name="i2bl-1721843513239"></a>[    userB get piture  :  rp3(version6) rp1(version7)  rp2(version7)  Than fix rp3 value to version7](#e1ur-1708760618873)

<a name="ty4x-1721843513241"></a>[ 读修复和反熵(失效节点重新连机后如何caught up)](#tyv3-1708760780373)

<a name="ygzv-1721843513243"></a>[读修复like userB get piture fixed rp3](#wjho-1708761214792)

<a name="hhrl-1721843513245"></a>[反熵 后台进程不断查找副本之间的数据差异。Voldmort无反熵过程，副本可能丢失数据](#xblj-1708761286988)

<a name="dvzl-1721843513247"></a>[ 读写的法定人数（仲裁）](#w3ia-1708761120623)

<a name="ljug-1721843513249"></a>[仲裁一致性的局限性-最终一致，更强的保证需要事务或共识](#oj1i-1708759830121)

<a name="kuab-1721843513251"></a>[松散法定人数与带提示的接力](#cu5q-1708759841416)

<a name="bcwg-1721843513253"></a>[运维多个数据中心-将写入发送到所有副本，仅需本地IDC内法定节点确认](#kzki-1708761744887)

<a name="hk8f-1721843513255"></a>[检测并发写入](#pt1k-1708759856530)

<a name="jrau-1721843513257"></a>[Dynamo风格的数据存储，没有明确定义的顺序。](#mu89-1708761978075)

<a name="ga46-1721843513259"></a>[userA set x=A   get x](#dbni-1708763823783)

<a name="naak-1721843513261"></a>[rp 1 A ok    B unresponsive   A](#auce-1708763993783)

<a name="dxad-1721843513263"></a>[rp2 A ok   B OK  B](#kteo-1708764011894)

<a name="vymo-1721843513265"></a>[rp3 B ok A ok A](#9xyy-1708764019308)

<a name="u8ns-1721843513267"></a>[userB set x=B ](#esiv-1708702764305)

<a name="sz7d-1721843513269"></a>[最后写入胜利(丢弃并发写入)](#wd1i-1708764197180)

<a name="giot-1721843513271"></a>[LLW 无法确定真实排序，强制排序，选择最新的最大时间戳，并丢弃较早的任何写入.Cassandra唯一支持的方式，Riak可选](#uzhw-1708874432788)

<a name="pstx-1721843513273"></a>[缺点：数据丢失 ](#henp-1708874594301)

<a name="dpfj-1721843513275"></a>[此前发生的关系和并发](#hzwp-1708764215825)

<a name="uvwv-1721843513277"></a>[因果依赖(causally dependent)  如果B后发与A, 则B因果依赖A, ](#3wp0-1708874672763)

<a name="4nzx-1721843513279"></a>[如果是并发，则存在需要解决的冲突](#1wzv-1708875051673)

<a name="zu3l-1721843513281"></a>[捕获此前发生的关系](#j2r6-1708764228505)

<a name="gdr3-1721843513284"></a>[捕获两个客户端间的因果关系，同时编辑购物车(示例为单副本)](#vv7q-1708875756229)

<a name="vpt4-1721843513286"></a>[合并同时写入的值](#zp0i-1708874374616)

<a name="zy3k-1721843513288"></a>[客户端需额外工作，合并并发写入的值来擦屁股。Riak称这些并发值兄弟(sibings)](#wawo-1708876272614)

<a name="0r4o-1721843513290"></a>[版本向量](#arlv-1708874381589)

<a name="pnsx-1721843513292"></a>[所有副本的版本号集合称为版本向量(version vector)](#b1ov-1708700703636)

<a name="dqlv-1721843513294"></a>[6.分区](#dyz5-1709800112532)

<a name="o6ze-1721843513296"></a>[.分区与复制(分区与复制方案是独立的)](#twd1-1709800204792)

<a name="bhfj-1721843513298"></a>[.键值数据的分区](#fbqg-1709800263679)

<a name="eahy-1721843513300"></a>[偏斜skew：分区过多数据或过多查询](#s7ju-1709801062977)

<a name="u0xq-1721843513302"></a>[热点hot spot:高负载的分区](#u0d3-1709801107270)

<a name="nzfs-1721843513304"></a>[根据键的范围分区](#lqbu-1709800332210)

<a name="rjsy-1721843513306"></a>[Bigtable, HBase, RethinkDB 和 MongoDB2.4](#i2ju-1709801151406)

<a name="fpkt-1721843513308"></a>[按照一定的顺序保存键（SSTbale和LSM-树）](#np00-1709801582805)

<a name="3ly0-1721843513310"></a>[按时间分区当日写过载（需加传感器保证日期+传感主键均匀分布）](#evhb-1709801683166)

<a name="ror7-1721843513312"></a>[根据键的散列分区(可将偏斜数据均匀分布)](#a1yy-1709800347130)

<a name="mvft-1721843513314"></a>[不适合分区的简单哈希函数：java .hashCode-同键不同进程不同哈希值](#mdg4-1709801628016)

<a name="hzyg-1721843513316"></a>[一致性哈希consistent hashing:哈希键分区边界均匀间隔，也可伪随机选择（CDN均匀分配负载）。](#7rkg-1709802019859)

<a name="7skp-1721843513318"></a>[缺点：无序，低效范围查询(需发送到所有分区)](#iktb-1709802309508)

<a name="q65x-1721843513320"></a>[折中方案：复合主键/组合索引。(uid,time).不同用户在不同分区，每个用户按时间搓顺序存储在单个分区上。](#zznq-1709802490074)

<a name="vqqg-1721843513322"></a>[负载倾斜与消除热点](#ed70-1709800357523)

<a name="iycx-1721843513324"></a>[数百万追随者做某事-大量写入同一个键](#403a-1709802593546)

<a name="ggqt-1721843513326"></a>[解决：火爆主键+随机数即可将主键分散为100个分区](#wx5s-1709802730512)

<a name="hxue-1721843513328"></a>[缺点：数据合并，跟踪火爆主键。需权衡利弊。](#h0b7-1709802773377)

<a name="1aus-1721843513330"></a>[.分片与次级索引](#ekdv-1709800287975)

<a name="9lxt-1721843513332"></a>[次级索引通常并不能唯一标识记录。](#n3vk-1709803239471)

<a name="isia-1721843513334"></a>[HBase Volde-mort为了减少实现复杂度放弃了次级索引。](#q1u5-1709803293988)

<a name="hr9o-1721843513336"></a>[Riak开始添加， 次索是Solr Elasticesearch 搜索的基石](#fhpr-1709803333585)

<a name="w4ln-1721843513338"></a>[按文档的二级索引](#mwm0-1709800370635)

<a name="fcwz-1721843513340"></a>[文档分区索引/本地索引](#ud7o-1709803718409)

<a name="ym71-1721843513342"></a>[每个分区独立维护自己的二级索引。](#zlhf-1709803740582)

<a name="hbue-1721843513344"></a>[查询发送所有分区，并合并所有返回结果，分散/聚集scatter/gather-容易导致尾部延迟放大。](#bkj3-1709803789802)

<a name="mpmh-1721843513346"></a>[缺点：可能使二级索引读取查询相当昂贵。](#ghpm-1709803878421)

<a name="jr2m-1721843513348"></a>[根据关键词(Term)的二级索引](#itl0-1709800380617)

<a name="ukjq-1721843513350"></a>[全局索引：覆盖所有分区数据的索引，也须分区。](#8bw4-1709804016790)

<a name="vr60-1721843513352"></a>[关键词分区：关键词本身或它的散列进行分区。](#qc2d-1709913637902)

<a name="v9os-1721843513354"></a>[优点：只需请求包含关键词的分区，读取更有效率](#jmj8-1709913775261)

<a name="lpu3-1721843513356"></a>[缺点：写入慢且复杂。需支持分布式事务。](#i7kp-1709913825503)

<a name="9fzu-1721843513358"></a>[理想下总是最新，实践中更新通常为异步。Amazon DynamoDB声称全局次级索引不到1s内更新。](#mv7j-1709913923874)

<a name="y9xk-1721843513360"></a>[.分区再平衡(reblancing)](#hpnd-1709800294747)

<a name="me0b-1721843513362"></a>[吞吐量增加：加cpu](#1f0n-1709914101899)

<a name="5mxd-1721843513364"></a>[数据集大小增加：加磁盘和RAM](#vjb0-1709914129763)

<a name="neny-1721843513366"></a>[机器故障：其他机器接管](#smcd-1709914153882)

<a name="myhn-1721843513368"></a>[----------再平衡应满足--------------](#2efu-1709916803909)

<a name="sx6i-1721843513370"></a>[发生时：数据库应该继续接受读取和写入](#20wj-1709916807951)

<a name="duq5-1721843513372"></a>[节点之间只移动必须数据(分区)，以便快速再平衡，减少网络和磁盘io负载。](#cxoi-1709916893371)

<a name="yoaz-1721843513374"></a>[平衡后：存储，读取和写入公平共享](#cj8j-1709916938075)

<a name="mewo-1721843513376"></a>[平衡策略](#cavd-1709800402611)

<a name="3chs-1721843513378"></a>[反面教材：hash mod N](#6f6z-1709800409866)

<a name="tequ-1721843513380"></a>[$hash(key)=22  22mod10..2  22mod 11...0  22 mod 9 ...4 ](#anib-1709916997775)

<a name="pjir-1721843513382"></a>[节点需要转移秘钥及次数过多，过于昂贵。](#anz7-1709917243580)

<a name="ndlk-1721843513384"></a>[解决：更换为只移动必须数据的方法。](#7ytl-1709917334275)

<a name="lrzl-1721843513386"></a>[固定数量的分区(加节点时分配分区)](#8l9j-1709800420954)

<a name="n9x3-1721843513388"></a>[新增/减少节点时，将现存部分数据转移到节点新增/现存节点(Riak,es,couchbase Voldemort使用这种再平衡）](#vmsm-1709917322722)

<a name="wrgg-1721843513390"></a>[适用：分区数量第一次建立时确定。](#ktrd-1709917648400)

<a name="opzf-1721843513392"></a>[缺点：数据集总量大小难以预估时；分区大再平衡代价昂贵，分区小产生额外开销。](#vw7j-1709917692466)

<a name="1wfv-1721843513394"></a>[分区大小与集群数据总量成比例增长](#eszc-1709921747523)

<a name="ftsf-1721843513396"></a>[动态分区(适用键范围的分区)](#tkjw-1709800428033)

<a name="bg5a-1721843513398"></a>[解决：使用键范围分区，固定边界的固定数量的分区不便。出现边界错误，手动重新去配分区边界将非常繁琐。](#itsg-1709917825657)

<a name="r9gu-1721843513400"></a>[动态分区：与B树类似，分区数据增长超过配置时将分成两区，大量数据删除分区缩小低于阈值则合并(HBase RethinkDB)](#05rm-1709917996703)

<a name="b1wy-1721843513402"></a>[优点：分区数量适应总数据量-动态划分分区数量。](#v8uv-1709918235496)

<a name="zh8u-1721843513404"></a>[注意：空库分区开始，未绘制边界先验信息。所有写操作都必须由单个节点处理。其它节点空闲](#cdjv-1709918375629)

<a name="iuoo-1721843513406"></a>[解决：配置一组初始分区-预分割 Hbase MongoDb。配需提前知道键分配方式。](#3uee-1709918458100)

<a name="gi1w-1721843513408"></a>[MongoDB同时支持范围和哈希分区且动态分割分区。](#tlmq-1709918504615)

<a name="nciz-1721843513410"></a>[分区数量与数据集大小成正比](#xqee-1709921516740)

<a name="rj20-1721843513412"></a>[按节点比列分区](#kcsr-1709800432396)

<a name="vftm-1721843513414"></a>[新增节点，分区将变小。随机选择固定数量的现有分区进行拆分,最终获得公平的负载份额。cassandre ketama.](#xscz-1709920011051)

<a name="5t54-1721843513416"></a>[随机选择分区边界要求使用基于散列的分区-一致性哈希。](#pmpc-1709920187661)

<a name="hxt3-1721843513418"></a>[分区数量与节点数量无关](#a0l0-1709923420226)

<a name="aytj-1721843513420"></a>[ 运维：手动还是自动平衡](#w6ob-1709800443454)

<a name="kva6-1721843513422"></a>[自动：与故障检测结合将十分危险，高负载节点响应慢被视为死亡被踢掉，重新平衡集群时其他超负荷节点可能级联失败](#qobk-1709920292898)

<a name="vbsa-1721843513424"></a>[手动人为监控+自动](#a05n-1709920414620)

<a name="yqc1-1721843513426"></a>[.请求路由](#qxk3-1709800301840)

<a name="fiwq-1721843513428"></a>[分区再平衡后的服务发现(IP 端口)](#sd2e-1709921854453)

<a name="2ssx-1721843513430"></a>[-------方案-------](#gliq-1709921964410)

<a name="42dh-1721843513432"></a>[1.循环策略：Round-Robin load balancer，轮询节点看是否有请求的分区。](#ibln-1709921978507)

<a name="ieva-1721843513434"></a>[2.路由层：有中间层的路由决定请求的节点，由路由层负载均衡](#gjxa-1709922094115)

<a name="mqmm-1721843513436"></a>[3.要求客户端知道分区和节点的分配。客户端可直连节点。](#ukz9-1709922149547)

<a name="spy2-1721843513438"></a>[具有挑战性的问题。重要的是所有参与者都同意-否则将被发送到错误的节点，而不是正确处理。分布式中的共识协议-但很难正确实现。](#1c54-1709922244119)

<a name="aytv-1721843513440"></a>[Zookeper分区分配改变时通知路由层保持最新信息。](#c7dc-1709922373821)

<a name="nl19-1721843513442"></a>[LinkedIn的Espressor使用Heix进行集群管理(依靠Zookeeper）](#ne7u-1709922442881)

<a name="lugn-1721843513444"></a>[Hbase,SolrCloud 和kafka也是用Zookeeper来跟踪分区分配。](#41cr-1709922584212)

<a name="e5be-1721843513446"></a>[Cassandra  Riaks节点间使用留言协议gossip protocol来传播群集状态变化。请求发送任意节点，该节点转发到含有请求分区的节点。模型增加数据库节点的复杂性。但避免对Zookeeper这类外部协调服务的依赖](#kg5k-1709922347652)

<a name="x1ze-1721843513448"></a>[Couchbash不会自动再平衡，简化了设计。moxi路由层。](#uohs-1709922928889)

<a name="zyic-1721843513450"></a>[执行并行查询](#h26t-1709800460759)

<a name="ojdj-1721843513452"></a>[大规模并行处理(MPP,massively parallel processing)-数仓](#oj8k-1709923010027)

<a name="8igo-1721843513454"></a>[7.事务](#7qvp-1708523954496)

<a name="3alx-1721843513456"></a>[简化故障失败的机制-强大的事务！！](#wk3n-1710172857428)

<a name="mna9-1721843513458"></a>[故障](#pzui-1710172844274)

<a name="sx6v-1721843513460"></a>[崩溃](#znoj-1710172848152)

<a name="5brm-1721843513462"></a>[网络中断](#vovu-1710172885568)

<a name="j1dl-1721843513464"></a>[多线程/客户端写入覆盖](#sxty-1710172894683)

<a name="pszo-1721843513466"></a>[读取无意义中间态数据](#hbqy-1710172933218)

<a name="ygka-1721843513468"></a>[多线程/客户端竞争](#jlng-1710172974900)

<a name="prdd-1721843513470"></a>[.事务的棘手概念](#58hv-1710167822460)

<a name="fhyu-1721843513472"></a>[ACID的含义](#yxrp-1710167867782)

<a name="xfm4-1721843513474"></a>[原子性atomicity](#hryj-1710167943276)

<a name="pd2h-1721843513476"></a>[一致性consistency](#9aal-1710167983379)

<a name="lail-1721843513478"></a>[—致性这个词重载的很厉害:](#jkse-1710173130714)

<a name="tabw-1721843513480"></a>[隔离性isolation](#gfkv-1710171645686)

<a name="ibpw-1721843513482"></a>[持久性durability](#7kja-1710171663168)

<a name="x13a-1721843513484"></a>[单对象与多对象操作](#pblh-1710167919896)

<a name="zkmi-1721843513486"></a>[违反隔离性：一个事务读取另一个事务未被执行的写入（脏读）](#42qx-1710250188446)

<a name="bha0-1721843513488"></a>[ 原⼦性确保发⽣错误时，事务先前的任何写⼊都会被撤消，以避免状态不⼀致（all or nothing）](#daxd-1710250201202)

<a name="us1g-1721843513490"></a>[单对象写入](#7ymn-1710171710772)

<a name="ezmj-1721843513492"></a>[单对象写入崩溃，原子性通过日志实现恢复](#h5aa-1710250215106)

<a name="pqgq-1721843513494"></a>[原子操作：CAS也是流行的操作](#ihdr-1710250368749)

<a name="yepu-1721843513496"></a>[事务通常被理解为：将多个对象上的多个操作合并为一个执行单元的机制](#a1qj-1710250481310)

<a name="wrlq-1721843513498"></a>[多对象事务的需求](#afyc-1710171718578)

<a name="pas5-1721843513500"></a>[是否需要多对象事务？ ](#t9gh-1710251706186)

<a name="tqok-1721843513502"></a>[是否有可能只用键值模型和单对象来实现应用程序？](#9b6e-1710251739137)

<a name="tbrc-1721843513504"></a>[ 关系型数据库：多表关联插入操作](#ormg-1710250533532)

<a name="0wwd-1721843513506"></a>[ 文档数据模型：多个字段常在同一个文档(被视为单个对象），缺乏连接功能的文档DB会鼓励非规范化(操作非规范化信息需要更新多个文档)。事务可防止非规范化数据不同步。](#opfe-1710250566216)

<a name="mn1q-1721843513508"></a>[ 二级索引的数据库中：一二级索引的同步更新](#syt6-1710251863622)

<a name="i82q-1721843513510"></a>[无原子性:复杂的错误处理](#ymgi-1710251891615)

<a name="aekr-1721843513512"></a>[无隔离性：并发问题](#ovhl-1710251918119)

<a name="uchd-1721843513514"></a>[处理错误和中止](#g5o1-1710171723084)

<a name="8b5q-1721843513516"></a>[···   ACID哲学：违反规则宁可放弃，不留半成品。](#ygfp-1710251941752)

<a name="q0tt-1721843513518"></a>[无主复制则是尽力而为：数据库将做尽可能多的事。错误时不会撤销已经完成的事。-错误恢复是应用程序的责任。](#0hze-1710252188073)

<a name="rzxn-1721843513520"></a>[Rails的ActiveRecord、Django这样的orm框架不会重试中断的事务。丢弃用户输入。](#7mbo-1710252298563)

<a name="jhuk-1721843513522"></a>[中止的重点应该是允许安全的重试。但它并不完美：](#p2mf-1710253466041)

<a name="basg-1721843513524"></a>[事务成功，网络故障可能导致执行两次。除非有额外应用级除重机制。](#lmfw-1710253530673)

<a name="fsjc-1721843513526"></a>[负载过大，重试将更槽糕。限制重试次数，指数退避算法。并单独处理和过载相关的错误](#nxyx-1710253675080)

<a name="oetq-1721843513528"></a>[仅在临时性错误才值得重试（死锁，异常，网络中断和切换）。发生永久性错误的重试是无意义的](#njy9-1710253740189)

<a name="hefq-1721843513530"></a>[数据库外的副作用：重试每次重发电子邮件。不同系统事务。两阶段提交2PC.](#auy9-1710253799114)

<a name="w7yx-1721843513532"></a>[ 客户端重试失效则丢失数据。](#mtpo-1710253936214)

<a name="lyzo-1721843513534"></a>[.弱隔离级别](#jngf-1710167840980)

<a name="3v7t-1721843513536"></a>[安全并行parallel：事务不触及相同数据](#wdhp-1710263089880)

<a name="tsrk-1721843513538"></a>[竞争条件：](#ykgs-1710263216103)

<a name="dv51-1721843513540"></a>[读：事务读取另一个事务同时修改的数据](#er05-1710263177909)

<a name="1bea-1721843513542"></a>[写：事务同时修改相同的数据](#pypw-1710263203957)

<a name="d5s9-1721843513544"></a>[事务隔离：](#xps5-1710263234506)

<a name="ndio-1721843513546"></a>[可序列化(一次一个执行，没有任何并发)](#ghkk-1710263260640)

<a name="8for-1721843513548"></a>[性能损失](#a876-1710263299289)

<a name="s72y-1721843513550"></a>[弱隔离级别(非串行化nonserializable)](#nqm3-1710263313752)

<a name="a0sf-1721843513552"></a>[较弱的隔离级别防止一部分，而非全部的并发问题](#e7nl-1710263334073)

<a name="scvy-1721843513554"></a>[资金损失，耗费财务调查，财务数据请使用ACID数据库(注意：流行的数据库也使用弱隔离级别，不一定能防止并发错误)](#2xxd-1710331395046)

<a name="v54m-1721843513556"></a>[读已提交](#pjqb-1710171742279)

<a name="k4w3-1721843513558"></a>[没有脏读](#7h42-1710171796899)

<a name="flrb-1721843513560"></a>[dirty reads：事务看到另一个事务未提交的值](#lyju-1710332135761)

<a name="g6uo-1721843513562"></a>[为什么要防止dirty reads：](#x8ch-1710333899846)

<a name="s6xg-1721843513564"></a>[更新多对象：脏读以为只看到部分数据](#pwpa-1710333902582)

<a name="vv7m-1721843513566"></a>[事务中止：回滚后，看到的是未提交的数据](#jcj0-1710333902583)

<a name="ajlw-1721843513568"></a>[解决：只能读取提交后的数据，且不会阻塞，并行时保存已提交的旧值 -mvcc](#3mi1-1710332238978)

<a name="gbgf-1721843513570"></a>[没有脏写](#vmfl-1710171803833)

<a name="yfj4-1721843513572"></a>[dirty write: 事务同时更新相同对象。后面的写入覆盖尚未提交的值。](#hvah-1710332040048)

<a name="ewbu-1721843513574"></a>[避免的问题：](#chr0-1710333916523)

<a name="arjr-1721843513576"></a>[混乱写入，导致bob后买车先更新发票commit而alic先买车后更新发票commit(buyer=bob but recipient=alice)](#14wx-1710333919188)

<a name="ek96-1721843513578"></a>[解决：延迟/阻塞第二次的写入，直到第一次写入事务提交或终止。](#g1sw-1710332222649)

<a name="covw-1721843513580"></a>[但不能防止计数器增量的竞争状态。(读写非原子性，写依赖读的副本)](#ujzx-1710333397576)

<a name="v3hw-1721843513582"></a>[计数器增量安全：防止更新丢失 -版本号](#ugiq-1710333641028)

<a name="7jeu-1721843513584"></a>[实现读已提交](#z96g-1710171821987)

<a name="zoio-1721843513586"></a>[默认的隔离级别：oracle,postgreSQL,sql server ,memSql](#tays-1710333754461)

<a name="ujfw-1721843513588"></a>[行锁row-level lock](#svaf-1710333809593)

<a name="3wq6-1721843513590"></a>[读写锁防止脏读：读写锁互斥，只有读锁拥有者可持有写锁。](#fsbu-1710334081090)

<a name="711m-1721843513592"></a>[缺点：阻塞，性能损失。](#xj1j-1710334321006)

<a name="j7qh-1721843513594"></a>[优化：所以一般用mvcc的模式。-或者copy on write](#7klj-1710334353854)

<a name="ukq7-1721843513596"></a>[快照隔离和可重复读](#bww4-1710171760070)

<a name="ecpt-1721843513598"></a>[不可重复读nonrepeatable read/读取偏差read skew](#wjut-1710343195467)

<a name="yn6a-1721843513600"></a>[skew重载：在热点指的是不平衡，这里指异常时机  alice两个账号各500，alice先读acount1=500,转账员将acount1+100,acount2-100后commit，alice读acount2=400.commit.导致Alice看起来少了100。-暂时不一致。](#jmuu-1710343248537)

<a name="9y3h-1721843513602"></a>[提交后，刷新网页即可。有些情况不能容忍暂时不一致：](#gwgf-1710343469620)

<a name="6jtj-1721843513604"></a>[备份：数据库备份需要几小时，期间接收写入包含新老数据。如果备份用于恢复，不一致就变成永久的了。-解决：全局锁/快照备份](#m0km-1710345572560)

<a name="v58s-1721843513606"></a>[分析查询和完整性检查：扫描大部分数据库，查询在不同时间点观察数据库产生不同，可能返回无意义的结果。](#i5pt-1710345666724)

<a name="1wzz-1721843513608"></a>[ 快照隔离snapshot isolation 对长时间运行的只读查询非常有用（备份和分析）。](#p7tm-1710345899708)

<a name="4j65-1721843513610"></a>[ 即 一致快照consistent snapshot,即使被另一个事务更改，每个事务只能看到该特定时间的旧数据（特定时间点冻结的一致快照）。](#q8oz-1710345935366)

<a name="8gux-1721843513612"></a>[PostgerSQL, mysql innoDB, Oracle, sqlServer](#mo1i-1710346175801)

<a name="l1oy-1721843513614"></a>[实现快照隔离](#2hpt-1710171981487)

<a name="zeib-1721843513616"></a>[关键原则：读不阻塞写，写不阻塞读。两者没有任何锁定争用。](#49s0-1710346236063)

<a name="wjne-1721843513618"></a>[多版本并发控制mvcc,multi-version concurrentcy contorl](#w8v8-1710346319154)

<a name="tcws-1721843513620"></a>[读已提交不提供快照隔离，保留对象的一两个版本就足够。通常支持快照隔离也是用mvcc来实现读已提交隔离级别：](#fh82-1710346453757)

<a name="iie6-1721843513622"></a>[读已提交为每个查询使用单独的快照-每个select单独生成。](#3xbw-1710346540026)

<a name="zxyq-1721843513624"></a>[快照隔离对整个事务使用相同的快照-复用第一个select生成的快照](#xqhm-1710346554737)

<a name="n2fc-1721843513626"></a>[update操作在内部翻译为Delete 和 insert](#pmk8-1710351883488)

<a name="ct46-1721843513628"></a>[-innoDB实际上delete将旧数据版本移到undolog版本链中。垃圾收集会删除任何事务不可见的就对象版本。](#vnfd-1710351911457)

<a name="e0jf-1721843513630"></a>[观察一致性快照的可见性规则](#box0-1710171988275)

<a name="yvue-1721843513632"></a>[从来不更新值，而是每次值改变时创建一个新版本。使得数据库提供一致快照产生的开销很小。](#yapf-1710408915465)

<a name="c3gd-1721843513634"></a>[事务id决定它可以看到哪些对象，规则如下：](#ecrk-1710408160769)

<a name="nulk-1721843513636"></a>[事务开始时列出当时所有事务清单，即使之后提交，这些事务的写入也都会被忽略。](#ogtp-1710408539120)

<a name="ozg5-1721843513638"></a>[忽略被中止事务任何写入](#unjc-1710408595672)

<a name="eirs-1721843513640"></a>[较晚(当前事务之后开始)的写入都被忽略，不管是否提交](#ofbz-1710408626209)

<a name="ol1s-1721843513642"></a>[所有其他写入，对应用都是可见的。](#hgwi-1710408682423)

<a name="brni-1721843513644"></a>[对象可见的两条规则](#rg1c-1710408738736)

<a name="jxdy-1721843513646"></a>[读事务开始时，创建该对象的事务已提交。](#weyp-1710408754844)

<a name="6vyk-1721843513648"></a>[请求删除的事务在读事务开始时未提交。](#xqky-1710408773006)

<a name="mlol-1721843513650"></a>[索引和快照隔离(索引如何在多版本数据库中工作)](#ai77-1710171999516)

<a name="mbey-1721843513652"></a>[同一对象不同版本放在同一个页面中，PostgreSQL的优化可以避免更新索引](#kanl-1710410047690)

<a name="7v6m-1721843513654"></a>[仅追加/写时拷贝apeend-only/copy-on-wirte的变体B树：更新不覆盖树的页面，为每个修改页创建副本。](#yv2q-1710410120895)

<a name="kxpg-1721843513656"></a>[每个写入事务/一批事务都会创建一个新的B树，当创建时，从该特定树根生长的树就是数据库的一个一致性快照。](#etza-1710410471666)

<a name="4qf9-1721843513658"></a>[需要负责压缩和垃圾收集的后台进程。](#79xv-1710410561061)

<a name="plgq-1721843513660"></a>[可重复读与命名混淆](#xr4f-1710172004472)

<a name="lri8-1721843513662"></a>[原因：System R定义隔离级别时并未有快照隔离](#nohd-1710417835613)

<a name="enfb-1721843513664"></a>[oracle DB2 称为序列化](#uwdp-1710417928621)

<a name="vazt-1721843513666"></a>[postgreSql mySql称为可重复读](#f5te-1710417946615)

<a name="jjnd-1721843513668"></a>[防止丢失更新](#e9wg-1710171770800)

<a name="u5t4-1721843513670"></a>[脏写导致丢失更新lost update](#ajmt-1710418075399)

<a name="r8qd-1721843513672"></a>[读取-修改-写入序列的狠揍clobber：第二个事务并没有包括第一个事务的修改: -写依赖读](#c7rv-1710418271703)

<a name="4hbu-1721843513674"></a>[增加计数器或更新账户余额(需读取当前值，计算新值并写回更新后的值)](#uvoq-1710418375497)

<a name="buul-1721843513676"></a>[进行本地修改： 解析文档，更改后回写修改的文档](#ro12-1710418458493)

<a name="wdrt-1721843513678"></a>[同时编辑wiki页面：整个页面覆盖当前内容。](#9n83-1710418515773)

<a name="y80e-1721843513680"></a>[原子写(x排它锁)](#lftw-1710172034957)

<a name="lth6-1721843513682"></a>[数据库原子更新操作保证并发安全](#6jim-1710418574114)

<a name="lw5c-1721843513684"></a>[mysql: 行级写锁](#dxgy-1710419672127)

<a name="ztpb-1721843513686"></a>[MongoDB：对JSON文档一部分进行本地修改的原子操作](#bqxj-1710419591972)

<a name="4qiq-1721843513688"></a>[redis提供了优先队列等修改数据的原子操作。](#wxju-1710419646040)

<a name="tlsm-1721843513690"></a>[原子操作/游标稳定性cursor stability：通常在读取对象时获取其上的排它锁，以便提交前没有事务可以读取它。另一个选择是将所有原子操作在单一线程上执行。-redis](#h0ip-1710421887552)

<a name="gdmg-1721843513692"></a>[unfortunately,ORM框架易执行读取-修改-写入序列，而不是使用数据库提供的原子操作。如果你知道自己在做什么那当然不是问题](#6hwo-1710422121598)

<a name="4mfk-1721843513694"></a>[显式锁定(for update：读-改-写序列)](#vysa-1710172041914)

<a name="7wj4-1721843513696"></a>[让应用程序显示锁定更新的对象，直到一个读取-修改-写入序列完成](#oknq-1710422501689)

<a name="29jw-1721843513698"></a>[select ..... for update;](#89ij-1710422624973)

<a name="exyw-1721843513700"></a>[--更新先前select 返回棋子的位置。](#50q1-1710422845671)

<a name="iroq-1721843513702"></a>[ update](#rmgw-1710422637550)

<a name="mifp-1721843513704"></a>[for update-对返回的所有行加锁，忘记加锁很容易引入竞争条件(同时修改)](#euv5-1710422671170)

<a name="qjob-1721843513706"></a>[自动检测丢失的更新(管理器检测处理并发问题)](#jpu5-1710172058032)

<a name="5tem-1721843513708"></a>[允许并行执行，事务管理器检测到丢失更新，中止事务并强制重试读-改-写序列。](#8ytj-1710423161566)

<a name="dy9r-1721843513710"></a>[Oracle可串行化(快照隔离)和sqlServer的快照隔离级别会自动检测到丢失更新，中止惹麻烦的事务。一些作者认为能防止丢失更新才算提供快照隔离。这个定义下，mysql不算提供快照隔离](#w9el-1710423029153)

<a name="actm-1721843513712"></a>[优点：是一个很好的功能，不需要应用代码使用任何特殊数据库功能。允许你忘记加锁或原子操作，由管理器检测丢失更新。](#qg6e-1710423330067)

<a name="rvje-1721843513714"></a>[比较并设置(CAS)](#ftwe-1710172063360)

<a name="lty8-1721843513716"></a>[不提供事务的数据库中的原子操作：比较并设置（CAS compare and set）](#os3h-1710424617661)

<a name="wutp-1721843513718"></a>[update table set content='new content' where id=123 and content = 'old content'  必要时重试](#hlfh-1710425612756)

<a name="qlin-1721843513720"></a>[问题：数据库允许where子句从旧快照读取，此语句无法防止丢失更新。即另一个并发写入，where条件也为真。-非当前读或非原子写。](#rxcv-1710425806449)

<a name="r5hr-1721843513722"></a>[解决：检查数据库的CAS是否安全。保证比较交换为当前读且写是否加锁/原子写](#zss4-1710425865867)

<a name="kfjj-1721843513724"></a>[冲突解决与复制(多个数据库副本的并发)](#bvrp-1710172079412)

<a name="rcbu-1721843513726"></a>[基于锁和cas操作不适用于多个数据库副本](#ewf7-1710434904534)

<a name="efwk-1721843513728"></a>[如检测并发写入：允许并发吸入创建多个冲突版本(也称兄弟），应用代码或特殊数据结构在发生之后解决合并这些版本。](#8dx4-1710434970886)

<a name="j62v-1721843513730"></a>[原子操作可在复制的上下文中很好工作，尤其具有可交换性时。Riak2.0不同客户端同时更新一个值是，Riak将自动更新合并在一起，以免丢失更新。防止复制副本丢失更新。](#gl8j-1710435048968)

<a name="nm4m-1721843513732"></a>[最后写入LWW解决冲突很容易丢失更新。unfortunately,许多复制数据库默认LWW。](#gdtn-1710435259414)

<a name="9ypf-1721843513734"></a>[写入偏差与幻读（两个事务更新两个不同的对象）](#rkev-1710172453385)

<a name="rvy5-1721843513736"></a>[select count(*) where oncall=true....alice 和 bob分别查在职医生人数](#itfd-1710436127298)

<a name="qsit-1721843513738"></a>[update...set oncall=false 然后将自己的记录更新为请假，违反至少一医生在职。](#leam-1710436160580)

<a name="mocq-1721843513740"></a>[写偏差的特征](#ovid-1710172462835)

<a name="rnuj-1721843513742"></a>[特征：涉及多个对象，单对象的原子操作不起作用](#iedp-1710437034438)

<a name="jq1u-1721843513744"></a>[快照隔离实现中，自动检测丢失更新对此无帮助。postgred,innodb的可重复读，oracle序列化或sql server的快照隔离级别中，都不会自动检测写入偏差。写入偏差需要真正的可序列隔离-业务上的问题。](#wszw-1710437034814)

<a name="bhhu-1721843513746"></a>[数据库配置约束，指定至少一个值为true.大多数不支持这种配置，可以使用触发器或者物化视图实现。](#hn04-1710437034815)

<a name="mnyf-1721843513748"></a>[显示锁定。 select ...fro update -锁定返回的所有行，锁定两个医生](#crrt-1710437034816)

<a name="zgff-1721843513750"></a>[写偏差的更多例子](#4jr1-1710172470885)

<a name="4y6l-1721843513752"></a>[读数据为空，分别插入一条数据的会议室预定系统：select count(*) from bookings where roomid=123 and time...，insert into bookings....不能防止另一个用户插入冲突会议。解决：又需要串行化执行。](#0hyt-1710437389755)

<a name="btyx-1721843513754"></a>[多人游戏：棋盘用锁防止丢失更新，但锁定不能妨碍将不同的棋子放在相同位置。产生写入偏差 。解决：使用唯一约束。](#pgcb-1710437636980)

<a name="oifz-1721843513756"></a>[抢注用户名：和会议系统一样。不过唯一性约束可以解决该问题。](#bwel-1710437042998)

<a name="onby-1721843513758"></a>[防止双重开支；用户花钱和积分服务，检查支付数不超过余额，有了写入偏差，可能会发生两个支出项目同时插入，导致余额变为负值，两个事务都不会注意到另一个。](#ogt8-1710438166946)

<a name="j0m3-1721843513760"></a>[导致写入偏差的幻读](#8gty-1710172478550)

<a name="zdbe-1721843513762"></a>[所有以上例子都遵循类似的模式](#tw0y-1710438423955)

<a name="a7wn-1721843513765"></a>[Select查询符合条件的行，至少两名医生值班；不存在该会议室同一时段的预定；棋盘位置未被占据；用户未被抢注；账户还有足够余额](#bngi-1710438445792)

<a name="d6mi-1721843513767"></a>[按照第一个查询的结果，应用代码决定是否继续](#l6p0-1710438590471)

<a name="smh4-1721843513769"></a>[应用决定继续操作，执行写入(插入更新删除），并提交事务](#qt10-1710438739456)

<a name="lnj6-1721843513771"></a>[步骤3修改的行，是步骤1中返回的行之一，可以使用select for update来使事务安全避免写入偏差.](#cdmo-1710438899441)

<a name="kczs-1721843513773"></a>[但检查是否不存在满足条件行，写入添加一个匹配相同条件的行。select for update 锁不了任何东西。](#caet-1710439501945)

<a name="yqic-1721843513775"></a>[       这种效应：一个事务中的写入改变另一个事务的搜索查询结果，被称为幻读。快照隔离避免了只读查询中的幻读。以上的读写事务中，幻影会导致特别棘手的写歪斜情况。](#cwgh-1710440241091)

<a name="kpt4-1721843513777"></a>[物化冲突](#1cjy-1710172485201)

<a name="fydr-1721843513779"></a>[物化冲突：将幻读变为数据库中一组具体行上的锁冲突。](#fv3x-1710440426895)

<a name="7v7v-1721843513781"></a>[通过创建时间槽和房间的表，提前出入房间和时间的所有可能组合。创建预定的事务可以select for update锁定房间和时间段对应的行，在获得锁定后，可以检查重叠的预定并插入新的预定。该表不是存储预定相关的信息，它完全就是一组锁，用于防止同时修改同一房间和时间范围内的预定。](#laff-1710440634993)

<a name="qp9m-1721843513783"></a>[缺点：弄清除如何物化冲突可能很难，也很容易出错，而让并发控制机制泄露到应用数据模型是很丑陋的做法。](#dngy-1710441936216)

<a name="qqiz-1721843513785"></a>[物化重入应为最后的手段。可序列化Serializeble级别是更可取的。](#i0he-1710441997817)

<a name="hjbe-1721843513787"></a>[.可序列化](#di29-1710167844061)

<a name="trsq-1721843513789"></a>[弱隔离级别读已提交和快照隔离不能解决写入偏差幻读：](#ztac-1710587737356)

<a name="khlm-1721843513791"></a>[隔离级别难以理解，且不同数据库中实现不一致，可重复读概念不一样](#ky3h-1710588699885)

<a name="tkaw-1721843513793"></a>[光检查应用代码很难判定在特定隔离界别是否安全](#tpbs-1710588738858)

<a name="fmyk-1721843513795"></a>[无检测竞争条件的好工具，往往倒霉时才会出现问题。](#jp98-1710588779920)

<a name="04uv-1721843513797"></a>[20世纪70年代system R就已经是这样，研究人员的答案都很简单：可序列化（serializeble）级别（但非人见人爱），都使用三种技术之一。](#sqvc-1710588820273)

<a name="mgvb-1721843513799"></a>[字面意义上的串行顺序执行事务](#mqa4-1710589545518)

<a name="uiom-1721843513801"></a>[两相锁定2PL two-phase locking,几十年来唯一的可行选择](#neot-1710589568078)

<a name="7nga-1721843513803"></a>[乐观并发控制，可序列话的快照隔离serializable snapshot isolation](#pizj-1710589721553)

<a name="gbpw-1721843513805"></a>[真的串行执行(单线程执行事务)](#2oi3-1710172506817)

<a name="3sp4-1721843513807"></a>[数据库设计人员07年才确定，单线程循环执行事务时可行的。（多线程过去30年中被认为是获得良好性能的关键所在）](#o5af-1710589822067)

<a name="uuij-1721843513809"></a>[两个进展引发了这个反思：](#phuh-1710609564138)

<a name="t7je-1721843513811"></a>[RAM足够便宜，许多场景可以将完整的活跃数据保存在内存中。-redis](#owi7-1710609747624)

<a name="i6c7-1721843513813"></a>[数据库设计人员意识到OLTP事务很短，只进行少量的读写操作。长时间的分析查询通常是只读的，可以用一致快照（快照隔离）上运行。](#vhy4-1710609817752)

<a name="xces-1721843513815"></a>[VoltDB/H-Store, Redis 和 Datomic中实现。避免锁的协调开销。吞吐量仅限单个cpu](#xcax-1710609934885)

<a name="tnse-1721843513817"></a>[在存储过程中封装事务(优化交互式单线程事务)](#xh4n-1710172519134)

<a name="pnhc-1721843513819"></a>[数据库设计者认为，机票全流程是一个事务，可以被原子化执行。缺点：交互式会使流程性能直接下降。](#xthc-1710757083497)

<a name="dkd3-1721843513821"></a>[解决：单线程串行执行事务的系统不允许交互式的多语句事务。提前将整个事务作为存储过程提交数据库：](#oo8b-1710757291600)

<a name="nfzf-1721843513823"></a>[Interactive transaction :bob医生请假 1.select count  2.if count>=2 3.update false](#9fzd-1710757436562)

<a name="m3nv-1721843513825"></a>[stored procedure: execute stored take doctor of call](#gegl-1710763202697)

<a name="ryub-1721843513827"></a>[事务所需的数据都在内存中，快速执行，无需等待网络和磁盘IO](#t47s-1710763179337)

<a name="9ujc-1721843513829"></a>[存储过程的优点和缺点](#7ksv-1710172529258)

<a name="84lg-1721843513831"></a>[名声不好：](#jfoa-1710763413471)

<a name="4lfn-1721843513833"></a>[陈旧丑陋无库生态，数据库存储过程各自的语言没跟上通用编程语言的发展](#4qhf-1710763421594)

<a name="yevp-1721843513835"></a>[管理困难，调试困难，版本控制测试部署困难，和监控指标的系统集成困难](#96la-1710763483936)

<a name="8mkf-1721843513837"></a>[单个数据库通常由多个应用共享，写得不好的存储过程（占用大量内存和cpu）会比代码造成更大麻烦](#idii-1710763602399)

<a name="11hd-1721843513839"></a>[ 这些问题都可以克服。现代存储过程放弃了PL/SQL,使用现有通用编程语言：VoltDB使用java或Groovy, Datomic使用Java或Clojure, Redis使用Lua.](#1w0a-1710763899035)

<a name="skwb-1721843513841"></a>[存储过程与内存存储，使得单线程执行事务可行，](#bp68-1710767504595)

<a name="ngpn-1721843513843"></a>[无需等待I/O,](#ahfz-1710767568244)

<a name="l6ge-1721843513845"></a>[避免并发控制机制的开销，可以在单线程实现相当好吞吐量](#mfvt-1710767570930)

<a name="4nyj-1721843513847"></a>[VoltDB还用存储过程进行复制，在每个节点上执行相同的存储过程，所以要求存储过程是确定性的。比如使用当前日期，需要通过特殊的确定性API实现。](#7m1p-1710767621202)

<a name="ofon-1721843513851"></a>[分区](#xxtp-1710172539181)

<a name="0tnn-1721843513853"></a>[顺序执行事务使并发控制简单多，但吞吐限制为单机单核。吞吐量高的应用，单线程将可能成为严重瓶颈。](#rqu5-1710767939361)

<a name="lgau-1721843513855"></a>[扩展多核多节点，可以对数据进行分区，每个事务只需在单个分区中读写数据，事务吞度量就可以与cpu保持现行扩展。](#puih-1710768082742)

<a name="zgl1-1721843513857"></a>[对于需要访问多个分区的任务事务，需要进行协调，存储过程跨所有分区锁定执行，保证串行。](#jpiw-1710768164695)

<a name="kqft-1721843513859"></a>[缺点：协调开销性能比单区事务慢得多。VoltDB吞吐量每秒1000个跨分区写入，比单分区低几个数量级，且通过增加机器来提高](#fgu3-1710768218238)

<a name="jh3h-1721843513861"></a>[事务是否可划分-应用的数据结构，键值数据，多个二级索的数据引需要大量跨分区协调。](#8lf4-1710768407791)

<a name="3pbl-1721843513863"></a>[串行执行小结](#zyih-1710172540516)

<a name="pmhf-1721843513865"></a>[需每个事务小而快，一个缓慢的事务拖慢所有事务。](#dibg-1710768638498)

<a name="t0yi-1721843513867"></a>[可放入内存仅限活跃数据集，少量数据会移动到磁盘。但需要访问执行中的事务，系统会变慢。](#22nq-1710768681244)

<a name="zjt7-1721843513869"></a>[写入吞吐量必须低到能在单个cpu运行，否则事务能划分至但分区，且无需分区协调](#jmsk-1710768781527)

<a name="xtgh-1721843513871"></a>[跨分区事务使用程度受限。](#wlnd-1710769060180)

<a name="5gki-1721843513873"></a>[两阶段锁定（2PL）](#uhxa-1710172558745)

<a name="go4c-1721843513875"></a>[30年高使用的序列化算法：两阶段锁定2PL two phase locking ,独占访问exclusive access:](#nhdj-1710769248115)

<a name="ule3-1721843513877"></a>[事务A读取对象，阻塞B写入，直至A提交；](#khdp-1710769659952)

<a name="xcqe-1721843513879"></a>[事务A写入对象，阻塞B读取,直至A提交；](#elpw-1710769685611)

<a name="uhzw-1721843513881"></a>[快照隔离使得不会阻塞读，2PL提高序列化性质，解决丢失更新和写入偏差。](#6ja2-1710769959539)

<a name="pejq-1721843513883"></a>[实现两阶段锁](#lfuv-1710172605096)

<a name="uylf-1721843513885"></a>[2PL即innoDB可序列化级别及DB2可重复读隔离级别。](#8oif-1710770052594)

<a name="o9es-1721843513887"></a>[读写阻塞为每个对象添加锁。共享模式shared mode 与独占模式exclusive mode:](#6wad-1710770158675)

<a name="q8uz-1721843513889"></a>[读取对象需以共享模式获取锁。读共享](#1dyc-1710770195788)

<a name="sobk-1721843513891"></a>[写入需独占模式取锁。写互斥。](#bshw-1710770251530)

<a name="mzcv-1721843513893"></a>[事务获得锁必须持有锁知道事务结束(提交或中止)。即一阶段获取锁，二阶段释放所有锁。](#r0b0-1711207524774)

<a name="qutv-1721843513895"></a>[死锁deadlock, 数据库会自动检测死锁，并中止其中一个。被中止的事务充实需应用程序实现。](#iuyh-1710770211133)

<a name="qhpu-1721843513897"></a>[两阶段锁定的性能](#qi7j-1710172616303)

<a name="p4yh-1721843513899"></a>[比弱隔离差得多](#vz0p-1711207837446)

<a name="8rpr-1721843513901"></a>[锁开销、串行并发性降低](#ienx-1711207878742)

<a name="gyig-1721843513903"></a>[交互式事务形成等待队列、高百分位响应慢](#z85f-1711207913718)

<a name="nxpg-1721843513905"></a>[死锁频繁时重试造成浪费](#kmkr-1711207799940)

<a name="avrz-1721843513907"></a>[谓词锁predicate lock](#ccq8-1710172621528)

<a name="dyt9-1721843513909"></a>[谓词锁：属于符合搜索条件的对象，解决幻读phantoms](#kfpi-1711208306292)

<a name="s3qu-1721843513911"></a>[事务A获取共享谓词锁shared-mode predicate lock读取匹配对象，与排它互斥](#6dqd-1711208459688)

<a name="ofhv-1721843513913"></a>[事务A写入需等待其他事务谓词锁释放。](#p3er-1711208588906)

<a name="obka-1721843513915"></a>[适用于尚不存在，将可能添加的对象（幻象），如果两阶段包含谓词锁，可实现串行化。](#bdwj-1711208433268)

<a name="4qyp-1721843513917"></a>[索引范围锁next-key lock](#zv5c-1710172626404)

<a name="y45c-1721843513919"></a>[谓词锁性能不佳：活跃事务持锁多，检查匹配非常耗时](#a3ce-1711208973949)

<a name="bl9g-1721843513921"></a>[2PL采用索引范围锁-简化版谓词锁：](#ayfb-1711209059199)

<a name="yvdi-1721843513923"></a>[索引位于roomid, 指示room123用于预定](#qmbu-1711212311152)

<a name="butm-1721843513925"></a>[或者索引位于时间上，指示12:00~13:00用于预定。](#ajbo-1711212362665)

<a name="qntw-1721843513927"></a>[以上任何一条件，当另一个事务想写入时，需要更新索引-叶子节点，会收到共享锁。解决幻读和写入偏差](#k1ie-1711212755816)

<a name="awjl-1721843513929"></a>[索引范围锁不如谓词锁精确，但开销低](#6lzs-1711212829915)

<a name="zec2-1721843513931"></a>[无可挂载索引，将退化为表锁，性能不利，但这是回退到一个安全位置。](#bofb-1711212877091)

<a name="7fxl-1721843513933"></a>[序列化快照隔离SSI（高性能序列化算法）](#slwa-1710172573367)

<a name="4qxn-1721843513935"></a>[新算法：可序列化快照隔离SSI serializeble snapshot isolation 仅与快照隔离有很小性能损失. 08年 micheal cahill博士论文。](#lnci-1711213123166)

<a name="vmjy-1721843513937"></a>[用于单节点PostgreSQL9.1后序列化和分布式数据库](#weo0-1711213307841)

<a name="5u5s-1721843513939"></a>[处于实践证明阶段](#ue1s-1711213377985)

<a name="w7ts-1721843513941"></a>[悲观pessimistic与乐观optimistic的并发控制](#yq9i-1710172639651)

<a name="ct0z-1721843513943"></a>[极致悲观：串行排它锁](#54jr-1711213690005)

<a name="xis5-1721843513945"></a>[序列化快照隔离SSI是乐观技术： ](#bjxf-1711213769533)

<a name="xgkz-1721843513947"></a>[缺点：多事务争用contention时性能不佳，大部分事务中止，吞吐量极限下有重试机制将使性能变差。](#mefw-1711213819265)

<a name="gzjq-1721843513949"></a>[优点：有备用容量，竞争不高场景比悲观好，可交换的原子操作可减少争用。](#nk1s-1711213915330)

<a name="gxjh-1721843513951"></a>[SSI在快照隔离基础上添加算法检测写入的序列化冲突，并决定中止哪些事务。](#snvf-1711214019984)

<a name="k7ik-1721843513953"></a>[基于过时前提的决策](#9lgw-1710172651041)

<a name="bv8a-1721843513955"></a>[医生值班读取-修改-写入。数据库检测过时并终止：](#td4m-1711214184809)

<a name="hrmu-1721843513957"></a>[检测对旧MVCC对象版本的读取(读之前存在未提交的写入)](#t08a-1711215992016)

<a name="ohay-1721843513959"></a>[检测影响先前读取的写入（读之后发生写入）](#aego-1711216030637)

<a name="kqag-1721843513961"></a>[检测旧MVCC读取](#5smj-1710172660675)

<a name="lerz-1721843513963"></a>[事务提交时，检测是否有被忽略的写入已被提交。](#z7u2-1711216050316)

<a name="aelq-1721843513965"></a>[SSI支持一致快照中长时间运行的读取-仅在提交时中止检测的陈旧读取。因为只读不产生幻读和写入偏差风险](#afqq-1711216243096)

<a name="e3uu-1721843513967"></a>[检测影响之前读取的写入](#mvok-1710172671381)

<a name="694a-1721843513969"></a>[事务写入提交时，在索引中查找最近读取受影响的其他事务，通知读取的事务非最新。并中止未提交写入的其他事务。](#mo5j-1711216452745)

<a name="slpc-1721843513971"></a>[可序列化的快照隔离的性能](#0sq6-1710172685702)

<a name="rsbk-1721843513973"></a>[粒度granularity，精准哪些事务需要中止，但簿记开销显著。](#g2eg-1711216636788)

<a name="23d3-1721843513975"></a>[简略的跟踪速度快（粗粒度），但导致不必要的事务中止。](#ux2m-1711216812849)

<a name="rmmt-1721843513977"></a>[相比2PL, 不需要锁定阻塞，读性能高](#jzqb-1711216700614)

<a name="32dj-1721843513979"></a>[相比串行化，可扩展多台机器提高吞吐量，可跨分区读。](#qm51-1710756953994)

<a name="ii3v-1721843513981"></a>[SSI要求事务尽量短，避免长事务发生冲突中止。慢事务SSI比2PL或串行执行更不敏感](#wvsk-1711216911828)

<a name="5uze-1721843513983"></a>[8.分布式系统的麻烦](#enui-1704985776096)

<a name="346m-1721843513985"></a>[前几章failover故障切换, 复制延迟 与事务控制 处理各种可能发生的边缘情况，本章则是彻底的悲观总结。](#e2bp-1711387736669)

<a name="ki28-1721843513987"></a>[故障与部分失效](#4yaw-1711386647072)

<a name="bdzz-1721843513989"></a>[部分失效partial failure  不确定性的nondeterministic: IDC配电单元故障](#9d0g-1711387883443)

<a name="0vbk-1721843513991"></a>[云计算与超级计算机](#w7ln-1711386736921)

<a name="yuwx-1721843513993"></a>[不可靠的网络(Timeout)](#ynhs-1711386665148)

<a name="kk9p-1721843513995"></a>[请求丢失： 拔网线](#fav6-1711388032544)

<a name="thuj-1721843513997"></a>[请求排队：](#znsf-1711388048086)

<a name="jwyo-1721843513999"></a>[请求失效：](#gmdu-1711388084834)

<a name="ra5f-1721843514001"></a>[.....](#dssu-1711388054944)

<a name="rowg-1721843514003"></a>[真实世界的网络故障](#y933-1711387087536)

<a name="ceiv-1721843514005"></a>[检测故障](#aywv-1711387099045)

<a name="gmpq-1721843514007"></a>[超时与无穷的延迟](#z4hi-1711387103669)

<a name="frjr-1721843514009"></a>[级联失效cascading failure](#qs2e-1711388153448)

<a name="o55m-1721843514011"></a>[网络拥塞和排队](#gttn-1711387323883)

<a name="8fm9-1721843514013"></a>[TCP执行流量控制flow control](#v9f2-1711388199023)

<a name="ezs7-1721843514015"></a>[视频、语音会议使用UDP，折中丢包与流畅](#up7k-1711389082773)

<a name="i4lz-1721843514017"></a>[同步网络vs异步网络](#t56p-1711387113980)

<a name="lajx-1721843514019"></a>[有限延迟bounded delay：同步网络，不收排队影响](#fmrl-1711389283437)

<a name="ovbc-1721843514021"></a>[我们不能简单地使用网络延迟可预测吗](#bwvp-1711387335617)

<a name="moti-1721843514023"></a>[不可靠的时钟](#l3p1-1711386676597)

<a name="cgli-1721843514025"></a>[机器的时钟：硬件设备，石英振荡器，](#faqp-1711469591901)

<a name="w7mh-1721843514027"></a>[不是完全准确的。](#xtjc-1711469629964)

<a name="hygo-1721843514029"></a>[同步时钟：网络时间协议NTP](#knwp-1711469656643)

<a name="qnvw-1721843514031"></a>[服务器从精确时间源获取时间-GPS接收器](#pfpq-1711469689783)

<a name="3kw9-1721843514033"></a>[单调钟与时钟](#qoxv-1711387218692)

<a name="ujgc-1721843514035"></a>[时钟](#wu2k-1711387376627)

<a name="ilzz-1721843514037"></a>[Linux: clock_gettime(CLOCK_REALTIME)](#obwb-1711469781129)

<a name="uq5r-1721843514039"></a>[java:system.currentTimeMilis](#uxdp-1711469821742)

<a name="olbx-1721843514041"></a>[通常与NTP同步，但举例NTP服务器太远，则可能被强制重置(及时跳回）](#gwyx-1711469840905)

<a name="gjw7-1721843514043"></a>[单调钟](#hl1a-1711387385739)

<a name="18pi-1721843514045"></a>[保证总是前进](#uzaz-1711470052827)

<a name="ifo6-1721843514047"></a>[Linux:CLOCK_MONOTONIC](#tbmn-1711469988760)

<a name="dmbn-1721843514049"></a>[java:System.nanoTime](#fb70-1711470014393)

<a name="epxi-1721843514051"></a>[调整频率：NTP检测到计算机石英钟更快或更慢，则调整单调钟频率（偏移skewing时钟）.](#sn42-1711470028035)

<a name="pa83-1721843514053"></a>[不假定不同节点时钟存在同步：分布式系统用单调钟效果好，对测量的不准确不敏感](#ct3v-1711470667953)

<a name="mfdv-1721843514055"></a>[时钟同步与准确性](#a7gy-1711387238026)

<a name="mkkr-1721843514057"></a>[漂移drifts: 计算机石英钟不准确原因,取决机器温度。](#pbyu-1711470750697)

<a name="1ecr-1721843514059"></a>[实现精确度：GPS接收机，精确时间协议PTP](#kgdy-1711470917769)

<a name="hqsc-1721843514061"></a>[同步错误的原因：NTP守护进程配置错误，防火墙阻止NTP通信。](#kgez-1711470944635)

<a name="gqhi-1721843514063"></a>[依赖同步时钟](#vo0i-1711387245745)

<a name="lxmt-1721843514065"></a>[使用需要同步时钟的软件需监测所有机器间的时钟偏移](#zm2f-1711471000801)

<a name="qmqc-1721843514067"></a>[有序事件的时间戳](#fnxq-1711387475761)

<a name="cnm4-1721843514069"></a>[写入排序问题：B客户端写入比A晚但具有更早的时间戳。 ](#n1pp-1711471283186)

<a name="gwwf-1721843514071"></a>[ 最后写入为准LWW](#50kp-1711471399605)

<a name="hu2d-1721843514073"></a>[ 版本向量](#axgx-1711471482711)

<a name="my62-1721843514075"></a>[时钟读数存在置信区间](#ofpq-1711387431462)

<a name="tgiy-1721843514077"></a>[ 置信区间的不确定性：NTP服务器的不去定性，加上服务器网络往返时间](#aihs-1711471513794)

<a name="abuq-1721843514079"></a>[当clock_gettime()返回值不会告诉你预期错误，不知道置信区间是5毫秒还是5年](#aave-1711471693187)

<a name="uiqu-1721843514081"></a>[例外：Spanner Google TureTime API明确报告本地时钟置信区间（最早，最晚）。](#znqm-1711471741654)

<a name="opf7-1721843514084"></a>[全局快照的同步时钟](#bfz6-1711387449885)

<a name="u8jl-1721843514086"></a>[分布式的事务快照隔离，分布式事务ID时序成为站不住脚瓶颈](#dpco-1711471815493)

<a name="eblv-1721843514088"></a>[Spanner通过置信区间来比较A,B发生的时序。](#2ihe-1711471939317)

<a name="1nbp-1721843514090"></a>[分布式事务语义使用时钟同步是一个活跃的研究领域，没有在谷歌之外的主流数据库中实现。](#9qfk-1711471991096)

<a name="opnm-1721843514092"></a>[暂停进程](#3mnj-1711387250438)

<a name="apd0-1721843514094"></a>[如何确保分布式主节点仍未领导者](#ui0e-1711472636558)

<a name="lgxh-1721843514096"></a>[方式一：从其他节点获得租约lease, 类似一个带超时的锁，周期性过期前续约。-和redison续约类似](#yh9a-1711472775035)

<a name="yz1l-1721843514098"></a>[过期时，由另一个节点接管。](#kqwv-1711472837428)

<a name="wjyh-1721843514100"></a>[缺点：依赖同步时钟](#gi5a-1711473874947)

<a name="8isg-1721843514102"></a>[意外的时间停顿：](#93uw-1711473992955)

<a name="rokb-1721843514104"></a>[stop-the-world  HotSpot GC](#7kp7-1711474017909)

<a name="7wkj-1721843514106"></a>[suspend虚拟机](#6ejp-1711474059672)

<a name="ztef-1721843514108"></a>[随意暂停恢复：关闭笔记本盖子](#92se-1711474080346)

<a name="1ccn-1721843514110"></a>[窃取时间steal time:虚拟机切换或cpu上下文切换，在其他机器中花费的时间.](#tfxw-1711474128862)

<a name="igkx-1721843514112"></a>[同步时的阻塞io：java惰性加载类文件；磁盘为网络文件系统或网络块设备-亚马逊EBS](#7jwg-1711474280466)

<a name="tb59-1721843514114"></a>[磁盘交换内存抖动thrashing: 允许交换到磁盘（分页），内存访问可能导致页面错误page fault .话费大量时间将页面交换到内存，实际完成的工作很少thrashing。 服务器机器禁用页面调度，干掉进程释放内存。](#kvsa-1711474441136)

<a name="dkha-1721843514116"></a>[SIGSTOP暂停unix进程:Ctrl-Z立即阻止进程的CPU周期](#ocvk-1711474648160)

<a name="6pd3-1721843514118"></a>[这些都可以随时抢占preempt正在运行的线程。](#t1w7-1711474768157)

<a name="lsam-1721843514120"></a>[响应时间保证](#cirf-1711473855327)

<a name="xs7x-1721843514122"></a>[硬实时hard real-time系统: 不满足特定截止时间deadline可能会导致整个系统故障。](#r1ji-1711474887529)

<a name="ld4s-1721843514124"></a>[嵌入式系统精心设计和测试：安全气囊不会因系统GC暂停弹出。](#pgjw-1711475001376)

<a name="gvor-1721843514126"></a>[大量的额外工作，昂贵。](#urp5-1711475089330)

<a name="z9ak-1721843514128"></a>[限制垃圾收集的影响](#i1wt-1711387521748)

<a name="2vsi-1721843514130"></a>[通知GC暂停，停止接收新请求-对延迟敏感的金融系统](#oxal-1711475134772)

<a name="gpom-1721843514132"></a>[变种：GC只收集新生代，积累老年代，一次重启一个节点，类似滚动升级。](#ho3v-1711475217820)

<a name="y4tk-1721843514134"></a>[知识、真相与谎言](#ujyf-1711386681865)

<a name="r2mw-1721843514136"></a>[真理由多数所定义](#hdwi-1711387268312)

<a name="kfpf-1721843514138"></a>[stop the world 一分钟，被其他节点宣告死亡，重新选举。](#rxcy-1711561420884)

<a name="eutg-1721843514140"></a>[领导者与锁定](#3zea-1711387542106)

<a name="eceq-1721843514142"></a>[数据库分区领导者只能有一个节点：避免脑裂](#b6am-1711561462773)

<a name="retw-1721843514144"></a>[特定资源的锁和对象只允许一个事务/客户端持有](#3ynw-1711561525662)

<a name="fisp-1721843514146"></a>[用户唯一标识](#hqa3-1711561556083)

<a name="zmcl-1721843514148"></a>[节点认为它是天选者the choosen one](#rv2w-1711561875596)

<a name="q4fz-1721843514150"></a>[HBase例子：分布式锁的实现不正确，客户端1持有锁stop the world导致lease超时,客户端2获得锁进行处理，客户端1仍认为它具有有效的租约，即使它已经过期，从而破坏了存储的文件。](#gu25-1711561617808)

<a name="ftxj-1721843514152"></a>[防护令牌](#mhlf-1711387550649)

<a name="2opx-1721843514154"></a>[解决天选者问题：防护fencing](#gw5w-1711561950975)

<a name="svq0-1721843514156"></a>[fencing token :只允许增加屏蔽令牌的顺序进行写操作。](#vi5w-1711562021406)

<a name="uaza-1721843514158"></a>[服务器端检查token,获取锁时token增加33+1，存储服务器记录更高令牌34的写入，拒绝令牌33的请求。-一般是redisson续期，这个更像乐观锁。](#2yxl-1711562140276)

<a name="dulp-1721843514160"></a>[ZooKeeper将事务标识zxid和节点版本conersion用作屏蔽令牌。保证了单调递增](#e6n2-1711562077138)

<a name="huha-1721843514162"></a>[如文件存储服务器可将令牌卸载文件命中](#uujk-1711564755459)

<a name="esug-1721843514164"></a>[拜占庭故障](#bsay-1711387279845)

<a name="envi-1721843514166"></a>[拜占庭故障Byzantine fault: 在不信任的环境中达成共识的问题称为拜占庭将军问题。](#id0b-1711628556885)

<a name="uklq-1721843514168"></a>[拜占庭将军问题：n位将军需要同意，一些叛徒通过发送虚假或不真实信息来混淆欺骗他人。](#lxw6-1711628612728)

<a name="wblp-1721843514170"></a>[拜占庭容错：系统在部分节点发生故障、不遵守协议，恶意攻击，扰乱网络时仍能继续正确工作：](#lpn6-1711628716132)

<a name="eocm-1721843514172"></a>[航空航天环境计算机被辐射破坏，不可预知方式响应其他节点](#py6z-1711638469892)

<a name="1kca-1721843514174"></a>[多个参与组织系统中，参与者试图欺骗他人。比特币等区块链对等网络让互不信任的各方同意交易不依赖中央当局。](#csli-1711638605446)

<a name="vcqm-1721843514176"></a>[弱谎言形式](#f38o-1711387557457)

<a name="eflt-1721843514178"></a>[添加防止撒谎弱形式机制；](#eepx-1711638744038)

<a name="ovug-1721843514180"></a>[校验和防止数据包被破坏](#yseh-1711638821915)

<a name="dymm-1721843514182"></a>[公开访问的系统需仔细清理来自用户的任何输入](#2a8h-1711638847924)

<a name="dlsd-1721843514184"></a>[NTP多数对时间范围达成一致，配置错误的服务器将被排除](#zcdt-1711638888096)

<a name="rzah-1721843514186"></a>[系统模型与实现](#x4lu-1711387293192)

<a name="nuql-1721843514188"></a>[定时假设三种系统模型：](#iyps-1711639179162)

<a name="t2su-1721843514190"></a>[同步模型synchronous model: 网络延迟，暂停和时钟漂移不会超过某个固定上限；](#pgo0-1711640511485)

<a name="gklp-1721843514192"></a>[部分同步模型partial synchronous：大多数情况像一个同步系统一样运行，有时出现超时，进程暂停和时钟漂移界限](#h1x4-1711640383000)

<a name="a3uw-1721843514194"></a>[异步模型：一个算法不允许对实际做任何假设，事实上它甚至没有时钟。](#vkkn-1711640459345)

<a name="gdtk-1721843514196"></a>[节点系统模型：-节点失效问题](#lg5f-1711640536166)

<a name="1kdt-1721843514198"></a>[崩溃停止crash-stop:只能由崩溃失效，且永远不会回来。](#ahco-1711640498506)

<a name="8ok7-1721843514200"></a>[崩溃恢复crash-recovery: 具有稳定存储（非易失性磁盘），崩溃中保留，内存中状态会丢失-innodb三阶段提交](#35nl-1711640632666)

<a name="6ozn-1721843514202"></a>[拜占庭（任意）故障：节点可以做任何事情，包括戏弄和欺骗其他节点](#rpmc-1711640822813)

<a name="gyg2-1721843514204"></a>[具有崩溃恢复的部分同步模型是最有用的模型。分布式算法如何应用这种模型](#6gea-1711640879281)

<a name="5vzq-1721843514206"></a>[算法的正确性](#hwoz-1711387576180)

<a name="mrf4-1721843514208"></a>[描述属性：定义算法的正确性](#i9kv-1711640972087)

<a name="tvpn-1721843514210"></a>[锁生成屏蔽令牌，要求具有以下属性：](#qsck-1711641049261)

<a name="779k-1721843514212"></a>[唯一性：没有两个屏蔽令牌请求返回相同的值](#tvxj-1711641079676)

<a name="kqsz-1721843514214"></a>[单调序列：时序实现单调](#2d0a-1711641105012)

<a name="qic0-1721843514216"></a>[可用性：请求防护令牌且不会崩溃的节点，最终会收到响应](#mlbd-1711641130527)

<a name="lwgv-1721843514218"></a>[安全性和活性](#1lz8-1711387585629)

<a name="gfnm-1721843514220"></a>[澄清这种情况，需区分两种不同性质](#hctm-1711641203049)

<a name="ya3a-1721843514222"></a>[安全性safety: 唯一性和单调序列](#k48b-1711641295367)

<a name="oes5-1721843514224"></a>[活性：可用性](#fmy7-1711641313609)

<a name="bm7w-1721843514226"></a>[将系统模型映射到现实世界](#ndiw-1711387592922)

<a name="o7kg-1721843514228"></a>[9.一致性共识](#rp9s-1705080859004)

<a name="x6bz-1721843514230"></a>[共识consensus: 让所有节点对某件事达成一致](#vrvh-1712996687843)

<a name="v5qf-1721843514232"></a>[脑裂brain split: 两个节点都认为自己是master, 经常导致数据丢失；](#oqcs-1712996726634)

<a name="vuwu-1721843514234"></a>[一致性保证](#obqn-1711730044966)

<a name="8p9v-1721843514236"></a>[最终一致性：收敛convergence, 最终收敛到相同的值](#ku5g-1712996774138)

<a name="1tac-1721843514238"></a>[事务一致性：避免同时执行事务导致的竞争状态](#ga60-1712996859001)

<a name="q2w8-1721843514240"></a>[分布式一致性模型：面对延迟和故障时，如何协调副本间的状态](#eovi-1712996916251)

<a name="o6nc-1721843514242"></a>[线性一致性](#thyh-1711730049653)

<a name="zsfj-1721843514244"></a>[背后的想法：原子一致性atomic consistency, 强一致性strong consistency, 立即一致性 immediate consistency ,外部一致性 external consistency](#bvre-1712997165569)

<a name="fdia-1721843514246"></a>[看起来只有一个数据副本，实际有多个副本 - 强一致性就是逆分布式化，看成一个整体。](#qbsw-1712997247742)

<a name="y7yq-1721843514248"></a>[线性一致是一个新鲜度保证 recency gurantee;](#f0su-1712997377059)

<a name="vd04-1721843514250"></a>[非线性一致的例子： world cup ,  alice refresh - DB1 return germany 1: 0 argentina won ;  bob refresh website - DB2(un asychronize) return still playing;](#mtb7-1712997407717)

<a name="vzmq-1721843514252"></a>[为什么使得系统线性一致？](#qimr-1711730403998)

<a name="mijy-1721843514254"></a>[例子：CAS使得多个客户端并发按序更新](#ffat-1712998155207)

<a name="71ca-1721843514256"></a>[线性一致性与可序列化是两种完全不同的保证：](#3elk-1712997586736)

<a name="1ljz-1721843514258"></a>[可序列化serializeble: 单对象或者多对象操作，确保按照某种顺序执行](#qpvu-1712998010030)

<a name="ldd1-1721843514260"></a>[线性一致性Linearizability:是读取和写入寄存器（单个对象）的新鲜度保证，不会将操作组合为事务，不会阻止写入偏差等问题](#ojsh-1712998125336)

<a name="mvkd-1721843514262"></a>[单副本强可串行性strong-1SR: 一个数据库可提供可串行性和线性一致, 基于两阶段锁2PL和实际串行执行通常是线性一致的](#5hda-1712998332148)

<a name="fpsw-1721843514264"></a>[SSI一致性快照不是线性一致的：不会包括比快照更新的写入；-不会阻塞非写的读。](#obfn-1712998432352)

<a name="4dyi-1721843514266"></a>[依赖线性一致性](#bje8-1711730427157)

<a name="azkg-1721843514268"></a>[锁定与领导选举](#xyll-1711730652620)

<a name="ihd7-1721843514270"></a>[领导选举的一种方法：每个节点启动时尝试获取锁，成功者称为领导者。](#2fqs-1712998599719)

<a name="gnh5-1721843514272"></a>[保证锁时线性一致的： zookeeper 和 etcd 协调服务的一致性算法。curator基于zookeeper上更高级别的配方](#cbzr-1712998723133)

<a name="y6hb-1721843514274"></a>[约束和唯一性保证](#gpva-1711730659968)

<a name="rqye-1721843514276"></a>[这种情况类似于一个锁，锁定用户名。该操作与原子性的cas类似：](#9jmj-1712998930168)

<a name="hckq-1721843514278"></a>[用户名和邮箱；](#lhyk-1712999021176)

<a name="qgav-1721843514280"></a>[银行账号不为负数；](#7sgo-1712999031257)

<a name="tcsz-1721843514282"></a>[航班剧院预定了同一时间同一位置](#so5k-1712999045093)

<a name="hakt-1721843514284"></a>[实际应用中，处理这些限制有时可以接受。如调换位置并补偿。](#q05j-1712999070223)

<a name="iu2q-1721843514286"></a>[跨信道的时序依赖](#7cbv-1711730671963)

<a name="mxrj-1721843514288"></a>[将用户上传的照片降低分辨率以加快下载速度：](#cqkp-1712999245541)

<a name="vnmb-1721843514290"></a>[步骤：消息队列一般针对较短的消息而设计，一张图片可能达到几M.所以步骤为](#3zoo-1712999362806)

<a name="wa1e-1721843514292"></a>[1.上传照片-  web server-2.  (store img) 存储文件服务器  ](#umkb-1712999318589)

<a name="uxrn-1721843514294"></a>[  | 3. send message  || 5.fetch full size img  6.store resized img](#er8u-1712999518585)

<a name="qb1x-1721843514296"></a>[消息队列   - 4.deliver message     image resizer](#iiv4-1712999532781)

<a name="aizj-1721843514298"></a>[问题：存储和缩放存在两个不同的信道，没有线性一致的新鲜度保证](#0yys-1712999647965)

<a name="tvy5-1721843514300"></a>[3和4可能比存储服务器内部的复制更快，当5时，可能会看到图像旧版本或者什么都没有，如果处理的是旧版本，则产生不一致。](#xtun-1712999768959)

<a name="kpsc-1721843514302"></a>[实现线性一致性的系统](#ytt0-1711730433598)

<a name="gis0-1721843514304"></a>[单主复制（可能线性一致）protential潜在线性一致：](#j997-1712999879559)

<a name="jhf7-1721843514306"></a>[快照隔离并发错误；](#t174-1712999979364)

<a name="uxyh-1721843514308"></a>[脑裂；异步复制延迟，故障切换](#hh6o-1712999996439)

<a name="m80v-1721843514310"></a>[共识算法（线性一致）：共识算法可以安全实现线性一致性的存储，zookeeper 和 etcd](#z3nq-1713000050923)

<a name="hudo-1721843514312"></a>[多主复制（非线性一致）：同时多个节点上处理写入，异步复制到其他节点，会产生冲突的写入](#q0kz-1713000066034)

<a name="vinu-1721843514314"></a>[无主复制（也许不是线性一致的）：Dynamo风格，法定人数读写获得强一致性。通常不完全正确](#ca4m-1713030167882)

<a name="sydo-1721843514316"></a>[线性一致性和法定人数](#9gst-1711730681011)

<a name="uz5y-1721843514318"></a>[最安全的做法是：假设采用Dynamo风格的无主复制的系统是不能提供线性一致性。](#sqvx-1713030399799)

<a name="sh7d-1721843514320"></a>[线性一致性的代价](#vpxf-1711730440465)

<a name="utq9-1721843514322"></a>[CAP定理](#fqqf-1711730717308)

<a name="7oja-1721843514324"></a>[不仅是单主多主复制的后果，任何线性一致性的数据库都有这个问题：](#8hzl-1713030564813)

<a name="qteu-1721843514326"></a>[.应用需要线性一致性，副本因为网络问题断开连接，请求必须等到网络问题解决或直接返回错误（不可用unavailable）](#7lux-1713030592466)

<a name="t6gn-1721843514328"></a>[.网络断开也可独立处理请求（如多主复制），可以在网络问题前保持可用，但其行为不是线性一致的。](#48wk-1713031150235)

<a name="3kd5-1721843514330"></a>[CAP定理没有帮助：网络分区是不可避免的，所以只能是AP 或 CP。](#lsdc-1713031249676)

<a name="c2tu-1721843514332"></a>[线性一致性和网络延迟](#kxsm-1711730728177)

<a name="930s-1721843514334"></a>[ 线性一致的系统惊人的少。例如多核CPU并没有保证一定能读到第一个线程写入的值（除非使用内存屏障memory barrier或围栏fence）](#lbl2-1713031508671)

<a name="l1oc-1721843514336"></a>[ 牺牲线性一致性的原因是性能performance. 内存访问先走缓存，副本都是异步更新的，所以失去了线性一致性。](#pnsn-1713031585885)

<a name="m16l-1721843514338"></a>[搞笑的线性一致性存储不可实现。](#8y6v-1713031685808)

<a name="h0mj-1721843514340"></a>[顺序保证](#on5f-1711730057760)

<a name="tfj7-1721843514342"></a>[写入顺序order of write: 单主复制的主要目的就是复制日志中确定写入顺序。](#dhiv-1713031758875)

<a name="0b5e-1721843514344"></a>[序列顺序serial order：某种序列顺序some sequential order](#cyfr-1713031815356)

<a name="l9ky-1721843514346"></a>[顺序与因果](#z48k-1711730472679)

<a name="br22-1721843514348"></a>[顺序有助于保持因果关系causality](#khzl-1713031939113)

<a name="erax-1721843514350"></a>[一致前缀读：先看到答案再看到问题。违背因cause果effect. 存在因果依赖causal dependency](#nbes-1713031966982)

<a name="0wvp-1721843514352"></a>[更新不存在的记录：3位领导者间的复制，一些写入会压到其他写入。一条记录需被创建才能更新。](#xehj-1713032060272)

<a name="1y7m-1721843514354"></a>[检测并发写入：A和B并发，则不知道顺序，A和B不知道彼此。](#v1kv-1713032135082)

<a name="kcmu-1721843514356"></a>[快照隔离：写偏差read skew，读取的数据违反因果关系（不可重复读）](#ozi8-1713032226341)

<a name="et9z-1721843514358"></a>[事务的写偏差write skew：幻读和值班。](#pgzq-1713032264605)

<a name="oeh3-1721843514360"></a>[世界杯球赛结果，跨信道的时序依赖。](#3ang-1713032756197)

<a name="augi-1721843514362"></a>[因果一致causally：系统服从因果关系锁规定的顺序。](#tryg-1713032788961)

<a name="st25-1721843514364"></a>[因果顺序不是全序的](#niwx-1711730751513)

<a name="xjst-1721843514366"></a>[全序total order: 自然数更大或更小，总是有序的](#x8gk-1713086054855)

<a name="av9h-1721843514368"></a>[偏序partially order: 一个集合大于另一个集合，但是其它情况下无法比较](#wvsa-1713086222914)

<a name="dzby-1721843514370"></a>[线性一致性：操作是全序的，系统表现好像只有一个副本，所有操作都是原子性的。意味对每个操作总能判定发生顺序](#u7jq-1713086312064)

<a name="eogs-1721843514372"></a>[因果性：两个操作没在彼此之前发生，即并发无法比较顺序，意味着因果关系定义了一个偏序，而不是全序。一些有序一些无序](#xa0w-1713086399916)

<a name="2sae-1721843514374"></a>[线性一致的数据存储中是不存在并发操作的。确保每个请求都是在唯一时间线上自动处理](#uaxz-1713086531138)

<a name="0wgy-1721843514376"></a>[并发意味着时间线会分叉然后合并。操作的偏序：](#qs64-1713086635361)

<a name="crsd-1721843514378"></a>[类似git系统，一个提交commit发生在另一个提交之后。分支合并merge会在这些并发创建的提交相融合时创建。](#ctkd-1713086670170)

<a name="jfpt-1721843514380"></a>[线性一致性强于因果一致性](#qdnf-1711730766239)

<a name="sjj0-1721843514382"></a>[线性一致性隐含implies着因果关系;](#dam4-1713086279684)

<a name="ihl2-1721843514384"></a>[捕获因果关系](#uqqx-1711730776113)

<a name="d7jv-1721843514386"></a>[为了维持因果性，需确认操作发生在哪个操作之前happened before:](#agrw-1713086796608)

<a name="0jsn-1721843514388"></a>[刑侦决定Y时是否知到X与Y因果关系](#rys3-1713086865582)

<a name="zfuz-1721843514390"></a>[检测并发写入：推广版本向量解决因果依赖](#znup-1713086911030)

<a name="xy8f-1721843514392"></a>[SSI序列化隔离快照：事务提交时，检测读取是否最新，为此跟踪哪些事务被那些事务锁读取。](#1ivk-1713086936754)

<a name="85lh-1721843514394"></a>[序列号顺序](#jsuf-1711730485869)

<a name="hkqu-1721843514396"></a>[序列号sequence number或时间戳timestamp](#y9ti-1713091524670)

<a name="tyeg-1721843514398"></a>[非因果序列号生成器](#qpya-1711730796494)

<a name="3hlw-1721843514400"></a>[兰伯特时间戳](#mtzj-1711730811106)

<a name="ni0n-1721843514402"></a>[兰伯特时间戳提供了与因果关系一致的总排序：施行一个全序](#f8uv-1713091653199)

<a name="3gss-1721843514404"></a>[检测并发写入有着不同目的：区分两个操作是并发的，一个因果依赖另一个。](#2ayx-1713091789731)

<a name="oufm-1721843514406"></a>[光有时间戳排序还不够](#elc6-1711730816628)

<a name="kes3-1721843514408"></a>[全序广播](#aw2l-1711730490423)

<a name="1olf-1721843514410"></a>[可靠交付reliable delivery：没有消息丢失，如果消息被传递到一个节点，它将被传递到所有节点](#axul-1713091937508)

<a name="mdxg-1721843514412"></a>[全序交付totally ordered delivery: 消息以相同的顺序传递给每个节点。](#cruc-1713091989510)

<a name="vg7p-1721843514414"></a>[使用全序广播](#hp3a-1711730834892)

<a name="wo2b-1721843514416"></a>[zookeeper和etcd共识服务实际上实现了全序广播](#ztws-1713108978601)

<a name="yvfr-1721843514418"></a>[状态机复制state machine repliacation: 每个副本都按相同的顺序处理相同的写入。](#i8bk-1713109007327)

<a name="uyfn-1721843514420"></a>[与之类似，使用全序广播来实现可序列化的事务：真的串行执行，确定的事务以存储过程来执行，每个节点以相同的顺序处理这些消息。](#8jch-1713109071990)

<a name="dltx-1721843514422"></a>[以及防护令牌的锁服务，全序广播使得所有消息按顺序一次编号，序列号可当做防护令牌(单调递增)，zookeeper中这个序列号称为zxid;](#w19a-1713109204107)

<a name="etp9-1721843514424"></a>[使用全序广播实现线性一致的存储](#i3vg-1711730844593)

<a name="ck2q-1721843514426"></a>[使用线性一致性存储实现全序广播](#xlae-1711730855140)

<a name="ihqt-1721843514428"></a>[分布式事务与共识](#y1bv-1711730380233)

<a name="aot9-1721843514430"></a>[让几个节点达成一致get serveral nodes to agree on somthing](#yt5r-1713109388776)

<a name="s7om-1721843514432"></a>[领导选举：避免脑裂](#d7t7-1713109479427)

<a name="u3ph-1721843514434"></a>[原子提交atomic commit：多节点事务提交/中止/回滚](#frsp-1713109508353)

<a name="f2xw-1721843514436"></a>[原子提交与两阶段提交2PC](#abk6-1711730509647)

<a name="mpp0-1721843514438"></a>[原子性可以避免中间态，多对象事务原子性确保二级索引与主数据库保持一致。](#0h2f-1713110484428)

<a name="hkzz-1721843514440"></a>[从单节点到分布式原子提交](#iqfd-1711730882368)

<a name="qlmj-1721843514442"></a>[从数据库的角度看，这是单独的事务，任何跨事务正确性的保证都是应用自己的问题。](#h1ym-1713110537245)

<a name="hobt-1721843514444"></a>[2PC两阶段提交简介](#roa9-1711730906391)

<a name="0evd-1721843514446"></a>[coodinator协调子事务，子事务单独执行完，在准备阶段询问是否可提交](#vaax-1705118249954)

<a name="bmxh-1721843514448"></a>[.全部为是，则分别提交。](#7zwc-1705118288968)

<a name="4vmf-1721843514450"></a>[.其中有否，则中断回滚。](#3b8s-1705118337513)

<a name="c3gl-1721843514452"></a>[系统承诺](#kpgk-1711730913393)

<a name="flc4-1721843514454"></a>[一旦协调者做出决定，这一决定是不可撤销的。](#wkui-1713110739239)

<a name="t8vf-1721843514456"></a>[协调者失败](#qhdj-1711730921387)

<a name="c6us-1721843514458"></a>[参与者投赞成票后，参与者协调者崩溃，数据库1不知道是否提交或中止。](#jpd8-1713110804532)

<a name="xwnn-1721843514460"></a>[三阶段提交](#ixzv-1711730924556)

<a name="ejxw-1721843514462"></a>[阻塞blocking原子提交协议, 2PC可能卡主等待协调者恢复的情况。](#edp3-1713111179295)

<a name="ai7m-1721843514464"></a>[在提交阶段，如果子事务进程crash,或者协调者崩溃的时的解决方案，弱原子性，最终一致性。](#llyc-1711731148564)

<a name="lj0h-1721843514466"></a>[许多coodinator不支持高可用或者只支持基本的复制](#nlrk-1705118500709)

<a name="swd3-1721843514468"></a>[实践中的分布式事务](#xexf-1711730524691)

<a name="yxgw-1721843514470"></a>[云服务由于其导致的运维问题而选择不实现分布式事务。](#inqh-1713111548114)

<a name="opkn-1721843514472"></a>[两阶段难以实现安全保证，且导致的运维问题造成性能下降。](#zuho-1713111590325)

<a name="gycd-1721843514474"></a>[数据库内部的分布式事务](#gf92-1711731287296)

<a name="5uy6-1721843514476"></a>[VoltDB 与mysql Cluster 的NDB引擎就有这样的内部事务支持。](#jhqw-1705080950920)

<a name="nir7-1721843514478"></a>[异构分布式事务](#gvng-1713111648038)

<a name="m9fd-1721843514480"></a>[保证异构数据库的事务更有挑战性](#st60-1713111659854)

<a name="k2q6-1721843514482"></a>[恰好一次的消息处理](#btdt-1711730944613)

<a name="uzhn-1721843514484"></a>[XA事务eXtended Architecture](#qvbk-1711730954739)

<a name="i1da-1721843514486"></a>[怀疑时持有锁](#med0-1711730959684)

<a name="q3ew-1721843514488"></a>[从协调者故障中恢复](#ouyq-1711730969007)

<a name="8ps5-1721843514490"></a>[唯一的出路是让管理员手动决定提交还是回滚事务](#ouur-1713116418144)

<a name="guaf-1721843514492"></a>[分布式事务的限制](#gzya-1711730975747)

<a name="8ido-1721843514494"></a>[协调者本身就是一种数据库，存储了事务的结果。](#jkt3-1713116480399)

<a name="bmey-1721843514496"></a>[协调者默认不是高可用的，只有基本的复制](#mcvv-1713116529836)

<a name="kyoh-1721843514498"></a>[应用服务器不再是无状态的了](#h6gt-1713116550997)

<a name="sog9-1721843514500"></a>[不能检测不同系统间的死锁，且无法与SSI协同工作](#rrrl-1713116568769)

<a name="dxzk-1721843514502"></a>[与构建容错系统的目标背道而驰，分布式事务有扩大失效amplifying failures的趋势](#wbzw-1713116600081)

<a name="4rlb-1721843514504"></a>[容错共识](#npne-1713118985168)

<a name="b9td-1721843514506"></a>[一个或多个节点提议propose某些值，共识算法决定decides采用其中的某个值。](#beiq-1713118985169)

<a name="5pvm-1721843514508"></a>[一致同意Uniform agreement:  没有两个节点的决定不同-核心 决定了相同的结果，一旦决定不能改变](#pq0x-1713118985170)

<a name="xrkr-1721843514510"></a>[完整性Integrity: 没有节点决定两次-核心](#xnwp-1713118985171)

<a name="fluw-1721843514512"></a>[有效性validity: 如果一个节点决定了值v, 则v由某个节点所提议-排除平凡的解决方案](#2bty-1713118985172)

<a name="3ff5-1721843514514"></a>[终止Termination由所有为崩溃的几点来最终决定值。-活性属性，必须取得进展，即使部分节点出现故障，其他节点也必须达成一致。不超过一般的节点崩溃或不可达](#9k32-1713118985173)

<a name="oqwp-1721843514516"></a>[稳健达成共识：只要少于三分之一的节点存在拜占庭故障](#scne-1713118985174)

<a name="ew3u-1721843514518"></a>[共识算法和全序广播](#prxr-1713118985175)

<a name="tktp-1721843514520"></a>[视图戳复制VSR viewstamped repliacation, Paxos，Raft, Zab](#zmcg-1713118985176)

<a name="vh4k-1721843514523"></a>[全序广播相当于重复进行多轮共识：](#1u8f-1713118985177)

<a name="vk7w-1721843514525"></a>[一致同意属性，所有节点决定以相同的顺序传递相同的消息](#d2l2-1713118985178)

<a name="jlcy-1721843514527"></a>[完整性属性，消息不会重复](#z7u4-1713118985179)

<a name="9q5v-1721843514529"></a>[有效性属性，消息不会被破坏，也不能凭空编造](#pphb-1713118985180)

<a name="ycwn-1721843514531"></a>[终止属性,消息不会丢失](#gqmq-1713118985181)

<a name="nfrz-1721843514533"></a>[视图戳复制，raft和zab直接实现了全序广播，比重复一次一致one value a time的共识更高效， paxos 下这种优化称为multi-paxos.](#lxll-1713118985182)

<a name="oefo-1721843514535"></a>[单领导者复制和共识](#krsz-1713118985183)

<a name="4jxt-1721843514537"></a>[时代编号和法定人数](#90tt-1713118985184)

<a name="67tz-1721843514539"></a>[共识的局限性](#qywj-1713118985185)

<a name="rsbo-1721843514541"></a>[成员与协调服务](#8qzt-1713118985186)

<a name="kag6-1721843514543"></a>[将工作分配给节点](#4tlb-1713118985187)

<a name="oviz-1721843514545"></a>[服务发现](#tbbj-1713118985188)

<a name="rfr9-1721843514547"></a>[成员服务](#1lld-1713118985189)

<a name="bllq-1721843514549"></a>[第三部分：衍生数据](#46k8-1705118453932)

<a name="zpe5-1721843514551"></a>[记录和衍生数据系统](#rboc-1716226529015)

<a name="jouv-1721843514553"></a>[从高层次看，存储和处理数据的系统可以分为两大类](#cmdh-1716226737947)

<a name="owry-1721843514555"></a>[记录系统System of record](#1dmv-1716226552894)

<a name="kynf-1721843514557"></a>[真相源source of truth. 记录用户输入新数据，标准化normalized](#dh96-1716226777418)

<a name="cckg-1721843514559"></a>[衍生数据系统Derived data system](#qjlf-1716226568395)

<a name="mc2a-1721843514561"></a>[缓存cache, 衍生数据是冗余的，重复了已有的信息。](#igtl-1716226871151)

<a name="khup-1721843514563"></a>[10.批处理](#0bgb-1716226496297)

<a name="bw9r-1721843514565"></a>[服务（在线系统）：高可用性，性能指标-响应时间](#yygb-1720542683707)

<a name="pzne-1721843514567"></a>[批处理系统（离线系统）：定时任务job，性能指标-吞吐量](#goo7-1720542700859)

<a name="ds1p-1721843514569"></a>[流处理系统（准实时系统）：介于在线离线系统之间](#mv2a-1720542952432)

<a name="tqcj-1721843514571"></a>[使用Unix工具的批处理](#6lu4-1716228538928)

<a name="ltdp-1721843514573"></a>[分析简单日志](#hyii-1716228597300)

<a name="opd2-1721843514575"></a>[Unix命令链：网站上找到五个最受欢迎的网页（nginx/access.log）](#smoq-1720543218731)

<a name="33g5-1721843514577"></a>[命令链与自定义程序Ruby](#ukyi-1716228816049)

<a name="wnsb-1721843514579"></a>[排序 VS 内存中的聚合](#cnuw-1716228829632)

<a name="j6qz-1721843514581"></a>[工作集working set(作业需要随机访问的内存大小)，单个url 重复出现百万次，哈希表性能好](#siiu-1720543940755)

<a name="vrfa-1721843514583"></a>[工作集大于内存，排序优，与SSTables 和 LSM树一样，内存聚合归并排序，GNU 中的sort通过溢出至磁盘自动应该大于内存大额数据集，瓶颈可能是磁盘io。-MQ的死信处理也是溢出到磁盘。](#lms0-1720544023798)

<a name="s3dn-1721843514585"></a>[Unix哲学](#mgei-1716228613042)

<a name="tl7j-1721843514587"></a>[统一的接口](#sk3b-1716228852580)

<a name="nrr0-1721843514589"></a>[Unix中统一的接口是一个文件file](#33ju-1720874904091)

<a name="1wtr-1721843514591"></a>[ASCII文本，\n 分隔，](#yogq-1720875513301)

<a name="tnwk-1721843514593"></a>[CSV， ，号分隔](#7fvb-1720875542091)

<a name="yeks-1721843514595"></a>[逻辑与布线相分离](#3oxq-1716228869387)

<a name="kf3e-1721843514597"></a>[松耦合loose coupling](#0zy9-1720876020643)

<a name="ctzb-1721843514599"></a>[晚期绑定late binding](#226j-1720876035472)

<a name="2ouv-1721843514601"></a>[控制反转inversion of control](#zedb-1720876065554)

<a name="wzb0-1721843514603"></a>[透明度与实验](#ftj8-1716228879278)

<a name="k0be-1721843514605"></a>[MapReduce和分布式文件系统](#djdy-1716228554334)

<a name="tuhh-1721843514607"></a>[MapReduce像是分布在数前台机器上的Unix。](#illh-1720876369554)

<a name="g4yj-1721843514609"></a>[Hadoop的Map-Reduce视线中，文件系统成为HDFS,基于google文件系统GFS的开源实现。](#e1cy-1720876447842)

<a name="02d3-1721843514611"></a>[Amazon S3，  Azure blob ](#mapk-1720876955975)

<a name="c7ba-1721843514613"></a>[MapReduce作业执行](#kdge-1716228625984)

<a name="t4ru-1721843514615"></a>[Mapper在每条输入记录上调用一次,从输入记录中提取键值（提取键值）](#vleh-1720877349422)

<a name="v2gl-1721843514617"></a>[Reduce拉取Mapper生成的键值对，收集属于同一个键的所有值。（收集同键的所有值）](#aol7-1720877397533)

<a name="2f1m-1721843514619"></a>[分布式执行MapReduce](#kv6u-1716231603620)

<a name="wwhi-1721843514621"></a>[即在不同服务器上执行mapper reduce 的task。](#wy7r-1720877483243)

<a name="x1mg-1721843514623"></a>[MapReduce工作流](#d0qe-1716231619319)

<a name="6mci-1721843514625"></a>[workflow。一系列命令，输出写入临时文件，下一个命令从临时文件中读取-物化中间状态](#rvme-1720877910897)

<a name="owk3-1721843514627"></a>[Reduce端连接与分组](#pyoc-1716228643855)

<a name="pzrw-1721843514629"></a>[用户活动事件](#1pza-1716231634942)

<a name="rcmd-1721843514631"></a>[左侧是事件日志/活动事件activity events/点击流事件clickstream evnets](#4l72-1720878002631)

<a name="yavz-1721843514633"></a>[右侧是用户数据库](#hivt-1720878131008)

<a name="lunk-1721843514635"></a>[用户行为日志与用户档案的连接](#cvii-1720878237531)

<a name="obsk-1721843514637"></a>[原始:逐个遍历活动事件关联查询。缺点：吞吐量受限数据库服务器且容易压垮](#eiqe-1720878248508)

<a name="3vhr-1721843514639"></a>[改良：获取用户数据库副本（ETL进程从数据库备份中提取数据，参考数仓），放在同一个分布式文件系统中。将用户数据库存储HDFS中的一组文件中，用户活动记录存储另一组文件中，](#iueg-1720878322010)

<a name="isza-1721843514641"></a>[并能用MapReduce将左右相关记录集中到同一个地方进行高效处理。](#ruua-1720878498786)

<a name="m11j-1721843514643"></a>[排序合并连接](#fihy-1716231663765)

<a name="uhbg-1721843514645"></a>[1.map提取键值(userid-url  usrid-do)和reduce(userid all url do)](#q51q-1720947527716)

<a name="fmwg-1721843514647"></a>[2.二次排序secondary sort ：对1的合并按时间戳排序](#4kvv-1720947648039)

<a name="ido7-1721843514649"></a>[排序合并连接sort-merge join: reduce一次处理一个特定用户所有记录，只需将一条用户记录保存在内存中，无需发送网络请求](#j8br-1720947805879)

<a name="rvuv-1721843514651"></a>[把相关数据放在一起](#8vrk-1716231670998)

<a name="7twm-1721843514653"></a>[Mapper和排序过程确保特定用户id连接操作的必须数据都放在同一个地方](#t1tc-1720947947656)

<a name="tymp-1721843514655"></a>[GROUP BY](#9j4s-1716228658160)

<a name="bafp-1721843514657"></a>[除了连接之外，“把相关数据放在一起”的常见模式是记录分组。SQL中的Group By](#a6wg-1720952083180)

<a name="3mqp-1721843514659"></a>[处理倾斜](#qa24-1716231688547)

<a name="25fr-1721843514661"></a>[名流热点数据hot spot](#f55j-1720952155251)

<a name="xwuh-1721843514663"></a>[参考负载倾斜和消除热点](#julg-1720952222343)

<a name="mgwb-1721843514665"></a>[Mapper将热键的关联记录随机发送到几个Reduce之一](#akfb-1720952286891)

<a name="x3nw-1721843514667"></a>[Map端连接](#2tox-1716228671225)

<a name="rd1b-1721843514669"></a>[预处理输入数据](#qiil-1720971178915)

<a name="h6zo-1721843514671"></a>[广播散列连接](#wjhj-1716231713037)

<a name="pjfi-1721843514673"></a>[broadcast hash join](#k3se-1720971260954)

<a name="dpzc-1721843514675"></a>[分区散列连接](#su27-1716231723170)

<a name="9xvq-1721843514677"></a>[Map桶端连接bucketd map jons](#5h9a-1720971514797)

<a name="k1bu-1721843514679"></a>[Map端合并连接](#ftdq-1716231736611)

<a name="s1hy-1721843514681"></a>[MapReduce工作流与Map端连接](#yrmc-1716231744413)

<a name="shym-1721843514683"></a>[批处理工作流的输入](#zzir-1716228678980)

<a name="kkit-1721843514685"></a>[OLTP ：查找少量记录，使用索引，呈现给用户](#hiqn-1720971586510)

<a name="47ps-1721843514687"></a>[OLAP：扫描大量记录，执行分组与聚合，输出有着报告的形式，商业决策的分析。](#cqba-1720971612883)

<a name="wr7h-1721843514689"></a>[建立搜索索引](#bwjf-1716231761454)

<a name="ure8-1721843514691"></a>[MapReduce最初作为google搜索引擎的索引](#lypn-1720971694941)

<a name="grft-1721843514693"></a>[全文搜索和模糊索引  Lucene](#iijq-1720971776882)

<a name="vbei-1721843514695"></a>[分区和二级索引](#vcun-1720971828838)

<a name="9xi5-1721843514697"></a>[键值存储作为批处理输入](#8fix-1716231782091)

<a name="gn2j-1721843514699"></a>[批处理输入的哲学](#audd-1716231802005)

<a name="nciv-1721843514701"></a>[视为不可变且避免副作用：](#6i34-1720972317458)

<a name="3v4t-1721843514703"></a>[人类容错human fault tolerance](#zciu-1720972319614)

<a name="nawt-1721843514705"></a>[最小化不可逆性mininizing irreversibility](#oolm-1720972319615)

<a name="lm5a-1721843514707"></a>[Hadoop与分布式数据库的对比](#lp33-1716228684462)

<a name="1umy-1721843514709"></a>[Hadoop 像Unix的分布式版本，HDFS是它的文件系统，而MapReduce是Unix进程的怪异实现](#g0vj-1720972341966)

<a name="ejin-1721843514711"></a>[MapReduce论文发表前，并行连接算法已在数据库实现-大规模并行处理MPP massively parallel processing ](#gjbt-1720972427948)

<a name="a5yf-1721843514713"></a>[Gamma database machine, Teradata, Tandem NonStop SQL](#go7m-1720972523351)

<a name="orgm-1721843514715"></a>[区别：MMP专注一组及骑行并行执行分析SQL 查询](#5mnr-1720972551600)

<a name="dfj6-1721843514717"></a>[MapReduce和分布式文件系统的组合是一个可以运行任意程序的通用操作系统](#gx7b-1720972580058)

<a name="d7w0-1721843514719"></a>[存储多样性](#eebl-1716231817367)

<a name="gox3-1721843514721"></a>[数据湖data lake / 企业数据中心enterprise data hub](#5lga-1720972673599)

<a name="c2ef-1721843514723"></a>[Hadoop 常用于实现数仓ETL Extract, Transform, Load](#jrhw-1720972777529)

<a name="v8cu-1721843514725"></a>[处理模型多样](#ysfv-1716231826972)

<a name="pmbs-1721843514727"></a>[针对频繁故障设计](#kwz4-1716231831752)

<a name="cpos-1721843514729"></a>[MapReduce之后](#p0zx-1716228568687)

<a name="xocb-1721843514731"></a>[建立在MapReduce上的高级编程模型](#wcyn-1721117329960)

<a name="ahjz-1721843514733"></a>[Pig，Hive, Cascading, Crunch](#l9ug-1721117359714)

<a name="hive-1721843514735"></a>[流处理：加速批处理的另一种方法](#bz2s-1721117576614)

<a name="kfy7-1721843514737"></a>[物化中间状态](#fvak-1716228706372)

<a name="uuln-1721843514739"></a>[中间状态intermediate state](#npb7-1721117756510)

<a name="ubnj-1721843514741"></a>[物化materialization:中间态写入文件的过程](#0rlu-1721117876651)

<a name="ov2o-1721843514743"></a>[MapReduce完全物化中间态的方法不足：](#fnqf-1721117967688)

<a name="o7db-1721843514745"></a>[只有在前驱作业生成其输入完成时才能启动](#pood-1721117984973)

<a name="xtk4-1721843514747"></a>[mapper通常是多余的：仅仅读取由Reducer写入的同样文件](#iljf-1721118032959)

<a name="ip85-1721843514749"></a>[临时文件（数据）被复制到多个节点](#tghz-1721118071785)

<a name="eymz-1721843514751"></a>[解决：数据流引擎](#aer2-1721118148615)

<a name="kqoj-1721843514753"></a>[数据流引擎](#sdac-1716231877023)

<a name="o8vl-1721843514755"></a>[分布式批处理新引擎：](#4gu5-1721118111495)

<a name="wpvm-1721843514757"></a>[spark,  Flink: 独立的网络通信层，调度器，用户向API](#nfnv-1721118162692)

<a name="8son-1721843514759"></a>[Tez : 薄库，依赖YARN shuffle服务实现节点间的数据复制](#0kbz-1721123564974)

<a name="op6n-1721843514761"></a>[dataflow engines模型:](#jojo-1721118227522)

<a name="xt2q-1721843514763"></a>[函数/算子operators: 一个算子的输出连接到另一个算子的输入](#kstp-1721118246090)

<a name="otfv-1721843514765"></a>[优点：](#zbrh-1721118327524)

<a name="z9sg-1721843514767"></a>[排序等昂贵工作只需在实际需要地方执行，不是默认在Map和Reduce阶段间](#8oqo-1721118330975)

<a name="omp4-1721843514769"></a>[没有不必要的Map任务](#amzf-1721118375240)

<a name="akvv-1721843514771"></a>[连接和数据依赖都是显示声明的](#bunw-1721118382779)

<a name="efz2-1721843514773"></a>[算子中间态足以保存内存或写入本地磁盘，比HDFS需要更少I/O](#bzui-1721122836028)

<a name="jvmb-1721843514775"></a>[算子可在输入就绪后立即执行，不许等待前驱完成](#ka7f-1721123164712)

<a name="2vdo-1721843514777"></a>[MapReduce为每个任务启动新JVM, 而df enginer可重用现有JVM，减少启动开销](#rmr3-1721123191298)

<a name="exxy-1721843514779"></a>[执行速度更快](#mp4i-1721123431562)

<a name="tths-1721843514781"></a>[使用：](#2cxo-1721123304059)

<a name="sof5-1721843514783"></a>[算子是Map和Reduce的泛化/抽象，相同处理代码可在任意引擎上运行](#vyfa-1721123442398)

<a name="rcsb-1721843514785"></a>[Pig Hive Casacding中实现的工作流无需修改代码，修改配置，从MapReduce切换到Tez 或spark.](#qxck-1721123483308)

<a name="6a0g-1721843514787"></a>[容错](#glfr-1716231882229)

<a name="xc77-1721843514789"></a>[重启，算子重新计算](#neqa-1721499456929)

<a name="osrg-1721843514791"></a>[关于物化的讨论](#npsg-1716231884238)

<a name="5caa-1721843514793"></a>[图与迭代处理](#dvkh-1716228727874)

<a name="cscb-1721843514795"></a>[图数据模型常用于机器学习应用](#y476-1721499725472)

<a name="zzms-1721843514797"></a>[图形算法PageRank:根据连接到某个网页的其他网页来估计该网页的流行度](#ld62-1721499760165)

<a name="iqux-1721843514799"></a>[闭包传递transitive clousure: 重复跟进标明地点归属关系的边，生成数据库中北美地点列表](#et5r-1721499798288)

<a name="14hu-1721843514801"></a>[MapReduce低效：没考虑算法迭代性](#x4m1-1721499995671)

<a name="anpg-1721843514803"></a>[Pregel处理模型](#lf5y-1716231892007)

<a name="picp-1721843514805"></a>[图批处理的优化：批量同步并行（BSP）计算模型。](#1faf-1721499959178)

<a name="vmf7-1721843514807"></a>[Pregel模型：Google的Pregel论文推广了处理图的方法。Apache Giraph , Spark GraphX API 和 Flink Gelly API](#3mh8-1721500149918)

<a name="k7f7-1721843514809"></a>[容错](#pxnd-1716231909468)

<a name="cll4-1721843514811"></a>[并行执行](#v8gr-1716231912877)

<a name="amsc-1721843514813"></a>[高级API和语言](#cxqk-1716228736349)

<a name="fit2-1721843514815"></a>[Hive,pig, Cascading,Crunch等高级语言和API, Tez](#qlnr-1721841646688)

<a name="qis0-1721843514817"></a>[向声明式查询语言的转变](#dfa6-1716231923208)

<a name="h2vn-1721843514819"></a>[声明式declarative](#zman-1721841903902)

<a name="jv8m-1721843514821"></a>[与SQL的完全声明式查询有很大的区别：](#inea-1721841971310)

<a name="hyfi-1721843514823"></a>[围绕回调函数的概念建立，自由调用任意代码来决定输出什么。](#ahki-1721842021736)

<a name="rdfj-1721843514825"></a>[可基于大量已有库的生态系统创作： 解析、自然语言分析，图像分析以及运算数值算法或统计算法等。](#bdyf-1721842047384)

<a name="ctnj-1721843514827"></a>[专业化的不同领域](#m2pu-1716231937991)

<a name="76cb-1721843514829"></a>[空间算法：最近邻搜索K-nearest neghbors](#wpot-1721842227412)
...
<a name="djyj-1716228436077"></a><a name="lk3f-1721118456500"></a><a name="m2ie-1721118456661"></a>技术选型应该区分使用场景，不是技术不行，而是哪些技术更适合哪些场景。新技术的出现就是为了解决新的场景下出现的问题。 
